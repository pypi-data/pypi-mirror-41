...
def check_compatible_version(gateVer, compVer, majorVer):
    ...
    #elif rev > compVer :
    #    raise RuntimeError('API versions not compatible, gateway: {} library: {}, library upgrade required'
    #                       .format(gateVer[:3], majorVer))
...
class Group:
    ...
    def __init__(self, gateway='http://localhost:33000', group='me', timeout=60, ssl_untrusted=True, ssl_cert_file=None,
        ...
        #raise RuntimeError('This version does not match with the gateway. Please update to newer version.')
...
class Device:
    ...
    def get(self, parameter='', after=None, options=False, attributes=None, args=None):
