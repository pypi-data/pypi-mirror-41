...
if not os.environ['ADRILL_USER_CFG']:
    raise EnvironmentError('ADRILL_USER_CFG environment variable is not set!')
if not os.path.exists(os.environ['ADRILL_USER_CFG']):
...
if not os.environ['ADRILL_SHARED_CFG']:
    raise EnvironmentError('ADRILL_SHARED_CFG environment variable is not set!')
if not os.path.exists(os.environ['ADRILL_SHARED_CFG']):
