...
class MotController:
    ...
    def _setInverted_2(self, invertType: int) -> None:
        assert isinstance(invertType, int)
    ...
    def configSelectedFeedbackSensor(self, feedbackDevice: int, pidIdx: int = 0, timeoutMs: int = 0) -> ErrorCode:
    ...
    def configRemoteFeedbackFilter(self, deviceID: int, remoteSensorSource: int, remoteOrdinal: int, timeoutMs: int = 0) -> ErrorCode:
        ...
        assert isinstance(timeoutMs, int)
        retval = ErrorCode.OK
        raise NotImplementedError("configRemoteFeedbackFilter not implemented in simulation (file a bug on github if you need it)")

    def configSensorTerm(self, sensorTerm: int, feedbackDevice: int, timeoutMs: int = 0) -> ErrorCode:
    ...
    def setSelectedSensorPosition(self, sensorPos: int, pidIdx: int = 0, timeoutMs: int = 0) -> ErrorCode:
    ...
    def configVelocityMeasurementPeriod(self, period: int, timeoutMs: int = 0) -> ErrorCode:
    ...
    def configForwardLimitSwitchSource(self, type: int, normalOpenOrClose: int, deviceID: int = 0, timeoutMs: int = 0) -> ErrorCode:
    ...
    def configReverseLimitSwitchSource(self, type: int, normalOpenOrClose: int, deviceID: int = 0, timeoutMs: int = 0) -> ErrorCode:
    ...
    def configAllowableClosedloopError(self, slotIdx: int, allowableClosedLoopError: int, timeoutMs: int = 0) -> ErrorCode:
    ...
    def getActiveTrajectoryHeading(self) -> float:
        ...
        '''
        raise NotImplementedError("getActiveTrajectoryHeading not implemented in simulation (file a bug on github if you need it)")
    ...
    def getActiveTrajectoryPosition(self, pidIdx: int = 0) -> int:
        ...
        '''
        assert isinstance(pidIdx, int)
        raise NotImplementedError("getActiveTrajectoryPosition not implemented in simulation (file a bug on github if you need it)")
    ...
    def getActiveTrajectoryVelocity(self, pidIdx: int = 0) -> int:
        ...
        '''
        assert isinstance(pidIdx, int)
        raise NotImplementedError("getActiveTrajectoryVelocity not implemented in simulation (file a bug on github if you need it)")
    ...
    def getActiveTrajectoryArbFeedFwd(self, pidIdx: int = 0) -> float:
        ...
        '''
        assert isinstance(pidIdx, int)
        raise NotImplementedError("getActiveTrajectoryArbFeedFwd not implemented in simulation (file a bug on github if you need it)")

    def getActiveTrajectoryAll(self, pidIdx: int = 0) -> typing.Tuple[int, int, float]:
        ...
        '''
        assert isinstance(pidIdx, int)
        raise NotImplementedError("getActiveTrajectoryAll not implemented in simulation (file a bug on github if you need it)")
    ...
    def clearMotionProfileTrajectories(self) -> ErrorCode:
        ...
        '''
        retval = ErrorCode.OK
        raise NotImplementedError("clearMotionProfileTrajectories not implemented in simulation (file a bug on github if you need it)")
    ...
    def getMotionProfileTopLevelBufferCount(self) -> int:
        ...
        '''
        raise NotImplementedError("getMotionProfileTopLevelBufferCount not implemented in simulation (file a bug on github if you need it)")
    ...
    def _pushMotionProfileTrajectory(self, position: float, velocity: float, headingDeg: float, profileSlotSelect: int, isLastPoint: bool, zeroPos: bool) -> ErrorCode:
        ...
        retval = ErrorCode.OK
        raise NotImplementedError("_pushMotionProfileTrajectory not implemented in simulation (file a bug on github if you need it)")
    ...
    def _pushMotionProfileTrajectory_2(self, position: float, velocity: float, headingDeg: float, profileSlotSelect0: int, profileSlotSelect1: int, isLastPoint: bool, zeroPos: bool, durationMs: int) -> ErrorCode:
        ...
        retval = ErrorCode.OK
        raise NotImplementedError("_pushMotionProfileTrajectory_2 not implemented in simulation (file a bug on github if you need it)")
    ...
    def _pushMotionProfileTrajectory_3(self, position: float, velocity: float, arbFeedFwd: float, auxiliaryPos: float, auxiliaryVel: float, auxiliaryArbFeedFwd: float, profileSlotSelect0: int, profileSlotSelect1: int, isLastPoint: bool, zeroPos0: bool, timeDur: int, useAuxPID: bool) -> ErrorCode:
        ...
        assert isinstance(isLastPoint, bool)
        assert isinstance(zeroPos0, bool)
        assert isinstance(timeDur, int) and 0 <= timeDur < 1<<32
        assert isinstance(useAuxPID, bool)
        retval = ErrorCode.OK
        raise NotImplementedError("_pushMotionProfileTrajectory_3 not implemented in simulation (file a bug on github if you need it)")
    ...
    def startMotionProfile(self, stream: None, minBufferedPts: int, controlMode: ControlMode) -> ErrorCode:
        ...
        '''
        assert isinstance(minBufferedPts, int) and 0 <= minBufferedPts < 1<<32
        retval = ErrorCode.OK
        raise NotImplementedError("startMotionProfile not implemented in simulation (file a bug on github if you need it)")
    ...
    def isMotionProfileFinished(self) -> bool:
        ...
        '''
        raise NotImplementedError("isMotionProfileFinished not implemented in simulation (file a bug on github if you need it)")
    ...
    def isMotionProfileTopLevelBufferFull(self) -> bool:
        ...
        '''
        raise NotImplementedError("isMotionProfileTopLevelBufferFull not implemented in simulation (file a bug on github if you need it)")
    ...
    def processMotionProfileBuffer(self) -> ErrorCode:
        ...
        '''
        retval = ErrorCode.OK
        raise NotImplementedError("processMotionProfileBuffer not implemented in simulation (file a bug on github if you need it)")
    ...
    def _getMotionProfileStatus(self) -> typing.Tuple[int, int, int, bool, bool, bool, bool, int, int]:
        ...
        '''
        raise NotImplementedError("_getMotionProfileStatus not implemented in simulation (file a bug on github if you need it)")

    def _getMotionProfileStatus_2(self) -> typing.Tuple[int, int, int, bool, bool, bool, bool, int, int, int, int]:
        raise NotImplementedError("_getMotionProfileStatus_2 not implemented in simulation (file a bug on github if you need it)")
    ...
    def clearMotionProfileHasUnderrun(self, timeoutMs: int = 0) -> ErrorCode:
        ...
        assert isinstance(timeoutMs, int)
        retval = ErrorCode.OK
        raise NotImplementedError("clearMotionProfileHasUnderrun not implemented in simulation (file a bug on github if you need it)")
    ...
    def changeMotionControlFramePeriod(self, periodMs: int) -> ErrorCode:
        ...
        assert isinstance(periodMs, int)
        retval = ErrorCode.OK
        raise NotImplementedError("changeMotionControlFramePeriod not implemented in simulation (file a bug on github if you need it)")

    def configMotionProfileTrajectoryPeriod(self, durationMs: int, timeoutMs: int = 0) -> ErrorCode:
        ...
        assert isinstance(timeoutMs, int)
        retval = ErrorCode.OK
        raise NotImplementedError("configMotionProfileTrajectoryPeriod not implemented in simulation (file a bug on github if you need it)")
    ...
    def configMotionProfileTrajectoryInterpolationEnable(self, enable: bool, timeoutMs: int = 0) -> ErrorCode:
        ...
        assert isinstance(timeoutMs, int)
        retval = ErrorCode.OK
        raise NotImplementedError("configMotionProfileTrajectoryInterpolationEnable not implemented in simulation (file a bug on github if you need it)")
    ...
    def configFeedbackNotContinuous(self, feedbackNotContinuous: bool, timeoutMs: int = 0) -> ErrorCode:
        ...
        '''
        assert isinstance(feedbackNotContinuous, bool)
        assert isinstance(timeoutMs, int)
        retval = ErrorCode.OK
        raise NotImplementedError("configFeedbackNotContinuous not implemented in simulation (file a bug on github if you need it)")
    ...
    def configRemoteSensorClosedLoopDisableNeutralOnLOS(self, remoteSensorClosedLoopDisableNeutralOnLOS: bool, timeoutMs: int = 0) -> ErrorCode:
        ...
        '''
        assert isinstance(remoteSensorClosedLoopDisableNeutralOnLOS, bool)
        assert isinstance(timeoutMs, int)
        retval = ErrorCode.OK
        raise NotImplementedError("configRemoteSensorClosedLoopDisableNeutralOnLOS not implemented in simulation (file a bug on github if you need it)")
    ...
    def configClearPositionOnLimitF(self, clearPositionOnLimitF: bool, timeoutMs: int = 0) -> ErrorCode:
        ...
        '''
        assert isinstance(clearPositionOnLimitF, bool)
        assert isinstance(timeoutMs, int)
        retval = ErrorCode.OK
        self.hal_data['clear_pos_on_limit_fwd'] = clearPositionOnLimitF
        assert isinstance(retval, ErrorCode)
        return retval
    ...
    def configClearPositionOnLimitR(self, clearPositionOnLimitR: bool, timeoutMs: int = 0) -> ErrorCode:
        ...
        '''
        assert isinstance(clearPositionOnLimitR, bool)
        assert isinstance(timeoutMs, int)
        retval = ErrorCode.OK
        self.hal_data['clear_pos_on_limit_rev'] = clearPositionOnLimitR
        assert isinstance(retval, ErrorCode)
        return retval
    ...
    def configClearPositionOnQuadIdx(self, clearPositionOnQuadIdx: bool, timeoutMs: int = 0) -> ErrorCode:
        ...
        '''
        assert isinstance(clearPositionOnQuadIdx, bool)
        assert isinstance(timeoutMs, int)
        retval = ErrorCode.OK
        raise NotImplementedError("configClearPositionOnQuadIdx not implemented in simulation (file a bug on github if you need it)")
    ...
    def configLimitSwitchDisableNeutralOnLOS(self, limitSwitchDisableNeutralOnLOS: bool, timeoutMs: int = 0) -> ErrorCode:
        ...
        '''
        assert isinstance(limitSwitchDisableNeutralOnLOS, bool)
        assert isinstance(timeoutMs, int)
        retval = ErrorCode.OK
        self.hal_data['limit_switch_disable_neutral_on_los'] = limitSwitchDisableNeutralOnLOS
        assert isinstance(retval, ErrorCode)
        return retval
    ...
    def configSoftLimitDisableNeutralOnLOS(self, softLimitDisableNeutralOnLOS: bool, timeoutMs: int = 0) -> ErrorCode:
        ...
        '''
        assert isinstance(softLimitDisableNeutralOnLOS, bool)
        assert isinstance(timeoutMs, int)
        retval = ErrorCode.OK
        self.hal_data['soft_limit_disable_neutral_on_los'] = softLimitDisableNeutralOnLOS
        assert isinstance(retval, ErrorCode)
        return retval
    ...
    def configPulseWidthPeriod_EdgesPerRot(self, pulseWidthPeriod_EdgesPerRot: int, timeoutMs: int = 0) -> ErrorCode:
        ...
        '''
        assert isinstance(pulseWidthPeriod_EdgesPerRot, int)
        assert isinstance(timeoutMs, int)
        retval = ErrorCode.OK
        self.hal_data['pulse_width_period_edges_per_rot'] = pulseWidthPeriod_EdgesPerRot
        assert isinstance(retval, ErrorCode)
        return retval
    ...
    def configPulseWidthPeriod_FilterWindowSz(self, pulseWidthPeriod_FilterWindowSz: int, timeoutMs: int = 0) -> ErrorCode:
        ...
        '''
        assert isinstance(pulseWidthPeriod_FilterWindowSz, int)
        assert isinstance(timeoutMs, int)
        retval = ErrorCode.OK
        self.hal_data['pulse_width_period_filter_window_sz'] = pulseWidthPeriod_FilterWindowSz
        assert isinstance(retval, ErrorCode)
        return retval
    ...
    def setMPEOutput(self, MpeOutput: int) -> ErrorCode:
        ...
        retval = ErrorCode.OK
        raise NotImplementedError("setMPEOutput not implemented in simulation (file a bug on github if you need it)")
    ...
    def getClosedLoopTarget(self, pidIdx: int = 0) -> int:
