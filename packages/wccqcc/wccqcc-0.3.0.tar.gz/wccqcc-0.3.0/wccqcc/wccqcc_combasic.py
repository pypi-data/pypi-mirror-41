...
def thread_main(thread_id, thread_jobs, thread_params, thread_results):
    try: 
        ...
        thread_results["addinfo"]["lot"] += finish_time - start_time
...
def wcc_qcc_combasic(THREAD_N):
    ...
    thread_results={"combasic":[],"error_urls":[],"done_urls":[],"addinfo":{"insert":0,"update":0,"ignore":0,"except":0,"lot":0,"threads":0,"threadn":THREAD_N}}
    ...
    thread_results["addinfo"]["time"] = timestr
    finish_time = int(time.time())
    thread_results["addinfo"]["lot"] = finish_time - start_time
