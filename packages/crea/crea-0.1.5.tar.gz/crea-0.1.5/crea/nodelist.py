...
class NodeList(list):
    ...
    def __init__(self):
        nodes = [
            ...
            {
                "url": "https://cread-appbase.creary.net",
                "version": "0.20.2",
                "type": "appbase",
                "owner": "creait",
                "score": -10
            ...
            {
                "url": "wss://cread-appbase.creary.net",
                "version": "0.20.2",
                "type": "appbase",
                "owner": "creait",
                "score": -10
            ...
            {
                "url": "wss://cread.minnowsupportproject.org",
                "version": "0.19.11",
                "type": "appbase",
                "owner": "followbtcnews",
                "score": -10
            ...
            {
                "url": "https://cread.minnowsupportproject.org",
                "version": "0.19.12",
                "type": "appbase",
                "owner": "followbtcnews",
                "score": 10
            ...
            {
                "url": "https://testnet.creaitdev.com",
                "version": "0.21.0",
                "type": "testnet-dev",
                "owner": "creait",
                "score": 5
    ...
    def update_nodes(self, weights=None, crea_instance=None):
        """ Reads metadata from fullnodeupdate and recalculates the nodes score
            ...
            .. code-block:: python
                ...
                nl.update_nodes(weights)
        """
        crea = crea_instance or shared_crea_instance()
        metadata = None
        account = None
        cnt = 0
        while metadata is None and cnt < 5:
            cnt += 1
            try:
                account = Account("fullnodeupdate", crea_instance=crea)
