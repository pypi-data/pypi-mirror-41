...
@click.option('--username', type=str, help="Trustpilot username",
              envvar='TRUSTPILOT_USERNAME')
@click.option('--password', type=str, help="Trustpilot password",
...
def create_access_token():
    ...
    Get an access token
    '''
    access_token = auth.request_new_access_token(client.get_session())
