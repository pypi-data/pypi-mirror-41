...
setup(
    ...
    python_requires='>=3',
    install_requires=['argdirective', 'os', 're', 'fnmatch', 'augeas', 'yaml', 'json', 'dpath', 'errno', 'stat', 'lockfile', 'collections', 'time', 'shutils', 'llfuse', 'xattr', 'datetime', 'argparse', 'sys', 'faulthandler'],
