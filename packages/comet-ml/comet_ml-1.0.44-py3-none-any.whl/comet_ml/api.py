...
class APIExperiment(object):
    ...
    def get_asset(self, asset_id):
        ...
        """
        return self._api.get_experiment_asset(self.key, asset_id)

    def upload_asset(self, filename, step=None,
                     overwrite=None, context=None):
        """
        Upload an asset to this experiment.
        """
        return self._api.upload_asset(self.key,
                                      filename=filename,
                                      step=step,
                                      overwrite=overwrite,
                                      context=context)

    def upload_image(self, filename, image_name=None,
                      step=None, overwrite=None, context=None):
        """
        Upload an image to this experiment.
        """
        return self._api.upload_image(self.key,
                                      filename=filename,
...
class API(object):
    ...
    """
    DEFAULT_VERSION = "v1"
    URLS = {"v1": {"SERVER": _get_server_url(),
                   "REST": "/api/rest/v1/"}}
    ...
    def post_request(self, end_point, json=None, **kwargs):
        ...
        if json is None:
            json = {}
        LOGGER.debug("API.post_request: url = %s, json = %s",
                     url, json)
        headers = {
            self.COMET_HEADER: self._rest_api_key,
            "PYTHON-SDK-VERSION": __version__,
    ...
    def set_experiment_parameter(self, experiment_key, parameter, value,
                                 step=None):
        """
    ...
    def set_experiment_metric(self, experiment_key, metric, value,
                                 step=None):
        """
    ...
    def set_experiment_start_end(self, experiment_key, start, end):
        ...
        results = self.post_request(
            "write/experiment-start-end-time", json)
        self._rebuild_cache()
        return results
    ...
    def upload_asset(self, experiment_key, filename, step=None,
                     overwrite=None, context=None):
        """
    ...
    def upload_image(self, experiment_key, filename, image_name=None,
                     step=None, overwrite=None, context=None):
        """
