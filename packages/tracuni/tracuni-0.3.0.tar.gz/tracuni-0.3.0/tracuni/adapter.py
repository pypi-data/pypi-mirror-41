...
from tracuni.side_steps.stat.intercept import (
...
def fab_tracer(component_class=None, ):
    # вариант адаптера для работы с Tornado-based приложением
    if component_class is None:
        class TracerBase(ABC, FutureTracer):
            variant = 'tornado'
    ...
    # вариант адаптера для работы с новым framework "core"
    else:
