...
from tracuni.schema.builtin.pipe import (
    ...
    pipe_dump,
    pipe_cut,
    ext_send_request_args, ext_api_kind, pipe_by_name)
...
ruleset = (
    ...
    Rule(
        ...
        pipeline=(
            pipe_head,
            partial(pipe_by_name, **{"name": "response_body"}),
        ),
        origins=(
            Origin(
    ...
    Rule(
        ...
        pipeline=(
            pipe_head,
            partial(pipe_by_name, **{"name": "response_code"}),
        ),
        origins=(
            Origin(
                OriginSection.REUSE, "response"
    ...
    Rule(
        ...
        pipeline=(
            pipe_head,
            partial(pipe_by_name, **{"name": "response_headers"}),
            pipe_dump,
        ),
        origins=(
            Origin(
    ...
    Rule(
        ...
        pipeline=(
            pipe_head,
            partial(pipe_by_name, **{"name": "request_cert"}),
        ),
        origins=(
            Origin(
                OriginSection.REUSE, "response"
