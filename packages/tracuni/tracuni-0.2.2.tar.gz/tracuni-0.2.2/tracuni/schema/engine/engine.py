...
if TYPE_CHECKING:
    ...
    from tracuni.adapter import TracerWrapperRef  # noqa
...
class SchemaEngine(metaclass=SchemaEngineCache):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self.adapter = None  # type: TracerWrapperRef
    ...
    def observe_state_change(self, adapter: 'TracerWrapperRef'):
        """
...
# Area privata
    ...
    def _update_point_context(
        ...
        if dest is None:
            ...
            new_args = namedtuple("PointArgumets", old_vals)(**{
                **old_vals,
    ...
    def _skip_secret(self, fn: Callable, destination: "Destination") -> bool:
        """Проврка условия пропуска обработчика маскирования по команде
