...
class Context(object):
    class Data(object):
        ...
        def __eq__(self, other):
            ...
            return self.data_dict is not None \
                ...
                and self.data_dict.get(CONTEXT_UID_NAME) == other.data_dict.get(CONTEXT_UID_NAME)
    ...
    def __exit__(self, exc_type, exc_value, traceback):
        ...
        Context._instances_registry = [p for i, p in enumerate(Context._instances_registry) if i not in remove]
