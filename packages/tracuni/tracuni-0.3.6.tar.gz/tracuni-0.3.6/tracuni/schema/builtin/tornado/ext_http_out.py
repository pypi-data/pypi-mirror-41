...
ruleset = (
    ...
    Rule(
        ...
        pipeline=(
            pipe_head,
            lambda v: v.get('response_body') if getattr(v, "get", False) else "error",
        ),
        origins=(
            Origin(
    ...
    Rule(
        ...
        pipeline=(
            pipe_head,
            lambda v: v.get('response_code') if getattr(v, "get", False) else "error",
        ),
        origins=(
            Origin(
                OriginSection.REUSE, "response"
    ...
    Rule(
        ...
        pipeline=(
            pipe_head,
            lambda v: v.get('response_headers') if getattr(v, "get", False) else "error",
            pipe_dump,
        ),
        origins=(
            Origin(
    ...
    Rule(
        ...
        pipeline=(
            pipe_head,
            lambda v: len(v.get('response_body')) if getattr(v, "get", False) else "error",
        ),
        origins=(
            Origin(
                OriginSection.REUSE, "response"
    ...
    Rule(
        ...
        pipeline=(
            pipe_head,
            lambda v: v.get('request_cert') if getattr(v, "get", False) else "error",
        ),
        origins=(
            Origin(
                OriginSection.REUSE, "response"
