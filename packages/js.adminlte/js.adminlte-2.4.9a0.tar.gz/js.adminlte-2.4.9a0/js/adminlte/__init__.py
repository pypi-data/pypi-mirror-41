...
fontawesome_css = Resource(library, 'font-awesome/css/font-awesome.css',
							minified = 'font-awesome/css/font-awesome.min.css',
							depends = [adminlte_css])

input_mask = Resource(library,
					'plugins/input-mask/jquery.inputmask.bundle.js',
					minified = 'plugins/input-mask/jquery.inputmask.bundle.min.js',
					depends = [adminlte_js],
					bottom = True
					)
...
all_plugins_js = Resource(library, 'all.js',
					depends=[adminlte_js,fontawesome_css, slimscroll_js, pace_js, icheck_js, bootstrap_wysihtml5_js,
