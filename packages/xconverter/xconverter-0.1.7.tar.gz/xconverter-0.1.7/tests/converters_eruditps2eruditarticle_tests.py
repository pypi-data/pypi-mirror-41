...
class TestEruditPS2EruditAticle(unittest.TestCase):
    ...
    def test_article_meta_title_group_title(self):
        ...
        expected = '<titre>« Chantez au Seigneur un chant nouveau… » (Ps.95.1) : le portrait de la musique <marquage typemarq="italique">rock</marquage> chrétienne</titre>'
        self.assertEqual(
    ...
    def test_article_meta_title_group_subtitle(self):
        ...
        expected = '<sstitre>Article <marquage typemarq="italique">Subtitle</marquage></sstitre>'
        self.assertEqual(
            etree.tostring(result, encoding="utf-8").decode('utf-8'),
            expected
        )
    ...
    def test_article_meta_title_group_translated_title(self):
        ...
        expected = """<titreparal lang="en">Translated title in <marquage typemarq="italique">english</marquage></titreparal>"""
    ...
    def test_article_meta_title_group_translated_subtitle(self):
        ...
        expected = """<sstitreparal lang="en">Translated subtitle in <marquage typemarq="italique">english</marquage></sstitreparal>"""
    ...
    def test_article_meta_contrib_group_content_surname(self):
        ...
        self.assertEqual(result, ['Falardeau', 'Perreault'])
    ...
    def test_article_meta_contrib_group_content_given_names(self):
        ...
        self.assertEqual(result, ['Marie-Chantal', 'Stéphane'])
    ...
    def test_article_meta_contrib_id(self):
        ...
        self.assertEqual(result, ['au1', 'au2', 'au3', 'au4'])
    ...
    def test_permissions_copyright_statement(self):
        ...
        expected = """<declaration>Tous droits réservés © Approches inductives, 2014</declaration>"""
    ...
    def test_trans_abstract(self):
        ...
        expected = """<resume lang="en"><titre>Abstract</titre><alinea>Abstract translation sample.</alinea></resume>"""
    ...
    def test_epigraph(self):
        ...
        expected = """<epigraphe><alinea>Un jour, tout sera bien, voilà notre espérance :</alinea><alinea>Tout est bien aujourd’hui, voilà l’illusion.</alinea><source>Voltaire, <marquage typemarq="italique">Le désastre de Lisbonne</marquage></source></epigraphe>"""
