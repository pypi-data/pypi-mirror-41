...
class PerfTime(object):
	...
	def getPreferedSeat(self, count=2, prefer=None, serial=True, strict=True):
...
class Yes24(object):
	...
	def browser_login(self, x=0, y=0):
		self.sel = Selenium_yes24(idperf=self.idperf, x=x, y=y)
	...
	def browser_wait_last_page(self, payment_method=1):
		self.sel.goLastPage()
