...
- barClassName (string; optional): CSS classes to apply to the bar."""
    ...
    def __init__(self, children=None, id=Component.UNDEFINED, style=Component.UNDEFINED, className=Component.UNDEFINED, tag=Component.UNDEFINED, bar=Component.UNDEFINED, multi=Component.UNDEFINED, max=Component.UNDEFINED, value=Component.UNDEFINED, animated=Component.UNDEFINED, striped=Component.UNDEFINED, color=Component.UNDEFINED, barClassName=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'style', 'className', 'tag', 'bar', 'multi', 'max', 'value', 'animated', 'striped', 'color', 'barClassName']
        self._type = 'Progress'
        self._namespace = 'dash_bootstrap_components/_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'style', 'className', 'tag', 'bar', 'multi', 'max', 'value', 'animated', 'striped', 'color', 'barClassName']
