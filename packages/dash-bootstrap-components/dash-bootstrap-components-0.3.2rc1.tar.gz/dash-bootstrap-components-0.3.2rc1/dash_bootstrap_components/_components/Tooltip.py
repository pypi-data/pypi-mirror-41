...
- boundaries_element (string; optional): boundaries for popper, can be scrollParent, window, viewport, or any DOM element
...
- offset (string | number; optional): Tooltip offset"""
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, style=Component.UNDEFINED, className=Component.UNDEFINED, target=Component.UNDEFINED, boundaries_element=Component.UNDEFINED, hide_arrow=Component.UNDEFINED, container=Component.UNDEFINED, delay=Component.UNDEFINED, innerClassName=Component.UNDEFINED, arrowClassName=Component.UNDEFINED, autohide=Component.UNDEFINED, placement=Component.UNDEFINED, offset=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'style', 'className', 'target', 'boundaries_element', 'hide_arrow', 'container', 'delay', 'innerClassName', 'arrowClassName', 'autohide', 'placement', 'offset']
        self._type = 'Tooltip'
        self._namespace = 'dash_bootstrap_components/_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'style', 'className', 'target', 'boundaries_element', 'hide_arrow', 'container', 'delay', 'innerClassName', 'arrowClassName', 'autohide', 'placement', 'offset']
