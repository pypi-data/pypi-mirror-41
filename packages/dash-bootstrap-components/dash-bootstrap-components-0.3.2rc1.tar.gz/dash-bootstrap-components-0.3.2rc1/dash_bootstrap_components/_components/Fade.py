...
- base_class_active (string; optional): CSS class used when the fade contents are displayed. Default: 'show'."""
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, style=Component.UNDEFINED, className=Component.UNDEFINED, is_in=Component.UNDEFINED, timeout=Component.UNDEFINED, appear=Component.UNDEFINED, enter=Component.UNDEFINED, exit=Component.UNDEFINED, tag=Component.UNDEFINED, base_class=Component.UNDEFINED, base_class_active=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'style', 'className', 'is_in', 'timeout', 'appear', 'enter', 'exit', 'tag', 'base_class', 'base_class_active']
        self._type = 'Fade'
        self._namespace = 'dash_bootstrap_components/_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'style', 'className', 'is_in', 'timeout', 'appear', 'enter', 'exit', 'tag', 'base_class', 'base_class_active']
