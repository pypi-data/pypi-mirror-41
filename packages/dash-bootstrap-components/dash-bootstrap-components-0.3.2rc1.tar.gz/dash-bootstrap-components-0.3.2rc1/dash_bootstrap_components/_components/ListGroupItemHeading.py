...
class ListGroupItemHeading(Component):
...
- tag (string; optional): HTML tag to use for the heading, default: h5"""
    ...
    def __init__(self, children=None, id=Component.UNDEFINED, style=Component.UNDEFINED, className=Component.UNDEFINED, tag=Component.UNDEFINED, **kwargs):
        ...
        self._type = 'ListGroupItemHeading'
        ...
        super(ListGroupItemHeading, self).__init__(children=children, **args)
        ...
        if(any(getattr(self, c, None) is not None
           ...
           or any(getattr(self, c, None) is not None
            ...
            wilds_string = ', '.join([c+'='+repr(getattr(self, c, None))
                                      ...
                                      for wc_attr in
                                      self._valid_wildcard_attributes])])
            return ('ListGroupItemHeading(' + props_string +
