...
- block (boolean; optional): Create block button.
...
- outline (boolean; optional): Set outline button style."""
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, n_clicks=Component.UNDEFINED, n_clicks_timestamp=Component.UNDEFINED, key=Component.UNDEFINED, active=Component.UNDEFINED, block=Component.UNDEFINED, color=Component.UNDEFINED, disabled=Component.UNDEFINED, size=Component.UNDEFINED, outline=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'className', 'style', 'n_clicks', 'n_clicks_timestamp', 'key', 'active', 'block', 'color', 'disabled', 'size', 'outline']
        self._type = 'Button'
        self._namespace = 'dash_bootstrap_components/_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'style', 'n_clicks', 'n_clicks_timestamp', 'key', 'active', 'block', 'color', 'disabled', 'size', 'outline']
