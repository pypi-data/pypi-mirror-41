...
- expand (boolean | string; optional): Specify screen size at which to expand the menu bar, e.g. sm, md, lg etc."""
    ...
    def __init__(self, children=None, id=Component.UNDEFINED, style=Component.UNDEFINED, className=Component.UNDEFINED, key=Component.UNDEFINED, brand=Component.UNDEFINED, brand_href=Component.UNDEFINED, brand_style=Component.UNDEFINED, brand_external_link=Component.UNDEFINED, fluid=Component.UNDEFINED, light=Component.UNDEFINED, dark=Component.UNDEFINED, fixed=Component.UNDEFINED, sticky=Component.UNDEFINED, color=Component.UNDEFINED, expand=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'style', 'className', 'key', 'brand', 'brand_href', 'brand_style', 'brand_external_link', 'fluid', 'light', 'dark', 'fixed', 'sticky', 'color', 'expand']
        self._type = 'NavbarSimple'
        self._namespace = 'dash_bootstrap_components/_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'style', 'className', 'key', 'brand', 'brand_href', 'brand_style', 'brand_external_link', 'fluid', 'light', 'dark', 'fixed', 'sticky', 'color', 'expand']
