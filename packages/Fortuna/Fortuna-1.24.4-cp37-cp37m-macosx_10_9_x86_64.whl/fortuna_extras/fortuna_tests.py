...
def tests(label: str):
    ...
    distribution_timer(d, 2**64 // 2 - 1, dist=False)
    ...
    distribution_timer(monty.quantum_not_monty, call_sig="monty.quantum_not_monty()")

    truffle_shuffle = TruffleShuffle(some_list)
    print(f"truffle_shuffle = {truffle_shuffle}\n")
    ...
    print(f"random_walk = {random_walk}\n")
...
if __name__ == "__main__":
    tests("Fortuna 1.24.4 Sample Distribution and Performance Test Suite")
