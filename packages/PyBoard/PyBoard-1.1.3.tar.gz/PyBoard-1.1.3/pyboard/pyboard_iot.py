...
class PyboardIOT:
    def __init__(self, my_core):
        ...
        self.command_map = {
            ...
            "neopixel_config": self.neopixel_config,
            "neopixel_setcolor": self.neopixel_setcolor,
    ...
    async def neopixel_config(self, command):
        """
        This method configures a digital pin to support neopixel_config devices.
        This is a FirmataPlus feature.
        :param command: {"method": "neopixel_config", "params": [datapin,, count, brightness]}
    ...
    async def neopixel_setcolor(self, command):
        """
        This method retrieves the last sonar data value that was cached.
        This is a polling method. After sonar config, sonar_data_reply messages will be sent automatically.
        :param command: {"method": "sonar_read", "params": [TRIGGER_PIN]}
