...
def bginfo():
    ...
    while True:
        ...
        table_header_fmt = "{_uid:7.7}{user:10.10}{datetime_start:16.16}{path_fds:30.30}{num_omp:7.7}{num_mpi:7.7}{progress:11.11}{status:6.6}\n"
        table_content_fmt = "{_uid:<7.7}{user:<10.6}{datetime_start:16.12}{path_fds:<30.26}{num_omp:<7d}{num_mpi:<7d}{progress:<11.1f}{status:<6d}\n"
