...
class DefaultApi(object):
    ...
    def delete_activity(self, external_key, client_id, integration_id, **kwargs):  # noqa: E501
        """Hard delete an activity by external key  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_activity(external_key, client_id, integration_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_activity_with_http_info(external_key, client_id, integration_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_activity_with_http_info(external_key, client_id, integration_id, **kwargs)  # noqa: E501
            return data

    def delete_activity_with_http_info(self, external_key, client_id, integration_id, **kwargs):  # noqa: E501
        """Hard delete an activity by external key  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_activity_with_http_info(external_key, client_id, integration_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('external_key' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `external_key` when calling `delete_activity`")  # noqa: E501
        # verify the required parameter 'client_id' is set
        if ('client_id' not in local_var_params or
                local_var_params['client_id'] is None):
            raise ValueError("Missing the required parameter `client_id` when calling `delete_activity`")  # noqa: E501
        # verify the required parameter 'integration_id' is set
        if ('integration_id' not in local_var_params or
                local_var_params['integration_id'] is None):
            raise ValueError("Missing the required parameter `integration_id` when calling `delete_activity`")  # noqa: E501
    ...
    def query(self, client_id, **kwargs):  # noqa: E501
        """Performs an aggregation query against an existing dataset  # noqa: E501
    ...
    def update_page(self, page_id, client_id, **kwargs):  # noqa: E501
        """Updates an existing page  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_page(page_id, client_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_page_with_http_info(page_id, client_id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_page_with_http_info(page_id, client_id, **kwargs)  # noqa: E501
            return data

    def update_page_with_http_info(self, page_id, client_id, **kwargs):  # noqa: E501
        """Updates an existing page  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_page_with_http_info(page_id, client_id, async_req=True)
        >>> result = thread.get()
