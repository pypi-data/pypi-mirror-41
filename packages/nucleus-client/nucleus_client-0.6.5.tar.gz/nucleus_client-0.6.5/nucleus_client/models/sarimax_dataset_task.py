...
class SarimaxDatasetTask(object):
    ...
    def __init__(self, dataset=None, date_column=None, dimensions=None, max_predict=None, metric=None, min_predict=None, output_activity_type=None, periodicity=None, periods_to_predict=None, write=None):  # noqa: E501
