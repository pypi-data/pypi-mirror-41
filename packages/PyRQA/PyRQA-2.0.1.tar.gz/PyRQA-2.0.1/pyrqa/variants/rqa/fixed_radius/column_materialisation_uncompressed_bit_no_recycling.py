...
from pyrqa.operators.create_matrix.fixed_radius.column_materialisation_uncompressed_bit import create_matrix
...
class ColumnMaterialisationUncompressedBitNoRecycling(BaseSettings):
    """
