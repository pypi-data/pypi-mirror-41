...
from pyrqa.operators.detect_vertical_lines.fixed_radius.row_materialisation_uncompressed_bit_recycling import \
...
class RowMaterialisationUncompressedBitRecycling(BaseSettings):
    """
