...
from pyrqa.operators.create_matrix.fixed_radius.column_materialisation_uncompressed_byte import create_matrix
from pyrqa.operators.detect_diagonal_lines.materialisation_uncompressed_byte import detect_diagonal_lines
from pyrqa.operators.detect_vertical_lines.materialisation_uncompressed_byte_no_recycling import detect_vertical_lines
...
class ColumnMaterialisationUncompressedByteNoRecycling(BaseSettings):
    """
    ...
    def __initialize(self):
        ...
        if not self.program_created:
            self.program = self.opencl.create_program(self.device,
                                                      ...
                                                      self.settings.time_series.data.dtype,
