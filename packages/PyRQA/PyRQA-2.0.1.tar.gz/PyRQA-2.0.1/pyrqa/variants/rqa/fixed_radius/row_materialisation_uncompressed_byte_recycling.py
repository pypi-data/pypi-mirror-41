...
from pyrqa.operators.detect_vertical_lines.fixed_radius.row_materialisation_uncompressed_byte_recycling import \
...
class RowMaterialisationUncompressedByteRecycling(BaseSettings):
    """
