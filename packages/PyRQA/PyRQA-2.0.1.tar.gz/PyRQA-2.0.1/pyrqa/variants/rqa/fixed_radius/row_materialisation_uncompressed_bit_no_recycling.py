...
from pyrqa.operators.create_matrix.fixed_radius.row_materialisation_uncompressed_bit import create_matrix
...
class RowMaterialisationUncompressedBitNoRecycling(BaseSettings):
    """
