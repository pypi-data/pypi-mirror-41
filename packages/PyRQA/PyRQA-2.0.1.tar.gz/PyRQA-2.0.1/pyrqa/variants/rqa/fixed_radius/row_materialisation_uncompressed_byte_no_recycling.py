...
from pyrqa.operators.create_matrix.fixed_radius.row_materialisation_uncompressed_byte import create_matrix
...
class RowMaterialisationUncompressedByteNoRecycling(BaseSettings):
    """
