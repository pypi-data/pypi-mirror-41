...
def detect_vertical_lines(settings,
                          ...
                          kernels):
    """
    Detect vertical lines within a sub matrix that adheres to the uncompressed matrix representation.
    The recurrence vectors are represented in a row-store layout.
    The similarity values are represented as byte values.
    Intermediate results of the similarity comparisons are recycled.
