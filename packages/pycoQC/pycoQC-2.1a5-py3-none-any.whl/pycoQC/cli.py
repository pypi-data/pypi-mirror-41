...
def main_pycoQC (args=None):
    ...
    group.add_argument("--file", "-f", type=str,
        help="""Path to the sequencing_summary generated by Albacore 1.0.0 +.
    ...
    parser.add_argument("--filter_calibration", default=False, action='store_true',
        help="If given read flagged as calibration strand by the basecaller are removed (default: %(default)s)")
