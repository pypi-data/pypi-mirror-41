...
setup(name='radware_nlbaas_v2_queens_driver',
      version='4.7.0-1',
      description='Neutron LBaaS Radware driver for Openstack Queens',
      ...
      url='https://pypi.python.org/pypi/radware_nlbaas_v2_queens_driver',
      author='Evgeny Fedoruk, Radware',
      author_email='evgenyf@radware.com',
      packages=['radware_nlbaas_v2_queens_driver'],
      zip_safe=False,
