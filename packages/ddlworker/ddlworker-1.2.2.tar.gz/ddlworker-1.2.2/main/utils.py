...
def register(runtime,
    ...
    # First, check if the GPU register file exists.
...
def load_worker_runtime(debug_mode):
    runtime_file_name = "./{}".format(RUNTIME_DEBUG_NAME if debug_mode else RUNTIME_PRODUCTION_NAME )
    with open(runtime_file_name, "r") as f:
        runtime = yaml.load(f)
