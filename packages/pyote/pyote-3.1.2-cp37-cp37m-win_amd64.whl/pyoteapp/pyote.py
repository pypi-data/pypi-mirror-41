        ...
        while errmsg != 'ok':
            ...
            if errmsg != 'ok':
                ...
                if abs(actualFrameCount - expectedFrameCount) >= 0.12:
                    msg = (
                        f'Possible dropped frame(s) !!!\n\n'
                        f'Frame count input: {actualFrameCount:.2f}  \n\n'
                        f'Frame count computed from frame rate: {expectedFrameCount:.2f}'
                    )
                ...
                if manualTime:
                    ...
                    self.showMsg(
                        ...
                        ' seconds per reading' +
                        ' (frame time calculated from manual input timestamps)',
                        blankLine=False)
                    self.showMsg(
