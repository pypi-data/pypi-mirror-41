...
rst_epilog = """
.. |API| replace:: C
.. |supportedspk| replace:: 1, 2, 3, 8, 9, 12, 13, 17, 20, 21, 102, 103 and 120
...
.. |calceph_getconstantsd| replace:: :c:func:`calceph_getconstantsd()`
.. |menu_calceph_getconstantvd| replace:: calceph_getconstantvd
.. |calceph_getconstantvd| replace:: :c:func:`calceph_getconstantvd()`
.. |menu_calceph_getconstantss| replace:: calceph_getconstantss
.. |calceph_getconstantss| replace:: :c:func:`calceph_getconstantss()`
.. |menu_calceph_getconstantvs| replace:: calceph_getconstantvs
.. |calceph_getconstantvs| replace:: :c:func:`calceph_getconstantvs()`
...
.. |calceph_sgetfileversion| replace:: :c:func:`calceph_sgetfileversion()`
.. |menu_calceph_getfileversion| replace:: calceph_getfileversion
.. |calceph_getfileversion| replace:: :c:func:`calceph_getfileversion()`
...
.. |CALCEPH_OUTPUT_EULERANGLES| replace:: :c:macro:`CALCEPH_OUTPUT_EULERANGLES`
.. |CALCEPH_OUTPUT_NUTATIONANGLES| replace:: :c:macro:`CALCEPH_OUTPUT_NUTATIONANGLES`
