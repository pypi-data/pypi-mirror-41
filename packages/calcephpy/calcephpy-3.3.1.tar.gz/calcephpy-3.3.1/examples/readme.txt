...
- mexmultiple.m : 
Access to a binary ephemeris file through the "multiple file access functions" with the Octave/Matlab interface.

- mexcompute.m : 
Compute the heliocentric coordinates of the Earth at a julian day with the Octave/Matlab interface.

- mexorient.m : 
Access to a binary ephemeris file through the function CalcephBin.rotangmom_unit with the Octave/Matlab interface.

- mexerror.m : 
Generate errors and use different error handlers with the Octave/Matlab interface.
