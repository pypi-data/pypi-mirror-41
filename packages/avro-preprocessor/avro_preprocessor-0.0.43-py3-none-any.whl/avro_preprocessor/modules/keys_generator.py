"""
Automatically generates Avro Keys for Kafka topics keys using the property 'partition_key'.
"""
...
class KeysGenerator(PreprocessorModule):
    ...
    def find_partition_keys_records(
            self, record: Avro.Node, _: Avro.ParentNode, __: Avro.Key) -> None:
        """
        Finds property 'partition_key' inside schemas and saves the record they belong to.
