(window.webpackJsonp=window.webpackJsonp||[]).push([[7],{1812:function(e,t,r){"use strict";r.r(t);var a=r(0),n=r(370),o=r(841),i=r(1806),l=r(1793),s=r(1377),c=r.n(s),p=r(7),d=p.a`
  .ReactTable {
    position: relative;
    display: -webkit-box;
    display: -ms-flexbox;
...
`,H=r(1566),N=r.n(H);function B(e){let t="0.[00]a";return 0===e?"0":(e>1e14||e<1e-5?t="0.[000]e+0":e<1&&(t="0.[0000]a"),N()(e).format(t))}const Z=p.c.p`
  margin: 20px 0 5px;
`,G=p.c.g`
  & text {
    text-anchor: end;
