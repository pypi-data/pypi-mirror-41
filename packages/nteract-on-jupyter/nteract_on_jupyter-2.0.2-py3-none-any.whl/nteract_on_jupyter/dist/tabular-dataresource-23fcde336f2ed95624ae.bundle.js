(window.webpackJsonp=window.webpackJsonp||[]).push([[7],{1824:function(e,t,r){"use strict";r.r(t);var a=r(0),n=r(1226),o=r(1830),i=r(1817),l=r(1779),s=r(1362),c=r.n(s),p=r(24),d=p.a`
  .ReactTable {
    position: relative;
    display: -webkit-box;
    display: -ms-flexbox;
...
`,H=r(1551),N=r.n(H);function B(e){let t="0.[00]a";return 0===e?"0":(e>1e14||e<1e-5?t="0.[000]e+0":e<1&&(t="0.[0000]a"),N()(e).format(t))}const Z=p.c.p`
  margin: 20px 0 5px;
`,G=p.c.g`
  & text {
    text-anchor: end;
