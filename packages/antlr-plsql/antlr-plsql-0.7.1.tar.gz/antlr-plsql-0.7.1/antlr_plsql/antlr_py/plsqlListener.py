...
class plsqlListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by plsqlParser#column_name_list.
    def enterColumn_name_list(self, ctx:plsqlParser.Column_name_listContext):
        pass

    # Exit a parse tree produced by plsqlParser#column_name_list.
    def exitColumn_name_list(self, ctx:plsqlParser.Column_name_listContext):
        pass
