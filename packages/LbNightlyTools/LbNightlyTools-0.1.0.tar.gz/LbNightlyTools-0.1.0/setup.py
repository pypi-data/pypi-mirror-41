...
setup(
    ...
    install_requires=["LbEnv", "LbCommon>=0.0.7", "LbSoftConfDB", "LbDevTools",
                      "python-gitlab", "pika", "CouchDB", "tabulate"],
    ...
    dependency_links=[
        ...
        'https://lhcb-pypi.web.cern.ch/lhcb-pypi/simple/lbsoftconfdb',
    ...
    scripts=[
        'scripts/lb-msg-builddone',
        'scripts/lb-msg-buildnotif',
        'scripts/lbn-ansi2html',
        'scripts/lbn-build',
        'scripts/lbn-build-log-to-html',
        'scripts/lbn-checkout',
        'scripts/lbn-check-preconditions',
        'scripts/lbn-collect-build-logs',
        'scripts/lbn-enabled-slots',
        'scripts/lbn-generate-compatspec',
        'scripts/lbn-generate-do0spec',
        'scripts/lbn-generate-extspec',
        'scripts/lbn-generate-genericspec',
        'scripts/lbn-generate-lbscriptsspec',
        'scripts/lbn-generate-metaspec',
        'scripts/lbn-generate-spec',
        'scripts/lbn-gen-release-config',
        'scripts/lbn-get-configs',
        'scripts/lbn-index',
        'scripts/lbn-install',
        'scripts/lbn-list-platforms',
        'scripts/lbn-manage-remote',
        'scripts/lbn-preconditions',
        'scripts/lbn-release-poll',
        'scripts/lbn-release-trigger',
        'scripts/lbn-reschedule-tests',
        'scripts/lbn-rpm',
        'scripts/lbn-rpm-validator',
        'scripts/lbn-slots-by-deployment',
        'scripts/lbn-test',
        'scripts/lbn-test-poll',
        'scripts/lbn-wrapcmd',
        'scripts/lbp-check-periodic-tests',
        'scripts/lbp-check-periodic-tests-msg',
        'scripts/lbpr-collect',
        'scripts/lbpr-get-command',
        'scripts/lbq-builddone',
        'scripts/lbq-buildnotif',
        'scripts/lbq-getteststorun',
        'scripts/lbq-requesttest' ],
