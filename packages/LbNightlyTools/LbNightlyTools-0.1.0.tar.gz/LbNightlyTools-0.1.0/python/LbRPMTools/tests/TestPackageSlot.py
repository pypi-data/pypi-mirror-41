...
class Test(unittest.TestCase):
    ...
    def testSharedSpec(self):
        ...
        from LbRPMTools.PackageSlot import Script
        artifactdir = mkdtemp()
        # create fake (empty) source tarfile
        os.makedirs(os.path.join(artifactdir, 'packs'))
        with TarFile.open(os.path.join(artifactdir, 'packs', 'Brunel.v46r0.lhcb-release.999.src.tar.bz2'), 'w:bz2'):
            pass
