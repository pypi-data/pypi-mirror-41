...
setuptools.setup(
    ...
    entry_points={
        'probator.plugins.auditors': [
            'auditor_ebs = probator_auditor_ebs:EBSAuditor'
        ],
        'probator.plugins.types.issues': [
            'aws_ebs_volume_audit = probator_auditor_ebs.types:EBSVolumeAuditIssue',
        ],
    },
    ...
    url='https://github.com/bunjiboys/probator-auditor-ebs/',
