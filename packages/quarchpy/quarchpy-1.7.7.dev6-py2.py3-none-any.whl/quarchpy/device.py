...
def checkModuleFormat(ConString):
    ConnectionTypes = ["USB","SERIAL","TCP","REST"]     #acceptable conTypes
    ...
    if not correctConType:
        raise Exception ("Invalid connection type specified in Module string, use one of [USB|SERIAL|TCP|REST]")
        return False
