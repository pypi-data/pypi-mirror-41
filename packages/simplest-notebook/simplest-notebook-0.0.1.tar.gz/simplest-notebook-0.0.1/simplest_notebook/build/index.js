...
function main() {
    ...
    manager.ready.then(() => {
        let notebookPath = coreutils_1.PageConfig.getOption('notebookPath');
        ...
        ReactDOM.render(React.createElement(app_1.App, { notebookPath: notebookPath, serviceManager: manager, rendermime: rendermime }), document.getElementById('everything-container'));
    });
}
