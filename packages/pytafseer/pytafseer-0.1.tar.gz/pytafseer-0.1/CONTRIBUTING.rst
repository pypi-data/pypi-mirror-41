...
Tafseer Python Package could always use more documentation, whether as part of the
official Tafseer Python Package docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork the `pytafseer` repo on GitHub.
...
3. The pull request should work for Python 3.4, 3.5 3.6 and 3.7, and for PyPy. Check
   https://travis-ci.org/emadmokhtar/pytafseer/pull_requests
