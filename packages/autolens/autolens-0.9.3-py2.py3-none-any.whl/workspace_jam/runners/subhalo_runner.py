...
lens_name = 'lens_with_02_subhalo_cuspy_source'
...
from workspace_jam.pipelines import subhalo_source_inversion
pipeline = subhalo_source_inversion.make_pipeline(pipeline_path='/subhalo/' + lens_name + '/')
