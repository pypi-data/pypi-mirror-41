...
def test__image_is_output(image, positions, mask, data_plotter_path):
    ...
    data_plotters.plot_image(image=image, positions=positions, mask=mask, zoom_around_mask=True,
...
def test__noise_map_is_output(noise_map, mask, data_plotter_path):
    ...
    data_plotters.plot_noise_map(noise_map=noise_map, mask=mask, zoom_around_mask=True,
                                 output_path=data_plotter_path, output_format='png')
...
def test__psf_is_output(psf, data_plotter_path):
    ...
    data_plotters.plot_psf(psf=psf, output_path=data_plotter_path, output_format='png')
...
def test__signal_to_noise_map_is_output(image, noise_map, mask, data_plotter_path):
    ...
    data_plotters.plot_signal_to_noise_map(signal_to_noise_map=image/noise_map, mask=mask, zoom_around_mask=True,
                                           output_path=data_plotter_path, output_format='png')
