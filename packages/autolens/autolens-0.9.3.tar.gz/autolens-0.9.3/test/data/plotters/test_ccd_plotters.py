...
def test__ccd_sub_plot_output_dependent_on_config(ccd_data, general_config, ccd_plotter_path):

    ccd_plotters.plot_ccd_subplot(ccd_data=ccd_data, output_path=ccd_plotter_path, output_format='png')

    assert os.path.isfile(path=ccd_plotter_path+'ccd_data.png')
    os.remove(path=ccd_plotter_path+'ccd_data.png')

def test__ccd_individuals__output_dependent_on_config(ccd_data, general_config, ccd_plotter_path):

    ccd_plotters.plot_ccd_individual(ccd_data=ccd_data, output_path=ccd_plotter_path, output_format='png')
...
def test__image_is_output(ccd_data, positions, mask, ccd_plotter_path):
    ...
    ccd_plotters.plot_image(ccd_data=ccd_data, positions=positions, mask=mask, output_path=ccd_plotter_path,
                            output_format='png')
    assert os.path.isfile(path=ccd_plotter_path+'ccd_image.png')
    os.remove(path=ccd_plotter_path+'ccd_image.png')
...
def test__noise_map_is_output(ccd_data, mask, ccd_plotter_path):
    ...
    ccd_plotters.plot_noise_map(ccd_data=ccd_data, mask=mask, output_path=ccd_plotter_path, output_format='png')
...
def test__psf_is_output(ccd_data, ccd_plotter_path):
    ...
    ccd_plotters.plot_psf(ccd_data=ccd_data, output_path=ccd_plotter_path, output_format='png')
    assert os.path.isfile(path=ccd_plotter_path+'ccd_psf.png')
    os.remove(path=ccd_plotter_path+'ccd_psf.png')

def test__signal_to_noise_map_is_output(ccd_data, mask, ccd_plotter_path):

    ccd_plotters.plot_signal_to_noise_map(ccd_data=ccd_data, mask=mask, output_path=ccd_plotter_path,
                                          output_format='png')
