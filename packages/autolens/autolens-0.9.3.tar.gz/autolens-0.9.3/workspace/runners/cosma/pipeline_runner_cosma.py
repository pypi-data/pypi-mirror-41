...
ccd_data = ccd.load_ccd_data_from_fits(image_path=path + '/data/example/' + lens_name[cosma_array] + '/image.fits',
                                       psf_path=path+'/data/example/'+lens_name[cosma_array]+'/psf.fits',
                                       noise_map_path=path+'/data/example/'+lens_name[cosma_array]+'/noise_map.fits',
