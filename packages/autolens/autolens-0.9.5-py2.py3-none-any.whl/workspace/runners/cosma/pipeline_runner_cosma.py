...
conf.instance = conf.Config(config_path=path+'config',
                            output_path='/cosma5/data/durham/'+cosma_username+'/autolens/output')
...
cosma_data_path = '/cosma5/data/durham/'+cosma_username+'/autolens/data/'

ccd_data = ccd.load_ccd_data_from_fits(
    image_path=cosma_data_path + '/slacs/' + lens_name[cosma_array_id] + '/image.fits',
    psf_path=cosma_data_path+'/slacs/'+lens_name[cosma_array_id]+'/psf.fits',
    noise_map_path=cosma_data_path+'/slacs/'+lens_name[cosma_array_id]+'/noise_map.fits',
