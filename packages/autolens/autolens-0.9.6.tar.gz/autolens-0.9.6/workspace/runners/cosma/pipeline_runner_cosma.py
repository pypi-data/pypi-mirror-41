...
# run 17 jobs, and the id's of those jobs will be numbered from 1 to 4. Infact, these ids are passed to this runner,
...
cosma_data_path = '/cosma5/data/autolens/data/example_cosma/'

ccd_data = ccd.load_ccd_data_from_fits(
    image_path=cosma_data_path + lens_name[cosma_array_id] + '/image.fits',
    psf_path=cosma_data_path + lens_name[cosma_array_id]+'/psf.fits',
    noise_map_path=cosma_data_path + lens_name[cosma_array_id]+'/noise_map.fits',
