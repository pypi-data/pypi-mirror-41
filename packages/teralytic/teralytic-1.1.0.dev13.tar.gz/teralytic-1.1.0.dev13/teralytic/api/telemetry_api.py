...
class TelemetryApi(object):
    ...
    def analytics_query_with_http_info(self, organization_id, **kwargs):  # noqa: E501
        ...
        all_params = ['organization_id', 'start_date', 'end_date', 'fields', 'probes', 'properties', 'operation', 'sample_rate', 'limit', 'extended', 'sort', 'options']  # noqa: E501
    ...
    def readings_query_with_http_info(self, organization_id, **kwargs):  # noqa: E501
        ...
        all_params = ['organization_id', 'start_date', 'end_date', 'fields', 'probes', 'properties', 'extended', 'options', 'filter']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
