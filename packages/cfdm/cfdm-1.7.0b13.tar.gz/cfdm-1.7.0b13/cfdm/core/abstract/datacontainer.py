...
class DataContainer(with_metaclass(abc.ABCMeta, Container)):
    '''Abstract base class for a container of a data array.

.. versionadded:: 1.7.0

    '''   
    def __init__(self, data=None, source=None, copy=True,
                 _use_data=True):
        '''**Initialization**
...
:Parameters:
    ...
    source: optional
        Initialize the data from *source*.
