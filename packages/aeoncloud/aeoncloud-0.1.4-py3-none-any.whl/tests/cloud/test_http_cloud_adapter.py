...
def test_init_adapter_with_correct_arguments():
    # Arrange
    ...
    # Act
    http_cloud_adapter = HttpCloudAdapter(aeon_cloud_url, credentials, callback_url)
...
def test_init_adapter_with_correct_arguments_without_callback():
    # Arrange
    aeon_cloud_url = 'http://test'
    credentials = {
        'apiHost': '',
    ...
    # Act
    http_cloud_adapter = HttpCloudAdapter(aeon_cloud_url, credentials)
...
def test_init_adapter_with_incorrect_url():
    # Arrange
    aeon_cloud_url = None
    credentials = {
        'apiHost': '',
...
def test_init_adapter_with_incorrect_credentials():
    # Arrange
    aeon_cloud_url = 'http://test'
    credentials = 'test'
...
@patch('aeoncloud.cloud.http_cloud_adapter.post')
def test_deploy_runners(mock_post):
    # Arrange
    aeon_cloud_url = 'http://test'
    credentials = {
        'apiHost': '',
    ...
    # Act
    result = http_cloud_adapter.create_runners(2)
...
@patch('aeoncloud.cloud.http_cloud_adapter.delete')
def test_delete_runner(mock_delete):
    # Arrange
    aeon_cloud_url = 'http://test'
    credentials = {
        'apiHost': '',
    ...
    # Act
    result = http_cloud_adapter.delete_runner('z')
...
@patch('aeoncloud.cloud.http_cloud_adapter.delete')
def test_delete_runners(mock_delete):
    # Arrange
    aeon_cloud_url = 'http://test'
    credentials = {
        'apiHost': '',
    ...
    # Act
    result = http_cloud_adapter.delete_runners()
...
@patch('aeoncloud.cloud.http_cloud_adapter.get')
def test_get_runner(mock_get):
    # Arrange
    aeon_cloud_url = 'http://test'
    credentials = {
        'apiHost': '',
    ...
    # Act
    result = http_cloud_adapter.get_runner('id')
...
def test_get_runner(mock_get):
    ...
    # Act
    result = http_cloud_adapter.get_runners()
