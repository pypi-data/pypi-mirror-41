...
class SXAuthenticateHandler(BaseHandler):
    """
...
class SXAuthenticator(Authenticator):
    """
    ...
    def get_handlers(self, app):
        ...
        return [
            ('/sxlogin', SXAuthenticateHandler, extra_settings)
        ]

    def login_url(self, base_url):
        return url_path_join(base_url, 'sxlogin')
