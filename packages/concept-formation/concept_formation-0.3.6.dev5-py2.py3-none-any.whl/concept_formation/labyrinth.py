"""
The Labyrinth module contains the :class:`LabyrinthTree` class, which extends
...
class LabyrinthTree(Cobweb3Tree):
    """
    The LabyrinthTree instantiates the Trestle algorithm, which can
    ...
    def categorize(self, instance):
        ...
        .. seealso:: :meth:`TrestleTree.trestle`
        """
        return self._labyrinth_categorize(instance)
