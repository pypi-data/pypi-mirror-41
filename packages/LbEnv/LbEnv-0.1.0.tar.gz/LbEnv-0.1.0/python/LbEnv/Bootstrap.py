...
def search_path(roots):
    ...
    try:
        from LbDevTools import data_location
        yield join(data_location(), 'cmake')
    except ImportError:
        pass
...
def main():
    ...
    control.set('LHCBPROJECTPATH', '${CMAKE_PREFIX_PATH}')

    # FIXME do we really have to set CMTPROJECTPATH?
    control.set('CMTPROJECTPATH', '${CMAKE_PREFIX_PATH}')
