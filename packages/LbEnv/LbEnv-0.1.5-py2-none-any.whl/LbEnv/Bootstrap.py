...
def main():
    ...
    parser = OptionParser(prog='LbEnv', version='%prog {}'.format(__version__))
    parser.add_option(
    ...
    control.set('BINARY_TAG', opts.platform)
    ...
    if 'HOME' in os.environ and os.path.exists(
            join(os.environ['HOME'], 'cmtuser')):
