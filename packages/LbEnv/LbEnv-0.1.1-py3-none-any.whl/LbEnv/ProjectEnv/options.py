...
def addSearchPath(parser):
    ...
    def nightly_base(option, opt_str, value, parser):
        ...
        elif option.get_opt_string() == '--nightly-afs':
            path = '/afs/cern.ch/lhcb/software/nightlies'
        else:
            path = value
    ...
    parser.add_option(
        ...
        action='callback',
        callback=nightly_base,
        help='looks for nightly builds on AFS '
        '(must be specified before --nightly)')
    ...
    def nightly_option(_option, opt_str, _value, _parser):
        ...
        try:
            ...
            raise OptionValueError(
                ...
                'nightlies and optionally by the day' % opt_str)
