...
CVMFSDEV_EXCHANGE = "cvmfsdev_actions"
CVMFSDEV_ERRORS_EXCHANGE = "cvmfsdev_actions_errors"
...
class CvmfsDevExchange(CommandExchange):
    ...
    def __init__(self, connection):
        ...
        super(CvmfsDevExchange, self).__init__(connection,
                                               CVMFSDEV_EXCHANGE,
                                               CVMFSDEV_ERRORS_EXCHANGE)
