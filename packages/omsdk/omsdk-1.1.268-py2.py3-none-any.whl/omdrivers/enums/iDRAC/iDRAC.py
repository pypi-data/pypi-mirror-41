...
DefaultCredentialMitigation_DefaultCredentialMitigationConfigGroupTypes = EnumWrapper("DefaultCredentialMitigation_DefaultCredentialMitigationConfigGroupTypes", {
    "Disabled" : "Disabled",
    "Enabled" : "Enabled",
}).enum_type
...
NMSubSystemPwrMonitoringCapable_PlatformCapabilityTypes = EnumWrapper("NMSubSystemPwrMonitoringCapable_PlatformCapabilityTypes", {
    "Disabled" : "Disabled",
    "Enabled" : "Enabled",
}).enum_type

NOBladethrottleDuringCMCrebootCapable_PlatformCapabilityTypes = EnumWrapper("NOBladethrottleDuringCMCrebootCapable_PlatformCapabilityTypes", {
    "Disabled" : "Disabled",
    "Enabled" : "Enabled",
}).enum_type
...
PerformFactoryIdentityCertValidation_MachineTrustTypes = EnumWrapper("PerformFactoryIdentityCertValidation_MachineTrustTypes", {
    "Not_Supported" : "Not Supported",
    "Optional" : "Optional",
    "Required" : "Required",
}).enum_type
...
PowerConfigurationRemovalCapable_PlatformCapabilityTypes = EnumWrapper("PowerConfigurationRemovalCapable_PlatformCapabilityTypes", {
    "Disabled" : "Disabled",
    "Enabled" : "Enabled",
}).enum_type
...
RemainingRatedWriteEnduranceAlertThreshold_StorageTypes = EnumWrapper("RemainingRatedWriteEnduranceAlertThreshold_StorageTypes", {
    "T_1_99" : "1-99",
}).enum_type
...
SubSystemPowerMonitoringCapable_PlatformCapabilityTypes = EnumWrapper("SubSystemPowerMonitoringCapable_PlatformCapabilityTypes", {
    "Disabled" : "Disabled",
    "Enabled" : "Enabled",
}).enum_type
...
VirtualAddressPersistencePolicyNonAuxPwrd_IOIDOptTypes = EnumWrapper("VirtualAddressPersistencePolicyNonAuxPwrd_IOIDOptTypes", {
    "ACPowerLoss" : "ACPowerLoss",
    "ColdReset" : "ColdReset",
    "ColdReset__ACPowerLoss" : "ColdReset, ACPowerLoss",
    "T_None" : "None",
