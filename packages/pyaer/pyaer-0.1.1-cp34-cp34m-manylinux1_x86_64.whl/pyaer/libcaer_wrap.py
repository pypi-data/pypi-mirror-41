...
class aedat3_network_header(_object):
    ...
    if _newclass:
        magicNumber = property(_libcaer_wrap.aedat3_network_header_magicNumber_get, _libcaer_wrap.aedat3_network_header_magicNumber_set)
    ...
    if _newclass:
        sequenceNumber = property(_libcaer_wrap.aedat3_network_header_sequenceNumber_get, _libcaer_wrap.aedat3_network_header_sequenceNumber_set)
    ...
    if _newclass:
        versionNumber = property(_libcaer_wrap.aedat3_network_header_versionNumber_get, _libcaer_wrap.aedat3_network_header_versionNumber_set)
    ...
    if _newclass:
        formatNumber = property(_libcaer_wrap.aedat3_network_header_formatNumber_get, _libcaer_wrap.aedat3_network_header_formatNumber_set)
    ...
    if _newclass:
        sourceID = property(_libcaer_wrap.aedat3_network_header_sourceID_get, _libcaer_wrap.aedat3_network_header_sourceID_set)
...
class caer_dvs128_info(_object):
    ...
    if _newclass:
        deviceID = property(_libcaer_wrap.caer_dvs128_info_deviceID_get, _libcaer_wrap.caer_dvs128_info_deviceID_set)
    ...
    if _newclass:
        deviceSerialNumber = property(_libcaer_wrap.caer_dvs128_info_deviceSerialNumber_get, _libcaer_wrap.caer_dvs128_info_deviceSerialNumber_set)
    ...
    if _newclass:
        deviceUSBBusNumber = property(_libcaer_wrap.caer_dvs128_info_deviceUSBBusNumber_get, _libcaer_wrap.caer_dvs128_info_deviceUSBBusNumber_set)
    ...
    if _newclass:
        deviceUSBDeviceAddress = property(_libcaer_wrap.caer_dvs128_info_deviceUSBDeviceAddress_get, _libcaer_wrap.caer_dvs128_info_deviceUSBDeviceAddress_set)
    ...
    if _newclass:
        deviceString = property(_libcaer_wrap.caer_dvs128_info_deviceString_get, _libcaer_wrap.caer_dvs128_info_deviceString_set)
    ...
    if _newclass:
        logicVersion = property(_libcaer_wrap.caer_dvs128_info_logicVersion_get, _libcaer_wrap.caer_dvs128_info_logicVersion_set)
    ...
    if _newclass:
        deviceIsMaster = property(_libcaer_wrap.caer_dvs128_info_deviceIsMaster_get, _libcaer_wrap.caer_dvs128_info_deviceIsMaster_set)
    ...
    if _newclass:
        dvsSizeX = property(_libcaer_wrap.caer_dvs128_info_dvsSizeX_get, _libcaer_wrap.caer_dvs128_info_dvsSizeX_set)
    ...
    if _newclass:
        dvsSizeY = property(_libcaer_wrap.caer_dvs128_info_dvsSizeY_get, _libcaer_wrap.caer_dvs128_info_dvsSizeY_set)
...
class caer_edvs_info(_object):
    ...
    if _newclass:
        deviceID = property(_libcaer_wrap.caer_edvs_info_deviceID_get, _libcaer_wrap.caer_edvs_info_deviceID_set)
    ...
    if _newclass:
        deviceString = property(_libcaer_wrap.caer_edvs_info_deviceString_get, _libcaer_wrap.caer_edvs_info_deviceString_set)
    ...
    if _newclass:
        deviceIsMaster = property(_libcaer_wrap.caer_edvs_info_deviceIsMaster_get, _libcaer_wrap.caer_edvs_info_deviceIsMaster_set)
    ...
    if _newclass:
        dvsSizeX = property(_libcaer_wrap.caer_edvs_info_dvsSizeX_get, _libcaer_wrap.caer_edvs_info_dvsSizeX_set)
    ...
    if _newclass:
        dvsSizeY = property(_libcaer_wrap.caer_edvs_info_dvsSizeY_get, _libcaer_wrap.caer_edvs_info_dvsSizeY_set)
    ...
    if _newclass:
        serialPortName = property(_libcaer_wrap.caer_edvs_info_serialPortName_get, _libcaer_wrap.caer_edvs_info_serialPortName_set)
    ...
    if _newclass:
        serialBaudRate = property(_libcaer_wrap.caer_edvs_info_serialBaudRate_get, _libcaer_wrap.caer_edvs_info_serialBaudRate_set)
...
class caer_davis_info(_object):
    ...
    if _newclass:
        deviceID = property(_libcaer_wrap.caer_davis_info_deviceID_get, _libcaer_wrap.caer_davis_info_deviceID_set)
    ...
    if _newclass:
        deviceSerialNumber = property(_libcaer_wrap.caer_davis_info_deviceSerialNumber_get, _libcaer_wrap.caer_davis_info_deviceSerialNumber_set)
    ...
    if _newclass:
        deviceUSBBusNumber = property(_libcaer_wrap.caer_davis_info_deviceUSBBusNumber_get, _libcaer_wrap.caer_davis_info_deviceUSBBusNumber_set)
    ...
    if _newclass:
        deviceUSBDeviceAddress = property(_libcaer_wrap.caer_davis_info_deviceUSBDeviceAddress_get, _libcaer_wrap.caer_davis_info_deviceUSBDeviceAddress_set)
    ...
    if _newclass:
        deviceString = property(_libcaer_wrap.caer_davis_info_deviceString_get, _libcaer_wrap.caer_davis_info_deviceString_set)
    __swig_setmethods__["firmwareVersion"] = _libcaer_wrap.caer_davis_info_firmwareVersion_set
    __swig_getmethods__["firmwareVersion"] = _libcaer_wrap.caer_davis_info_firmwareVersion_get
    if _newclass:
        firmwareVersion = property(_libcaer_wrap.caer_davis_info_firmwareVersion_get, _libcaer_wrap.caer_davis_info_firmwareVersion_set)
    ...
    if _newclass:
        logicVersion = property(_libcaer_wrap.caer_davis_info_logicVersion_get, _libcaer_wrap.caer_davis_info_logicVersion_set)
    ...
    if _newclass:
        chipID = property(_libcaer_wrap.caer_davis_info_chipID_get, _libcaer_wrap.caer_davis_info_chipID_set)
    ...
    if _newclass:
        deviceIsMaster = property(_libcaer_wrap.caer_davis_info_deviceIsMaster_get, _libcaer_wrap.caer_davis_info_deviceIsMaster_set)
    ...
    if _newclass:
        muxHasStatistics = property(_libcaer_wrap.caer_davis_info_muxHasStatistics_get, _libcaer_wrap.caer_davis_info_muxHasStatistics_set)
    ...
    if _newclass:
        dvsSizeX = property(_libcaer_wrap.caer_davis_info_dvsSizeX_get, _libcaer_wrap.caer_davis_info_dvsSizeX_set)
    ...
    if _newclass:
        dvsSizeY = property(_libcaer_wrap.caer_davis_info_dvsSizeY_get, _libcaer_wrap.caer_davis_info_dvsSizeY_set)
    ...
    if _newclass:
        dvsHasPixelFilter = property(_libcaer_wrap.caer_davis_info_dvsHasPixelFilter_get, _libcaer_wrap.caer_davis_info_dvsHasPixelFilter_set)
    ...
    if _newclass:
        dvsHasBackgroundActivityFilter = property(_libcaer_wrap.caer_davis_info_dvsHasBackgroundActivityFilter_get, _libcaer_wrap.caer_davis_info_dvsHasBackgroundActivityFilter_set)
    ...
    if _newclass:
        dvsHasROIFilter = property(_libcaer_wrap.caer_davis_info_dvsHasROIFilter_get, _libcaer_wrap.caer_davis_info_dvsHasROIFilter_set)
    __swig_setmethods__["dvsHasSkipFilter"] = _libcaer_wrap.caer_davis_info_dvsHasSkipFilter_set
    __swig_getmethods__["dvsHasSkipFilter"] = _libcaer_wrap.caer_davis_info_dvsHasSkipFilter_get
    if _newclass:
        dvsHasSkipFilter = property(_libcaer_wrap.caer_davis_info_dvsHasSkipFilter_get, _libcaer_wrap.caer_davis_info_dvsHasSkipFilter_set)
    __swig_setmethods__["dvsHasPolarityFilter"] = _libcaer_wrap.caer_davis_info_dvsHasPolarityFilter_set
    __swig_getmethods__["dvsHasPolarityFilter"] = _libcaer_wrap.caer_davis_info_dvsHasPolarityFilter_get
    if _newclass:
        dvsHasPolarityFilter = property(_libcaer_wrap.caer_davis_info_dvsHasPolarityFilter_get, _libcaer_wrap.caer_davis_info_dvsHasPolarityFilter_set)
    ...
    if _newclass:
        dvsHasStatistics = property(_libcaer_wrap.caer_davis_info_dvsHasStatistics_get, _libcaer_wrap.caer_davis_info_dvsHasStatistics_set)
    ...
    if _newclass:
        apsSizeX = property(_libcaer_wrap.caer_davis_info_apsSizeX_get, _libcaer_wrap.caer_davis_info_apsSizeX_set)
    ...
    if _newclass:
        apsSizeY = property(_libcaer_wrap.caer_davis_info_apsSizeY_get, _libcaer_wrap.caer_davis_info_apsSizeY_set)
    ...
    if _newclass:
        apsColorFilter = property(_libcaer_wrap.caer_davis_info_apsColorFilter_get, _libcaer_wrap.caer_davis_info_apsColorFilter_set)
    ...
    if _newclass:
        apsHasGlobalShutter = property(_libcaer_wrap.caer_davis_info_apsHasGlobalShutter_get, _libcaer_wrap.caer_davis_info_apsHasGlobalShutter_set)
    __swig_setmethods__["imuType"] = _libcaer_wrap.caer_davis_info_imuType_set
    __swig_getmethods__["imuType"] = _libcaer_wrap.caer_davis_info_imuType_get
    if _newclass:
        imuType = property(_libcaer_wrap.caer_davis_info_imuType_get, _libcaer_wrap.caer_davis_info_imuType_set)
    ...
    if _newclass:
        extInputHasGenerator = property(_libcaer_wrap.caer_davis_info_extInputHasGenerator_get, _libcaer_wrap.caer_davis_info_extInputHasGenerator_set)
...
class caer_bias_vdac(_object):
    ...
    if _newclass:
        voltageValue = property(_libcaer_wrap.caer_bias_vdac_voltageValue_get, _libcaer_wrap.caer_bias_vdac_voltageValue_set)
    ...
    if _newclass:
        currentValue = property(_libcaer_wrap.caer_bias_vdac_currentValue_get, _libcaer_wrap.caer_bias_vdac_currentValue_set)
...
class caer_bias_coarsefine(_object):
    ...
    if _newclass:
        coarseValue = property(_libcaer_wrap.caer_bias_coarsefine_coarseValue_get, _libcaer_wrap.caer_bias_coarsefine_coarseValue_set)
    ...
    if _newclass:
        fineValue = property(_libcaer_wrap.caer_bias_coarsefine_fineValue_get, _libcaer_wrap.caer_bias_coarsefine_fineValue_set)
    ...
    if _newclass:
        enabled = property(_libcaer_wrap.caer_bias_coarsefine_enabled_get, _libcaer_wrap.caer_bias_coarsefine_enabled_set)
    ...
    if _newclass:
        sexN = property(_libcaer_wrap.caer_bias_coarsefine_sexN_get, _libcaer_wrap.caer_bias_coarsefine_sexN_set)
    ...
    if _newclass:
        typeNormal = property(_libcaer_wrap.caer_bias_coarsefine_typeNormal_get, _libcaer_wrap.caer_bias_coarsefine_typeNormal_set)
    ...
    if _newclass:
        currentLevelNormal = property(_libcaer_wrap.caer_bias_coarsefine_currentLevelNormal_get, _libcaer_wrap.caer_bias_coarsefine_currentLevelNormal_set)
...
class caer_bias_shiftedsource(_object):
    ...
    if _newclass:
        refValue = property(_libcaer_wrap.caer_bias_shiftedsource_refValue_get, _libcaer_wrap.caer_bias_shiftedsource_refValue_set)
    ...
    if _newclass:
        regValue = property(_libcaer_wrap.caer_bias_shiftedsource_regValue_get, _libcaer_wrap.caer_bias_shiftedsource_regValue_set)
    ...
    if _newclass:
        operatingMode = property(_libcaer_wrap.caer_bias_shiftedsource_operatingMode_get, _libcaer_wrap.caer_bias_shiftedsource_operatingMode_set)
    ...
    if _newclass:
        voltageLevel = property(_libcaer_wrap.caer_bias_shiftedsource_voltageLevel_get, _libcaer_wrap.caer_bias_shiftedsource_voltageLevel_set)
...
class caer_dynapse_info(_object):
    ...
    if _newclass:
        deviceID = property(_libcaer_wrap.caer_dynapse_info_deviceID_get, _libcaer_wrap.caer_dynapse_info_deviceID_set)
    ...
    if _newclass:
        deviceSerialNumber = property(_libcaer_wrap.caer_dynapse_info_deviceSerialNumber_get, _libcaer_wrap.caer_dynapse_info_deviceSerialNumber_set)
    ...
    if _newclass:
        deviceUSBBusNumber = property(_libcaer_wrap.caer_dynapse_info_deviceUSBBusNumber_get, _libcaer_wrap.caer_dynapse_info_deviceUSBBusNumber_set)
    ...
    if _newclass:
        deviceUSBDeviceAddress = property(_libcaer_wrap.caer_dynapse_info_deviceUSBDeviceAddress_get, _libcaer_wrap.caer_dynapse_info_deviceUSBDeviceAddress_set)
    ...
    if _newclass:
        deviceString = property(_libcaer_wrap.caer_dynapse_info_deviceString_get, _libcaer_wrap.caer_dynapse_info_deviceString_set)
    ...
    if _newclass:
        logicVersion = property(_libcaer_wrap.caer_dynapse_info_logicVersion_get, _libcaer_wrap.caer_dynapse_info_logicVersion_set)
    ...
    if _newclass:
        deviceIsMaster = property(_libcaer_wrap.caer_dynapse_info_deviceIsMaster_get, _libcaer_wrap.caer_dynapse_info_deviceIsMaster_set)
    ...
    if _newclass:
        logicClock = property(_libcaer_wrap.caer_dynapse_info_logicClock_get, _libcaer_wrap.caer_dynapse_info_logicClock_set)
    ...
    if _newclass:
        chipID = property(_libcaer_wrap.caer_dynapse_info_chipID_get, _libcaer_wrap.caer_dynapse_info_chipID_set)
    ...
    if _newclass:
        aerHasStatistics = property(_libcaer_wrap.caer_dynapse_info_aerHasStatistics_get, _libcaer_wrap.caer_dynapse_info_aerHasStatistics_set)
    ...
    if _newclass:
        muxHasStatistics = property(_libcaer_wrap.caer_dynapse_info_muxHasStatistics_get, _libcaer_wrap.caer_dynapse_info_muxHasStatistics_set)
...
class caer_bias_dynapse(_object):
    ...
    if _newclass:
        biasAddress = property(_libcaer_wrap.caer_bias_dynapse_biasAddress_get, _libcaer_wrap.caer_bias_dynapse_biasAddress_set)
    ...
    if _newclass:
        coarseValue = property(_libcaer_wrap.caer_bias_dynapse_coarseValue_get, _libcaer_wrap.caer_bias_dynapse_coarseValue_set)
    ...
    if _newclass:
        fineValue = property(_libcaer_wrap.caer_bias_dynapse_fineValue_get, _libcaer_wrap.caer_bias_dynapse_fineValue_set)
    ...
    if _newclass:
        enabled = property(_libcaer_wrap.caer_bias_dynapse_enabled_get, _libcaer_wrap.caer_bias_dynapse_enabled_set)
    ...
    if _newclass:
        sexN = property(_libcaer_wrap.caer_bias_dynapse_sexN_get, _libcaer_wrap.caer_bias_dynapse_sexN_set)
    ...
    if _newclass:
        typeNormal = property(_libcaer_wrap.caer_bias_dynapse_typeNormal_get, _libcaer_wrap.caer_bias_dynapse_typeNormal_set)
    ...
    if _newclass:
        biasHigh = property(_libcaer_wrap.caer_bias_dynapse_biasHigh_get, _libcaer_wrap.caer_bias_dynapse_biasHigh_set)
...
class caer_device_discovery_result(_object):
    ...
    if _newclass:
        deviceType = property(_libcaer_wrap.caer_device_discovery_result_deviceType_get, _libcaer_wrap.caer_device_discovery_result_deviceType_set)
    ...
    if _newclass:
        deviceErrorOpen = property(_libcaer_wrap.caer_device_discovery_result_deviceErrorOpen_get, _libcaer_wrap.caer_device_discovery_result_deviceErrorOpen_set)
    ...
    if _newclass:
        deviceErrorVersion = property(_libcaer_wrap.caer_device_discovery_result_deviceErrorVersion_get, _libcaer_wrap.caer_device_discovery_result_deviceErrorVersion_set)
    __swig_getmethods__["deviceInfo"] = _libcaer_wrap.caer_device_discovery_result_deviceInfo_get
    if _newclass:
        deviceInfo = property(_libcaer_wrap.caer_device_discovery_result_deviceInfo_get)
...
class caer_device_discovery_result_deviceInfo(_object):
    ...
    if _newclass:
        dvs128Info = property(_libcaer_wrap.caer_device_discovery_result_deviceInfo_dvs128Info_get, _libcaer_wrap.caer_device_discovery_result_deviceInfo_dvs128Info_set)
    ...
    if _newclass:
        edvsInfo = property(_libcaer_wrap.caer_device_discovery_result_deviceInfo_edvsInfo_get, _libcaer_wrap.caer_device_discovery_result_deviceInfo_edvsInfo_set)
    ...
    if _newclass:
        davisInfo = property(_libcaer_wrap.caer_device_discovery_result_deviceInfo_davisInfo_get, _libcaer_wrap.caer_device_discovery_result_deviceInfo_davisInfo_set)
    ...
    if _newclass:
        dynapseInfo = property(_libcaer_wrap.caer_device_discovery_result_deviceInfo_dynapseInfo_get, _libcaer_wrap.caer_device_discovery_result_deviceInfo_dynapseInfo_set)
    __swig_setmethods__["dvs132sInfo"] = _libcaer_wrap.caer_device_discovery_result_deviceInfo_dvs132sInfo_set
    __swig_getmethods__["dvs132sInfo"] = _libcaer_wrap.caer_device_discovery_result_deviceInfo_dvs132sInfo_get
    if _newclass:
        dvs132sInfo = property(_libcaer_wrap.caer_device_discovery_result_deviceInfo_dvs132sInfo_get, _libcaer_wrap.caer_device_discovery_result_deviceInfo_dvs132sInfo_set)
...
class caer_event_packet_header(_object):
    ...
    if _newclass:
        eventType = property(_libcaer_wrap.caer_event_packet_header_eventType_get, _libcaer_wrap.caer_event_packet_header_eventType_set)
    ...
    if _newclass:
        eventSource = property(_libcaer_wrap.caer_event_packet_header_eventSource_get, _libcaer_wrap.caer_event_packet_header_eventSource_set)
    ...
    if _newclass:
        eventSize = property(_libcaer_wrap.caer_event_packet_header_eventSize_get, _libcaer_wrap.caer_event_packet_header_eventSize_set)
    ...
    if _newclass:
        eventTSOffset = property(_libcaer_wrap.caer_event_packet_header_eventTSOffset_get, _libcaer_wrap.caer_event_packet_header_eventTSOffset_set)
    ...
    if _newclass:
        eventTSOverflow = property(_libcaer_wrap.caer_event_packet_header_eventTSOverflow_get, _libcaer_wrap.caer_event_packet_header_eventTSOverflow_set)
    ...
    if _newclass:
        eventCapacity = property(_libcaer_wrap.caer_event_packet_header_eventCapacity_get, _libcaer_wrap.caer_event_packet_header_eventCapacity_set)
    ...
    if _newclass:
        eventNumber = property(_libcaer_wrap.caer_event_packet_header_eventNumber_get, _libcaer_wrap.caer_event_packet_header_eventNumber_set)
    ...
    if _newclass:
        eventValid = property(_libcaer_wrap.caer_event_packet_header_eventValid_get, _libcaer_wrap.caer_event_packet_header_eventValid_set)
...
class caer_configuration_event(_object):
    r"""Proxy of C caer_configuration_event struct."""
    ...
    if _newclass:
        moduleAddress = property(_libcaer_wrap.caer_configuration_event_moduleAddress_get, _libcaer_wrap.caer_configuration_event_moduleAddress_set)
    ...
    if _newclass:
        parameterAddress = property(_libcaer_wrap.caer_configuration_event_parameterAddress_get, _libcaer_wrap.caer_configuration_event_parameterAddress_set)
    ...
    if _newclass:
        parameter = property(_libcaer_wrap.caer_configuration_event_parameter_get, _libcaer_wrap.caer_configuration_event_parameter_set)
    ...
    if _newclass:
        timestamp = property(_libcaer_wrap.caer_configuration_event_timestamp_get, _libcaer_wrap.caer_configuration_event_timestamp_set)

    def __init__(self):
        r"""__init__(caer_configuration_event self) -> caer_configuration_event"""
    ...
    def __del__(self):
        return None
# Register caer_configuration_event in _libcaer_wrap:
_libcaer_wrap.caer_configuration_event_swigregister(caer_configuration_event)

class caer_configuration_event_packet(_object):
    r"""Proxy of C caer_configuration_event_packet struct."""
    ...
    if _newclass:
        packetHeader = property(_libcaer_wrap.caer_configuration_event_packet_packetHeader_get, _libcaer_wrap.caer_configuration_event_packet_packetHeader_set)
    __swig_getmethods__["events"] = _libcaer_wrap.caer_configuration_event_packet_events_get
    if _newclass:
        events = property(_libcaer_wrap.caer_configuration_event_packet_events_get)

    def __init__(self):
        r"""__init__(caer_configuration_event_packet self) -> caer_configuration_event_packet"""
    ...
    def __del__(self):
        return None
# Register caer_configuration_event_packet in _libcaer_wrap:
_libcaer_wrap.caer_configuration_event_packet_swigregister(caer_configuration_event_packet)


def caerConfigurationEventPacketAllocate(eventCapacity, eventSource, tsOverflow):
    r"""caerConfigurationEventPacketAllocate(int32_t eventCapacity, int16_t eventSource, int32_t tsOverflow) -> caer_configuration_event_packet"""
...
def caerConfigurationEventPacketFromPacketHeader(header):
    r"""caerConfigurationEventPacketFromPacketHeader(caer_event_packet_header header) -> caer_configuration_event_packet"""
...
def caerConfigurationEventPacketFromPacketHeaderConst(header):
    r"""caerConfigurationEventPacketFromPacketHeaderConst(caer_event_packet_header header) -> caer_configuration_event_packet"""
...
def caerConfigurationEventPacketGetEvent(packet, n):
    r"""caerConfigurationEventPacketGetEvent(caer_configuration_event_packet packet, int32_t n) -> caer_configuration_event"""
    return _libcaer_wrap.caerConfigurationEventPacketGetEvent(packet, n)

def caerConfigurationEventPacketGetEventConst(packet, n):
    r"""caerConfigurationEventPacketGetEventConst(caer_configuration_event_packet packet, int32_t n) -> caer_configuration_event"""
    return _libcaer_wrap.caerConfigurationEventPacketGetEventConst(packet, n)

def caerConfigurationEventGetTimestamp(event):
    r"""caerConfigurationEventGetTimestamp(caer_configuration_event event) -> int32_t"""
    return _libcaer_wrap.caerConfigurationEventGetTimestamp(event)

def caerConfigurationEventGetTimestamp64(event, packet):
    r"""caerConfigurationEventGetTimestamp64(caer_configuration_event event, caer_configuration_event_packet packet) -> int64_t"""
...
def caerConfigurationEventSetModuleAddress(event, moduleAddress):
    r"""caerConfigurationEventSetModuleAddress(caer_configuration_event event, uint8_t moduleAddress)"""
...
def caerConfigurationEventGetParameterAddress(event):
    r"""caerConfigurationEventGetParameterAddress(caer_configuration_event event) -> uint8_t"""
...
def caerConfigurationEventSetParameterAddress(event, parameterAddress):
    r"""caerConfigurationEventSetParameterAddress(caer_configuration_event event, uint8_t parameterAddress)"""
...
def caerConfigurationEventGetParameter(event):
    r"""caerConfigurationEventGetParameter(caer_configuration_event event) -> uint32_t"""
    return _libcaer_wrap.caerConfigurationEventGetParameter(event)

def caerConfigurationEventSetParameter(event, parameter):
    r"""caerConfigurationEventSetParameter(caer_configuration_event event, uint32_t parameter)"""
...
class caer_ear_event(_object):
    r"""Proxy of C caer_ear_event struct."""
    ...
    if _newclass:
        data = property(_libcaer_wrap.caer_ear_event_data_get, _libcaer_wrap.caer_ear_event_data_set)
    ...
    if _newclass:
        timestamp = property(_libcaer_wrap.caer_ear_event_timestamp_get, _libcaer_wrap.caer_ear_event_timestamp_set)

    def __init__(self):
        r"""__init__(caer_ear_event self) -> caer_ear_event"""
    ...
    def __del__(self):
        return None
# Register caer_ear_event in _libcaer_wrap:
_libcaer_wrap.caer_ear_event_swigregister(caer_ear_event)

class caer_ear_event_packet(_object):
    r"""Proxy of C caer_ear_event_packet struct."""
    ...
    if _newclass:
        packetHeader = property(_libcaer_wrap.caer_ear_event_packet_packetHeader_get, _libcaer_wrap.caer_ear_event_packet_packetHeader_set)
    __swig_getmethods__["events"] = _libcaer_wrap.caer_ear_event_packet_events_get
    if _newclass:
        events = property(_libcaer_wrap.caer_ear_event_packet_events_get)

    def __init__(self):
        r"""__init__(caer_ear_event_packet self) -> caer_ear_event_packet"""
    ...
    def __del__(self):
        return None
# Register caer_ear_event_packet in _libcaer_wrap:
_libcaer_wrap.caer_ear_event_packet_swigregister(caer_ear_event_packet)


def caerEarEventPacketAllocate(eventCapacity, eventSource, tsOverflow):
    r"""caerEarEventPacketAllocate(int32_t eventCapacity, int16_t eventSource, int32_t tsOverflow) -> caer_ear_event_packet"""
...
class caer_frame_event(_object):
    ...
    if _newclass:
        info = property(_libcaer_wrap.caer_frame_event_info_get, _libcaer_wrap.caer_frame_event_info_set)
    ...
    if _newclass:
        ts_startframe = property(_libcaer_wrap.caer_frame_event_ts_startframe_get, _libcaer_wrap.caer_frame_event_ts_startframe_set)
    ...
    if _newclass:
        ts_endframe = property(_libcaer_wrap.caer_frame_event_ts_endframe_get, _libcaer_wrap.caer_frame_event_ts_endframe_set)
    ...
    if _newclass:
        ts_startexposure = property(_libcaer_wrap.caer_frame_event_ts_startexposure_get, _libcaer_wrap.caer_frame_event_ts_startexposure_set)
    ...
    if _newclass:
        ts_endexposure = property(_libcaer_wrap.caer_frame_event_ts_endexposure_get, _libcaer_wrap.caer_frame_event_ts_endexposure_set)
    ...
    if _newclass:
        lengthX = property(_libcaer_wrap.caer_frame_event_lengthX_get, _libcaer_wrap.caer_frame_event_lengthX_set)
    ...
    if _newclass:
        lengthY = property(_libcaer_wrap.caer_frame_event_lengthY_get, _libcaer_wrap.caer_frame_event_lengthY_set)
    ...
    if _newclass:
        positionX = property(_libcaer_wrap.caer_frame_event_positionX_get, _libcaer_wrap.caer_frame_event_positionX_set)
    ...
    if _newclass:
        positionY = property(_libcaer_wrap.caer_frame_event_positionY_get, _libcaer_wrap.caer_frame_event_positionY_set)
    ...
    if _newclass:
        pixels = property(_libcaer_wrap.caer_frame_event_pixels_get, _libcaer_wrap.caer_frame_event_pixels_set)
...
class caer_frame_event_packet(_object):
    ...
    if _newclass:
        packetHeader = property(_libcaer_wrap.caer_frame_event_packet_packetHeader_get, _libcaer_wrap.caer_frame_event_packet_packetHeader_set)
...
class caer_imu6_event(_object):
    ...
    if _newclass:
        info = property(_libcaer_wrap.caer_imu6_event_info_get, _libcaer_wrap.caer_imu6_event_info_set)
    ...
    if _newclass:
        timestamp = property(_libcaer_wrap.caer_imu6_event_timestamp_get, _libcaer_wrap.caer_imu6_event_timestamp_set)
    ...
    if _newclass:
        accel_x = property(_libcaer_wrap.caer_imu6_event_accel_x_get, _libcaer_wrap.caer_imu6_event_accel_x_set)
    ...
    if _newclass:
        accel_y = property(_libcaer_wrap.caer_imu6_event_accel_y_get, _libcaer_wrap.caer_imu6_event_accel_y_set)
    ...
    if _newclass:
        accel_z = property(_libcaer_wrap.caer_imu6_event_accel_z_get, _libcaer_wrap.caer_imu6_event_accel_z_set)
    ...
    if _newclass:
        gyro_x = property(_libcaer_wrap.caer_imu6_event_gyro_x_get, _libcaer_wrap.caer_imu6_event_gyro_x_set)
    ...
    if _newclass:
        gyro_y = property(_libcaer_wrap.caer_imu6_event_gyro_y_get, _libcaer_wrap.caer_imu6_event_gyro_y_set)
    ...
    if _newclass:
        gyro_z = property(_libcaer_wrap.caer_imu6_event_gyro_z_get, _libcaer_wrap.caer_imu6_event_gyro_z_set)
    ...
    if _newclass:
        temp = property(_libcaer_wrap.caer_imu6_event_temp_get, _libcaer_wrap.caer_imu6_event_temp_set)
...
class caer_imu6_event_packet(_object):
    ...
    if _newclass:
        packetHeader = property(_libcaer_wrap.caer_imu6_event_packet_packetHeader_get, _libcaer_wrap.caer_imu6_event_packet_packetHeader_set)
    __swig_getmethods__["events"] = _libcaer_wrap.caer_imu6_event_packet_events_get
    if _newclass:
        events = property(_libcaer_wrap.caer_imu6_event_packet_events_get)
...
class caer_imu9_event(_object):
    ...
    if _newclass:
        info = property(_libcaer_wrap.caer_imu9_event_info_get, _libcaer_wrap.caer_imu9_event_info_set)
    ...
    if _newclass:
        timestamp = property(_libcaer_wrap.caer_imu9_event_timestamp_get, _libcaer_wrap.caer_imu9_event_timestamp_set)
    ...
    if _newclass:
        accel_x = property(_libcaer_wrap.caer_imu9_event_accel_x_get, _libcaer_wrap.caer_imu9_event_accel_x_set)
    ...
    if _newclass:
        accel_y = property(_libcaer_wrap.caer_imu9_event_accel_y_get, _libcaer_wrap.caer_imu9_event_accel_y_set)
    ...
    if _newclass:
        accel_z = property(_libcaer_wrap.caer_imu9_event_accel_z_get, _libcaer_wrap.caer_imu9_event_accel_z_set)
    ...
    if _newclass:
        gyro_x = property(_libcaer_wrap.caer_imu9_event_gyro_x_get, _libcaer_wrap.caer_imu9_event_gyro_x_set)
    ...
    if _newclass:
        gyro_y = property(_libcaer_wrap.caer_imu9_event_gyro_y_get, _libcaer_wrap.caer_imu9_event_gyro_y_set)
    ...
    if _newclass:
        gyro_z = property(_libcaer_wrap.caer_imu9_event_gyro_z_get, _libcaer_wrap.caer_imu9_event_gyro_z_set)
    ...
    if _newclass:
        temp = property(_libcaer_wrap.caer_imu9_event_temp_get, _libcaer_wrap.caer_imu9_event_temp_set)
    ...
    if _newclass:
        comp_x = property(_libcaer_wrap.caer_imu9_event_comp_x_get, _libcaer_wrap.caer_imu9_event_comp_x_set)
    ...
    if _newclass:
        comp_y = property(_libcaer_wrap.caer_imu9_event_comp_y_get, _libcaer_wrap.caer_imu9_event_comp_y_set)
    ...
    if _newclass:
        comp_z = property(_libcaer_wrap.caer_imu9_event_comp_z_get, _libcaer_wrap.caer_imu9_event_comp_z_set)
...
class caer_imu9_event_packet(_object):
    ...
    if _newclass:
        packetHeader = property(_libcaer_wrap.caer_imu9_event_packet_packetHeader_get, _libcaer_wrap.caer_imu9_event_packet_packetHeader_set)
    __swig_getmethods__["events"] = _libcaer_wrap.caer_imu9_event_packet_events_get
    if _newclass:
        events = property(_libcaer_wrap.caer_imu9_event_packet_events_get)
...
class caer_event_packet_container(_object):
    ...
    if _newclass:
        lowestEventTimestamp = property(_libcaer_wrap.caer_event_packet_container_lowestEventTimestamp_get, _libcaer_wrap.caer_event_packet_container_lowestEventTimestamp_set)
    ...
    if _newclass:
        highestEventTimestamp = property(_libcaer_wrap.caer_event_packet_container_highestEventTimestamp_get, _libcaer_wrap.caer_event_packet_container_highestEventTimestamp_set)
    ...
    if _newclass:
        eventsNumber = property(_libcaer_wrap.caer_event_packet_container_eventsNumber_get, _libcaer_wrap.caer_event_packet_container_eventsNumber_set)
    ...
    if _newclass:
        eventsValidNumber = property(_libcaer_wrap.caer_event_packet_container_eventsValidNumber_get, _libcaer_wrap.caer_event_packet_container_eventsValidNumber_set)
    ...
    if _newclass:
        eventPacketsNumber = property(_libcaer_wrap.caer_event_packet_container_eventPacketsNumber_get, _libcaer_wrap.caer_event_packet_container_eventPacketsNumber_set)
    __swig_getmethods__["eventPackets"] = _libcaer_wrap.caer_event_packet_container_eventPackets_get
    if _newclass:
        eventPackets = property(_libcaer_wrap.caer_event_packet_container_eventPackets_get)
...
class caer_point1d_event(_object):
    r"""Proxy of C caer_point1d_event struct."""
    ...
    if _newclass:
        info = property(_libcaer_wrap.caer_point1d_event_info_get, _libcaer_wrap.caer_point1d_event_info_set)
    __swig_setmethods__["x"] = _libcaer_wrap.caer_point1d_event_x_set
    __swig_getmethods__["x"] = _libcaer_wrap.caer_point1d_event_x_get
    if _newclass:
        x = property(_libcaer_wrap.caer_point1d_event_x_get, _libcaer_wrap.caer_point1d_event_x_set)
    ...
    if _newclass:
        timestamp = property(_libcaer_wrap.caer_point1d_event_timestamp_get, _libcaer_wrap.caer_point1d_event_timestamp_set)

    def __init__(self):
        r"""__init__(caer_point1d_event self) -> caer_point1d_event"""
    ...
    def __del__(self):
        return None
# Register caer_point1d_event in _libcaer_wrap:
_libcaer_wrap.caer_point1d_event_swigregister(caer_point1d_event)

class caer_point1d_event_packet(_object):
    r"""Proxy of C caer_point1d_event_packet struct."""
    ...
    if _newclass:
        packetHeader = property(_libcaer_wrap.caer_point1d_event_packet_packetHeader_get, _libcaer_wrap.caer_point1d_event_packet_packetHeader_set)
    __swig_getmethods__["events"] = _libcaer_wrap.caer_point1d_event_packet_events_get
    if _newclass:
        events = property(_libcaer_wrap.caer_point1d_event_packet_events_get)

    def __init__(self):
        r"""__init__(caer_point1d_event_packet self) -> caer_point1d_event_packet"""
    ...
    def __del__(self):
        return None
# Register caer_point1d_event_packet in _libcaer_wrap:
_libcaer_wrap.caer_point1d_event_packet_swigregister(caer_point1d_event_packet)


def caerPoint1DEventPacketAllocate(eventCapacity, eventSource, tsOverflow):
    r"""caerPoint1DEventPacketAllocate(int32_t eventCapacity, int16_t eventSource, int32_t tsOverflow) -> caer_point1d_event_packet"""
...
class caer_point2d_event(_object):
    r"""Proxy of C caer_point2d_event struct."""
    ...
    if _newclass:
        info = property(_libcaer_wrap.caer_point2d_event_info_get, _libcaer_wrap.caer_point2d_event_info_set)
    __swig_setmethods__["x"] = _libcaer_wrap.caer_point2d_event_x_set
    __swig_getmethods__["x"] = _libcaer_wrap.caer_point2d_event_x_get
    if _newclass:
        x = property(_libcaer_wrap.caer_point2d_event_x_get, _libcaer_wrap.caer_point2d_event_x_set)
    __swig_setmethods__["y"] = _libcaer_wrap.caer_point2d_event_y_set
    __swig_getmethods__["y"] = _libcaer_wrap.caer_point2d_event_y_get
    if _newclass:
        y = property(_libcaer_wrap.caer_point2d_event_y_get, _libcaer_wrap.caer_point2d_event_y_set)
    ...
    if _newclass:
        timestamp = property(_libcaer_wrap.caer_point2d_event_timestamp_get, _libcaer_wrap.caer_point2d_event_timestamp_set)

    def __init__(self):
        r"""__init__(caer_point2d_event self) -> caer_point2d_event"""
    ...
    def __del__(self):
        return None
# Register caer_point2d_event in _libcaer_wrap:
_libcaer_wrap.caer_point2d_event_swigregister(caer_point2d_event)

class caer_point2d_event_packet(_object):
    r"""Proxy of C caer_point2d_event_packet struct."""
    ...
    if _newclass:
        packetHeader = property(_libcaer_wrap.caer_point2d_event_packet_packetHeader_get, _libcaer_wrap.caer_point2d_event_packet_packetHeader_set)
    __swig_getmethods__["events"] = _libcaer_wrap.caer_point2d_event_packet_events_get
    if _newclass:
        events = property(_libcaer_wrap.caer_point2d_event_packet_events_get)

    def __init__(self):
        r"""__init__(caer_point2d_event_packet self) -> caer_point2d_event_packet"""
    ...
    def __del__(self):
        return None
# Register caer_point2d_event_packet in _libcaer_wrap:
_libcaer_wrap.caer_point2d_event_packet_swigregister(caer_point2d_event_packet)


def caerPoint2DEventPacketAllocate(eventCapacity, eventSource, tsOverflow):
    r"""caerPoint2DEventPacketAllocate(int32_t eventCapacity, int16_t eventSource, int32_t tsOverflow) -> caer_point2d_event_packet"""
...
class caer_point3d_event(_object):
    r"""Proxy of C caer_point3d_event struct."""
    ...
    if _newclass:
        info = property(_libcaer_wrap.caer_point3d_event_info_get, _libcaer_wrap.caer_point3d_event_info_set)
    __swig_setmethods__["x"] = _libcaer_wrap.caer_point3d_event_x_set
    __swig_getmethods__["x"] = _libcaer_wrap.caer_point3d_event_x_get
    if _newclass:
        x = property(_libcaer_wrap.caer_point3d_event_x_get, _libcaer_wrap.caer_point3d_event_x_set)
    __swig_setmethods__["y"] = _libcaer_wrap.caer_point3d_event_y_set
    __swig_getmethods__["y"] = _libcaer_wrap.caer_point3d_event_y_get
    if _newclass:
        y = property(_libcaer_wrap.caer_point3d_event_y_get, _libcaer_wrap.caer_point3d_event_y_set)
    __swig_setmethods__["z"] = _libcaer_wrap.caer_point3d_event_z_set
    __swig_getmethods__["z"] = _libcaer_wrap.caer_point3d_event_z_get
    if _newclass:
        z = property(_libcaer_wrap.caer_point3d_event_z_get, _libcaer_wrap.caer_point3d_event_z_set)
    ...
    if _newclass:
        timestamp = property(_libcaer_wrap.caer_point3d_event_timestamp_get, _libcaer_wrap.caer_point3d_event_timestamp_set)

    def __init__(self):
        r"""__init__(caer_point3d_event self) -> caer_point3d_event"""
    ...
    def __del__(self):
        return None
# Register caer_point3d_event in _libcaer_wrap:
_libcaer_wrap.caer_point3d_event_swigregister(caer_point3d_event)

class caer_point3d_event_packet(_object):
    r"""Proxy of C caer_point3d_event_packet struct."""
    ...
    if _newclass:
        packetHeader = property(_libcaer_wrap.caer_point3d_event_packet_packetHeader_get, _libcaer_wrap.caer_point3d_event_packet_packetHeader_set)
    __swig_getmethods__["events"] = _libcaer_wrap.caer_point3d_event_packet_events_get
    if _newclass:
        events = property(_libcaer_wrap.caer_point3d_event_packet_events_get)

    def __init__(self):
        r"""__init__(caer_point3d_event_packet self) -> caer_point3d_event_packet"""
    ...
    def __del__(self):
        return None
# Register caer_point3d_event_packet in _libcaer_wrap:
_libcaer_wrap.caer_point3d_event_packet_swigregister(caer_point3d_event_packet)


def caerPoint3DEventPacketAllocate(eventCapacity, eventSource, tsOverflow):
    r"""caerPoint3DEventPacketAllocate(int32_t eventCapacity, int16_t eventSource, int32_t tsOverflow) -> caer_point3d_event_packet"""
...
class caer_point4d_event(_object):
    r"""Proxy of C caer_point4d_event struct."""
    ...
    if _newclass:
        timestamp = property(_libcaer_wrap.caer_point4d_event_timestamp_get, _libcaer_wrap.caer_point4d_event_timestamp_set)

    def __init__(self):
        r"""__init__(caer_point4d_event self) -> caer_point4d_event"""
    ...
    def __del__(self):
        return None
# Register caer_point4d_event in _libcaer_wrap:
_libcaer_wrap.caer_point4d_event_swigregister(caer_point4d_event)

class caer_point4d_event_packet(_object):
    r"""Proxy of C caer_point4d_event_packet struct."""
    ...
    if _newclass:
        packetHeader = property(_libcaer_wrap.caer_point4d_event_packet_packetHeader_get, _libcaer_wrap.caer_point4d_event_packet_packetHeader_set)
    __swig_getmethods__["events"] = _libcaer_wrap.caer_point4d_event_packet_events_get
    if _newclass:
        events = property(_libcaer_wrap.caer_point4d_event_packet_events_get)

    def __init__(self):
        r"""__init__(caer_point4d_event_packet self) -> caer_point4d_event_packet"""
    ...
    def __del__(self):
        return None
# Register caer_point4d_event_packet in _libcaer_wrap:
_libcaer_wrap.caer_point4d_event_packet_swigregister(caer_point4d_event_packet)


def caerPoint4DEventPacketAllocate(eventCapacity, eventSource, tsOverflow):
    r"""caerPoint4DEventPacketAllocate(int32_t eventCapacity, int16_t eventSource, int32_t tsOverflow) -> caer_point4d_event_packet"""
...
class caer_polarity_event(_object):
    ...
    if _newclass:
        data = property(_libcaer_wrap.caer_polarity_event_data_get, _libcaer_wrap.caer_polarity_event_data_set)
    ...
    if _newclass:
        timestamp = property(_libcaer_wrap.caer_polarity_event_timestamp_get, _libcaer_wrap.caer_polarity_event_timestamp_set)
...
class caer_polarity_event_packet(_object):
    ...
    if _newclass:
        packetHeader = property(_libcaer_wrap.caer_polarity_event_packet_packetHeader_get, _libcaer_wrap.caer_polarity_event_packet_packetHeader_set)
    __swig_getmethods__["events"] = _libcaer_wrap.caer_polarity_event_packet_events_get
    if _newclass:
        events = property(_libcaer_wrap.caer_polarity_event_packet_events_get)
...
class caer_sample_event(_object):
    r"""Proxy of C caer_sample_event struct."""
    ...
    if _newclass:
        data = property(_libcaer_wrap.caer_sample_event_data_get, _libcaer_wrap.caer_sample_event_data_set)
    ...
    if _newclass:
        timestamp = property(_libcaer_wrap.caer_sample_event_timestamp_get, _libcaer_wrap.caer_sample_event_timestamp_set)

    def __init__(self):
        r"""__init__(caer_sample_event self) -> caer_sample_event"""
    ...
    def __del__(self):
        return None
# Register caer_sample_event in _libcaer_wrap:
_libcaer_wrap.caer_sample_event_swigregister(caer_sample_event)

class caer_sample_event_packet(_object):
    r"""Proxy of C caer_sample_event_packet struct."""
    ...
    if _newclass:
        packetHeader = property(_libcaer_wrap.caer_sample_event_packet_packetHeader_get, _libcaer_wrap.caer_sample_event_packet_packetHeader_set)
    __swig_getmethods__["events"] = _libcaer_wrap.caer_sample_event_packet_events_get
    if _newclass:
        events = property(_libcaer_wrap.caer_sample_event_packet_events_get)

    def __init__(self):
        r"""__init__(caer_sample_event_packet self) -> caer_sample_event_packet"""
    ...
    def __del__(self):
        return None
# Register caer_sample_event_packet in _libcaer_wrap:
_libcaer_wrap.caer_sample_event_packet_swigregister(caer_sample_event_packet)


def caerSampleEventPacketAllocate(eventCapacity, eventSource, tsOverflow):
    r"""caerSampleEventPacketAllocate(int32_t eventCapacity, int16_t eventSource, int32_t tsOverflow) -> caer_sample_event_packet"""
...
class caer_special_event(_object):
    ...
    if _newclass:
        data = property(_libcaer_wrap.caer_special_event_data_get, _libcaer_wrap.caer_special_event_data_set)
    ...
    if _newclass:
        timestamp = property(_libcaer_wrap.caer_special_event_timestamp_get, _libcaer_wrap.caer_special_event_timestamp_set)
...
class caer_special_event_packet(_object):
    ...
    if _newclass:
        packetHeader = property(_libcaer_wrap.caer_special_event_packet_packetHeader_get, _libcaer_wrap.caer_special_event_packet_packetHeader_set)
    __swig_getmethods__["events"] = _libcaer_wrap.caer_special_event_packet_events_get
    if _newclass:
        events = property(_libcaer_wrap.caer_special_event_packet_events_get)
...
class caer_spike_event(_object):
    ...
    if _newclass:
        data = property(_libcaer_wrap.caer_spike_event_data_get, _libcaer_wrap.caer_spike_event_data_set)
    ...
    if _newclass:
        timestamp = property(_libcaer_wrap.caer_spike_event_timestamp_get, _libcaer_wrap.caer_spike_event_timestamp_set)
...
class caer_spike_event_packet(_object):
    ...
    if _newclass:
        packetHeader = property(_libcaer_wrap.caer_spike_event_packet_packetHeader_get, _libcaer_wrap.caer_spike_event_packet_packetHeader_set)
    __swig_getmethods__["events"] = _libcaer_wrap.caer_spike_event_packet_events_get
    if _newclass:
        events = property(_libcaer_wrap.caer_spike_event_packet_events_get)
...
class caer_filter_dvs_pixel(_object):
    ...
    if _newclass:
        x = property(_libcaer_wrap.caer_filter_dvs_pixel_x_get, _libcaer_wrap.caer_filter_dvs_pixel_x_set)
    ...
    if _newclass:
        y = property(_libcaer_wrap.caer_filter_dvs_pixel_y_get, _libcaer_wrap.caer_filter_dvs_pixel_y_set)
