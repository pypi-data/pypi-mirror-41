...
from demyst.common import load_volatile_config
...
class DataFunction(object):
    ...
    def __init__(self, txid=NTXID, inputs={}, config_file=None, sample_mode=False, region=None, env=None, key=None):
        self.C = load_volatile_config(config_file=config_file, region=region, env=env, key=key)
...
def df2(f):
    ...
    def wrapper(*args, **kwargs):
        ...
        df = DataFunction(txid=NTXID, inputs=inputs)
        return f(df)
