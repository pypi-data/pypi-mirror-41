...
Version:
"""
from rgi.geopackage.core.geopackage_core import GEOPACKAGE_CONTENTS_TABLE_NAME
...
from rgi.geopackage.utility.sql_utility import table_exists, select_query, select_all_query, insert_or_update_row
...
class GeoPackageVectorLayers(Extension):
    ...
    def insert_or_update_vector_tile_layer_entry(cursor,
        ...
        # get the id value
        vector_tile_layer_entry.id = select_query(cursor=cursor,
                                                  select_columns=['id'],
                                                  table_name=GEOPACKAGE_VECTOR_LAYERS_TABLE_NAME,
                                                  where_columns_dictionary={'table_name': vector_tile_layer_entry.table_name,
                                                                            'name' : vector_tile_layer_entry.name,
                                                                            'description' : vector_tile_layer_entry.description,
                                                                            'minzoom' : vector_tile_layer_entry.min_zoom,
                                                                            'maxzoom' : vector_tile_layer_entry.max_zoom})[0]['id']
