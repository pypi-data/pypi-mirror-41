...
class ServiceProvider(ProviderMixin, models.Model):
    ...
    allow_unknown_attributes = models.NullBooleanField(help_text=_('If True there must be a mapping for the attribute.'))

    create_user = models.BooleanField(default=False, blank=True, help_text=_('If checked the SP will try to create new user accounts.'))
