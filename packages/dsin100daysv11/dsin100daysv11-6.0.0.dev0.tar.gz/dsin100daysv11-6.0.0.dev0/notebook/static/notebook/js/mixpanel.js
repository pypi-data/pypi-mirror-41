...
define([
    ...
    var track_events = function() {
        ...
        events.on('execute.CodeCell', function (e, d) {
            ...
            mixpanel.track('cell execution', {'notebook_path': path, 'index': i});
        });
        ...
        events.on('finished_execute.CodeCell', function (e, d) {
            ...
            mixpanel.track('finished cell execution', {'notebook_path': path, 'index': i, 'status': status});
        });
        ...
        function paste_event() {
            ...
            mixpanel.track("code pasted", {'notebook_path': path, 'index': i});
        }
