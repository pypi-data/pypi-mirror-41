...
After having resolved the dependencies, you can easily use the SDK following these steps.
  ...
  1. Create a "jsdhgsdysdhggds_test.py" file in the root directory.
  2. Use any controller as follows:
```python
from __future__ import print_function
from jsdhgsdysdhggds.jsdhgsdysdhggds_client import JsdhgsdysdhggdsClient

api_client = JsdhgsdysdhggdsClient()
