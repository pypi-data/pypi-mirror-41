...
from LbSoftConfDb2Server.LbSoftConfDB2.SoftConfDB import sortVersions
...
class LbSdbQuery(Script):
    ...
    def defineOpts(self):
        ...
        parser.add_option("--noxmlrpc",
                          ...
                          default=False,
                          action="store_true",
                          help="Use the py2neo interface to Neo4j "
                               "instead of XMLRPC")
    ...
    def cmdlistTag(self, args):
        ...
        if self.options.json:
            import json
            print(json.dumps(sorted(self.mConfDB.listTag(args[0].upper())),
                             indent=2))
        else:
