"""A setuptools based setup module SE.
...
setup(
    ...
    name='LbSoftConfDb2Clients',  # Required
    ...
    description='LHCb Software configuration database 2 clients',  # Required
    ...
    url='https://gitlab.cern.ch/lhcb-core/LbSoftConfDb2Clients',  # Optional
    ...
    install_requires=[ "py2neo>=4.1.0", "LbCommon", "LbEnv" ],  # Optional
