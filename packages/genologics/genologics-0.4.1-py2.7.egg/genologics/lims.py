...
class Lims(object):
    ...
    def create_container(self, container_type, name=None):
        "Create a new container of type container_typ;e and returns it"
        el = ElementTree.Element("con:container", attrib={"xmlns:con":"http://genologics.com/ri/container"})
        if name is not None:
        ...
        ret = self.post(nsmap('cons'), ElementTree.tostring(el))
