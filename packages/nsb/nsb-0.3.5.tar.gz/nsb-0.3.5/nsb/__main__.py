...
def main():
    ...
    """
    brt = Brightness(Options, Configuration, date_and_time, date_and_time2, source, level, threshold=None,timeresolution=1)
    brt.calculateOnce()
