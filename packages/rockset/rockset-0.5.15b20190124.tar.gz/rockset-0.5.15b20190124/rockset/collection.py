...
from rockset.swagger_client.models import (AddDocumentsRequest,
        CreateCollectionRequest, DeleteDocumentsRequest)
...
class Collection(Resource):
    ...
    def create(
        ...
        **kwargs
        ...
        collection = CollectionsApi(client).create(body=req).get('data').to_dict()
    ...
    def add_docs(self, docs, timeout=None):
        ...
        * Fields present in the collection document but not the input
        ...
        for chunk in self._chopper(docs):
            ...
            retval.extend(DocumentsApi(self.client).add(
                collection=self.name,
                body=request,
                _request_timeout=timeout).get('data'))
    ...
    def remove_docs(self, docs, timeout=None):
        ...
        for chunk in self._chopper(docids):
            ...
            retval.extend(DocumentsApi(self.client).delete(
                collection=self.name,
                body=request,
                _request_timeout=timeout).get('data'))
        return retval
