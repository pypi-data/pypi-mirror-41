...
setup(
    ...
    description='Module for custom Dynaconf loader to access a Spring Config server',
    long_description='',
    ...
    packages=find_packages(exclude=['*.sh', 'tests', 'tests/*', "*.egg-info", "EGG-INFO", './dist','./build','.*']),
    include_package_data=True,
    install_requires=['requests','dynaconf'],
    setup_requires=['requests-mock', 'flake8'],
    test_suite='test',
    package_data={
        'sample': [''],
    },
