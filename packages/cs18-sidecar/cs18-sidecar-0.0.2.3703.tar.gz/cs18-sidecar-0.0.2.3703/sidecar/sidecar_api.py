...
from sidecar.cloud_logger import ICloudLogger, LogEntry, FileLogger
from sidecar.cloud_logger.file_logger import FakeFileLogger
...
def brute_force_escape(input: bytes):
    return input.decode("utf-8").encode("unicode_escape").decode("utf-8")
...
def run_impl(config: ISidecarConfiguration, own_public_ip: str):
    ...
    if _file_logger is None:
        _file_logger = FileLogger(app_names=app_names)
...
def configure_debug():
    ...
    #                                          sandbox_id="t7onu02wct02c1",
    #                                          kub_api_address="http://api-eagle-agile-cluster-k-hljc87-1960987313.eu-west-1.elb.amazonaws.com",
