...
class AzureStatusMaintainer:
    ...
    def update_app_instance_status(self, instance_logical_id, instance_id, app_name, status):
        with self._lock:
            ...
            self._cached_realtime_apps[instance_logical_id]["gil_test"] = instances_under_logical_id

            # todo gil remove this
            ...
            #                                      data=instances_under_logical_id,
            #                                      column_name=instances_key_path)
