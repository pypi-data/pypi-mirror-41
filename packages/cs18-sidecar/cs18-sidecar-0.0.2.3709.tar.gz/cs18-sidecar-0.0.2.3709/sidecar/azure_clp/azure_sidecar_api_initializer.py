...
class AzureSidecarApiInitializer:
    ...
    def initialize(self):
        ...
        azure_cosmos_service = AzureCosmosService(clients_manager=azure_clients_manager)

        azure_status_maintainer = AzureStatusMaintainer(data_store_service=azure_cosmos_service,
