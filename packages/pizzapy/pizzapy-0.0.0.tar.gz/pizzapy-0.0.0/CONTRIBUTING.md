...
Report bugs at <https://github.com/aluttik/pizzapy/issues>.
...
pizzapy could always use more documentation, whether as part of the
official pizzapy docs, in docstrings, or even on the web in blog posts,
articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at
<https://github.com/aluttik/pizzapy/issues>.
...
Ready to contribute? Here's how to set up pizzapy for local development.

1.  [Fork](https://github.com/aluttik/pizzapy/fork) the
    pizzapy repo on GitHub.

2.  Clone your fork locally:

        git clone git@github.com:your_name_here/pizzapy.git
...
3.  The pull request should work for CPython 2.7, 3.4, 3.5, 3.6, and 3.7. Check
    <https://travis-ci.org/aluttik/pizzapy> under pull requests
