# -*- coding: utf-8 -*-
#
# vault-keepass-import documentation build configuration file, created by
...
# ones.
extensions = ['sphinx.ext.todo', 'sphinxarg.ext', ]
...
project = u'vault-keepass-import'
copyright = u'2018 Philipp Schmitt, 2019 singuliere'
author = u'singuliere'
...
htmlhelp_basename = 'vault-keepass-importdoc'
...
latex_documents = [
  (master_doc, 'vault-keepass-import.tex', u'vault-keepass-import Documentation',
   author, 'manual'),
]
...
man_pages = [
    (master_doc, 'enough', u'vault-keepass-import Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'vault-keepass-import', u'vault-keepass-import Documentation',
   author, 'vault-keepass-import', 'One line description of project.',
   'Miscellaneous'),
]
