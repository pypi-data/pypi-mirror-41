...
namespace __pythran_operators
{
  ...
  struct __for_method__OperatorsSphereHarmo2D__vsh_from_divrotsh
  {
    ...
    struct type
    {
      ...
      typedef typename std::remove_cv<typename std::remove_reference<decltype(pythonic::__builtin__::pythran::functor::static_if_{})>::type>::type __type2;
  ...
  {
    {
      static typename __transonic__::type::result_type tmp_global = pythonic::types::make_tuple(pythonic::types::str("0.1.9.post0"));
      return tmp_global;
    }
  }
...
"    return pythran_func(self.inv_K2_r, self.nlm, div_lm, rot_lm, uD_lm, uR_lm)\n"
"\n"
"");
      return tmp_global;
    }
...
"    return pythran_func(self.K2_r, self.nlm, uD_lm, uR_lm, div_lm, rot_lm)\n"
"\n"
"");
      return tmp_global;
    }
...
"    return pythran_func(self.inv_K2_not0, a_lm, negative)\n"
"\n"
"");
      return tmp_global;
    }
...
"\n"
"def new_method(self, a_lm, negative=False):\n"
"    return pythran_func(self.K2, a_lm, negative)\n"
"\n"
"");
      return tmp_global;
    }
  ...
  {
    typedef typename std::remove_cv<typename std::remove_reference<decltype(pythonic::__builtin__::pythran::functor::static_if_{})>::type>::type __type0;
    ...
    typename pythonic::assignable<decltype(pythonic::__builtin__::pythran::functor::static_if_{}(pythonic::__builtin__::pythran::functor::is_none{}(uD_lm_), $isstatic4(), $isstatic5())(self_nlm, uD_lm_))>::type __tuple0 = pythonic::__builtin__::pythran::functor::static_if_{}(pythonic::__builtin__::pythran::functor::is_none{}(uD_lm_), $isstatic4(), $isstatic5())(self_nlm, uD_lm_);
    typename pythonic::assignable<typename __combined<__type9,__type13>::type>::type uD_lm__ = std::get<0>(__tuple0);
    typename pythonic::assignable<decltype(pythonic::__builtin__::pythran::functor::static_if_{}(pythonic::__builtin__::pythran::functor::is_none{}(uR_lm_), $isstatic6(), $isstatic7())(self_nlm, uR_lm_))>::type __tuple1 = pythonic::__builtin__::pythran::functor::static_if_{}(pythonic::__builtin__::pythran::functor::is_none{}(uR_lm_), $isstatic6(), $isstatic7())(self_nlm, uR_lm_);
  ...
  typename __for_method__OperatorsSphereHarmo2D__divrotsh_from_vsh::type<argument_type0, argument_type1, argument_type2, argument_type3, argument_type4, argument_type5>::result_type __for_method__OperatorsSphereHarmo2D__divrotsh_from_vsh::operator()(argument_type0&& self_K2_r, argument_type1&& self_nlm, argument_type2&& uD_lm, argument_type3&& uR_lm, argument_type4 div_lm, argument_type5 rot_lm) const
  {
    ...
    typename pythonic::assignable<decltype(pythonic::__builtin__::pythran::functor::static_if_{}(pythonic::__builtin__::pythran::functor::is_none{}(div_lm_), $isstatic0(), $isstatic1())(div_lm_, self_nlm))>::type __tuple0 = pythonic::__builtin__::pythran::functor::static_if_{}(pythonic::__builtin__::pythran::functor::is_none{}(div_lm_), $isstatic0(), $isstatic1())(div_lm_, self_nlm);
    typename pythonic::assignable<typename __combined<__type9,__type13>::type>::type div_lm__ = std::get<0>(__tuple0);
    typename pythonic::assignable<decltype(pythonic::__builtin__::pythran::functor::static_if_{}(pythonic::__builtin__::pythran::functor::is_none{}(rot_lm_), $isstatic2(), $isstatic3())(rot_lm_, self_nlm))>::type __tuple1 = pythonic::__builtin__::pythran::functor::static_if_{}(pythonic::__builtin__::pythran::functor::is_none{}(rot_lm_), $isstatic2(), $isstatic3())(rot_lm_, self_nlm);
...
typename __pythran_operators::__for_method__OperatorsSphereHarmo2D__vsh_from_divrotsh::type<pythonic::types::ndarray<double,pythonic::types::pshape<long>>, long, pythonic::types::ndarray<std::complex<double>,pythonic::types::pshape<long>>, pythonic::types::ndarray<std::complex<double>,pythonic::types::pshape<long>>, pythonic::types::none_type, pythonic::types::ndarray<std::complex<double>,pythonic::types::pshape<long>>>::result_type __for_method__OperatorsSphereHarmo2D__vsh_from_divrotsh2(pythonic::types::ndarray<double,pythonic::types::pshape<long>>&& self_inv_K2_r, long&& self_nlm, pythonic::types::ndarray<std::complex<double>,pythonic::types::pshape<long>>&& div_lm, pythonic::types::ndarray<std::complex<double>,pythonic::types::pshape<long>>&& rot_lm, pythonic::types::none_type&& uD_lm, pythonic::types::ndarray<std::complex<double>,pythonic::types::pshape<long>>&& uR_lm) 
{
...
typename __pythran_operators::__for_method__OperatorsSphereHarmo2D__vsh_from_divrotsh::type<pythonic::types::ndarray<double,pythonic::types::pshape<long>>, long, pythonic::types::ndarray<std::complex<double>,pythonic::types::pshape<long>>, pythonic::types::ndarray<std::complex<double>,pythonic::types::pshape<long>>, pythonic::types::none_type, pythonic::types::none_type>::result_type __for_method__OperatorsSphereHarmo2D__vsh_from_divrotsh3(pythonic::types::ndarray<double,pythonic::types::pshape<long>>&& self_inv_K2_r, long&& self_nlm, pythonic::types::ndarray<std::complex<double>,pythonic::types::pshape<long>>&& div_lm, pythonic::types::ndarray<std::complex<double>,pythonic::types::pshape<long>>&& rot_lm, pythonic::types::none_type&& uD_lm, pythonic::types::none_type&& uR_lm) 
{
...
typename __pythran_operators::__for_method__OperatorsSphereHarmo2D__divrotsh_from_vsh::type<pythonic::types::ndarray<double,pythonic::types::pshape<long>>, long, pythonic::types::ndarray<std::complex<double>,pythonic::types::pshape<long>>, pythonic::types::ndarray<std::complex<double>,pythonic::types::pshape<long>>, pythonic::types::none_type, pythonic::types::ndarray<std::complex<double>,pythonic::types::pshape<long>>>::result_type __for_method__OperatorsSphereHarmo2D__divrotsh_from_vsh2(pythonic::types::ndarray<double,pythonic::types::pshape<long>>&& self_K2_r, long&& self_nlm, pythonic::types::ndarray<std::complex<double>,pythonic::types::pshape<long>>&& uD_lm, pythonic::types::ndarray<std::complex<double>,pythonic::types::pshape<long>>&& uR_lm, pythonic::types::none_type&& div_lm, pythonic::types::ndarray<std::complex<double>,pythonic::types::pshape<long>>&& rot_lm) 
{
...
typename __pythran_operators::__for_method__OperatorsSphereHarmo2D__divrotsh_from_vsh::type<pythonic::types::ndarray<double,pythonic::types::pshape<long>>, long, pythonic::types::ndarray<std::complex<double>,pythonic::types::pshape<long>>, pythonic::types::ndarray<std::complex<double>,pythonic::types::pshape<long>>, pythonic::types::none_type, pythonic::types::none_type>::result_type __for_method__OperatorsSphereHarmo2D__divrotsh_from_vsh3(pythonic::types::ndarray<double,pythonic::types::pshape<long>>&& self_K2_r, long&& self_nlm, pythonic::types::ndarray<std::complex<double>,pythonic::types::pshape<long>>&& uD_lm, pythonic::types::ndarray<std::complex<double>,pythonic::types::pshape<long>>&& uR_lm, pythonic::types::none_type&& div_lm, pythonic::types::none_type&& rot_lm) 
{
...
PyErr_Clear();
                ...
                return pythonic::python::raise_invalid_argument(
                               "__for_method__OperatorsSphereHarmo2D__invlaplacian_sh", "\n    - __for_method__OperatorsSphereHarmo2D__invlaplacian_sh(float64[:], complex128[:], bool)", args, kw);
                });
            }
...
PyErr_Clear();
                ...
                return pythonic::python::raise_invalid_argument(
                               "__for_method__OperatorsSphereHarmo2D__laplacian_sh", "\n    - __for_method__OperatorsSphereHarmo2D__laplacian_sh(float64[:], complex128[:], bool)", args, kw);
                });
            }
    ...
    {NULL, NULL, 0, NULL}
            ...
            PYTHRAN_MODULE_INIT(operators)(void) {
                ...
                PyObject * theDoc = Py_BuildValue("(sss)",
                                                  "0.9.1",
                                                  "2019-01-30 22:54:38.556205",
                                                  "979ad3899caa04da305dd0d4d487cb00f1bb852a216a0288252be3e4f428df07");
                if(! theDoc)
                    PYTHRAN_RETURN;
