...
class Trade:
    ...
    def ReqUserLogin2(self, TradingDay: str = '', BrokerID: str = '', UserID: str = '', Password: str = '', UserProductInfo: str = '', InterfaceProductInfo: str = '', ProtocolInfo: str = '', MacAddress: str = '', OneTimePassword: str = '', ClientIPAddress: str = '', LoginRemark: str = ''):
        pReqUserLogin = CThostFtdcReqUserLoginField()
        ...
        pReqUserLogin.OneTimePassword = bytes(OneTimePassword, encoding='ascii')
        pReqUserLogin.ClientIPAddress = bytes(ClientIPAddress, encoding='ascii')
        pReqUserLogin.LoginRemark = bytes(LoginRemark, encoding='ascii')
        self.nRequestID += 1
        self.h.ReqUserLogin2(self.api, byref(pReqUserLogin), self.nRequestID)
    ...
    def ReqUserPasswordUpdate2(self, BrokerID: str = '', UserID: str = '', OldPassword: str = '', NewPassword: str = ''):
        ...
        pUserPasswordUpdate.NewPassword = bytes(NewPassword, encoding='ascii')
        self.nRequestID += 1
        self.h.ReqUserPasswordUpdate2(self.api, byref(pUserPasswordUpdate), self.nRequestID)
