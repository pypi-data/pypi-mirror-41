...
class  CThostFtdcReqAuthenticateField(Structure):
    ...
    def __str__(self): # 可以直接print
        return f"'BrokerID'={self.getBrokerID()}, 'UserID'={self.getUserID()}, 'UserProductInfo'={self.getUserProductInfo()}, 'AuthCode'={self.getAuthCode()}"
...
class  CThostFtdcRspAuthenticateField(Structure):
    ...
    def __str__(self): # 可以直接print
        return f"'BrokerID'={self.getBrokerID()}, 'UserID'={self.getUserID()}, 'UserProductInfo'={self.getUserProductInfo()}"
...
class  CThostFtdcAuthenticationInfoField(Structure):
    ...
    def __str__(self): # 可以直接print
        return f"'BrokerID'={self.getBrokerID()}, 'UserID'={self.getUserID()}, 'UserProductInfo'={self.getUserProductInfo()}, 'AuthInfo'={self.getAuthInfo()}, 'IsResult'={self.getIsResult()}"
