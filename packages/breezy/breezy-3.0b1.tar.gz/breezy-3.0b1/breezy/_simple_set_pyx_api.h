...
static int import_breezy___simple_set_pyx(void) {
  PyObject *module = 0;
  module = __Pyx_ImportModule("breezy._simple_set_pyx");
  if (!module) goto bad;
  ...
  __pyx_ptype_6breezy_15_simple_set_pyx_SimpleSet = __Pyx_ImportType("breezy._simple_set_pyx", "SimpleSet", sizeof(struct SimpleSetObject), 1); if (!__pyx_ptype_6breezy_15_simple_set_pyx_SimpleSet) goto bad;
  return 0;
  bad:
  Py_XDECREF(module);
  return -1;
