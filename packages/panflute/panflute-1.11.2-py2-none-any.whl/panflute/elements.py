...
class Doc(Element):
    ...
    def __init__(self, *args, **_3to2kwargs):
        if 'api_version' in _3to2kwargs: api_version = _3to2kwargs['api_version']; del _3to2kwargs['api_version']
        else: api_version = None
        if 'format' in _3to2kwargs: format = _3to2kwargs['format']; del _3to2kwargs['format']
        else: format = 'html'
...
class Header(Block):
    ...
    def __init__(self, *args, **_3to2kwargs):
        if 'attributes' in _3to2kwargs: attributes = _3to2kwargs['attributes']; del _3to2kwargs['attributes']
        else: attributes = {}
        if 'classes' in _3to2kwargs: classes = _3to2kwargs['classes']; del _3to2kwargs['classes']
        else: classes = []
        if 'identifier' in _3to2kwargs: identifier = _3to2kwargs['identifier']; del _3to2kwargs['identifier']
        else: identifier = ''
...
class Quoted(Inline):
    ...
    def __init__(self, *args, **_3to2kwargs):
        if 'quote_type' in _3to2kwargs: quote_type = _3to2kwargs['quote_type']; del _3to2kwargs['quote_type']
...
class Cite(Inline):
    ...
    def __init__(self, *args, **_3to2kwargs):
        if 'citations' in _3to2kwargs: citations = _3to2kwargs['citations']; del _3to2kwargs['citations']
        else: citations = []
        self._set_content(args, Inline)
...
class Link(Inline):
    ...
    def __init__(self, *args, **_3to2kwargs):
        ...
        if 'url' in _3to2kwargs: url = _3to2kwargs['url']; del _3to2kwargs['url']
        else: url = ''
        self._set_content(args, Inline)
        self._set_ica(identifier, classes, attributes)
...
class OrderedList(Block):
    ...
    def __init__(self, *args, **_3to2kwargs):
        ...
        if 'style' in _3to2kwargs: style = _3to2kwargs['style']; del _3to2kwargs['style']
        else: style = 'Decimal'
...
class Table(Block):
    ...
    def __init__(self, *args, **_3to2kwargs):
        ...
        if 'caption' in _3to2kwargs: caption = _3to2kwargs['caption']; del _3to2kwargs['caption']
        else: caption = None
        if 'header' in _3to2kwargs: header = _3to2kwargs['header']; del _3to2kwargs['header']
        else: header = None
