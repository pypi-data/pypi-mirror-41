    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_identifier', models.CharField(db_index=True, editable=False, max_length=25)),
                ('order_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, validators=[edc_base.model_validators.date.datetime_not_future])),
                ...
                ('aliquot', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_lab.Aliquot')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_identifier', models.CharField(editable=False, max_length=25, unique=True)),
                ('order_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, validators=[edc_base.model_validators.date.datetime_not_future])),
                ('panel_name', models.CharField(max_length=25)),
                ('aliquot', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='edc_lab.Aliquot')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resulted_datetime', models.DateTimeField(default=django.utils.timezone.now)),
                ('resulted', models.BooleanField(default=False)),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='edc_lab.Order')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='order',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_lab.Order'),
        ),
    ]
