...
__all__ = [
    "SQLRow", "sqlrow", "Storage", "storage", "JsonDict", "jsondict", "AttrDict", "attrdict",
...
class SQLRow(dict):
    ...
    def __init__(self, zips):
        super(SQLRow, self).__init__(dict(zips))
    ...
    def __getitem__(self, i):
        ...
        if isinstance(i, basestring):
            try:
                return super(SQLRow, self).__getitem__(i)
            except KeyError:
    ...
    def __getattr__(self, name):
        if name in self.cursor_description:
            return super(SQLRow, self).__getitem__(name)
        return None
    ...
    def __repr__(self):
        return "<%s: %s>" % (self.__class__.__name__, super(SQLRow, self).__repr__())
    ...
    def __getstate__(self):
        ...
        _vars = [self.__getitem__(x) for x in _desc]
