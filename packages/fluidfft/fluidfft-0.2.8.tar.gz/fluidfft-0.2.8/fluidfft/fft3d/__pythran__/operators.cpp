...
namespace __pythran_operators
{
  ...
  struct __for_method__OperatorsPseudoSpectral3D__rotfft_from_vecfft_outin
  {
    ...
    struct type
    {
      ...
      typedef __type8 __ptype20;
      typedef __type14 __ptype21;
  ...
  struct __for_method__OperatorsPseudoSpectral3D__project_perpk3d
  {
    ...
    struct type
    {
      ...
      typedef __type0 __ptype23;
      typedef __type1 __ptype24;
      typedef typename pythonic::returnable<pythonic::types::none_type>::type result_type;
    }  
    ;
    template <typename argument_type0 , typename argument_type1 , typename argument_type2 , typename argument_type3 , typename argument_type4 , typename argument_type5 , typename argument_type6 >
  ...
  {
    {
      static typename __transonic__::type::result_type tmp_global = pythonic::types::make_tuple(pythonic::types::str("0.1.8"));
      return tmp_global;
    }
  }
  template <typename argument_type0 , typename argument_type1 , typename argument_type2 >
  typename loop_spectra3d::type<argument_type0, argument_type1, argument_type2>::result_type loop_spectra3d::operator()(argument_type0&& spectrum_k0k1k2, argument_type1&& ks, argument_type2&& K2) const
  {
    ...
    {
      long  __target139934638931304 = nk0;
      for (long  ik0=0L; ik0 < __target139934638931304; ik0 += 1L)
      {
        {
          long  __target139934638953304 = nk1;
          for (long  ik1=0L; ik1 < __target139934638953304; ik1 += 1L)
          {
            {
              long  __target139934638953864 = nk2;
              for (long  ik2=0L; ik2 < __target139934638953864; ik2 += 1L)
              {
  ...
  typename vector_product::type<argument_type0, argument_type1, argument_type2, argument_type3, argument_type4, argument_type5>::result_type vector_product::operator()(argument_type0&& ax, argument_type1&& ay, argument_type2&& az, argument_type3&& bx, argument_type4&& by, argument_type5&& bz) const
  {
    ...
    {
      long  __target139934639383664 = n0;
      for (long  i0=0L; i0 < __target139934639383664; i0 += 1L)
      {
        {
          long  __target139934639384784 = n1;
          for (long  i1=0L; i1 < __target139934639384784; i1 += 1L)
          {
            {
              long  __target139934639385344 = n2;
              for (long  i2=0L; i2 < __target139934639385344; i2 += 1L)
              {
...
"    return pythran_func(self.Kx, self.Ky, vx_fft, vy_fft)\n"
"\n"
"");
      return tmp_global;
    }
...
"    return pythran_func(self.Kx, self.Ky, self.Kz, vx_fft, vy_fft, vz_fft, rotxfft, rotyfft, rotzfft)\n"
"\n"
"");
      return tmp_global;
    }
...
"    return pythran_func(self.Kx, self.Ky, self.Kz, vx_fft, vy_fft, vz_fft)\n"
"\n"
"");
      return tmp_global;
    }
...
"\n"
"def new_method(self, vx_fft, vy_fft, vz_fft):\n"
"    return pythran_func(self.Kx, self.Ky, self.Kz, self.inv_K_square_nozero, vx_fft, vy_fft, vz_fft)\n"
"\n"
"");
      return tmp_global;
    }
...
typename __pythran_operators::__for_method__OperatorsPseudoSpectral3D__project_perpk3d::type<pythonic::types::ndarray<double,pythonic::types::pshape<long,long,long>>, pythonic::types::ndarray<double,pythonic::types::pshape<long,long,long>>, pythonic::types::ndarray<double,pythonic::types::pshape<long,long,long>>, pythonic::types::ndarray<double,pythonic::types::pshape<long,long,long>>, pythonic::types::ndarray<double,pythonic::types::pshape<long,long,long>>, pythonic::types::ndarray<double,pythonic::types::pshape<long,long,long>>, pythonic::types::ndarray<double,pythonic::types::pshape<long,long,long>>>::result_type __for_method__OperatorsPseudoSpectral3D__project_perpk3d1(pythonic::types::ndarray<double,pythonic::types::pshape<long,long,long>>&& self_Kx, pythonic::types::ndarray<double,pythonic::types::pshape<long,long,long>>&& self_Ky, pythonic::types::ndarray<double,pythonic::types::pshape<long,long,long>>&& self_Kz, pythonic::types::ndarray<double,pythonic::types::pshape<long,long,long>>&& self_inv_K_square_nozero, pythonic::types::ndarray<double,pythonic::types::pshape<long,long,long>>&& vx_fft, pythonic::types::ndarray<double,pythonic::types::pshape<long,long,long>>&& vy_fft, pythonic::types::ndarray<double,pythonic::types::pshape<long,long,long>>&& vz_fft) 
{
...
PyErr_Clear();
                ...
                return pythonic::python::raise_invalid_argument(
                               "loop_spectra3d", "\n    - loop_spectra3d(float64[:,:,:], float[:], float64[:,:,:])", args, kw);
                });
            }
...
static PyMethodDef Methods[] = {
    ...
    "Compute the 3d spectrum.\n\n    Supported prototypes:\n\n    - loop_spectra3d(float64[:,:,:], float[:], float64[:,:,:])"},{
    "vector_product",
    ...
    {NULL, NULL, 0, NULL}
            ...
            PYTHRAN_MODULE_INIT(operators)(void) {
                ...
                PyObject * theDoc = Py_BuildValue("(sss)",
                                                  "0.9.1",
                                                  "2019-01-27 21:06:20.637298",
                                                  "734ca39db7e2d7f7a4ad1a365b8e7d49d55a9cb22e47f13c736ec35675a403a3");
                if(! theDoc)
                    PYTHRAN_RETURN;
