...
class AMLPipelinesAPI10(object):
    ...
    def api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_submit_by_pipeline_run_id_post(
            self, subscription_id, resource_group_name, workspace_name, pipeline_run_id, parent_run_name=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param parent_run_name: The run name of the parent run of this
         pipeline
        ...
        if parent_run_name is not None:
            query_parameters['parentRunName'] = self._serialize.query("parent_run_name", parent_run_name, 'str')
