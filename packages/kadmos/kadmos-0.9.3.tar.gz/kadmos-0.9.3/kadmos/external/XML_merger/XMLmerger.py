...
def merge_xmls(filenames, output_file_name, destination_folder=None, perform_checks=False):
    ...
    if destination_folder is not None:
        assert isinstance(destination_folder, str), "Destination folder should be a string."
    assert isinstance(output_file_name, str), "Output file name should be a string."
...
def main(*args, **kwargs):
    ...
    if 'path' in kwargs:
        ...
        assert isinstance(path_to_file, str), "Path must be string."
    else:
        path_to_file = None
