...
class CMDOWS(object):
    ...
    def add_dc_general_info(self, dc_uid, description, status=None, creation_date=None, owner_uid=None,
        ...
        if operator_uid:
            if isinstance(operator_uid, str):
    ...
    def add_dc_sources(self, dc_uid, repository_link=None, download_link=None, references=None):
        ...
        if references:
            ...
            for ref in references:
                assert isinstance(ref, str), 'Each reference in the references list should be a string ({}).'.format(ref)
    ...
    def add_actor(self, contact_uid, role):
        ...
        assert isinstance(role, str), 'Role should be of type string.'
