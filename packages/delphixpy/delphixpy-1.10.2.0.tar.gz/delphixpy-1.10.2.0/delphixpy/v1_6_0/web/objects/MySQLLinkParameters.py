...
class MySQLLinkParameters(LinkParameters):
    ...
    *(extends* :py:class:`v1_6_0.web.vo.LinkParameters` *)* MySQL specific
    ...
    def is_dirty(self):
        return any([self._staging_repository[1], self._container[1], self._staging_port[1], self._staging_host_user[1], self._source[1], self._db_credentials[1], self._db_user[1], self._sync_parameters[1]])
