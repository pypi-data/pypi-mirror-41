...
class OracleAttachSourceParameters(AttachSourceParameters):
    ...
    *(extends* :py:class:`v1_7_1.web.vo.AttachSourceParameters` *)* Represents
    ...
    def is_dirty(self):
        return any([self._allow_missing_resetlogs[1], self._allow_recreated_controlfile[1], self._link_now[1], self._source[1], self._environment_user[1], self._db_credentials[1], self._db_user[1], self._double_sync[1], self._allow_archivelog_not_found[1]])
