...
class ASELinkParameters(LinkParameters):
    ...
    *(extends* :py:class:`v1_6_1.web.vo.LinkParameters` *)* SAP ASE specific
    ...
    def is_dirty(self):
        return any([self._staging_repository[1], self._container[1], self._staging_host_user[1], self._source[1], self._staging_post_script[1], self._db_credentials[1], self._db_user[1], self._source_host_user[1], self._staging_pre_script[1], self._sync_parameters[1]])
