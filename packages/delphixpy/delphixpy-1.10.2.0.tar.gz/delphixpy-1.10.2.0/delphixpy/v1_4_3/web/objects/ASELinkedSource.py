...
class ASELinkedSource(ASESource):
    ...
    *(extends* :py:class:`v1_4_3.web.vo.ASESource` *)* A linked SAP ASE source.
    ...
    def is_dirty(self):
        return any([self._load_backup_path[1], self._load_backup_server_name[1], self._post_script[1], self._pre_script[1], self._external_file_path[1], self._monitor_location[1], self._staging_source[1], self._config[1]])
