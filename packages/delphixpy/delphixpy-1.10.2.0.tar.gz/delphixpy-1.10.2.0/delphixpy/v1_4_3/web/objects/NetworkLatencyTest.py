...
class NetworkLatencyTest(UserObject):
    ...
    *(extends* :py:class:`v1_4_3.web.vo.UserObject` *)* Round-trip latency
    ...
    def is_dirty(self):
        return any([self._loss[1], self._end_time[1], self._start_time[1], self._remote_address[1], self._average[1], self._maximum[1], self._state[1], self._minimum[1], self._request_count[1], self._stddev[1], self._request_size[1], self._remote_host[1]])
