...
class JSBookmarkCapacityData(TypedObject):
    ...
    *(extends* :py:class:`v1_4_3.web.vo.TypedObject` *)* The capacity
    ...
    def is_dirty(self):
        return any([self._data_layout[1], self._referenced_externally[1], self._bookmark[1], self._referencing_bookmarks[1], self._referenced_by_branches[1], self._referenced_by_bookmarks[1], self._referencing_branches[1], self._unique[1]])
