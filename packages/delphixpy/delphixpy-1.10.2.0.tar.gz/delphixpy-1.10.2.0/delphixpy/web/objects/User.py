...
class User(NamedUserObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.NamedUserObject` *)* Delphix users.
    ...
    def is_dirty(self):
        return any([self._credential[1], self._authentication_type[1], self._first_name[1], self._user_type[1], self._locale[1], self._last_name[1], self._enabled[1], self._public_key[1], self._session_timeout[1], self._email_address[1], self._password_update_request[1], self._home_phone_number[1], self._mobile_phone_number[1], self._work_phone_number[1], self._is_default[1], self._principal[1]])
