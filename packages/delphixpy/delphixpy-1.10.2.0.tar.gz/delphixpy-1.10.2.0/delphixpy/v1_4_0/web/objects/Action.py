...
class Action(PersistentObject):
    ...
    *(extends* :py:class:`v1_4_0.web.vo.PersistentObject` *)* Represents an
    ...
    def is_dirty(self):
        return any([self._user_name[1], self._title[1], self._successful[1], self._parent_action[1], self._state[1], self._action_type[1], self._details[1], self._start_time[1], self._report[1], self._user_agent[1], self._end_time[1], self._user[1]])
