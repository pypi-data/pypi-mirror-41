...
class JSContainerCapacityData(TypedObject):
    ...
    *(extends* :py:class:`v1_4_0.web.vo.TypedObject` *)* The capacity
    ...
    def is_dirty(self):
        return any([self._data_container[1], self._referenced_by_self[1], self._unvirtualized[1], self._unique[1], self._referenced_by_siblings[1]])
    ...
    def __eq__(self, other):
        ...
        return super(JSContainerCapacityData, self).__eq__(other) and \
               ...
               self.referenced_by_siblings == other.referenced_by_siblings
