...
class ToolkitVirtualSource(TypedObject):
    ...
    *(extends* :py:class:`v1_6_2.web.vo.TypedObject` *)* A virtual source
    ...
    def is_dirty(self):
        return any([self._status[1], self._parameters[1], self._stop[1], self._start[1], self._initialize[1], self._provision[1], self._post_snapshot[1], self._pre_snapshot[1]])
