...
class SettingsMandatory(object):
    ...
    def __init__(self, source_visibility=None, language=None, environment=None, package_set=None, license=None, royalty_microcredits=None, network_access=None, pipeline_enabled=None):  # noqa: E501
