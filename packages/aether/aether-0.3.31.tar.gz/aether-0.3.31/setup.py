...
DEPENDENCY_LINKS = [
    "git+https://github.com/tensorflow/tensorflow/tree/master#egg=tensorflow-1.12.0"
    # "https://storage.googleapis.com/tensorflow/linux/cpu/tensorflow-1.12.0-cp27-none-linux_x86_64.whl#egg=tensorflow-1.12.0",
]
