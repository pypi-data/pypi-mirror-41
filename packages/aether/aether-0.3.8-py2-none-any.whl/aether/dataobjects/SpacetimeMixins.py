...
class SpacetimeMixins(object):
    ...
    def generate_gif(stack, n_bands, save_to, pause_ends=True, durations_ms=100,
        ...
        frames = [SpacetimeMixins.generate_image(stack[ts_i], n_bands, mask, color_table, show_now=False,
                                                 save_to=None, normalize_values=False, return_image=True)
