...
import time
import glymur
from _geotiff_utils import geotiff_utils
from _geometry_utils import geometry_utils
...
class geotiff_transforms_handler(object):
    ...
    def crop_raster_layer(raster_layer, polygon, projection_crs, destination_stub, _filemanager, _logger):
        ...
        with rasterio.open(temporary_file.name) as src:
            ...
            crop_data, crop_mask, crop_meta = geotiff_transforms_handler.geotiff_window_read(src, utm_polygon)
