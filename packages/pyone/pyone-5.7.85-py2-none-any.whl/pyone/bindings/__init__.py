...
#
# Generated Wed Feb  6 11:42:41 2019 by generateDS.py version 2.29.24.
...
#
# Command line:
#   /usr/bin/generateDS -q -f -o "pyone/bindings/supbind.py" -s "pyone/bindings/__init__.py" --super="supbind" --external-encoding="utf-8" --silence ../../../share/doc/xsd/index.xsd
#
...
class IMAGESub(TemplatedType, supermod.IMAGE):
    def __init__(self, ID=None, UID=None, GID=None, UNAME=None, GNAME=None, NAME=None, LOCK=None, PERMISSIONS=None, TYPE=None, DISK_TYPE=None, PERSISTENT=None, REGTIME=None, SOURCE=None, PATH=None, FSTYPE=None, SIZE=None, STATE=None, RUNNING_VMS=None, CLONING_OPS=None, CLONING_ID=None, TARGET_SNAPSHOT=None, DATASTORE_ID=None, DATASTORE=None, VMS=None, CLONES=None, APP_CLONES=None, TEMPLATE=None, SNAPSHOTS=None):
        super(IMAGESub, self).__init__(ID, UID, GID, UNAME, GNAME, NAME, LOCK, PERMISSIONS, TYPE, DISK_TYPE, PERSISTENT, REGTIME, SOURCE, PATH, FSTYPE, SIZE, STATE, RUNNING_VMS, CLONING_OPS, CLONING_ID, TARGET_SNAPSHOT, DATASTORE_ID, DATASTORE, VMS, CLONES, APP_CLONES, TEMPLATE, SNAPSHOTS, )
...
class MARKETPLACEAPPSub(TemplatedType, supermod.MARKETPLACEAPP):
    def __init__(self, ID=None, UID=None, GID=None, UNAME=None, GNAME=None, LOCK=None, REGTIME=None, NAME=None, ZONE_ID=None, ORIGIN_ID=None, SOURCE=None, MD5=None, SIZE=None, DESCRIPTION=None, VERSION=None, FORMAT=None, APPTEMPLATE64=None, MARKETPLACE_ID=None, MARKETPLACE=None, STATE=None, TYPE=None, PERMISSIONS=None, TEMPLATE=None):
        super(MARKETPLACEAPPSub, self).__init__(ID, UID, GID, UNAME, GNAME, LOCK, REGTIME, NAME, ZONE_ID, ORIGIN_ID, SOURCE, MD5, SIZE, DESCRIPTION, VERSION, FORMAT, APPTEMPLATE64, MARKETPLACE_ID, MARKETPLACE, STATE, TYPE, PERMISSIONS, TEMPLATE, )
...
class VM_GROUP_POOLSub(TemplatedType, supermod.VM_GROUP_POOL):
    def __init__(self, VM_GROUP=None):
        super(VM_GROUP_POOLSub, self).__init__(VM_GROUP, )
...
class VM_GROUPSub(TemplatedType, supermod.VM_GROUP):
    def __init__(self, ID=None, UID=None, GID=None, UNAME=None, GNAME=None, NAME=None, PERMISSIONS=None, LOCK=None, ROLES=None, TEMPLATE=None):
        super(VM_GROUPSub, self).__init__(ID, UID, GID, UNAME, GNAME, NAME, PERMISSIONS, LOCK, ROLES, TEMPLATE, )
...
class VMTEMPLATESub(TemplatedType, supermod.VMTEMPLATE):
    def __init__(self, ID=None, UID=None, GID=None, UNAME=None, GNAME=None, NAME=None, LOCK=None, PERMISSIONS=None, REGTIME=None, TEMPLATE=None):
        super(VMTEMPLATESub, self).__init__(ID, UID, GID, UNAME, GNAME, NAME, LOCK, PERMISSIONS, REGTIME, TEMPLATE, )
supermod.VMTEMPLATE.subclass = VMTEMPLATESub
# end class VMTEMPLATESub


class VMSub(TemplatedType, supermod.VM):
    def __init__(self, ID=None, UID=None, GID=None, UNAME=None, GNAME=None, NAME=None, PERMISSIONS=None, LAST_POLL=None, STATE=None, LCM_STATE=None, PREV_STATE=None, PREV_LCM_STATE=None, RESCHED=None, STIME=None, ETIME=None, DEPLOY_ID=None, LOCK=None, MONITORING=None, TEMPLATE=None, USER_TEMPLATE=None, HISTORY_RECORDS=None, SNAPSHOTS=None):
        super(VMSub, self).__init__(ID, UID, GID, UNAME, GNAME, NAME, PERMISSIONS, LAST_POLL, STATE, LCM_STATE, PREV_STATE, PREV_LCM_STATE, RESCHED, STIME, ETIME, DEPLOY_ID, LOCK, MONITORING, TEMPLATE, USER_TEMPLATE, HISTORY_RECORDS, SNAPSHOTS, )
...
class VNETSub(TemplatedType, supermod.VNET):
    def __init__(self, ID=None, UID=None, GID=None, UNAME=None, GNAME=None, NAME=None, LOCK=None, PERMISSIONS=None, CLUSTERS=None, BRIDGE=None, BRIDGE_TYPE=None, PARENT_NETWORK_ID=None, VN_MAD=None, PHYDEV=None, VLAN_ID=None, OUTER_VLAN_ID=None, VLAN_ID_AUTOMATIC=None, OUTER_VLAN_ID_AUTOMATIC=None, USED_LEASES=None, VROUTERS=None, TEMPLATE=None, AR_POOL=None):
        super(VNETSub, self).__init__(ID, UID, GID, UNAME, GNAME, NAME, LOCK, PERMISSIONS, CLUSTERS, BRIDGE, BRIDGE_TYPE, PARENT_NETWORK_ID, VN_MAD, PHYDEV, VLAN_ID, OUTER_VLAN_ID, VLAN_ID_AUTOMATIC, OUTER_VLAN_ID_AUTOMATIC, USED_LEASES, VROUTERS, TEMPLATE, AR_POOL, )
supermod.VNET.subclass = VNETSub
# end class VNETSub


class VNTEMPLATE_POOLSub(TemplatedType, supermod.VNTEMPLATE_POOL):
    def __init__(self, VNTEMPLATE=None):
        super(VNTEMPLATE_POOLSub, self).__init__(VNTEMPLATE, )
...
class VNTEMPLATESub(TemplatedType, supermod.VNTEMPLATE):
    def __init__(self, ID=None, UID=None, GID=None, UNAME=None, GNAME=None, NAME=None, LOCK=None, PERMISSIONS=None, REGTIME=None, TEMPLATE=None):
        super(VNTEMPLATESub, self).__init__(ID, UID, GID, UNAME, GNAME, NAME, LOCK, PERMISSIONS, REGTIME, TEMPLATE, )
...
class VROUTERSub(TemplatedType, supermod.VROUTER):
    def __init__(self, ID=None, UID=None, GID=None, UNAME=None, GNAME=None, NAME=None, PERMISSIONS=None, LOCK=None, VMS=None, TEMPLATE=None):
        super(VROUTERSub, self).__init__(ID, UID, GID, UNAME, GNAME, NAME, PERMISSIONS, LOCK, VMS, TEMPLATE, )
...
class ZONE_POOLSub(TemplatedType, supermod.ZONE_POOL):
    def __init__(self, ZONE=None):
        super(ZONE_POOLSub, self).__init__(ZONE, )
supermod.ZONE_POOL.subclass = ZONE_POOLSub
# end class ZONE_POOLSub


class ZONESub(TemplatedType, supermod.ZONE):
    def __init__(self, ID=None, NAME=None, TEMPLATE=None, SERVER_POOL=None):
        super(ZONESub, self).__init__(ID, NAME, TEMPLATE, SERVER_POOL, )
...
class SNAPSHOTSTypeSub(TemplatedType, supermod.SNAPSHOTSType):
    def __init__(self, ALLOW_ORPHANS=None, CURRENT_BASE=None, DISK_ID=None, NEXT_SNAPSHOT=None, SNAPSHOT=None):
        super(SNAPSHOTSTypeSub, self).__init__(ALLOW_ORPHANS, CURRENT_BASE, DISK_ID, NEXT_SNAPSHOT, SNAPSHOT, )
...
class TEMPLATETypeSub(TemplatedType, supermod.TEMPLATEType):
    def __init__(self, VCENTER_DC_NAME=None, VCENTER_DC_REF=None, VCENTER_DS_NAME=None, VCENTER_DS_REF=None, VCENTER_HOST=None, VCENTER_INSTANCE_ID=None, VCENTER_PASSWORD=None, VCENTER_USER=None, anytypeobjs_=None):
        super(TEMPLATETypeSub, self).__init__(VCENTER_DC_NAME, VCENTER_DC_REF, VCENTER_DS_NAME, VCENTER_DS_REF, VCENTER_HOST, VCENTER_INSTANCE_ID, VCENTER_PASSWORD, VCENTER_USER, anytypeobjs_, )
...
class VMType2Sub(TemplatedType, supermod.VMType2):
    def __init__(self, CPU=None, CPU_USED=None, MEMORY=None, MEMORY_USED=None, RUNNING_CPU=None, RUNNING_CPU_USED=None, RUNNING_MEMORY=None, RUNNING_MEMORY_USED=None, RUNNING_VMS=None, RUNNING_VMS_USED=None, SYSTEM_DISK_SIZE=None, SYSTEM_DISK_SIZE_USED=None, VMS=None, VMS_USED=None):
        super(VMType2Sub, self).__init__(CPU, CPU_USED, MEMORY, MEMORY_USED, RUNNING_CPU, RUNNING_CPU_USED, RUNNING_MEMORY, RUNNING_MEMORY_USED, RUNNING_VMS, RUNNING_VMS_USED, SYSTEM_DISK_SIZE, SYSTEM_DISK_SIZE_USED, VMS, VMS_USED, )
...
class VMType8Sub(TemplatedType, supermod.VMType8):
    def __init__(self, CPU=None, CPU_USED=None, MEMORY=None, MEMORY_USED=None, RUNNING_CPU=None, RUNNING_CPU_USED=None, RUNNING_MEMORY=None, RUNNING_MEMORY_USED=None, RUNNING_VMS=None, RUNNING_VMS_USED=None, SYSTEM_DISK_SIZE=None, SYSTEM_DISK_SIZE_USED=None, VMS=None, VMS_USED=None):
        super(VMType8Sub, self).__init__(CPU, CPU_USED, MEMORY, MEMORY_USED, RUNNING_CPU, RUNNING_CPU_USED, RUNNING_MEMORY, RUNNING_MEMORY_USED, RUNNING_VMS, RUNNING_VMS_USED, SYSTEM_DISK_SIZE, SYSTEM_DISK_SIZE_USED, VMS, VMS_USED, )
...
class VMType18Sub(TemplatedType, supermod.VMType18):
    def __init__(self, CPU=None, CPU_USED=None, MEMORY=None, MEMORY_USED=None, RUNNING_CPU=None, RUNNING_CPU_USED=None, RUNNING_MEMORY=None, RUNNING_MEMORY_USED=None, RUNNING_VMS=None, RUNNING_VMS_USED=None, SYSTEM_DISK_SIZE=None, SYSTEM_DISK_SIZE_USED=None, VMS=None, VMS_USED=None):
        super(VMType18Sub, self).__init__(CPU, CPU_USED, MEMORY, MEMORY_USED, RUNNING_CPU, RUNNING_CPU_USED, RUNNING_MEMORY, RUNNING_MEMORY_USED, RUNNING_VMS, RUNNING_VMS_USED, SYSTEM_DISK_SIZE, SYSTEM_DISK_SIZE_USED, VMS, VMS_USED, )
...
class VMType27Sub(TemplatedType, supermod.VMType27):
    def __init__(self, CPU=None, CPU_USED=None, MEMORY=None, MEMORY_USED=None, RUNNING_CPU=None, RUNNING_CPU_USED=None, RUNNING_MEMORY=None, RUNNING_MEMORY_USED=None, RUNNING_VMS=None, RUNNING_VMS_USED=None, SYSTEM_DISK_SIZE=None, SYSTEM_DISK_SIZE_USED=None, VMS=None, VMS_USED=None):
        super(VMType27Sub, self).__init__(CPU, CPU_USED, MEMORY, MEMORY_USED, RUNNING_CPU, RUNNING_CPU_USED, RUNNING_MEMORY, RUNNING_MEMORY_USED, RUNNING_VMS, RUNNING_VMS_USED, SYSTEM_DISK_SIZE, SYSTEM_DISK_SIZE_USED, VMS, VMS_USED, )
...
class TEMPLATEType31Sub(TemplatedType, supermod.TEMPLATEType31):
    def __init__(self, VCENTER_CCR_REF=None, VCENTER_DS_REF=None, VCENTER_HOST=None, VCENTER_INSTANCE_ID=None, VCENTER_NAME=None, VCENTER_PASSWORD=None, VCENTER_RESOURCE_POOL_INFO=None, VCENTER_USER=None, VCENTER_VERSION=None, anytypeobjs_=None):
        super(TEMPLATEType31Sub, self).__init__(VCENTER_CCR_REF, VCENTER_DS_REF, VCENTER_HOST, VCENTER_INSTANCE_ID, VCENTER_NAME, VCENTER_PASSWORD, VCENTER_RESOURCE_POOL_INFO, VCENTER_USER, VCENTER_VERSION, anytypeobjs_, )
...
class LOCKTypeSub(TemplatedType, supermod.LOCKType):
    def __init__(self, LOCKED=None, OWNER=None, TIME=None, REQ_ID=None):
        super(LOCKTypeSub, self).__init__(LOCKED, OWNER, TIME, REQ_ID, )
...
class PERMISSIONSType32Sub(TemplatedType, supermod.PERMISSIONSType32):
    def __init__(self, OWNER_U=None, OWNER_M=None, OWNER_A=None, GROUP_U=None, GROUP_M=None, GROUP_A=None, OTHER_U=None, OTHER_M=None, OTHER_A=None):
        super(PERMISSIONSType32Sub, self).__init__(OWNER_U, OWNER_M, OWNER_A, GROUP_U, GROUP_M, GROUP_A, OTHER_U, OTHER_M, OTHER_A, )
...
class VMSType33Sub(TemplatedType, supermod.VMSType33):
    def __init__(self, ID=None):
        super(VMSType33Sub, self).__init__(ID, )
...
class TEMPLATEType34Sub(TemplatedType, supermod.TEMPLATEType34):
    def __init__(self, VCENTER_IMPORTED=None, anytypeobjs_=None):
        super(TEMPLATEType34Sub, self).__init__(VCENTER_IMPORTED, anytypeobjs_, )
...
class SNAPSHOTSType35Sub(TemplatedType, supermod.SNAPSHOTSType35):
    def __init__(self, ALLOW_ORPHANS=None, CURRENT_BASE=None, NEXT_SNAPSHOT=None, SNAPSHOT=None):
        super(SNAPSHOTSType35Sub, self).__init__(ALLOW_ORPHANS, CURRENT_BASE, NEXT_SNAPSHOT, SNAPSHOT, )
...
class SNAPSHOTType36Sub(TemplatedType, supermod.SNAPSHOTType36):
    def __init__(self, CHILDREN=None, ACTIVE=None, DATE=None, ID=None, NAME=None, PARENT=None, SIZE=None):
        super(SNAPSHOTType36Sub, self).__init__(CHILDREN, ACTIVE, DATE, ID, NAME, PARENT, SIZE, )
...
class LOCKType37Sub(TemplatedType, supermod.LOCKType37):
    def __init__(self, LOCKED=None, OWNER=None, TIME=None, REQ_ID=None):
        super(LOCKType37Sub, self).__init__(LOCKED, OWNER, TIME, REQ_ID, )
...
class PERMISSIONSType38Sub(TemplatedType, supermod.PERMISSIONSType38):
    def __init__(self, OWNER_U=None, OWNER_M=None, OWNER_A=None, GROUP_U=None, GROUP_M=None, GROUP_A=None, OTHER_U=None, OTHER_M=None, OTHER_A=None):
        super(PERMISSIONSType38Sub, self).__init__(OWNER_U, OWNER_M, OWNER_A, GROUP_U, GROUP_M, GROUP_A, OTHER_U, OTHER_M, OTHER_A, )
...
class PERMISSIONSType39Sub(TemplatedType, supermod.PERMISSIONSType39):
    def __init__(self, OWNER_U=None, OWNER_M=None, OWNER_A=None, GROUP_U=None, GROUP_M=None, GROUP_A=None, OTHER_U=None, OTHER_M=None, OTHER_A=None):
        super(PERMISSIONSType39Sub, self).__init__(OWNER_U, OWNER_M, OWNER_A, GROUP_U, GROUP_M, GROUP_A, OTHER_U, OTHER_M, OTHER_A, )
...
class QUOTASType40Sub(TemplatedType, supermod.QUOTASType40):
    def __init__(self, ID=None, DATASTORE_QUOTA=None, NETWORK_QUOTA=None, VM_QUOTA=None, IMAGE_QUOTA=None):
        super(QUOTASType40Sub, self).__init__(ID, DATASTORE_QUOTA, NETWORK_QUOTA, VM_QUOTA, IMAGE_QUOTA, )
...
class DATASTORE_QUOTAType41Sub(TemplatedType, supermod.DATASTORE_QUOTAType41):
    def __init__(self, DATASTORE=None):
        super(DATASTORE_QUOTAType41Sub, self).__init__(DATASTORE, )
...
class DATASTOREType42Sub(TemplatedType, supermod.DATASTOREType42):
    def __init__(self, ID=None, IMAGES=None, IMAGES_USED=None, SIZE=None, SIZE_USED=None):
        super(DATASTOREType42Sub, self).__init__(ID, IMAGES, IMAGES_USED, SIZE, SIZE_USED, )
...
class NETWORK_QUOTAType43Sub(TemplatedType, supermod.NETWORK_QUOTAType43):
    def __init__(self, NETWORK=None):
        super(NETWORK_QUOTAType43Sub, self).__init__(NETWORK, )
...
class NETWORKType44Sub(TemplatedType, supermod.NETWORKType44):
    def __init__(self, ID=None, LEASES=None, LEASES_USED=None):
        super(NETWORKType44Sub, self).__init__(ID, LEASES, LEASES_USED, )
...
class VM_QUOTAType45Sub(TemplatedType, supermod.VM_QUOTAType45):
    def __init__(self, VM=None):
        super(VM_QUOTAType45Sub, self).__init__(VM, )
...
class VMType46Sub(TemplatedType, supermod.VMType46):
    def __init__(self, CPU=None, CPU_USED=None, MEMORY=None, MEMORY_USED=None, RUNNING_CPU=None, RUNNING_CPU_USED=None, RUNNING_MEMORY=None, RUNNING_MEMORY_USED=None, RUNNING_VMS=None, RUNNING_VMS_USED=None, SYSTEM_DISK_SIZE=None, SYSTEM_DISK_SIZE_USED=None, VMS=None, VMS_USED=None):
        super(VMType46Sub, self).__init__(CPU, CPU_USED, MEMORY, MEMORY_USED, RUNNING_CPU, RUNNING_CPU_USED, RUNNING_MEMORY, RUNNING_MEMORY_USED, RUNNING_VMS, RUNNING_VMS_USED, SYSTEM_DISK_SIZE, SYSTEM_DISK_SIZE_USED, VMS, VMS_USED, )
...
class IMAGE_QUOTAType47Sub(TemplatedType, supermod.IMAGE_QUOTAType47):
    def __init__(self, IMAGE=None):
        super(IMAGE_QUOTAType47Sub, self).__init__(IMAGE, )
...
class IMAGEType48Sub(TemplatedType, supermod.IMAGEType48):
    def __init__(self, ID=None, RVMS=None, RVMS_USED=None):
        super(IMAGEType48Sub, self).__init__(ID, RVMS, RVMS_USED, )
...
class DATASTORE_QUOTAType49Sub(TemplatedType, supermod.DATASTORE_QUOTAType49):
    def __init__(self, DATASTORE=None):
        super(DATASTORE_QUOTAType49Sub, self).__init__(DATASTORE, )
...
class DATASTOREType50Sub(TemplatedType, supermod.DATASTOREType50):
    def __init__(self, ID=None, IMAGES=None, IMAGES_USED=None, SIZE=None, SIZE_USED=None):
        super(DATASTOREType50Sub, self).__init__(ID, IMAGES, IMAGES_USED, SIZE, SIZE_USED, )
...
class NETWORK_QUOTAType51Sub(TemplatedType, supermod.NETWORK_QUOTAType51):
    def __init__(self, NETWORK=None):
        super(NETWORK_QUOTAType51Sub, self).__init__(NETWORK, )
...
class NETWORKType52Sub(TemplatedType, supermod.NETWORKType52):
    def __init__(self, ID=None, LEASES=None, LEASES_USED=None):
        super(NETWORKType52Sub, self).__init__(ID, LEASES, LEASES_USED, )
...
class VM_QUOTAType53Sub(TemplatedType, supermod.VM_QUOTAType53):
    def __init__(self, VM=None):
        super(VM_QUOTAType53Sub, self).__init__(VM, )
...
class VMType54Sub(TemplatedType, supermod.VMType54):
    def __init__(self, CPU=None, CPU_USED=None, MEMORY=None, MEMORY_USED=None, RUNNING_CPU=None, RUNNING_CPU_USED=None, RUNNING_MEMORY=None, RUNNING_MEMORY_USED=None, RUNNING_VMS=None, RUNNING_VMS_USED=None, SYSTEM_DISK_SIZE=None, SYSTEM_DISK_SIZE_USED=None, VMS=None, VMS_USED=None):
        super(VMType54Sub, self).__init__(CPU, CPU_USED, MEMORY, MEMORY_USED, RUNNING_CPU, RUNNING_CPU_USED, RUNNING_MEMORY, RUNNING_MEMORY_USED, RUNNING_VMS, RUNNING_VMS_USED, SYSTEM_DISK_SIZE, SYSTEM_DISK_SIZE_USED, VMS, VMS_USED, )
...
class IMAGE_QUOTAType55Sub(TemplatedType, supermod.IMAGE_QUOTAType55):
    def __init__(self, IMAGE=None):
        super(IMAGE_QUOTAType55Sub, self).__init__(IMAGE, )
...
class IMAGEType56Sub(TemplatedType, supermod.IMAGEType56):
    def __init__(self, ID=None, RVMS=None, RVMS_USED=None):
        super(IMAGEType56Sub, self).__init__(ID, RVMS, RVMS_USED, )
...
class GROUPSType57Sub(TemplatedType, supermod.GROUPSType57):
    def __init__(self, ID=None):
        super(GROUPSType57Sub, self).__init__(ID, )
...
class LOGIN_TOKENType58Sub(TemplatedType, supermod.LOGIN_TOKENType58):
    def __init__(self, TOKEN=None, EXPIRATION_TIME=None, EGID=None):
        super(LOGIN_TOKENType58Sub, self).__init__(TOKEN, EXPIRATION_TIME, EGID, )
...
class DATASTORE_QUOTAType59Sub(TemplatedType, supermod.DATASTORE_QUOTAType59):
    def __init__(self, DATASTORE=None):
        super(DATASTORE_QUOTAType59Sub, self).__init__(DATASTORE, )
...
class DATASTOREType60Sub(TemplatedType, supermod.DATASTOREType60):
    def __init__(self, ID=None, IMAGES=None, IMAGES_USED=None, SIZE=None, SIZE_USED=None):
        super(DATASTOREType60Sub, self).__init__(ID, IMAGES, IMAGES_USED, SIZE, SIZE_USED, )
...
class NETWORK_QUOTAType61Sub(TemplatedType, supermod.NETWORK_QUOTAType61):
    def __init__(self, NETWORK=None):
        super(NETWORK_QUOTAType61Sub, self).__init__(NETWORK, )
...
class NETWORKType62Sub(TemplatedType, supermod.NETWORKType62):
    def __init__(self, ID=None, LEASES=None, LEASES_USED=None):
        super(NETWORKType62Sub, self).__init__(ID, LEASES, LEASES_USED, )
...
class VM_QUOTAType63Sub(TemplatedType, supermod.VM_QUOTAType63):
    def __init__(self, VM=None):
        super(VM_QUOTAType63Sub, self).__init__(VM, )
...
class VMType64Sub(TemplatedType, supermod.VMType64):
    def __init__(self, CPU=None, CPU_USED=None, MEMORY=None, MEMORY_USED=None, RUNNING_CPU=None, RUNNING_CPU_USED=None, RUNNING_MEMORY=None, RUNNING_MEMORY_USED=None, RUNNING_VMS=None, RUNNING_VMS_USED=None, SYSTEM_DISK_SIZE=None, SYSTEM_DISK_SIZE_USED=None, VMS=None, VMS_USED=None):
        super(VMType64Sub, self).__init__(CPU, CPU_USED, MEMORY, MEMORY_USED, RUNNING_CPU, RUNNING_CPU_USED, RUNNING_MEMORY, RUNNING_MEMORY_USED, RUNNING_VMS, RUNNING_VMS_USED, SYSTEM_DISK_SIZE, SYSTEM_DISK_SIZE_USED, VMS, VMS_USED, )
...
class IMAGE_QUOTAType65Sub(TemplatedType, supermod.IMAGE_QUOTAType65):
    def __init__(self, IMAGE=None):
        super(IMAGE_QUOTAType65Sub, self).__init__(IMAGE, )
...
class IMAGEType66Sub(TemplatedType, supermod.IMAGEType66):
    def __init__(self, ID=None, RVMS=None, RVMS_USED=None):
        super(IMAGEType66Sub, self).__init__(ID, RVMS, RVMS_USED, )
...
class DEFAULT_USER_QUOTASType67Sub(TemplatedType, supermod.DEFAULT_USER_QUOTASType67):
    def __init__(self, DATASTORE_QUOTA=None, NETWORK_QUOTA=None, VM_QUOTA=None, IMAGE_QUOTA=None):
        super(DEFAULT_USER_QUOTASType67Sub, self).__init__(DATASTORE_QUOTA, NETWORK_QUOTA, VM_QUOTA, IMAGE_QUOTA, )
...
class DATASTORE_QUOTAType68Sub(TemplatedType, supermod.DATASTORE_QUOTAType68):
    def __init__(self, DATASTORE=None):
        super(DATASTORE_QUOTAType68Sub, self).__init__(DATASTORE, )
...
class DATASTOREType69Sub(TemplatedType, supermod.DATASTOREType69):
    def __init__(self, ID=None, IMAGES=None, IMAGES_USED=None, SIZE=None, SIZE_USED=None):
        super(DATASTOREType69Sub, self).__init__(ID, IMAGES, IMAGES_USED, SIZE, SIZE_USED, )
...
class NETWORK_QUOTAType70Sub(TemplatedType, supermod.NETWORK_QUOTAType70):
    def __init__(self, NETWORK=None):
        super(NETWORK_QUOTAType70Sub, self).__init__(NETWORK, )
...
class NETWORKType71Sub(TemplatedType, supermod.NETWORKType71):
    def __init__(self, ID=None, LEASES=None, LEASES_USED=None):
        super(NETWORKType71Sub, self).__init__(ID, LEASES, LEASES_USED, )
...
class VM_QUOTAType72Sub(TemplatedType, supermod.VM_QUOTAType72):
    def __init__(self, VM=None):
        super(VM_QUOTAType72Sub, self).__init__(VM, )
...
class VMType73Sub(TemplatedType, supermod.VMType73):
    def __init__(self, CPU=None, CPU_USED=None, MEMORY=None, MEMORY_USED=None, RUNNING_CPU=None, RUNNING_CPU_USED=None, RUNNING_MEMORY=None, RUNNING_MEMORY_USED=None, RUNNING_VMS=None, RUNNING_VMS_USED=None, SYSTEM_DISK_SIZE=None, SYSTEM_DISK_SIZE_USED=None, VMS=None, VMS_USED=None):
        super(VMType73Sub, self).__init__(CPU, CPU_USED, MEMORY, MEMORY_USED, RUNNING_CPU, RUNNING_CPU_USED, RUNNING_MEMORY, RUNNING_MEMORY_USED, RUNNING_VMS, RUNNING_VMS_USED, SYSTEM_DISK_SIZE, SYSTEM_DISK_SIZE_USED, VMS, VMS_USED, )
...
class IMAGE_QUOTAType74Sub(TemplatedType, supermod.IMAGE_QUOTAType74):
    def __init__(self, IMAGE=None):
        super(IMAGE_QUOTAType74Sub, self).__init__(IMAGE, )
...
class IMAGEType75Sub(TemplatedType, supermod.IMAGEType75):
    def __init__(self, ID=None, RVMS=None, RVMS_USED=None):
        super(IMAGEType75Sub, self).__init__(ID, RVMS, RVMS_USED, )
...
class GROUPSType76Sub(TemplatedType, supermod.GROUPSType76):
    def __init__(self, ID=None):
        super(GROUPSType76Sub, self).__init__(ID, )
...
class CLUSTERSType77Sub(TemplatedType, supermod.CLUSTERSType77):
    def __init__(self, CLUSTER=None):
        super(CLUSTERSType77Sub, self).__init__(CLUSTER, )
...
class HOSTSType78Sub(TemplatedType, supermod.HOSTSType78):
    def __init__(self, HOST=None):
        super(HOSTSType78Sub, self).__init__(HOST, )
...
class DATASTORESType79Sub(TemplatedType, supermod.DATASTORESType79):
    def __init__(self, DATASTORE=None):
        super(DATASTORESType79Sub, self).__init__(DATASTORE, )
...
class DATASTOREType80Sub(TemplatedType, supermod.DATASTOREType80):
    def __init__(self, ZONE_ID=None, DATASTORE_ID=None):
        super(DATASTOREType80Sub, self).__init__(ZONE_ID, DATASTORE_ID, )
...
class VNETSType81Sub(TemplatedType, supermod.VNETSType81):
    def __init__(self, VNET=None):
        super(VNETSType81Sub, self).__init__(VNET, )
...
class LOCKType83Sub(TemplatedType, supermod.LOCKType83):
    def __init__(self, LOCKED=None, OWNER=None, TIME=None, REQ_ID=None):
        super(LOCKType83Sub, self).__init__(LOCKED, OWNER, TIME, REQ_ID, )
...
class ROLESTypeSub(TemplatedType, supermod.ROLESType):
    def __init__(self, ROLE=None):
        super(ROLESTypeSub, self).__init__(ROLE, )
supermod.ROLESType.subclass = ROLESTypeSub
# end class ROLESTypeSub


class ROLETypeSub(TemplatedType, supermod.ROLEType):
    def __init__(self, HOST_AFFINED=None, HOST_ANTI_AFFINED=None, ID=None, NAME=None, POLICY=None):
        super(ROLETypeSub, self).__init__(HOST_AFFINED, HOST_ANTI_AFFINED, ID, NAME, POLICY, )
supermod.ROLEType.subclass = ROLETypeSub
# end class ROLETypeSub


class VMType84Sub(TemplatedType, supermod.VMType84):
    def __init__(self, ID=None, UID=None, GID=None, UNAME=None, GNAME=None, NAME=None, LAST_POLL=None, STATE=None, LCM_STATE=None, RESCHED=None, STIME=None, ETIME=None, DEPLOY_ID=None, TEMPLATE=None, MONITORING=None, USER_TEMPLATE=None, HISTORY_RECORDS=None):
        super(VMType84Sub, self).__init__(ID, UID, GID, UNAME, GNAME, NAME, LAST_POLL, STATE, LCM_STATE, RESCHED, STIME, ETIME, DEPLOY_ID, TEMPLATE, MONITORING, USER_TEMPLATE, HISTORY_RECORDS, )
supermod.VMType84.subclass = VMType84Sub
# end class VMType84Sub


class TEMPLATEType85Sub(TemplatedType, supermod.TEMPLATEType85):
    def __init__(self, DISK=None, anytypeobjs_=None, NIC=None):
        super(TEMPLATEType85Sub, self).__init__(DISK, anytypeobjs_, NIC, anytypeobjs_, )
...
class DISKTypeSub(TemplatedType, supermod.DISKType):
    def __init__(self, VCENTER_DS_REF=None, VCENTER_INSTANCE_ID=None, anytypeobjs_=None):
        super(DISKTypeSub, self).__init__(VCENTER_DS_REF, VCENTER_INSTANCE_ID, anytypeobjs_, )
supermod.DISKType.subclass = DISKTypeSub
# end class DISKTypeSub


class NICTypeSub(TemplatedType, supermod.NICType):
    def __init__(self, anytypeobjs_=None, VCENTER_INSTANCE_ID=None, VCENTER_NET_REF=None, VCENTER_PORTGROUP_TYPE=None):
        super(NICTypeSub, self).__init__(anytypeobjs_, VCENTER_INSTANCE_ID, VCENTER_NET_REF, VCENTER_PORTGROUP_TYPE, )
...
class MONITORINGTypeSub(TemplatedType, supermod.MONITORINGType):
    def __init__(self, anytypeobjs_=None):
        super(MONITORINGTypeSub, self).__init__(anytypeobjs_, )
...
class USER_TEMPLATETypeSub(TemplatedType, supermod.USER_TEMPLATEType):
    def __init__(self, anytypeobjs_=None):
        super(USER_TEMPLATETypeSub, self).__init__(anytypeobjs_, )
...
class HISTORYTypeSub(TemplatedType, supermod.HISTORYType):
    def __init__(self, OID=None, SEQ=None, HOSTNAME=None, HID=None, CID=None, DS_ID=None, ACTION=None):
        super(HISTORYTypeSub, self).__init__(OID, SEQ, HOSTNAME, HID, CID, DS_ID, ACTION, )
...
class LOCKType86Sub(TemplatedType, supermod.LOCKType86):
    def __init__(self, LOCKED=None, OWNER=None, TIME=None, REQ_ID=None):
        super(LOCKType86Sub, self).__init__(LOCKED, OWNER, TIME, REQ_ID, )
...
class PERMISSIONSType87Sub(TemplatedType, supermod.PERMISSIONSType87):
    def __init__(self, OWNER_U=None, OWNER_M=None, OWNER_A=None, GROUP_U=None, GROUP_M=None, GROUP_A=None, OTHER_U=None, OTHER_M=None, OTHER_A=None):
        super(PERMISSIONSType87Sub, self).__init__(OWNER_U, OWNER_M, OWNER_A, GROUP_U, GROUP_M, GROUP_A, OTHER_U, OTHER_M, OTHER_A, )
...
class TEMPLATEType88Sub(TemplatedType, supermod.TEMPLATEType88):
    def __init__(self, VCENTER_CCR_REF=None, VCENTER_INSTANCE_ID=None, VCENTER_TEMPLATE_REF=None, anytypeobjs_=None):
        super(TEMPLATEType88Sub, self).__init__(VCENTER_CCR_REF, VCENTER_INSTANCE_ID, VCENTER_TEMPLATE_REF, anytypeobjs_, )
...
class PERMISSIONSType89Sub(TemplatedType, supermod.PERMISSIONSType89):
    def __init__(self, OWNER_U=None, OWNER_M=None, OWNER_A=None, GROUP_U=None, GROUP_M=None, GROUP_A=None, OTHER_U=None, OTHER_M=None, OTHER_A=None):
        super(PERMISSIONSType89Sub, self).__init__(OWNER_U, OWNER_M, OWNER_A, GROUP_U, GROUP_M, GROUP_A, OTHER_U, OTHER_M, OTHER_A, )
...
class LOCKType90Sub(TemplatedType, supermod.LOCKType90):
    def __init__(self, LOCKED=None, OWNER=None, TIME=None, REQ_ID=None):
        super(LOCKType90Sub, self).__init__(LOCKED, OWNER, TIME, REQ_ID, )
...
class TEMPLATEType91Sub(TemplatedType, supermod.TEMPLATEType91):
    def __init__(self, DISK=None, anytypeobjs_=None, NIC=None, NIC_ALIAS=None):
        super(TEMPLATEType91Sub, self).__init__(DISK, anytypeobjs_, NIC, anytypeobjs_, NIC_ALIAS, anytypeobjs_, )
...
class DISKType92Sub(TemplatedType, supermod.DISKType92):
    def __init__(self, VCENTER_DS_REF=None, VCENTER_INSTANCE_ID=None, anytypeobjs_=None):
        super(DISKType92Sub, self).__init__(VCENTER_DS_REF, VCENTER_INSTANCE_ID, anytypeobjs_, )
supermod.DISKType92.subclass = DISKType92Sub
# end class DISKType92Sub


class NICType93Sub(TemplatedType, supermod.NICType93):
    def __init__(self, BRIDGE_TYPE=None, anytypeobjs_=None, VCENTER_INSTANCE_ID=None, VCENTER_NET_REF=None, VCENTER_PORTGROUP_TYPE=None):
        super(NICType93Sub, self).__init__(BRIDGE_TYPE, anytypeobjs_, VCENTER_INSTANCE_ID, VCENTER_NET_REF, VCENTER_PORTGROUP_TYPE, )
...
class NIC_ALIASTypeSub(TemplatedType, supermod.NIC_ALIASType):
    def __init__(self, ALIAS_ID=None, PARENT=None, PARENT_ID=None, anytypeobjs_=None, VCENTER_INSTANCE_ID=None, VCENTER_NET_REF=None, VCENTER_PORTGROUP_TYPE=None):
        super(NIC_ALIASTypeSub, self).__init__(ALIAS_ID, PARENT, PARENT_ID, anytypeobjs_, VCENTER_INSTANCE_ID, VCENTER_NET_REF, VCENTER_PORTGROUP_TYPE, )
...
class USER_TEMPLATEType94Sub(TemplatedType, supermod.USER_TEMPLATEType94):
    def __init__(self, VCENTER_CCR_REF=None, VCENTER_DS_REF=None, VCENTER_INSTANCE_ID=None, anytypeobjs_=None):
        super(USER_TEMPLATEType94Sub, self).__init__(VCENTER_CCR_REF, VCENTER_DS_REF, VCENTER_INSTANCE_ID, anytypeobjs_, )
...
class HISTORY_RECORDSType95Sub(TemplatedType, supermod.HISTORY_RECORDSType95):
    def __init__(self, HISTORY=None):
        super(HISTORY_RECORDSType95Sub, self).__init__(HISTORY, )
...
class HISTORYType96Sub(TemplatedType, supermod.HISTORYType96):
    def __init__(self, OID=None, SEQ=None, HOSTNAME=None, HID=None, CID=None, STIME=None, ETIME=None, VM_MAD=None, TM_MAD=None, DS_ID=None, PSTIME=None, PETIME=None, RSTIME=None, RETIME=None, ESTIME=None, EETIME=None, ACTION=None, UID=None, GID=None, REQUEST_ID=None):
        super(HISTORYType96Sub, self).__init__(OID, SEQ, HOSTNAME, HID, CID, STIME, ETIME, VM_MAD, TM_MAD, DS_ID, PSTIME, PETIME, RSTIME, RETIME, ESTIME, EETIME, ACTION, UID, GID, REQUEST_ID, )
...
class SNAPSHOTSType97Sub(TemplatedType, supermod.SNAPSHOTSType97):
    def __init__(self, ALLOW_ORPHANS=None, CURRENT_BASE=None, DISK_ID=None, NEXT_SNAPSHOT=None, SNAPSHOT=None):
        super(SNAPSHOTSType97Sub, self).__init__(ALLOW_ORPHANS, CURRENT_BASE, DISK_ID, NEXT_SNAPSHOT, SNAPSHOT, )
...
class SNAPSHOTType98Sub(TemplatedType, supermod.SNAPSHOTType98):
    def __init__(self, ACTIVE=None, CHILDREN=None, DATE=None, ID=None, NAME=None, PARENT=None, SIZE=None):
        super(SNAPSHOTType98Sub, self).__init__(ACTIVE, CHILDREN, DATE, ID, NAME, PARENT, SIZE, )
...
class VNETType99Sub(TemplatedType, supermod.VNETType99):
    def __init__(self, ID=None, UID=None, GID=None, UNAME=None, GNAME=None, NAME=None, PERMISSIONS=None, CLUSTERS=None, BRIDGE=None, BRIDGE_TYPE=None, PARENT_NETWORK_ID=None, VN_MAD=None, PHYDEV=None, VLAN_ID=None, OUTER_VLAN_ID=None, VLAN_ID_AUTOMATIC=None, OUTER_VLAN_ID_AUTOMATIC=None, USED_LEASES=None, VROUTERS=None, TEMPLATE=None, AR_POOL=None):
        super(VNETType99Sub, self).__init__(ID, UID, GID, UNAME, GNAME, NAME, PERMISSIONS, CLUSTERS, BRIDGE, BRIDGE_TYPE, PARENT_NETWORK_ID, VN_MAD, PHYDEV, VLAN_ID, OUTER_VLAN_ID, VLAN_ID_AUTOMATIC, OUTER_VLAN_ID_AUTOMATIC, USED_LEASES, VROUTERS, TEMPLATE, AR_POOL, )
...
class PERMISSIONSType100Sub(TemplatedType, supermod.PERMISSIONSType100):
    def __init__(self, OWNER_U=None, OWNER_M=None, OWNER_A=None, GROUP_U=None, GROUP_M=None, GROUP_A=None, OTHER_U=None, OTHER_M=None, OTHER_A=None):
        super(PERMISSIONSType100Sub, self).__init__(OWNER_U, OWNER_M, OWNER_A, GROUP_U, GROUP_M, GROUP_A, OTHER_U, OTHER_M, OTHER_A, )
...
class CLUSTERSType101Sub(TemplatedType, supermod.CLUSTERSType101):
    def __init__(self, ID=None):
        super(CLUSTERSType101Sub, self).__init__(ID, )
...
class LOCKType102Sub(TemplatedType, supermod.LOCKType102):
    def __init__(self, LOCKED=None, OWNER=None, TIME=None, REQ_ID=None):
        super(LOCKType102Sub, self).__init__(LOCKED, OWNER, TIME, REQ_ID, )
...
class PERMISSIONSType103Sub(TemplatedType, supermod.PERMISSIONSType103):
    def __init__(self, OWNER_U=None, OWNER_M=None, OWNER_A=None, GROUP_U=None, GROUP_M=None, GROUP_A=None, OTHER_U=None, OTHER_M=None, OTHER_A=None):
        super(PERMISSIONSType103Sub, self).__init__(OWNER_U, OWNER_M, OWNER_A, GROUP_U, GROUP_M, GROUP_A, OTHER_U, OTHER_M, OTHER_A, )
...
class CLUSTERSType104Sub(TemplatedType, supermod.CLUSTERSType104):
    def __init__(self, ID=None):
        super(CLUSTERSType104Sub, self).__init__(ID, )
...
class VROUTERSType105Sub(TemplatedType, supermod.VROUTERSType105):
    def __init__(self, ID=None):
        super(VROUTERSType105Sub, self).__init__(ID, )
...
class TEMPLATEType106Sub(TemplatedType, supermod.TEMPLATEType106):
    def __init__(self, VCENTER_FROM_WILD=None, VCENTER_INSTANCE_ID=None, VCENTER_NET_REF=None, VCENTER_PORTGROUP_TYPE=None, VCENTER_TEMPLATE_REF=None, anytypeobjs_=None):
        super(TEMPLATEType106Sub, self).__init__(VCENTER_FROM_WILD, VCENTER_INSTANCE_ID, VCENTER_NET_REF, VCENTER_PORTGROUP_TYPE, VCENTER_TEMPLATE_REF, anytypeobjs_, )
...
class AR_POOLType107Sub(TemplatedType, supermod.AR_POOLType107):
    def __init__(self, AR=None):
        super(AR_POOLType107Sub, self).__init__(AR, )
...
class ARType108Sub(TemplatedType, supermod.ARType108):
    def __init__(self, AR_ID=None, GLOBAL_PREFIX=None, IP=None, MAC=None, PARENT_NETWORK_AR_ID=None, SIZE=None, TYPE=None, ULA_PREFIX=None, VN_MAD=None, MAC_END=None, IP_END=None, IP6_ULA=None, IP6_ULA_END=None, IP6_GLOBAL=None, IP6_GLOBAL_END=None, IP6=None, IP6_END=None, USED_LEASES=None, LEASES=None):
        super(ARType108Sub, self).__init__(AR_ID, GLOBAL_PREFIX, IP, MAC, PARENT_NETWORK_AR_ID, SIZE, TYPE, ULA_PREFIX, VN_MAD, MAC_END, IP_END, IP6_ULA, IP6_ULA_END, IP6_GLOBAL, IP6_GLOBAL_END, IP6, IP6_END, USED_LEASES, LEASES, )
...
class LOCKType109Sub(TemplatedType, supermod.LOCKType109):
    def __init__(self, LOCKED=None, OWNER=None, TIME=None, REQ_ID=None):
        super(LOCKType109Sub, self).__init__(LOCKED, OWNER, TIME, REQ_ID, )
...
class PERMISSIONSType110Sub(TemplatedType, supermod.PERMISSIONSType110):
    def __init__(self, OWNER_U=None, OWNER_M=None, OWNER_A=None, GROUP_U=None, GROUP_M=None, GROUP_A=None, OTHER_U=None, OTHER_M=None, OTHER_A=None):
        super(PERMISSIONSType110Sub, self).__init__(OWNER_U, OWNER_M, OWNER_A, GROUP_U, GROUP_M, GROUP_A, OTHER_U, OTHER_M, OTHER_A, )
...
class TEMPLATEType111Sub(TemplatedType, supermod.TEMPLATEType111):
    def __init__(self, VN_MAD=None, anytypeobjs_=None):
        super(TEMPLATEType111Sub, self).__init__(VN_MAD, anytypeobjs_, )
...
class PERMISSIONSType112Sub(TemplatedType, supermod.PERMISSIONSType112):
    def __init__(self, OWNER_U=None, OWNER_M=None, OWNER_A=None, GROUP_U=None, GROUP_M=None, GROUP_A=None, OTHER_U=None, OTHER_M=None, OTHER_A=None):
        super(PERMISSIONSType112Sub, self).__init__(OWNER_U, OWNER_M, OWNER_A, GROUP_U, GROUP_M, GROUP_A, OTHER_U, OTHER_M, OTHER_A, )
...
class LOCKType113Sub(TemplatedType, supermod.LOCKType113):
    def __init__(self, LOCKED=None, OWNER=None, TIME=None, REQ_ID=None):
        super(LOCKType113Sub, self).__init__(LOCKED, OWNER, TIME, REQ_ID, )
...
class VMSType114Sub(TemplatedType, supermod.VMSType114):
    def __init__(self, ID=None):
        super(VMSType114Sub, self).__init__(ID, )
...
class ZONETypeSub(TemplatedType, supermod.ZONEType):
    def __init__(self, ID=None, NAME=None, TEMPLATE=None, SERVER_POOL=None):
        super(ZONETypeSub, self).__init__(ID, NAME, TEMPLATE, SERVER_POOL, )
...
class TEMPLATEType115Sub(TemplatedType, supermod.TEMPLATEType115):
    def __init__(self, ENDPOINT=None):
        super(TEMPLATEType115Sub, self).__init__(ENDPOINT, )
...
class SERVER_POOLTypeSub(TemplatedType, supermod.SERVER_POOLType):
    def __init__(self, SERVER=None):
        super(SERVER_POOLTypeSub, self).__init__(SERVER, )
...
class SERVERTypeSub(TemplatedType, supermod.SERVERType):
    def __init__(self, ENDPOINT=None, ID=None, NAME=None):
        super(SERVERTypeSub, self).__init__(ENDPOINT, ID, NAME, )
...
class TEMPLATEType116Sub(TemplatedType, supermod.TEMPLATEType116):
    def __init__(self, ENDPOINT=None):
        super(TEMPLATEType116Sub, self).__init__(ENDPOINT, )
...
class SERVER_POOLType117Sub(TemplatedType, supermod.SERVER_POOLType117):
    def __init__(self, SERVER=None):
        super(SERVER_POOLType117Sub, self).__init__(SERVER, )
...
class SERVERType118Sub(TemplatedType, supermod.SERVERType118):
    def __init__(self, ENDPOINT=None, ID=None, NAME=None, STATE=None, TERM=None, VOTEDFOR=None, COMMIT=None, LOG_INDEX=None, FEDLOG_INDEX=None):
        super(SERVERType118Sub, self).__init__(ENDPOINT, ID, NAME, STATE, TERM, VOTEDFOR, COMMIT, LOG_INDEX, FEDLOG_INDEX, )
