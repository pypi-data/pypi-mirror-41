...
def send_mail(report):
    ...
    username = 'qinchao@aicaigroup.com'
    password = 'Qch123!!'
    sender = 'qinchao@aicaigroup.com'
    # 收件人为多个收件人
    receiver = ['qinchao@aicaigroup.com']

    cc = ['qinchao@aicaigroup.com']

    subject = 'PTK内存检查报告(%s)' % TODAY
    ...
    text = """
        ...
        <p>
            ...
            <p></p>
            <div><b>内存变化曲线:</b></div>
            <img src="cid:plt_simple">
        </body>
        </html>
    """ % (TODAY, report.success, report.duration, report.pkg, report.device,
           len(report.anrs), len(report.crashes), report.max, report.avg)
