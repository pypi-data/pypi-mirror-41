...
gs.push( new Dygraph(
document.getElementById("graph_bestposprod"),
"best_dat/pos_prod_fecundant.csv", // path to CSV file
{
title: 'Production timecourse bruto',
...
labelsDiv: document.getElementById('legend_bestposprod'),
labelsDivWidth: 1400,
