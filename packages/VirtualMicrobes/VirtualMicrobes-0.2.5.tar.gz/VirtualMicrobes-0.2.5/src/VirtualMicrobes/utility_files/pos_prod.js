...
gs.push( new Dygraph(
document.getElementById("graph_posprod"),
"population_dat/pos_production.csv", // path to CSV file
{
title: 'Production (bruto)',
...
labelsDiv: document.getElementById('legend_posprod'),
