/***************************
	...
	***************************/ 
	gs.push( new Dygraph(
	document.getElementById("graph_off"),
	"population_dat/offspring_counts.csv", // path to CSV file
	{
	title: 'Living offspring',
	...
	labelsDiv: document.getElementById('legend_off'),
