# Copyright (C) 2017 PyNeel Developers
#
# This file is part of PyNeel.
#
...
CHAIN = 'mainnet'
CHAIN_ID = 'W'
#MATCHER = 'https://nodes.neelnodes.com'
MATCHER = 'http://matcher.neelnodes.com'
MATCHER_PUBLICKEY = ''

DATAFEED = 'http://marketdata.neelplatform.com'
...
class PyNeelException(ValueError):
    pass


def throw_error(msg):
    if THROW_EXCEPTION_ON_ERROR:
        raise PyNeelException(msg)
