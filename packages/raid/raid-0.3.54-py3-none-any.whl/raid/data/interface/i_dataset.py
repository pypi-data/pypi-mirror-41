...
from raid.data.resampler import oversample, undersample
from raid.data.stratifier import stratify_samples_weighted
...
class IDataset:
    ...
    def get_semantic_label(self, label_index: int):
