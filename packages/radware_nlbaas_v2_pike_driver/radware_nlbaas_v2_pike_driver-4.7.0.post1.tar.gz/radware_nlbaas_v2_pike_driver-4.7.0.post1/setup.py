...
setup(name='radware_nlbaas_v2_pike_driver',
      version='4.7.0-1',
      description='Neutron LBaaS Radware driver for Openstack Pike',
      ...
      url='https://pypi.python.org/pypi/radware_nlbaas_v2_pike_driver',
      author='Evgeny Fedoruk, Radware',
      author_email='evgenyf@radware.com',
      packages=['radware_nlbaas_v2_pike_driver'],
      zip_safe=False,
