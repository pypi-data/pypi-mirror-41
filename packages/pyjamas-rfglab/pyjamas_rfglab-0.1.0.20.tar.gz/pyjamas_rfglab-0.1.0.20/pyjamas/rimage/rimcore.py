...
import matplotlib
matplotlib.use('TkAgg')  # https://stackoverflow.com/questions/21784641/installation-issue-with-matplotlib-python
...
class rimage:
    ...
    def stretch(self, low: int = 0, high: int = 100, minimum: int = 0, maximum: int = 255):
        """
