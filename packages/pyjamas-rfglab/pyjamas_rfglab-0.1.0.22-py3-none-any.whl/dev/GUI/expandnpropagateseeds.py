...
# Form implementation generated from reading ui file 'expandnpropagateseeds.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_3.setGeometry(QtCore.QRect(9, 25, 81, 24))
        self.label_3.setObjectName("label_3")
        self.textEdit = QtWidgets.QTextEdit(self.groupBox_3)
        self.textEdit.setGeometry(QtCore.QRect(96, 27, 41, 21))
        self.textEdit.setObjectName("textEdit")
        self.sbFirst_2 = QtWidgets.QSpinBox(self.groupBox_3)
        self.sbFirst_2.setGeometry(QtCore.QRect(95, 50, 48, 24))
        self.sbFirst_2.setObjectName("sbFirst_2")
        self.label_4 = QtWidgets.QLabel(self.groupBox_3)
        self.label_4.setGeometry(QtCore.QRect(1, 50, 90, 24))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_4.setText(_translate("Dialog", "xcorr window size"))
