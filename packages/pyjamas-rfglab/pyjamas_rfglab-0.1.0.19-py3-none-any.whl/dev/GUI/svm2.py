...
# Form implementation generated from reading ui file 'svm2.ui'
#
...
class Ui_SVM(object):
    ...
    def retranslateUi(self, SVM):
        ...
        SVM.setWindowTitle(_translate("SVM", "Support Vector Machine"))
        ...
        self.comboKernel.setItemText(0, _translate("SVM", "linear"))
        self.groupBox_6.setTitle(_translate("SVM", "Image step size"))
        self.label_12.setText(_translate("SVM", "row"))
        self.label_13.setText(_translate("SVM", "column"))
