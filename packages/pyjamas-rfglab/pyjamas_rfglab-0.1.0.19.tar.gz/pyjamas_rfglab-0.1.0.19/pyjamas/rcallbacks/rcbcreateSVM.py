...
class RCBCreateSVM(RCallback):
    def cbCreateSVM(self, parameters: dict = None) -> bool:  # Handle IO errors.
        continue_flag = True
        ...
        if continue_flag:
            ...
            self.pjs.statusbar.showMessage("Trained support vector machine!")
            return True
