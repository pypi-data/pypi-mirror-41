...
class test_main(unittest.TestCase):
    def test_inputStr(self):
        ...
        pauseThenType('4.1\n2\n')
        self.assertEqual(pyip.inputStr(validationFunc=isEven), '2')
        pauseThenType('hello\n2\n')
        self.assertEqual(pyip.inputStr(validationFunc=isEven), '2')
        pauseThenType('4\n')
        self.assertEqual(pyip.inputStr(validationFunc=isEven), '4')
        pauseThenType('4.0\n')
        self.assertEqual(pyip.inputStr(validationFunc=isEven), '4.0')
