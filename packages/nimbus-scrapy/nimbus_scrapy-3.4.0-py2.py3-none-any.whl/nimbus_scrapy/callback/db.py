...
class SpiderDBItemCallback(SpiderItemCallback):
    ...
    def init_db_session(self, spider=None):
        raise NotImplementedError

    def get_model_kwargs(self, item, spider=None):
        return {}
    ...
    def get_db_session(self, spider=None):
        if self._db_session:
            return self._db_session
        self._db_session = self.init_db_session(spider=spider)
        return self._db_session
