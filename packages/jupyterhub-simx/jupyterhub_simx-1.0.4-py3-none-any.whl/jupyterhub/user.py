...
class User:
    ...
    async def spawn(self, server_name='', options=None, select_image=None):
        ...
        # pass user selected image to the spawner
        if self.spawner_class.__name__ == "KubeSpawner" and select_image is not None:
            spawner.image_spec = select_image
