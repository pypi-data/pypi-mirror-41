...
`},755:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,"HuiWeatherForecastCardEditor",function(){return HuiWeatherForecastCardEditor});var lit_element__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(13),_common_structs_struct__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(166),_common_dom_fire_event__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(59),_config_elements_style__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__(173),_components_entity_ha_entity_picker__WEBPACK_IMPORTED_MODULE_4__=__webpack_require__(164);const cardConfigStruct=Object(_common_structs_struct__WEBPACK_IMPORTED_MODULE_1__.a)({type:"string",entity:"string?",name:"string?"});class HuiWeatherForecastCardEditor extends lit_element__WEBPACK_IMPORTED_MODULE_0__.a{setConfig(config){config=cardConfigStruct(config);this._config=config}static get properties(){return{hass:{},_config:{}}}get _entity(){return this._config.entity||""}get _name(){return this._config.name||""}render(){if(!this.hass){return lit_element__WEBPACK_IMPORTED_MODULE_0__.c``}return lit_element__WEBPACK_IMPORTED_MODULE_0__.c`
      ${_config_elements_style__WEBPACK_IMPORTED_MODULE_3__.a}
    ...
    `}_valueChanged(ev){if(!this._config||!this.hass){return}const target=ev.target;if(this[`_${target.configValue}`]===target.value){return}if(target.configValue){if(""===target.value){delete this._config[target.configValue]}else{this._config=Object.assign({},this._config,{[target.configValue]:target.value})}}Object(_common_dom_fire_event__WEBPACK_IMPORTED_MODULE_2__.a)(this,"config-changed",{config:this._config})}}customElements.define("hui-weather-forecast-card-editor",HuiWeatherForecastCardEditor)}}]);
//# sourceMappingURL=04ffda3135a58cd9d50c.chunk.js.map