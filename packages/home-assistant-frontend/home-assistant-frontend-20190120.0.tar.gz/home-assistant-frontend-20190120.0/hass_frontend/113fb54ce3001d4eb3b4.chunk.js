...
*/Object(_polymer_polymer_lib_legacy_polymer_fn_js__WEBPACK_IMPORTED_MODULE_4__.a)({_template:_polymer_polymer_lib_utils_html_tag_js__WEBPACK_IMPORTED_MODULE_5__.a`
    ...
    <slot></slot>
`,is:"paper-dialog",behaviors:[_polymer_paper_dialog_behavior_paper_dialog_behavior_js__WEBPACK_IMPORTED_MODULE_3__.a,_polymer_neon_animation_neon_animation_runner_behavior_js__WEBPACK_IMPORTED_MODULE_2__.a],listeners:{"neon-animation-finish":"_onNeonAnimationFinish"},_renderOpened:function(){this.cancelAnimation();this.playAnimation("entry")},_renderClosed:function(){this.cancelAnimation();this.playAnimation("exit")},_onNeonAnimationFinish:function(){if(this.opened){this._finishRenderOpened()}else{this._finishRenderClosed()}}})},756:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,"HuiDialogMoveCardView",function(){return HuiDialogMoveCardView});var lit_element__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(41),_polymer_paper_dialog_paper_dialog__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(181),_polymer_paper_item_paper_item__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(127),_mixins_lit_localize_mixin__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__(155),_config_util__WEBPACK_IMPORTED_MODULE_4__=__webpack_require__(255);class HuiDialogMoveCardView extends Object(_mixins_lit_localize_mixin__WEBPACK_IMPORTED_MODULE_3__.a)(lit_element__WEBPACK_IMPORTED_MODULE_0__.a){static get properties(){return{_params:{}}}async showDialog(params){this._params=params;await this.updateComplete}render(){if(!this._params){return lit_element__WEBPACK_IMPORTED_MODULE_0__.c``}return lit_element__WEBPACK_IMPORTED_MODULE_0__.c`
      <style>
        paper-item {
          margin: 8px;
          cursor: pointer;
    ...
    `}get _dialog(){return this.shadowRoot.querySelector("paper-dialog")}_moveCard(e){const newView=e.currentTarget.index,path=this._params.path;if(newView===path[0]){return}const lovelace=this._params.lovelace;lovelace.saveConfig(Object(_config_util__WEBPACK_IMPORTED_MODULE_4__.e)(lovelace.config,path,[newView]));this._dialog.close()}_openedChanged(ev){if(!ev.detail.value){this._params=void 0}}}customElements.define("hui-dialog-move-card-view",HuiDialogMoveCardView)}}]);
//# sourceMappingURL=113fb54ce3001d4eb3b4.chunk.js.map