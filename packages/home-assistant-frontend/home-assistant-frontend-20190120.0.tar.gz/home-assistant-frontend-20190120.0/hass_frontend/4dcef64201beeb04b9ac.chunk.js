...
`,is:"paper-dialog-scrollable",properties:{dialogElement:{type:Object}},get scrollTarget(){return this.$.scrollable},ready:function(){this._ensureTarget();this.classList.add("no-padding")},attached:function(){this._ensureTarget();requestAnimationFrame(this.updateScrollState.bind(this))},updateScrollState:function(){this.toggleClass("is-scrolled",0<this.scrollTarget.scrollTop);this.toggleClass("can-scroll",this.scrollTarget.offsetHeight<this.scrollTarget.scrollHeight);this.toggleClass("scrolled-to-bottom",this.scrollTarget.scrollTop+this.scrollTarget.offsetHeight>=this.scrollTarget.scrollHeight)},_ensureTarget:function(){this.dialogElement=this.dialogElement||this.parentElement;if(this.dialogElement&&this.dialogElement.behaviors&&0<=this.dialogElement.behaviors.indexOf(_polymer_paper_dialog_behavior_paper_dialog_behavior_js__WEBPACK_IMPORTED_MODULE_3__.b)){this.dialogElement.sizingTarget=this.scrollTarget;this.scrollTarget.classList.remove("fit")}else if(this.dialogElement){this.scrollTarget.classList.add("fit")}}})},764:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var lit_element=__webpack_require__(41),paper_spinner=__webpack_require__(112),paper_dialog=__webpack_require__(181),paper_button=__webpack_require__(73),paper_dialog_scrollable=__webpack_require__(187),ha_style=__webpack_require__(101),paper_input=__webpack_require__(79),lit_localize_mixin=__webpack_require__(155),fire_event=__webpack_require__(66),config_elements_style=__webpack_require__(172);class hui_lovelace_editor_HuiLovelaceEditor extends Object(lit_localize_mixin.a)(lit_element.a){static get properties(){return{hass:{},config:{}}}get _title(){if(!this.config){return""}return this.config.title||""}render(){return lit_element.c`
...
//# sourceMappingURL=4dcef64201beeb04b9ac.chunk.js.map