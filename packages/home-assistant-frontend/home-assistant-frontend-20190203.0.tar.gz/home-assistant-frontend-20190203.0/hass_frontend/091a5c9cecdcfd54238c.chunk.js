...
`;template.setAttribute("strip-whitespace","");Object(_polymer_polymer_lib_legacy_polymer_fn_js__WEBPACK_IMPORTED_MODULE_7__.a)({_template:template,is:"paper-fab",behaviors:[_polymer_paper_behaviors_paper_button_behavior_js__WEBPACK_IMPORTED_MODULE_6__.a],properties:{src:{type:String,value:""},icon:{type:String,value:""},mini:{type:Boolean,value:!1,reflectToAttribute:!0},label:{type:String,observer:"_labelChanged"}},_labelChanged:function(){this.setAttribute("aria-label",this.label)},_computeIsIconFab:function(icon,src){return 0<icon.length||0<src.length}})},772:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var paper_fab=__webpack_require__(219),lit_element=__webpack_require__(13),paper_button=__webpack_require__(94),paper_menu_button=__webpack_require__(128),paper_icon_button=__webpack_require__(93),paper_listbox=__webpack_require__(124),show_edit_card_dialog=__webpack_require__(385),config_util=__webpack_require__(261);async function confDeleteCard(lovelace,path){if(!confirm("Are you sure you want to delete this card?")){return}try{await lovelace.saveConfig(Object(config_util.c)(lovelace.config,path))}catch(err){alert(`Deleting failed: ${err.message}`)}}var fire_event=__webpack_require__(58);let registeredDialog=!1;const registerEditCardDialog=element=>Object(fire_event.a)(element,"register-dialog",{dialogShowEvent:"show-move-card-view",dialogTag:"hui-dialog-move-card-view",dialogImport:()=>__webpack_require__.e(31).then(__webpack_require__.bind(null,767))}),showMoveCardViewDialog=(element,moveCardViewDialogParams)=>{if(!registeredDialog){registeredDialog=!0;registerEditCardDialog(element)}Object(fire_event.a)(element,"show-move-card-view",moveCardViewDialogParams)};class hui_card_options_HuiCardOptions extends lit_element.a{static get properties(){return{hass:{},lovelace:{},path:{}}}render(){return lit_element.c`
      <style>
        div.options {
...
//# sourceMappingURL=091a5c9cecdcfd54238c.chunk.js.map