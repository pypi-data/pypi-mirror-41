(window.webpackJsonp=window.webpackJsonp||[]).push([[11],{108:function(module,__webpack_exports__,__webpack_require__){"use strict";var polymer_legacy=__webpack_require__(3);/**
@license
...
`,is:"paper-dialog-scrollable",properties:{dialogElement:{type:Object}},get scrollTarget(){return this.$.scrollable},ready:function(){this._ensureTarget();this.classList.add("no-padding")},attached:function(){this._ensureTarget();requestAnimationFrame(this.updateScrollState.bind(this))},updateScrollState:function(){this.toggleClass("is-scrolled",0<this.scrollTarget.scrollTop);this.toggleClass("can-scroll",this.scrollTarget.offsetHeight<this.scrollTarget.scrollHeight);this.toggleClass("scrolled-to-bottom",this.scrollTarget.scrollTop+this.scrollTarget.offsetHeight>=this.scrollTarget.scrollHeight)},_ensureTarget:function(){this.dialogElement=this.dialogElement||this.parentElement;if(this.dialogElement&&this.dialogElement.behaviors&&0<=this.dialogElement.behaviors.indexOf(_polymer_paper_dialog_behavior_paper_dialog_behavior_js__WEBPACK_IMPORTED_MODULE_3__.b)){this.dialogElement.sizingTarget=this.scrollTarget;this.scrollTarget.classList.remove("fit")}else if(this.dialogElement){this.scrollTarget.classList.add("fit")}}})},761:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);__webpack_require__.d(__webpack_exports__,"CloudWebhookManageDialog",function(){return CloudWebhookManageDialog});var lit_element__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(20),_polymer_paper_button_paper_button__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(72),_polymer_paper_input_paper_input__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(78),_polymer_paper_dialog_scrollable_paper_dialog_scrollable__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__(187),_polymer_paper_dialog_paper_dialog__WEBPACK_IMPORTED_MODULE_4__=__webpack_require__(180),_resources_ha_style__WEBPACK_IMPORTED_MODULE_5__=__webpack_require__(100);const inputLabel="Public URL \u2013 Click to copy to clipboard";class CloudWebhookManageDialog extends lit_element__WEBPACK_IMPORTED_MODULE_0__.a{static get properties(){return{_params:{}}}async showDialog(params){this._params=params;await this.updateComplete;this._dialog.open()}render(){if(!this._params){return lit_element__WEBPACK_IMPORTED_MODULE_0__.c``}const{webhook,cloudhook}=this._params,docsUrl="automation"===webhook.domain?"https://www.home-assistant.io/docs/automation/trigger/#webhook-trigger":`https://www.home-assistant.io/components/${webhook.domain}/`;return lit_element__WEBPACK_IMPORTED_MODULE_0__.c`
    ...
    `}get _dialog(){return this.shadowRoot.querySelector("paper-dialog")}get _paperInput(){return this.shadowRoot.querySelector("paper-input")}_closeDialog(){this._dialog.close()}async _disableWebhook(){if(!confirm("Are you sure you want to disable this webhook?")){return}this._params.disableHook();this._closeDialog()}_copyClipboard(ev){const paperInput=ev.currentTarget,input=paperInput.inputElement.inputElement;input.setSelectionRange(0,input.value.length);try{document.execCommand("copy");paperInput.label="COPIED TO CLIPBOARD"}catch(err){}}_restoreLabel(){this._paperInput.label=inputLabel}static get styles(){return[_resources_ha_style__WEBPACK_IMPORTED_MODULE_5__.a,lit_element__WEBPACK_IMPORTED_MODULE_0__.b`
        paper-dialog {
          width: 650px;
        }
        paper-input {
...
//# sourceMappingURL=b35a93ac2a814df5588a.chunk.js.map