...
def change_status(
        ...
        new_status: STATUSES, reason: str = None,
        keyword: str = None, keyword_field: KEYWORD_FIELDS = None,
        customer: get_customer_id = None, exclude_customer: get_customer_id = None,
        service: CASE_TYPES = None, category: str = None, status: STATUSES = None, priority: PRIORITIES = None,
        dry: bool = False
):
    ...
    :param list service: Service type to search for
    :param list category: Category type to search for
    ...
    cases = advanced_case_search(
        ...
        priority=priority, status=status, category=category, service=service,
