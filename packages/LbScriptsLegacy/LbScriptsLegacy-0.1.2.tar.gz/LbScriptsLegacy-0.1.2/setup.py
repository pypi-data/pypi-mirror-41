...
# Get the list of endpoints and their mappings from the module itself
from LbScriptsLegacy import get_entry_points
legacy_mappings = get_entry_points()
...
setup(
    ...
    description='Legacy commands and tools from LbScripts, to be removed in the future',  # Required
    ...
    url='https://gitlab.cern.ch/lhcb-core/LbScriptsLegacy',  # Optional
    ...
    tests_require=['coverage', 'mock', 'nose>=1.0'],
    ...
    entry_points={  # Optional
        'console_scripts': legacy_mappings,
    },
