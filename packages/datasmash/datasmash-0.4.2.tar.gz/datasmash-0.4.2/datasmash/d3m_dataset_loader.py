...
class D3MDatasetLoader(object):
    ...
    def load_dataset(self, *, data, train_or_test, verbose=False, **kwargs):
        ...
        if data.find(os.path.join('TEST', 'dataset_TEST/datasetDoc.json')) != -1 or data.find(os.path.join( 'TRAIN', 'dataset_TRAIN/datasetDoc.json')) != -1:
