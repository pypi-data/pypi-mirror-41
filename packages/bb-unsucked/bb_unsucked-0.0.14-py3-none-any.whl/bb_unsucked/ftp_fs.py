  ...
  def stat(self, path):
    ...
    class StatAttr:
      def __init__(self, attrs):
        self.st_atime = attrs['st_atime']
        self.st_ctime = attrs['st_ctime']
        self.st_gid = attrs['st_gid']
        self.st_mode = attrs['st_mode']
        self.st_mtime = attrs['st_mtime']
        self.st_nlink = attrs['st_nlink']
        self.st_size = attrs['st_size']
        self.st_uid = attrs['st_uid']
