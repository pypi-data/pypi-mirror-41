...
Python external for controlling the Decibel ScorePlayer canvas mode, v0.1.14
...
class scorePlayerExternal:
    ...
    def connect(self, connectionHandler):
        ...
        return self.connectToAddress(address, self.__service.port, connectionHandler)
    ...
    def __onTick(self, oscAddress, location):
        if self.printTicks:
            print('{} {}\n'.format(oscAddress, location), end="")
