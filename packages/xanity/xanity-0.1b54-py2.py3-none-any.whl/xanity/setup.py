...
xanity_path_translation = ('src', 'self_replication')
...
for line in open(os.path.join(thispath, 'self_replication/xanity/__init__.py'), 'r').readlines():                ##_xanity_replace
...
setup(
    ...
    package_dir={'': 'self_replication'},                                                                        ##_xanity_replace

    scripts=[
        'self_replication/xanity/bin/xanity',                                                                    ##_xanity_replace
    ],
