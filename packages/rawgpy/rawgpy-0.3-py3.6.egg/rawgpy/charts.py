"""
Classes that represent a games chart listing values on RAWG_
"""
...
it would be the second best/most popular shooter game on RAWG_
    """
...
it would be the second best/most popular game on RAWG_ in 2012
    """
