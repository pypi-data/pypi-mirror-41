...
class ReactBridge():
  ...
  def handle_comm_msg(self, comm, msg):
    ...
    try:
      ...
      transform_id = msg_data.get('filterset', {}).get('transformId', None)
      ...
      if transform_id == None:
        comm_data['fixed_record_count'] = 'N/A'
      else:
        comm_data['fixed_record_count'] = self.reactdata.get_source_dataframe(transform_id).shape[0]
