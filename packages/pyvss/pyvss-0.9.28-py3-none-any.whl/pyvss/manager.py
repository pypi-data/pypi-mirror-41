...
class VssManager(object):
    ...
    def get_token(self, user=None, password=None):
        ...
        tk_request = self.request(self.token_endpoint,
                                  method=self.POST,
    ...
    def get_user_group(self, cn, member=False):
        ...
        json = self.request('/user/group/{cn}'.format(cn=cn), method=self.GET,
                            params=payload)
        return json.get('data')
    ...
    def get_user_token(self, token_id):
        ...
        """
        json = self.request('/user/token/{tk}'.format(tk=token_id),
                            method=self.GET)
        return json.get('data')
    ...
    def get_user_ssh_keys(self, show_all=False, **kwargs):
        ...
        """
        data = self._get_objects(pag_resource='/user/ssh-key',
                                 show_all=show_all,
                                 **kwargs)
        return data
    ...
    def get_user_ssh_key(self, key_id):
        ...
        """
        json = self.request('/user/ssh-key/{id}'.format(id=key_id),
                            method=self.GET)
        return json.get('data')
    ...
    def create_user_ssh_key(self, public_key):
        ...
        json = self.request('/user/ssh-key',
                            method=self.POST, payload=payload)
        return json.get('data')
    ...
    def get_user_request_notification_settings(self):
        ...
        :return: object
        """
        json = self.request('/user/setting/notification/request',
                            method=self.GET)
        return json.get('data')
    ...
    def get_user_notification_method(self):
        ...
        :return: object
        """
        json = self.request('/user/setting/notification/method',
                            method=self.GET)
        return json.get('data')
    ...
    def update_user_notification_method(self, method):
        ...
        _json = self.request('/user/setting/notification/method',
                             method=self.PUT,
                             payload=payload)
    ...
    def get_user_notification_format(self):
        ...
        :return:
        """
        json = self.request('/user/setting/notification/format',
                            method=self.GET)
        return json.get('data')
    ...
    def update_user_notification_format(self, fmt):
        ...
        _json = self.request('/user/setting/notification/format',
                             method=self.PUT,
                             payload=payload)
    ...
    def enable_user_message_digest(self):
        ...
        :return: updated email settings object
        """
        json = self.request('/user/setting/digest/message',
                            method=self.PUT,
    ...
    def ack_user_message(self, id):
        ...
        :return: message object
        """
        return self.request('/user/message/{id}'.format(id=id),
                            method=self.PATCH)
    ...
    def create_inventory_file(self, props=None, filters=None, fmt='json'):
        ...
        json = self.request('/inventory', payload=json_payload,
                            method=self.POST)
        return json.get('data')
    ...
    def download_inventory_result(self, request_id, directory=None):
        ...
        """
        response = self.request('/inventory/{}'.format(request_id),
                                method=self.GET)
    ...
    def _get_objects(self, pag_resource, show_all=False, **kwargs):
        ...
        json = self.request(pag_resource,
                            params=params)
        result = list()
    ...
    def get_new_request_meta_data(self, request_id):
        ...
        """
        json = self.request('/request/new/{id}/meta_data'.format(
            id=request_id))
        return json.get('data')
    ...
    def get_new_request_user_data(self, request_id, decode=False):
        ...
        json = self.request('/request/new/{id}/user_data'.format(
    ...
    def get_new_request_custom_spec(self, request_id):
        ...
        :return: object
        """
        json = self.request('/request/new/{id}/custom_spec'.format(
            id=request_id))
        return json.get('data')
    ...
    def cancel_scheduled_change_request(self, request_id):
        ...
        json = self.request('/request/change/{id}'.format(id=request_id),
                            payload=payload, method=self.PUT)
        return json
    ...
    def get_snapshot_request(self, request_id, **kwargs):
        ...
        """
        json = self.request('/request/snapshot/{id}'.format(
    ...
    def extend_snapshot_request(self, request_id, duration):
        ...
        request = self.request('/request/snapshot/{id}'.format(
            id=request_id))
        ...
        # update
        json = self.request('/request/snapshot/{id}'.format(
            id=request_id), method=self.PUT, payload=payload)
    ...
    def get_inventory_request(self, request_id, **kwargs):
        ...
        """
        json = self.request('/request/inventory/{id}'.format(
            id=request_id), params=kwargs)
        return json.get('data')
    ...
    def get_export_request(self, request_id, **kwargs):
        ...
        """
        json = self.request('/request/export/{id}'.format(id=request_id),
                            params=kwargs)
        return json.get('data')
    ...
    def get_folder_request(self, request_id, **kwargs):
        ...
        """
        json = self.request('/request/folder/{id}'.format(id=request_id),
                            params=kwargs)
        return json.get('data')
    ...
    def get_image_sync_request(self, request_id, **kwargs):
        ...
        """
        json = self.request('/request/image_sync/{id}'.format(
            id=request_id), params=kwargs)
        return json.get('data')
    ...
    def get_domain(self, moref, **kwargs):
        ...
        """
        json = self.request('/domain/{moId}'.format(moId=moref),
                            params=kwargs)
        return json.get('data')
    ...
    def get_network(self, moref, **kwargs):
        ...
        """
        json = self.request('/network/{moId}'.format(moId=moref),
                            params=kwargs)
        return json.get('data')
    ...
    def get_folder(self, moref, **kwargs):
        ...
        :return: object
        """
        json = self.request('/folder/{moId}'.format(moId=moref),
                            params=kwargs)
        return json.get('data')
    ...
    def rename_folder(self, moref, name, **kwargs):
        ...
        json = self.request('/folder/{moref}'.format(moref=moref),
                            payload=json_payload,
                            method=self.PUT)
        return json.get('data')
    ...
    def get_vm(self, uuid, **kwargs):
        ...
        """
        json = self.request('/vm/{uuid}'.format(uuid=uuid),
                            params=kwargs)
        return json.get('data')
    ...
    def update_vm_folder(self, uuid, folder_moId, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request('/vm/{uuid}/folder'.format(uuid=uuid),
                            method=self.PUT, payload=json_payload)
        return json.get('data')
    ...
    def run_cmd_guest_vm(self, uuid, user, pwd, cmd, arg, **kwargs):
        ...
        json_payload = {'user': user, 'pass': pwd,
                        'args': arg, 'cmd': cmd}
        json_payload.update(kwargs)
        json = self.request('/vm/{uuid}/guest/cmd'.format(uuid=uuid),
                            method=self.POST,
                            payload=json_payload)
        return json.get('data')
    ...
    def get_vm_guest_process_id(self, uuid, user, pwd, pid):
        ...
        """
        json_payload = {'user': user, 'pass': pwd}
        json = self.request('/vm/{uuid}/guest/cmd/{pid}'.format(uuid=uuid,
                                                                pid=pid),
                            method=self.GET,
                            payload=json_payload)
        return json.get('data')
    ...
    def get_vm_tools(self, uuid):
        ...
        - versionStatus
        """
        json = self.request('/vm/{uuid}/guest/tools'.format(uuid=uuid),
                            method=self.GET)
        return json.get('data')
    ...
    def get_vm_snapshot(self, uuid, snapshot):
        ...
        """
        json = self.request('/vm/{uuid}/snapshot/{id}'.format(
    ...
    def delete_vm_snapshot(self, uuid, snapshot):
        ...
        """
        json = self.request('/vm/{uuid}/snapshot/{id}'.format(
            uuid=uuid, id=snapshot), method=self.DELETE)
        return json.get('data')
    ...
    def revert_vm_snapshot(self, uuid, snapshot):
        ...
        """
        json = self.request('/vm/{uuid}/snapshot/{id}'.format(
            uuid=uuid, id=snapshot), method=self.PATCH)
        return json.get('data')
    ...
    def consolidate_vm_disks(self, uuid, **kwargs):
        ...
        json = self.request(
            '/vm/{uuid}/snapshot/consolidate'.format(uuid=uuid),
            method=self.PUT, payload=payload)
        return json.get('data')
    ...
    def get_vm_alarm(self, uuid, moref):
        ...
        """
        json = self.request('/vm/{uuid}/alarm/{moref}'.format(uuid=uuid,
                                                              moref=moref))
        return json.get('data')
    ...
    def get_vm_events(self, uuid, hours=1):
        ...
        json = self.request('/vm/{uuid}{events}'.format(uuid=uuid,
                                                        events=event_uri))
        return json.get('data')
    ...
    def export_vm(self, uuid):
        ...
        """
        json = self.request('/vm/{uuid}/export'.format(uuid=uuid),
                            method=self.POST)
        return json.get('data')
    ...
    def create_vm_from_image(self, os, image, bill_dept,
        ...
        if notes:
            json_payload['notes'] = notes
        json_payload.update(kwargs)
        json = self.request('/vm', payload=json_payload,
                            method=self.POST)
        return json.get('data')
    ...
    def create_vm_custom_spec(self, uuid, custom_spec, **kwargs):
        ...
        """
        json = self.request('/vm/{uuid}/custom_spec'.format(uuid=uuid),
                            method=self.POST, payload=custom_spec)
        return json.get('data')
    ...
    def get_vm_console(self, uuid, auth=None):
        ...
        if auth:
            ...
            kwargs['auth'] = _auth
        json = self.request('/vm/{uuid}/console'.format(uuid=uuid),
                            **kwargs)
        return json.get('data')
    ...
    def mark_vm_as_template(self, uuid, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request('/vm/{uuid}/template'.format(uuid=uuid),
                            payload=json_payload, method=self.PUT)
        return json.get('data')
    ...
    def set_vm_memory(self, uuid, sizeGB, **kwargs):
        ...
        payload.update(kwargs)
        json = self.request('/vm/{uuid}/memory'.format(uuid=uuid),
                            payload=payload,
                            method=self.PUT)
        return json.get('data')
    ...
    def get_vm_nics(self, uuid):
        ...
        for nic in nic_numbers:
            json = self.request('/vm/{uuid}/nic/{nic}'.format(uuid=uuid,
                                                              nic=nic))
    ...
    def create_vm_nic(self, uuid, networks, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request('/vm/{uuid}/nic'.format(uuid=uuid),
                            method=self.POST, payload=json_payload)
        return json.get('data')
    ...
    def delete_vm_nic(self, uuid, unit, **kwargs):
        ...
        json_payload = dict()
        json_payload.update(kwargs)
        json = self.request('/vm/{uuid}/nic/{number}'.format(uuid=uuid,
                                                             number=unit),
                            method=self.DELETE, payload=json_payload)
        return json.get('data')
    ...
    def get_vm_floppy(self, uuid, floppy):
        ...
        :return: object
        """
        json = self.request('/vm/{uuid}/floppy/{floppy}'.format(
    ...
    def get_vm_cd(self, uuid, cd):
        ...
        """
        json = self.request('/vm/{uuid}/cd/{cd}'.format(uuid=uuid,
                                                        cd=cd))
        return json.get('data')
    ...
    def update_vm_cd(self, uuid, unit, iso=None, **kwargs):
        ...
        json_payload = dict(iso=iso) \
            if iso else dict()
        json_payload.update(kwargs)
        json = self.request('/vm/{uuid}/cd/{unit}'.format(uuid=uuid,
                                                          unit=unit),
                            method=self.PATCH, payload=json_payload)
        return json.get('data')
    ...
    def get_vm_controller_scsi(self, uuid, bus, devices=None):
        ...
        :return: object
        """
        json = self.request('/vm/{uuid}/controller/scsi/{bus}'.format(
            uuid=uuid, bus=bus))
        if not json:
            raise VssError('No VM controllers')
        data = json.get('data')
    ...
    def get_vm_controller_scsi_disk(self, uuid, bus):
        ...
        :return: list of objects
        """
        json = self.request('/vm/{uuid}/controller/scsi/{bus}/disk'.format(
            uuid=uuid, bus=bus))
        disks = list()
    ...
    def get_vm_disk(self, uuid, disk):
        ...
        """
        json = self.request('/vm/{uuid}/disk/{disk}'.format(uuid=uuid,
                                                            disk=disk))
        return json.get('data')
    ...
    def get_vm_disk_backing(self, uuid, disk):
        ...
        """
        json = self.request('/vm/{uuid}/disk/{disk}/backing'.format(
            uuid=uuid, disk=disk))
        return json.get('data')
    ...
    def delete_vm_disk(self, uuid, unit, **kwargs):
        ...
        json = self.request('/vm/{uuid}/disk/{disk}'.format(uuid=uuid,
                                                            disk=unit),
                            method=self.DELETE, payload=kwargs)
        return json.get('data')
    ...
    def get_vm_vss_options(self, uuid):
        ...
        """
        json = self.request('/vm/{uuid}/vss/option'.format(
            uuid=uuid))
        return json.get('data')
    ...
    def get_vm_vss_option(self, uuid, option_name):
        ...
        :return: dict
        """
        json = self.request('/vm/{uuid}/vss/option/{option_name}'.format(
    ...
    def enable_vm_vss_option(self, uuid, option_name):
        ...
        """
        json = self.request('/vm/{uuid}/vss/option/{option_name}'.format(
            uuid=uuid, option_name=option_name), method=self.POST)
        return json.get('data')
    ...
    def disable_vm_vss_option(self, uuid, option_name):
        ...
        """
        json = self.request('/vm/{uuid}/vss/option/{option_name}'.format(
            uuid=uuid, option_name=option_name), method=self.DELETE)
        return json.get('data')
    ...
    def get_vm_vss_description(self, uuid):
        ...
        """
        json = self.request('/vm/{uuid}/vss/description'.format(
            uuid=uuid))
        return json.get('data')
    ...
    def request(self, url, headers=None, params=None, payload=None,
                method=None, auth=None, timeout=60):
        # update _headers
        ...
        # create kwargs
        request_kwargs = {'headers': _headers, 'params': params,
                          'auth': auth, 'url': url,
                          'json': payload, 'timeout': timeout}
        # method or default GET
        method = method or self.GET
        # lookup dictionary
        lookup = {self.POST: requests.post,
        ...
        try:
            try:
                ...
                raise VssError("Unsupported method: {}".format(method))
