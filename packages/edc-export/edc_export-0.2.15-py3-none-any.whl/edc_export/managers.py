...
class ExportHistoryManager(models.Manager):
    ...
    def serialize_to_exported_object_history(self, instance, change_type,
        ...
        try:
            ready_to_export_transaction = (
                force_export or instance.ready_to_export_transaction)
        except AttributeError as attribute_error:
            if str(attribute_error).endswith(
                    "has no attribute 'ready_to_export_transaction'"):
