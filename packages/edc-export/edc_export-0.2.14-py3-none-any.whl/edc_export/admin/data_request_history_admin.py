...
class DataRequestHistoryAdmin(admin.ModelAdmin):
    ...
    fields = ('data_request', 'archive_filename', 'emailed_to',
              'emailed_datetime', 'summary', 'exported_datetime')

    list_display = ('data_request', 'emailed_to',
                    'emailed_datetime', 'exported_datetime')

    list_filter = ('emailed_to', 'emailed_datetime', 'exported_datetime')

    readonly_fields = ('data_request', 'archive_filename', 'emailed_to',
                       'emailed_datetime', 'summary', 'exported_datetime')
...
class DataRequestHistoryInline(admin.TabularInline):
    ...
    fields = ('archive_filename', 'emailed_to',
              'emailed_datetime', 'exported_datetime')
