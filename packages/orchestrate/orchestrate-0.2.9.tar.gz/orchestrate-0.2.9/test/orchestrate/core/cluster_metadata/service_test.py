...
class TestClusterService(object):
  ...
  def services(self):
    ...
    mock_services.aws_service.create_cluster_object = fake_create_cluster_object
  ...
  def test_double_write(self, cluster_metadata_service):
    with TemporaryDirectory() as root_dirname:
      ...
      cluster = cluster_metadata_service.services.custom_cluster_service.create_cluster_object(
        services=cluster_metadata_service.services,
        name='foobar',
        registry=None,
      )
