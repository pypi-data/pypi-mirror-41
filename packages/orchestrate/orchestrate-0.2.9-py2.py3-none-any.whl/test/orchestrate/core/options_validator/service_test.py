...
class TestOptionsValidatorService(object):
  ...
  def test_validate_orchestrate_options_empty_run(self, options_validator_service, orchestrate_options):
    orchestrate_options['run'] = ['']
    with pytest.raises(AssertionError):
      options_validator_service.validate_orchestrate_options(**orchestrate_options)
  ...
  def test_validate_aws_for_cluster_rejects_ecr(self, options_validator_service):
  ...
  def test_validate_aws_ecr_no_longer_requires_respository(self, options_validator_service):
    options_validator_service.validate_aws_for_orchestrate(
      ecr=dict(),
    )
