...
class Csim(KaitaiStruct):
    ...
    class BeaconShort(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.imu_invalid_count = self._io.read_u2le()
            self.new_packet_count = self._io.read_u1()
            self.imu_vector_valid = self._io.read_u1()
            self.hr_run_count = self._io.read_u4le()
            ...
            self.payload_sec_since_last_tlm = self._io.read_u4le()
            self.payload_tlm_rx_count = self._io.read_u2le()
            self.payload_tlm_ack_count = self._io.read_u2le()
            self.payload_tlm_nak_count = self._io.read_u2le()
            ...
            self.box1_temp = self._io.read_s2le()
            self.imu_temp = self._io.read_s2le()
            self.motor1_temp = self._io.read_s2le()
            self.motor2_temp = self._io.read_s2le()
            self.motor3_temp = self._io.read_s2le()
            self.bus_voltage = self._io.read_s2le()
            self.battery_voltage = self._io.read_u2le()
            self.battery_current = self._io.read_s2le()
            self.battery1_temp = self._io.read_s2le()
            self.battery2_temp = self._io.read_s2le()
            self.user_analog1 = self._io.read_s4le()
            self.user_analog2 = self._io.read_s4le()
            self.operating_mode = self._io.read_u1()
            self.star_id_step = self._io.read_u1()
            self.att_status = self._io.read_u1()
            self.det_timeout_count = self._io.read_u2le()
            self.num_attitude_stars = self._io.read_u1()
            self.cycles_since_crc_data = self._io.read_u4le()
            self.gps_lock_count = self._io.read_u2le()
            self.gps_valid = self._io.read_u1()
            self.gps_enabled = self._io.read_u1()
            self.macros_status_2 = self._io.read_u2le()
            self.sd_minute_cur = self._io.read_u4le()
            ...
            self.sdr_tx_frames = self._io.read_u4le()
            self.sdr_rx_frames = self._io.read_u4le()
            ...
            self.sdr_rx_freq_offset = self._io.read_s4le()
            ...
            self.aid_status = self._io.read_u2le()
            self.star_id_status = self._io.read_u1()
            self.power_status = self._io.read_u4le()
    ...
    class BeaconLong(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.spare_end = self._io.read_u8le()
            ...
            self.macros_status_1 = self._io.read_u2le()
            ...
            self.tai_seconds = self._io.read_f8le()
            self.time_valid = self._io.read_u1()
            self.position_wrt_eci1 = self._io.read_s4le()
            self.position_wrt_eci2 = self._io.read_s4le()
            self.position_wrt_eci3 = self._io.read_s4le()
            self.velocity_wrt_eci1 = self._io.read_s4le()
            self.velocity_wrt_eci2 = self._io.read_s4le()
            self.velocity_wrt_eci3 = self._io.read_s4le()
            self.nadir_vector_body1 = self._io.read_s2le()
            self.nadir_vector_body2 = self._io.read_s2le()
            self.nadir_vector_body3 = self._io.read_s2le()
            self.sun_vector_body1 = self._io.read_s2le()
            self.sun_vector_body2 = self._io.read_s2le()
            self.sun_vector_body3 = self._io.read_s2le()
            self.sun_position_wrt_eci1 = self._io.read_s4le()
            self.sun_position_wrt_eci2 = self._io.read_s4le()
            self.sun_position_wrt_eci3 = self._io.read_s4le()
            self.moon_position_wrt_eci1 = self._io.read_s4le()
            self.moon_position_wrt_eci2 = self._io.read_s4le()
            self.moon_position_wrt_eci3 = self._io.read_s4le()
            self.refs_valid = self._io.read_u1()
            self.esm_valid = self._io.read_u1()
            self.run_low_rate_task = self._io.read_u1()
            self.q_body_wrt_eci1 = self._io.read_s4le()
            self.q_body_wrt_eci2 = self._io.read_s4le()
            self.q_body_wrt_eci3 = self._io.read_s4le()
            self.q_body_wrt_eci4 = self._io.read_s4le()
            self.body_rate1_dps = self._io.read_s4le()
            self.body_rate2_dps = self._io.read_s4le()
            self.body_rate3_dps = self._io.read_s4le()
            self.bad_att_timer = self._io.read_u4le()
            self.bad_rate_timer = self._io.read_u4le()
            self.reinit_count = self._io.read_u4le()
            self.gnc_status_1 = self._io.read_u4le()
            self.hr_cycle_safe_mode = self._io.read_u4le()
            self.rotisserie_rate_dps = self._io.read_s2le()
            self.adcs_mode = self._io.read_u1()
            self.gnc_status_2 = self._io.read_u2le()
            self.filtered_speed_rpm1 = self._io.read_s2le()
            self.filtered_speed_rpm2 = self._io.read_s2le()
            self.filtered_speed_rpm3 = self._io.read_s2le()
            ...
            self.det_timeout_count = self._io.read_u2le()
            self.num_attitude_stars = self._io.read_u1()
            self.position_error1 = self._io.read_s4le()
            self.position_error2 = self._io.read_s4le()
            self.position_error3 = self._io.read_s4le()
            self.eigen_error = self._io.read_u4le()
            self.time_into_search = self._io.read_u2le()
            self.wait_timer = self._io.read_u2le()
            self.sun_point_angle_error = self._io.read_u2le()
            self.sun_point_state = self._io.read_u1()
            self.momentum_vector_body1 = self._io.read_s2le()
            self.momentum_vector_body2 = self._io.read_s2le()
            self.momentum_vector_body3 = self._io.read_s2le()
            self.total_momentum_mag = self._io.read_u2le()
            ...
            self.sun_vector_body1_meas = self._io.read_s2le()
            self.sun_vector_body2_meas = self._io.read_s2le()
            self.sun_vector_body3_meas = self._io.read_s2le()
            self.sun_vector_status = self._io.read_u1()
            self.css_invalid_count = self._io.read_u2le()
            self.sun_sensor_used = self._io.read_u1()
            self.mag_vector_body1 = self._io.read_s2le()
            self.mag_vector_body2 = self._io.read_s2le()
            self.mag_vector_body3 = self._io.read_s2le()
            self.mag_invalid_count = self._io.read_u2le()
