...
*AlphaApi* | [**has_access**](docs/AlphaApi.md#has_access) | **GET** /files/{file_hash}/has_access | Returns a success if the user has access to this file
...
## Documentation For Models
 ...
 - [PublicFilesListResponse](docs/PublicFilesListResponse.md)
