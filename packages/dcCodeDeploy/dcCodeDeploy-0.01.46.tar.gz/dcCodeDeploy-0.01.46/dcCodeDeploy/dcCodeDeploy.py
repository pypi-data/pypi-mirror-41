...
#    sudo("ln -s /data/deploy/$(ls -t|grep 20|head -2|ls|grep 20|sort -r|head -2|tail -1) /data/deploy/current")   
#    sudo("ln -s /data/deploy/$(ls -t|grep 20|head -2|ls|grep 20|sort -r|head -2|tail -1) /data/deploy/pending")
#    sudo("ls -t|grep 20|head -2|ls|grep 20|sort -r|head -1 |xargs rm -rf")  

    sudo("$(ls -t|grep 20|head -2|ls|grep 20|sort -r|head -2|tail -1)")
    sudo("ls -t|grep 20|head -2|ls|grep 20|sort -r|head -1")
