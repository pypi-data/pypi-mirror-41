...
#
#  $ bin/test -s theme.habas34 -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src theme.habas34.testing.THEME_HABAS34_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/theme/habas34/tests/robot/test_example.robot
#
