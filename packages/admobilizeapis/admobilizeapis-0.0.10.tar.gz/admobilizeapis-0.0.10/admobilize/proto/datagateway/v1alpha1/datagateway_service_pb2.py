...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_options=_b('\n#com.admobilize.datagateway.v1alpha1B\020DataGatewayProtoP\001\242\002\005ADMDG\252\002\037AdMobilize.DataGateway.V1Alpha1'),
  serialized_pb=_b('\n9admobilize/datagateway/v1alpha1/datagateway_service.proto\x12\x1f\x61\x64mobilize.datagateway.v1alpha1\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1dmatrix_io/common/entity.proto\"\xc6\x01\n\x03Job\x12\x0e\n\x06job_id\x18\x01 \x01(\t\x12;\n\x06status\x18\x02 \x01(\x0e\x32+.admobilize.datagateway.v1alpha1.Job.Status\x12\x0e\n\x06\x64\x65tail\x18\x03 \x01(\t\x12\x16\n\x0estatus_message\x18\x04 \x01(\t\x12\x11\n\tself_link\x18\x05 \x01(\t\"7\n\x06Status\x12\x0b\n\x07PENDING\x10\x00\x12\x0b\n\x07RUNNING\x10\x01\x12\x08\n\x04\x44ONE\x10\x03\x12\t\n\x05\x45RROR\x10\x04\"\x98\x01\n\x10\x43reateJobRequest\x12.\n\nstart_time\x18\x01 \x01(\x0b\x32\x1a.google.protobuf.Timestamp\x12,\n\x08\x65nd_time\x18\x02 \x01(\x0b\x32\x1a.google.protobuf.Timestamp\x12\x12\n\nproduct_id\x18\x03 \x01(\t\x12\x12\n\ndevice_ids\x18\x04 \x03(\t\"G\n\rGetJobRequest\x12\n\n\x02id\x18\x01 \x01(\t\x12*\n\x06\x66ields\x18\x02 \x01(\x0b\x32\x1a.google.protobuf.FieldMask\"Y\n\x14GetJobResultRequests\x12\n\n\x02id\x18\x01 \x01(\t\x12\x11\n\tpage_size\x18\x02 \x01(\x05\x12\x12\n\npage_token\x18\x03 \x01(\t\x12\x0e\n\x06\x66ormat\x18\x04 \x01(\t\"j\n\x15GetDatapointsResponse\x12\x0e\n\x06job_id\x18\x01 \x01(\t\x12\x14\n\x0cjob_complete\x18\x02 \x01(\x08\x12\x17\n\x0fnext_page_token\x18\x03 \x01(\t\x12\x12\n\ndatapoints\x18\x04 \x01(\t2\xb9\x03\n\x12\x44\x61taGatewayService\x12|\n\tCreateJob\x12\x31.admobilize.datagateway.v1alpha1.CreateJobRequest\x1a$.admobilize.datagateway.v1alpha1.Job\"\x16\x82\xd3\xe4\x93\x02\x10\"\x0e/v1alpha1/jobs\x12}\n\x06GetJob\x12..admobilize.datagateway.v1alpha1.GetJobRequest\x1a$.admobilize.datagateway.v1alpha1.Job\"\x1d\x82\xd3\xe4\x93\x02\x17\x12\x15/v1alpha1/{id=jobs/*}\x12\xa5\x01\n\rGetJobResults\x12\x35.admobilize.datagateway.v1alpha1.GetJobResultRequests\x1a\x36.admobilize.datagateway.v1alpha1.GetDatapointsResponse\"%\x82\xd3\xe4\x93\x02\x1f\x12\x1d/v1alpha1/{id=jobs/*}/resultsBc\n#com.admobilize.datagateway.v1alpha1B\x10\x44\x61taGatewayProtoP\x01\xa2\x02\x05\x41\x44MDG\xaa\x02\x1f\x41\x64Mobilize.DataGateway.V1Alpha1b\x06proto3')
  ,
  dependencies=[google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_protobuf_dot_empty__pb2.DESCRIPTOR,google_dot_protobuf_dot_field__mask__pb2.DESCRIPTOR,google_dot_protobuf_dot_timestamp__pb2.DESCRIPTOR,matrix__io_dot_common_dot_entity__pb2.DESCRIPTOR,])
...
_CREATEJOBREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='product_id', full_name='admobilize.datagateway.v1alpha1.CreateJobRequest.product_id', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='device_ids', full_name='admobilize.datagateway.v1alpha1.CreateJobRequest.device_ids', index=3,
...
_GETJOBRESULTREQUESTS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='format', full_name='admobilize.datagateway.v1alpha1.GetJobResultRequests.format', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
GetJobResultRequests = _reflection.GeneratedProtocolMessageType('GetJobResultRequests', (_message.Message,), dict(
...
GetDatapointsResponse = _reflection.GeneratedProtocolMessageType('GetDatapointsResponse', (_message.Message,), dict(
...
_DATAGATEWAYSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=_JOB,
    serialized_options=_b('\202\323\344\223\002\020\"\016/v1alpha1/jobs'),
  ),
  _descriptor.MethodDescriptor(
    name='GetJob',
    ...
    output_type=_JOB,
    serialized_options=_b('\202\323\344\223\002\027\022\025/v1alpha1/{id=jobs/*}'),
  ),
  _descriptor.MethodDescriptor(
    name='GetJobResults',
    ...
    serialized_options=_b('\202\323\344\223\002\037\022\035/v1alpha1/{id=jobs/*}/results'),
  ),
])
