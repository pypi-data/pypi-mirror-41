...
class AyudaServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.CreateCredential = channel.unary_unary(
        ...
        request_serializer=admobilize_dot_ayuda_dot_v1alpha1_dot_resources__pb2.Credential.SerializeToString,
    ...
    self.CreateMapping = channel.unary_unary(
        ...
        request_serializer=admobilize_dot_ayuda_dot_v1alpha1_dot_resources__pb2.Mapping.SerializeToString,
...
def add_AyudaServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'CreateCredential': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=admobilize_dot_ayuda_dot_v1alpha1_dot_resources__pb2.Credential.FromString,
      ...
      'CreateMapping': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=admobilize_dot_ayuda_dot_v1alpha1_dot_resources__pb2.Mapping.FromString,
