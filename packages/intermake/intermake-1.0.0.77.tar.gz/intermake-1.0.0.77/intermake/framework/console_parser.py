...
def start_cli( mode: str ) -> None:
    ...
    assert mode in (EImRunMode.ARG, EImRunMode.CLI, EImRunMode.PYI)
...
def __prompt_for_input():
    ...
    try:
        ...
        # User quits
        original_stdout.write( "(Keyboard quit)\n" )
...
INTERMAKE_PROMPT: __IntermakePrompt = __IntermakePrompt()
