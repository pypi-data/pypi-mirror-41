...
def update_metadata(rootdir, version_str, timestamp_str):
    ...
    with io.open(os.path.join(rootdir, "fabber", "_version.py"), "w", encoding='utf-8') as f:
...
kwargs = {
    ...
    'description' : 'Python interface to the Fabber toolkit for Bayesian model fitting',
    'long_description' : get_filetext(module_dir, 'README.md'),
    'long_description_content_type' : 'text/markdown',
    'url' : 'https://fabber_core.readthedocs.io/',
    'author' : 'Martin Craig',
