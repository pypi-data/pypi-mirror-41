...
class TaskInfo(object):
    ...
    # TaskInfo
    def IsActorCheckpointMethod(self):
...
def TaskInfoStart(builder): builder.StartObject(18)
...
def TaskInfoAddIsActorCheckpointMethod(builder, isActorCheckpointMethod): builder.PrependBoolSlot(10, isActorCheckpointMethod, 0)
def TaskInfoAddNewActorHandles(builder, newActorHandles): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(newActorHandles), 0)
def TaskInfoAddArgs(builder, args): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(args), 0)
def TaskInfoStartArgsVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def TaskInfoAddReturns(builder, returns): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(returns), 0)
def TaskInfoAddRequiredResources(builder, requiredResources): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(requiredResources), 0)
def TaskInfoStartRequiredResourcesVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def TaskInfoAddRequiredPlacementResources(builder, requiredPlacementResources): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(requiredPlacementResources), 0)
def TaskInfoStartRequiredPlacementResourcesVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def TaskInfoAddLanguage(builder, language): builder.PrependInt32Slot(16, language, 0)
def TaskInfoAddFunctionDescriptor(builder, functionDescriptor): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(functionDescriptor), 0)
