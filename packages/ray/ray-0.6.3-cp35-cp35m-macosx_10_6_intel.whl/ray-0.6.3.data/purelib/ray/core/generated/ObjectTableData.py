...
class ObjectTableData(object):
    ...
    # ObjectTableData
    def NumEvictions(self):
        o = flatbuffers.number_types.UOffsetTFlags.py_type(self._tab.Offset(10))
        if o != 0:
            return self._tab.Get(flatbuffers.number_types.Int32Flags, o + self._tab.Pos)
        return 0

def ObjectTableDataStart(builder): builder.StartObject(4)
...
def ObjectTableDataAddNumEvictions(builder, numEvictions): builder.PrependInt32Slot(3, numEvictions, 0)
