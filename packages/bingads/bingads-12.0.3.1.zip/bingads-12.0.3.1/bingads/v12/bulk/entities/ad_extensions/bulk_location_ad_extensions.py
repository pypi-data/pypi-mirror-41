...
_LocationAdExtension = type(_CAMPAIGN_OBJECT_FACTORY_V12.create('LocationAdExtension'))
    ...
    * :class:`.BulkFileWriter`
    ...
    def set_geo_point_part(bulk_ad_extension, set_func, value):
        ...
        if bulk_ad_extension.location_ad_extension.GeoPoint is None:
            bulk_ad_extension.location_ad_extension.GeoPoint = _CAMPAIGN_OBJECT_FACTORY_V12.create('GeoPoint')
        set_func(bulk_ad_extension.location_ad_extension.GeoPoint, value)

    def process_mappings_from_row_values(self, row_values):
        self.location_ad_extension = _CAMPAIGN_OBJECT_FACTORY_V12.create('LocationAdExtension')
        ...
        if row_values[_StringTable.Latitude] or row_values[_StringTable.Longitude]:
            self.location_ad_extension.GeoPoint = _CAMPAIGN_OBJECT_FACTORY_V12.create('GeoPoint')
