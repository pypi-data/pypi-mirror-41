...
{'': ['*'],
 ...
 'abilian.sbe.apps': ['instance/data/files/2a/21/*',
                      'instance/data/files/73/02/*',
                      'instance/data/files/7b/1d/*',
                      'instance/data/files/8b/47/*',
                      'instance/data/files/8e/64/*',
                      'instance/data/files/a6/b7/*',
                      'instance/data/files/e8/df/*',
                      'instance/webassets/*',
                      'instance/webassets/compiled/*'],
