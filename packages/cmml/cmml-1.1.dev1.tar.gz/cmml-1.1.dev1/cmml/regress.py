# -*- coding: utf-8 -*-
"""
Created on Sat Feb  2 14:33:58 2019
...
if __name__ == '__main__':
    ...
    # regression4()
    #regression5()
    xArr, yArr = loadDataSet("rs.txt")
    abaloneTest(xArr, yArr)
    #crossValidation(xArr, yArr,10)
    #y=ridgeTest(xArr, yArr)
    #print (y)
    pass