...
# List recording the last verse in each chapter of each book in the bible.
# e.g last verse in Leviticus chapter 5 is last_verse_data[2][4].
last_verse_data = [
    ...
    [6,  12, 8,  8,  12, 10, 17, 9,  20, 18, 7,  8,  6,  7,  5,  11, 15, 50,
        ...
        28, 23, 10, 12, 20, 72, 13, 19, 16, 8,  18, 12, 13, 17, 7,  18, 52, 17,
...
translation_ids = {} #Bible translation IDs keyed to their abbreviation

def load_book_ids(api_key=""):
    ...
    try:
        ...
        for translation in response["data"]:
            translation_ids[translation["abbreviation"]] = translation["id"]
        print(translation_ids)
    except IOError:
        return "Error: Could not fetch passage text!"
