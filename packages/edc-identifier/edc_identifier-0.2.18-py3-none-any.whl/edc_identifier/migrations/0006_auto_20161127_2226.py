...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=edc_model_fields.fields.hostname_modification_field.HostnameModificationField(blank=True, editable=False, help_text='System field. (modified on every save)', max_length=50),
        ),
        migrations.AddField(
            model_name='historicalidentifierhistory',
            name='modified',
        ...
        migrations.AddField(
            model_name='historicalidentifierhistory',
            name='user_created',
            field=edc_model_fields.fields.userfield.UserField(blank=True, editable=False, max_length=50, verbose_name='user created'),
        ),
        migrations.AddField(
            model_name='historicalidentifierhistory',
            name='user_modified',
            field=edc_model_fields.fields.userfield.UserField(blank=True, editable=False, max_length=50, verbose_name='user modified'),
        ),
        migrations.AddField(
        ...
        migrations.AlterField(
            model_name='historicalidentifierhistory',
            name='history_id',
            field=edc_model_fields.fields.uuid_auto_field.UUIDAutoField(primary_key=True, serialize=False),
        ),
        migrations.AlterField(
            model_name='historicalidentifierhistory',
            name='id',
            field=edc_model_fields.fields.uuid_auto_field.UUIDAutoField(blank=True, db_index=True, editable=False, help_text='System auto field. UUID primary key.'),
        ),
        migrations.AlterField(
