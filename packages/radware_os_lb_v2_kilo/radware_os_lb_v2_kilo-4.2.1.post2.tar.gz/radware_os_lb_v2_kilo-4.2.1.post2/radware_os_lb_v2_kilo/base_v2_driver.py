...
driver_opts = [
    ...
    cfg.BoolOpt('configure_allowed_address_pairs',
                default=False,
                help=_('Enables or disables allowed address pairs configuration for VIP addresses. '
                       'Default: False.')),				   
...
class RadwareLBaaSBaseV2Driver(driver_base.LoadBalancerBaseDriver):
    ...
    def __init__(self, plugin, provider_name):
        ...
        cfg.CONF.register_opts(driver_opts, provider_name)
        cfg.CONF.register_opts(driver_debug_opts, provider_name + "_debug")
