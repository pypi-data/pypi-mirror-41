...
from .temporal_schemes import add_time_stepping, get_temporal_scheme
...
class Simulation(object):
    """High level container used to run simulation build on skfdiff Model.
      ...
      **kwargs
      ...
      Properties
      ----------
      post_processes: list of skfdiff.core.simulation.PostProcess
        contain all the post processing function attached to the simulation.
      container: skfdiff.Container
        give access to the attached container, if any.
      timer: skfdiff.core.simulation.Timer
      ...
      stream: streamz.Stream
        ...
        on disk by the Container and display the fields in real-time.
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.model = model
        self.fields = model.Fields(**{var: fields[var] for var in fields.variables})
        self.t = t
