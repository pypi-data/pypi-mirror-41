...
def get_kline_list(start_time='2019-01-01 00:00:00', end_time='2019-12-31 00:00:00', symbol='btc_usd', period='1hour', num=None):
...
def get_tick_kline_list(symbol, tick, period, expr=3, unit='day'):
    ...
    sub_col_row = "*,CEILING(created_date/(60*60*4*1000)-1)*60*60*4*1000 tick_date"
