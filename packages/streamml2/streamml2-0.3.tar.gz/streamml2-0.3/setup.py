...
setup(
  ...
  download_url = 'https://github.com/conradbm/streamml2/archive/v_03.tar.gz',    # I explain this later on
  keywords = ['Machine Learning', 'Model Selection', 'Transformation', "Feature Selection", "Statistics",""],   # Keywords that define your package best
