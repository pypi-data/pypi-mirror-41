...
setup(
    ...
    description='LHCb Common tools',  # Required
    ...
    url='https://gitlab.cern.ch/lhcb-core/LbCommon',  # Optional
    ...
    install_requires=["setuptools-git"],  # Optional
