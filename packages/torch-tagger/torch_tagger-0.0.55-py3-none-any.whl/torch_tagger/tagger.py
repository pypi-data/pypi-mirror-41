...
from .tagger_dataset import TaggerDataset, collate_fn
...
class Tagger(BaseEstimator):
    ...
    def fit(self,
        ...
        for epoch in range(epochs):
            ...
            ds = TaggerDataset(X, y, self.params['max_len'], self._sentence_lm,
                               self._tag_lm)
            ...
            if X_dev is not None:
                ...
                with torch.no_grad():
                    ...
                    ds = TaggerDataset(X_dev, y_dev, self.params['max_len'],
