...
class Zhixuewang(man, exam):
    ...
    def changePassword(self, oldPassword, newPassword):
        import execjs
        zxt = execjs.compile(open(os.path.join("\\".join(__file__.split("\\")[:-1]),  "RSAUTils.js")).read())
        oldPassword = zxt.call("get_data", oldPassword)
        newPassword = zxt.call("get_data", newPassword)
