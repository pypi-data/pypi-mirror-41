...
def text_password(username: str, password: str) -> (requests.sessions, str):
    ...
    data = __session.post("http://www.zhixue.com/weakPwdLogin/?from=web_login", data={
        "loginName": username,
        "password": password,
        "code": ""
    }).json()
...
class Zhixuewang(Exam, Person):
    ...
    def __login(self, username: str, password: str) -> requests.sessions:
        ...
        __session.post("http://www.zhixue.com:80/ssoservice.jsp", data={
            "action": "login",
            "username": user_id,
            "password": password,
            "ticket": st,
    ...
    def change_password(self, old_password: str, new_password: str) -> str:
        ...
        oldPassword = zxt.call("get_data", old_password)
        newPassword = zxt.call("get_data", new_password)
        r = self.__session.post("http://www.zhixue.com/portalcenter/home/updatePassword/", data={
