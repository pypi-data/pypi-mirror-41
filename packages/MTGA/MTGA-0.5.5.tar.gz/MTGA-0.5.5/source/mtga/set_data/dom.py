...
KarnScionofUrza = Card(name="karn_scion_of_urza", pretty_name="Karn, Scion of Urza", cost=['4'],
                       ...
                       abilities=[119049, 119050, 119052], set_id="DAR", rarity="Mythic Rare", collectible=True, set_number=1,
                       mtga_id=67106)
AdamantWill = Card(name="adamant_will", pretty_name="Adamant Will", cost=['1', 'W'],
                   color_identity=['W'], card_type="Instant", sub_types="",
                   abilities=[119053], set_id="DAR", rarity="Common", collectible=True, set_number=2,
                   mtga_id=67108)
AvenSentry = Card(name="aven_sentry", pretty_name="Aven Sentry", cost=['3', 'W'],
                  ...
                  abilities=[8], set_id="DAR", rarity="Common", collectible=True, set_number=3,
                  mtga_id=67110)
BairdStewardofArgive = Card(name="baird_steward_of_argive", pretty_name="Baird, Steward of Argive", cost=['2', 'W', 'W'],
                            ...
                            abilities=[15, 119054], set_id="DAR", rarity="Uncommon", collectible=True, set_number=4,
                            mtga_id=67112)
BenalishHonorGuard = Card(name="benalish_honor_guard", pretty_name="Benalish Honor Guard", cost=['1', 'W'],
                          ...
                          abilities=[119055], set_id="DAR", rarity="Common", collectible=True, set_number=5,
                          mtga_id=67114)
BenalishMarshal = Card(name="benalish_marshal", pretty_name="Benalish Marshal", cost=['W', 'W', 'W'],
                       color_identity=['W'], card_type="Creature", sub_types="Human Knight",
                       abilities=[2433], set_id="DAR", rarity="Rare", collectible=True, set_number=6,
                       mtga_id=67116)
BlessedLight = Card(name="blessed_light", pretty_name="Blessed Light", cost=['4', 'W'],
                    color_identity=['W'], card_type="Instant", sub_types="",
                    abilities=[6495], set_id="DAR", rarity="Common", collectible=True, set_number=7,
                    mtga_id=67118)
BoardtheWeatherlight = Card(name="board_the_weatherlight", pretty_name="Board the Weatherlight", cost=['1', 'W'],
                            ...
                            abilities=[119045], set_id="DAR", rarity="Uncommon", collectible=True, set_number=8,
                            mtga_id=67120)
CalltheCavalry = Card(name="call_the_cavalry", pretty_name="Call the Cavalry", cost=['3', 'W'],
                      color_identity=['W'], card_type="Sorcery", sub_types="",
                      abilities=[19691], set_id="DAR", rarity="Common", collectible=True, set_number=9,
                      mtga_id=67122)
Charge = Card(name="charge", pretty_name="Charge", cost=['W'],
              color_identity=['W'], card_type="Instant", sub_types="",
              abilities=[25230], set_id="DAR", rarity="Common", collectible=True, set_number=10,
              mtga_id=67124)
DAvenantTrapper = Card(name="davenant_trapper", pretty_name="D'Avenant Trapper", cost=['2', 'W'],
                       ...
                       abilities=[119057], set_id="DAR", rarity="Common", collectible=True, set_number=11,
                       mtga_id=67126)
DanithaCapashenParagon = Card(name="danitha_capashen_paragon", pretty_name="Danitha Capashen, Paragon", cost=['2', 'W'],
                              color_identity=['W'], card_type="Creature", sub_types="Human Knight",
                              abilities=[6, 15, 12, 119058], set_id="DAR", rarity="Uncommon", collectible=True, set_number=12,
                              mtga_id=67128)
DaringArchaeologist = Card(name="daring_archaeologist", pretty_name="Daring Archaeologist", cost=['3', 'W'],
                           ...
                           abilities=[88235, 119059], set_id="DAR", rarity="Rare", collectible=True, set_number=13,
                           mtga_id=67130)
DauntlessBodyguard = Card(name="dauntless_bodyguard", pretty_name="Dauntless Bodyguard", cost=['W'],
                          color_identity=['W'], card_type="Creature", sub_types="Human Knight",
                          abilities=[119060, 119061], set_id="DAR", rarity="Uncommon", collectible=True, set_number=14,
                          mtga_id=67132)
Dub = Card(name="dub", pretty_name="Dub", cost=['2', 'W'],
           color_identity=['W'], card_type="Enchantment", sub_types="Aura",
           abilities=[1027, 118954], set_id="DAR", rarity="Common", collectible=True, set_number=15,
           mtga_id=67134)
EvraHalcyonWitness = Card(name="evra_halcyon_witness", pretty_name="Evra, Halcyon Witness", cost=['4', 'W', 'W'],
                          ...
                          abilities=[12, 118815], set_id="DAR", rarity="Rare", collectible=True, set_number=16,
                          mtga_id=67136)
ExcavationElephant = Card(name="excavation_elephant", pretty_name="Excavation Elephant", cost=['4', 'W'],
                          ...
                          abilities=[9313, 118837], set_id="DAR", rarity="Common", collectible=True, set_number=17,
                          mtga_id=67138)
FalloftheThran = Card(name="fall_of_the_thran", pretty_name="Fall of the Thran", cost=['5', 'W'],
                      ...
                      abilities=[118852, 103194, 119075], set_id="DAR", rarity="Rare", collectible=True, set_number=18,
                      mtga_id=67140)
GideonsReproach = Card(name="gideons_reproach", pretty_name="Gideon's Reproach", cost=['1', 'W'],
                       color_identity=['W'], card_type="Instant", sub_types="",
                       abilities=[100370], set_id="DAR", rarity="Common", collectible=True, set_number=19,
                       mtga_id=67142)
HealingGrace = Card(name="healing_grace", pretty_name="Healing Grace", cost=['W'],
                    color_identity=['W'], card_type="Instant", sub_types="",
                    abilities=[118914], set_id="DAR", rarity="Common", collectible=True, set_number=20,
                    mtga_id=67144)
HistoryofBenalia = Card(name="history_of_benalia", pretty_name="History of Benalia", cost=['1', 'W', 'W'],
                        color_identity=['W'], card_type="Enchantment", sub_types="Saga",
                        abilities=[119071, 26820, 118952], set_id="DAR", rarity="Mythic Rare", collectible=True, set_number=21,
                        mtga_id=67146)
InvoketheDivine = Card(name="invoke_the_divine", pretty_name="Invoke the Divine", cost=['2', 'W'],
                       color_identity=['W'], card_type="Instant", sub_types="",
                       abilities=[2813], set_id="DAR", rarity="Common", collectible=True, set_number=22,
                       mtga_id=67148)
KnightofGrace = Card(name="knight_of_grace", pretty_name="Knight of Grace", cost=['1', 'W'],
                     color_identity=['W'], card_type="Creature", sub_types="Human Knight",
                     abilities=[6, 118964, 118970], set_id="DAR", rarity="Uncommon", collectible=True, set_number=23,
                     mtga_id=67150)
KnightofNewBenalia = Card(name="knight_of_new_benalia", pretty_name="Knight of New Benalia", cost=['1', 'W'],
                          color_identity=['W'], card_type="Creature", sub_types="Human Knight",
                          abilities=[], set_id="DAR", rarity="Common", collectible=True, set_number=24,
                          mtga_id=67152)
KwendePrideofFemeref = Card(name="kwende_pride_of_femeref", pretty_name="Kwende, Pride of Femeref", cost=['3', 'W'],
                            color_identity=['W'], card_type="Creature", sub_types="Human Knight",
                            abilities=[3, 1038], set_id="DAR", rarity="Uncommon", collectible=True, set_number=25,
                            mtga_id=67154)
LyraDawnbringer = Card(name="lyra_dawnbringer", pretty_name="Lyra Dawnbringer", cost=['3', 'W', 'W'],
                       ...
                       abilities=[8, 6, 12, 118983], set_id="DAR", rarity="Mythic Rare", collectible=True, set_number=26,
                       mtga_id=67156)
MesaUnicorn = Card(name="mesa_unicorn", pretty_name="Mesa Unicorn", cost=['1', 'W'],
                   ...
                   abilities=[12], set_id="DAR", rarity="Common", collectible=True, set_number=27,
                   mtga_id=67158)
OnSerrasWings = Card(name="on_serras_wings", pretty_name="On Serra's Wings", cost=['3', 'W'],
                     color_identity=['W'], card_type="Enchantment", sub_types="Aura",
                     abilities=[1027, 118991], set_id="DAR", rarity="Uncommon", collectible=True, set_number=28,
                     mtga_id=67160)
PegasusCourser = Card(name="pegasus_courser", pretty_name="Pegasus Courser", cost=['2', 'W'],
                      ...
                      abilities=[8, 103816], set_id="DAR", rarity="Common", collectible=True, set_number=29,
                      mtga_id=67162)
SanctumSpirit = Card(name="sanctum_spirit", pretty_name="Sanctum Spirit", cost=['3', 'W'],
                     ...
                     abilities=[12, 118814], set_id="DAR", rarity="Uncommon", collectible=True, set_number=30,
                     mtga_id=67164)
SealAway = Card(name="seal_away", pretty_name="Seal Away", cost=['1', 'W'],
                color_identity=['W'], card_type="Enchantment", sub_types="",
                abilities=[7, 118824], set_id="DAR", rarity="Uncommon", collectible=True, set_number=31,
                mtga_id=67166)
SergeantatArms = Card(name="sergeantatarms", pretty_name="Sergeant-at-Arms", cost=['2', 'W'],
                      color_identity=['W'], card_type="Creature", sub_types="Human Soldier",
                      abilities=[2478, 119011], set_id="DAR", rarity="Common", collectible=True, set_number=32,
                      mtga_id=67168)
SerraAngel = Card(name="serra_angel", pretty_name="Serra Angel", cost=['3', 'W', 'W'],
                  color_identity=['W'], card_type="Creature", sub_types="Angel",
                  abilities=[8, 15], set_id="DAR", rarity="Uncommon", collectible=True, set_number=33,
                  mtga_id=67170)
SerraDisciple = Card(name="serra_disciple", pretty_name="Serra Disciple", cost=['1', 'W'],
                     ...
                     abilities=[8, 6, 118831], set_id="DAR", rarity="Common", collectible=True, set_number=34,
                     mtga_id=67172)
...
AcademyDrake = Card(name="academy_drake", pretty_name="Academy Drake", cost=['2', 'U'],
                    ...
                    abilities=[2852, 8, 96521], set_id="DAR", rarity="Common", collectible=True, set_number=40,
                    mtga_id=67184)
AcademyJourneymage = Card(name="academy_journeymage", pretty_name="Academy Journeymage", cost=['4', 'U'],
                          ...
                          abilities=[118857, 96307], set_id="DAR", rarity="Common", collectible=True, set_number=41,
                          mtga_id=67186)
TheAntiquitiesWar = Card(name="the_antiquities_war", pretty_name="The Antiquities War", cost=['3', 'U'],
                         ...
                         abilities=[119269, 119272, 118868], set_id="DAR", rarity="Rare", collectible=True, set_number=42,
                         mtga_id=67188)
ArcaneFlight = Card(name="arcane_flight", pretty_name="Arcane Flight", cost=['U'],
                    ...
                    abilities=[1027, 6270], set_id="DAR", rarity="Common", collectible=True, set_number=43,
                    mtga_id=67190)
ArtificersAssistant = Card(name="artificers_assistant", pretty_name="Artificer's Assistant", cost=['U'],
                           ...
                           abilities=[8, 118876], set_id="DAR", rarity="Common", collectible=True, set_number=44,
                           mtga_id=67192)
Befuddle = Card(name="befuddle", pretty_name="Befuddle", cost=['2', 'U'],
                color_identity=['U'], card_type="Instant", sub_types="",
                abilities=[63602, 25848], set_id="DAR", rarity="Common", collectible=True, set_number=45,
                mtga_id=67194)
BlinkofanEye = Card(name="blink_of_an_eye", pretty_name="Blink of an Eye", cost=['1', 'U'],
                    color_identity=['U'], card_type="Instant", sub_types="",
                    abilities=[2739, 99193], set_id="DAR", rarity="Common", collectible=True, set_number=46,
                    mtga_id=67196)
CloudreaderSphinx = Card(name="cloudreader_sphinx", pretty_name="Cloudreader Sphinx", cost=['4', 'U'],
                         ...
                         abilities=[8, 100685], set_id="DAR", rarity="Common", collectible=True, set_number=47,
                         mtga_id=67198)
ColdWaterSnapper = Card(name="coldwater_snapper", pretty_name="Cold-Water Snapper", cost=['5', 'U'],
                        ...
                        abilities=[10], set_id="DAR", rarity="Common", collectible=True, set_number=48,
                        mtga_id=67200)
CuratorsWard = Card(name="curators_ward", pretty_name="Curator's Ward", cost=['2', 'U'],
                    color_identity=['U'], card_type="Enchantment", sub_types="Aura",
                    abilities=[1420, 118905, 118910], set_id="DAR", rarity="Uncommon", collectible=True, set_number=49,
                    mtga_id=67202)
DeepFreeze = Card(name="deep_freeze", pretty_name="Deep Freeze", cost=['2', 'U'],
                  color_identity=['U'], card_type="Enchantment", sub_types="Aura",
                  abilities=[1027, 118913], set_id="DAR", rarity="Common", collectible=True, set_number=50,
                  mtga_id=67204)
DiligentExcavator = Card(name="diligent_excavator", pretty_name="Diligent Excavator", cost=['1', 'U'],
                         ...
                         abilities=[118917], set_id="DAR", rarity="Uncommon", collectible=True, set_number=51,
                         mtga_id=67206)
Divination = Card(name="divination", pretty_name="Divination", cost=['2', 'U'],
                  color_identity=['U'], card_type="Sorcery", sub_types="",
                  abilities=[23607], set_id="DAR", rarity="Common", collectible=True, set_number=52,
                  mtga_id=67208)
HomaridExplorer = Card(name="homarid_explorer", pretty_name="Homarid Explorer", cost=['3', 'U'],
                       ...
                       abilities=[100740], set_id="DAR", rarity="Common", collectible=True, set_number=53,
                       mtga_id=67210)
InBolassClutches = Card(name="in_bolass_clutches", pretty_name="In Bolas's Clutches", cost=['4', 'U', 'U'],
                        color_identity=['U'], card_type="Enchantment", sub_types="Aura",
                        abilities=[1420, 1421, 118930], set_id="DAR", rarity="Uncommon", collectible=True, set_number=54,
                        mtga_id=67212)
KarnsTemporalSundering = Card(name="karns_temporal_sundering", pretty_name="Karn's Temporal Sundering", cost=['4', 'U', 'U'],
                              color_identity=['U'], card_type="Sorcery", sub_types="",
                              abilities=[118934], set_id="DAR", rarity="Rare", collectible=True, set_number=55,
                              mtga_id=67214)
MerfolkTrickster = Card(name="merfolk_trickster", pretty_name="Merfolk Trickster", cost=['U', 'U'],
                        ...
                        abilities=[7, 118938], set_id="DAR", rarity="Uncommon", collectible=True, set_number=56,
                        mtga_id=67216)
TheMirariConjecture = Card(name="the_mirari_conjecture", pretty_name="The Mirari Conjecture", cost=['4', 'U'],
                           color_identity=['U'], card_type="Enchantment", sub_types="Saga",
                           abilities=[118939, 118945, 118951], set_id="DAR", rarity="Rare", collectible=True, set_number=57,
                           mtga_id=67218)
NabanDeanofIteration = Card(name="naban_dean_of_iteration", pretty_name="Naban, Dean of Iteration", cost=['1', 'U'],
                            color_identity=['U'], card_type="Creature", sub_types="Human Wizard",
                            abilities=[118955], set_id="DAR", rarity="Rare", collectible=True, set_number=58,
                            mtga_id=67220)
NaruMehaMasterWizard = Card(name="naru_meha_master_wizard", pretty_name="Naru Meha, Master Wizard", cost=['2', 'U', 'U'],
                            color_identity=['U'], card_type="Creature", sub_types="Human Wizard",
                            abilities=[7, 118956, 118958], set_id="DAR", rarity="Mythic Rare", collectible=True, set_number=59,
                            mtga_id=67222)
Opt = Card(name="opt", pretty_name="Opt", cost=['U'],
           color_identity=['U'], card_type="Instant", sub_types="",
           abilities=[66937, 25848], set_id="DAR", rarity="Common", collectible=True, set_number=60,
           mtga_id=67224)
PrecognitionField = Card(name="precognition_field", pretty_name="Precognition Field", cost=['3', 'U'],
                         ...
                         abilities=[14523, 20123, 118960], set_id="DAR", rarity="Rare", collectible=True, set_number=61,
                         mtga_id=67226)
RelicRunner = Card(name="relic_runner", pretty_name="Relic Runner", cost=['1', 'U'],
                   ...
                   abilities=[118962], set_id="DAR", rarity="Common", collectible=True, set_number=62,
                   mtga_id=67228)
Rescue = Card(name="rescue", pretty_name="Rescue", cost=['U'],
              color_identity=['U'], card_type="Instant", sub_types="",
              abilities=[98407], set_id="DAR", rarity="Common", collectible=True, set_number=63,
              mtga_id=67230)
SageofLatNam = Card(name="sage_of_latnam", pretty_name="Sage of Lat-Nam", cost=['1', 'U'],
                    color_identity=['U'], card_type="Creature", sub_types="Human Artificer",
                    abilities=[1716], set_id="DAR", rarity="Uncommon", collectible=True, set_number=64,
                    mtga_id=67232)
SentinelofthePearlTrident = Card(name="sentinel_of_the_pearl_trident", pretty_name="Sentinel of the Pearl Trident", cost=['4', 'U'],
                                 ...
                                 abilities=[7, 118965], set_id="DAR", rarity="Uncommon", collectible=True, set_number=65,
                                 mtga_id=67234)
SlinnVodatheRisingDeep = Card(name="slinn_voda_the_rising_deep", pretty_name="Slinn Voda, the Rising Deep", cost=['6', 'U', 'U'],
                              ...
                              abilities=[2739, 118966], set_id="DAR", rarity="Uncommon", collectible=True, set_number=66,
                              mtga_id=67236)
Syncopate = Card(name="syncopate", pretty_name="Syncopate", cost=['X', 'U'],
                 color_identity=['U'], card_type="Instant", sub_types="",
                 abilities=[95637], set_id="DAR", rarity="Common", collectible=True, set_number=67,
                 mtga_id=67238)
TempestDjinn = Card(name="tempest_djinn", pretty_name="Tempest Djinn", cost=['U', 'U', 'U'],
                    ...
                    abilities=[8, 118967], set_id="DAR", rarity="Rare", collectible=True, set_number=68,
                    mtga_id=67240)
TetsukoUmezawaFugitive = Card(name="tetsuko_umezawa_fugitive", pretty_name="Tetsuko Umezawa, Fugitive", cost=['1', 'U'],
                              color_identity=['U'], card_type="Creature", sub_types="Human Rogue",
                              abilities=[118969], set_id="DAR", rarity="Uncommon", collectible=True, set_number=69,
                              mtga_id=67242)
TimeofIce = Card(name="time_of_ice", pretty_name="Time of Ice", cost=['3', 'U'],
                 color_identity=['U'], card_type="Enchantment", sub_types="Saga",
                 abilities=[119074, 21742, 118973], set_id="DAR", rarity="Uncommon", collectible=True, set_number=70,
                 mtga_id=67244)
TolarianScholar = Card(name="tolarian_scholar", pretty_name="Tolarian Scholar", cost=['2', 'U'],
                       color_identity=['U'], card_type="Creature", sub_types="Human Wizard",
                       abilities=[], set_id="DAR", rarity="Common", collectible=True, set_number=71,
                       mtga_id=67246)
Unwind = Card(name="unwind", pretty_name="Unwind", cost=['2', 'U'],
              color_identity=['U'], card_type="Instant", sub_types="",
              abilities=[118974], set_id="DAR", rarity="Common", collectible=True, set_number=72,
              mtga_id=67248)
VodalianArcanist = Card(name="vodalian_arcanist", pretty_name="Vodalian Arcanist", cost=['1', 'U'],
                        color_identity=['U'], card_type="Creature", sub_types="Merfolk Wizard",
                        abilities=[75763], set_id="DAR", rarity="Common", collectible=True, set_number=73,
                        mtga_id=67250)
WeightofMemory = Card(name="weight_of_memory", pretty_name="Weight of Memory", cost=['3', 'U', 'U'],
                      color_identity=['U'], card_type="Sorcery", sub_types="",
                      abilities=[20379], set_id="DAR", rarity="Uncommon", collectible=True, set_number=74,
                      mtga_id=67252)
WizardsRetort = Card(name="wizards_retort", pretty_name="Wizard's Retort", cost=['1', 'U', 'U'],
                     color_identity=['U'], card_type="Instant", sub_types="",
                     abilities=[118857, 25846], set_id="DAR", rarity="Uncommon", collectible=True, set_number=75,
                     mtga_id=67254)
ZahidDjinnoftheLamp = Card(name="zahid_djinn_of_the_lamp", pretty_name="Zahid, Djinn of the Lamp", cost=['4', 'U', 'U'],
                           color_identity=['U'], card_type="Creature", sub_types="Djinn",
                           abilities=[118980, 8], set_id="DAR", rarity="Rare", collectible=True, set_number=76,
                           mtga_id=67256)
BlessingofBelzenlok = Card(name="blessing_of_belzenlok", pretty_name="Blessing of Belzenlok", cost=['B'],
                           ...
                           abilities=[118981], set_id="DAR", rarity="Common", collectible=True, set_number=77,
                           mtga_id=67258)
CabalEvangel = Card(name="cabal_evangel", pretty_name="Cabal Evangel", cost=['1', 'B'],
                    ...
                    abilities=[], set_id="DAR", rarity="Common", collectible=True, set_number=78,
                    mtga_id=67260)
CabalPaladin = Card(name="cabal_paladin", pretty_name="Cabal Paladin", cost=['3', 'B'],
                    ...
                    abilities=[118982], set_id="DAR", rarity="Common", collectible=True, set_number=79,
                    mtga_id=67262)
CaligoSkinWitch = Card(name="caligo_skinwitch", pretty_name="Caligo Skin-Witch", cost=['1', 'B'],
                       ...
                       abilities=[10662, 118985], set_id="DAR", rarity="Common", collectible=True, set_number=80,
                       mtga_id=67264)
CastDown = Card(name="cast_down", pretty_name="Cast Down", cost=['1', 'B'],
                color_identity=['B'], card_type="Instant", sub_types="",
                abilities=[118987], set_id="DAR", rarity="Uncommon", collectible=True, set_number=81,
                mtga_id=67266)
ChainersTorment = Card(name="chainers_torment", pretty_name="Chainer's Torment", cost=['3', 'B'],
                       ...
                       abilities=[119079, 119080, 118989], set_id="DAR", rarity="Uncommon", collectible=True, set_number=82,
                       mtga_id=67268)
DarkBargain = Card(name="dark_bargain", pretty_name="Dark Bargain", cost=['3', 'B'],
                   color_identity=['B'], card_type="Instant", sub_types="",
                   abilities=[118990], set_id="DAR", rarity="Common", collectible=True, set_number=83,
                   mtga_id=67270)
DeathbloomThallid = Card(name="deathbloom_thallid", pretty_name="Deathbloom Thallid", cost=['2', 'B'],
                         ...
                         abilities=[90362], set_id="DAR", rarity="Common", collectible=True, set_number=84,
                         mtga_id=67272)
DemonicVigor = Card(name="demonic_vigor", pretty_name="Demonic Vigor", cost=['B'],
                    ...
                    abilities=[1027, 3974, 89217], set_id="DAR", rarity="Common", collectible=True, set_number=85,
                    mtga_id=67274)
DemonlordBelzenlok = Card(name="demonlord_belzenlok", pretty_name="Demonlord Belzenlok", cost=['4', 'B', 'B'],
                          ...
                          abilities=[8, 14, 118994], set_id="DAR", rarity="Mythic Rare", collectible=True, set_number=86,
                          mtga_id=67276)
Divest = Card(name="divest", pretty_name="Divest", cost=['B'],
              color_identity=['B'], card_type="Sorcery", sub_types="",
              abilities=[118995], set_id="DAR", rarity="Common", collectible=True, set_number=87,
              mtga_id=67278)
DreadShade = Card(name="dread_shade", pretty_name="Dread Shade", cost=['B', 'B', 'B'],
                  color_identity=['B'], card_type="Creature", sub_types="Shade",
                  abilities=[1162], set_id="DAR", rarity="Rare", collectible=True, set_number=88,
                  mtga_id=67280)
DrudgeSentinel = Card(name="drudge_sentinel", pretty_name="Drudge Sentinel", cost=['2', 'B'],
                      ...
                      abilities=[118996], set_id="DAR", rarity="Common", collectible=True, set_number=89,
                      mtga_id=67282)
TheEldestReborn = Card(name="the_eldest_reborn", pretty_name="The Eldest Reborn", cost=['4', 'B'],
                       color_identity=['B'], card_type="Enchantment", sub_types="Saga",
                       abilities=[118998, 119000, 119001], set_id="DAR", rarity="Uncommon", collectible=True, set_number=90,
                       mtga_id=67284)
Eviscerate = Card(name="eviscerate", pretty_name="Eviscerate", cost=['3', 'B'],
                  color_identity=['B'], card_type="Sorcery", sub_types="",
                  abilities=[26818], set_id="DAR", rarity="Common", collectible=True, set_number=91,
                  mtga_id=67286)
FeralAbomination = Card(name="feral_abomination", pretty_name="Feral Abomination", cost=['5', 'B'],
                        ...
                        abilities=[1], set_id="DAR", rarity="Common", collectible=True, set_number=92,
                        mtga_id=67288)
FinalParting = Card(name="final_parting", pretty_name="Final Parting", cost=['3', 'B', 'B'],
                    color_identity=['B'], card_type="Sorcery", sub_types="",
                    abilities=[119002], set_id="DAR", rarity="Uncommon", collectible=True, set_number=93,
                    mtga_id=67290)
FungalInfection = Card(name="fungal_infection", pretty_name="Fungal Infection", cost=['B'],
                       color_identity=['B'], card_type="Instant", sub_types="",
                       abilities=[119003], set_id="DAR", rarity="Common", collectible=True, set_number=94,
                       mtga_id=67292)
JosuVessLichKnight = Card(name="josu_vess_lich_knight", pretty_name="Josu Vess, Lich Knight", cost=['2', 'B', 'B'],
                          ...
                          abilities=[119004, 142, 119005], set_id="DAR", rarity="Rare", collectible=True, set_number=95,
                          mtga_id=67294)
KazarovSengirPureblood = Card(name="kazarov_sengir_pureblood", pretty_name="Kazarov, Sengir Pureblood", cost=['5', 'B', 'B'],
                              ...
                              abilities=[8, 119006, 119007], set_id="DAR", rarity="Rare", collectible=True, set_number=96,
                              mtga_id=67296)
KnightofMalice = Card(name="knight_of_malice", pretty_name="Knight of Malice", cost=['1', 'B'],
                      color_identity=['B'], card_type="Creature", sub_types="Human Knight",
                      abilities=[6, 119008, 119009], set_id="DAR", rarity="Uncommon", collectible=True, set_number=97,
                      mtga_id=67298)
LichsMastery = Card(name="lichs_mastery", pretty_name="Lich's Mastery", cost=['3', 'B', 'B', 'B'],
                    ...
                    abilities=[10, 118816, 118817, 118818, 16132], set_id="DAR", rarity="Rare", collectible=True, set_number=98,
                    mtga_id=67300)
LingeringPhantom = Card(name="lingering_phantom", pretty_name="Lingering Phantom", cost=['5', 'B'],
                        ...
                        abilities=[118819], set_id="DAR", rarity="Uncommon", collectible=True, set_number=99,
                        mtga_id=67302)
PhyrexianScriptures = Card(name="phyrexian_scriptures", pretty_name="Phyrexian Scriptures", cost=['2', 'B', 'B'],
                           color_identity=['B'], card_type="Enchantment", sub_types="Saga",
                           abilities=[118820, 118821, 118822], set_id="DAR", rarity="Mythic Rare", collectible=True, set_number=100,
                           mtga_id=67304)
RatColony = Card(name="rat_colony", pretty_name="Rat Colony", cost=['1', 'B'],
                 color_identity=['B'], card_type="Creature", sub_types="Rat",
                 abilities=[118823, 88192], set_id="DAR", rarity="Common", collectible=True, set_number=101,
                 mtga_id=67306)
RiteofBelzenlok = Card(name="rite_of_belzenlok", pretty_name="Rite of Belzenlok", cost=['2', 'B', 'B'],
                       color_identity=['B'], card_type="Enchantment", sub_types="Saga",
                       abilities=[119276, 119277, 118827], set_id="DAR", rarity="Rare", collectible=True, set_number=102,
                       mtga_id=67308)
SettletheScore = Card(name="settle_the_score", pretty_name="Settle the Score", cost=['2', 'B', 'B'],
                      color_identity=['B'], card_type="Sorcery", sub_types="",
                      abilities=[118828], set_id="DAR", rarity="Uncommon", collectible=True, set_number=103,
                      mtga_id=67310)
SoulSalvage = Card(name="soul_salvage", pretty_name="Soul Salvage", cost=['2', 'B'],
                   color_identity=['B'], card_type="Sorcery", sub_types="",
                   abilities=[1923], set_id="DAR", rarity="Common", collectible=True, set_number=104,
                   mtga_id=67312)
StrongholdConfessor = Card(name="stronghold_confessor", pretty_name="Stronghold Confessor", cost=['B'],
                           color_identity=['B'], card_type="Creature", sub_types="Human Cleric",
                           abilities=[2817, 142, 96521], set_id="DAR", rarity="Common", collectible=True, set_number=105,
                           mtga_id=67314)
ThallidOmnivore = Card(name="thallid_omnivore", pretty_name="Thallid Omnivore", cost=['3', 'B'],
                       color_identity=['B'], card_type="Creature", sub_types="Fungus",
                       abilities=[119014], set_id="DAR", rarity="Common", collectible=True, set_number=106,
                       mtga_id=67316)
ThallidSoothsayer = Card(name="thallid_soothsayer", pretty_name="Thallid Soothsayer", cost=['3', 'B'],
                         color_identity=['B'], card_type="Creature", sub_types="Fungus",
                         abilities=[119015], set_id="DAR", rarity="Uncommon", collectible=True, set_number=107,
                         mtga_id=67318)
TorgaarFamineIncarnate = Card(name="torgaar_famine_incarnate", pretty_name="Torgaar, Famine Incarnate", cost=['6', 'B', 'B'],
                              ...
                              abilities=[119016, 119018], set_id="DAR", rarity="Rare", collectible=True, set_number=108,
                              mtga_id=67320)
UrgorostheEmptyOne = Card(name="urgoros_the_empty_one", pretty_name="Urgoros, the Empty One", cost=['4', 'B', 'B'],
                          ...
                          abilities=[8, 119019], set_id="DAR", rarity="Uncommon", collectible=True, set_number=109,
                          mtga_id=67322)
ViciousOffering = Card(name="vicious_offering", pretty_name="Vicious Offering", cost=['1', 'B'],
                       color_identity=['B'], card_type="Instant", sub_types="",
                       abilities=[96532, 119021], set_id="DAR", rarity="Common", collectible=True, set_number=110,
                       mtga_id=67324)
WhisperBloodLiturgist = Card(name="whisper_blood_liturgist", pretty_name="Whisper, Blood Liturgist", cost=['3', 'B'],
                             color_identity=['B'], card_type="Creature", sub_types="Human Cleric",
                             abilities=[119022], set_id="DAR", rarity="Uncommon", collectible=True, set_number=111,
                             mtga_id=67326)
WindgraceAcolyte = Card(name="windgrace_acolyte", pretty_name="Windgrace Acolyte", cost=['4', 'B'],
                        ...
                        abilities=[8, 119023], set_id="DAR", rarity="Common", collectible=True, set_number=112,
                        mtga_id=67328)
YargleGluttonofUrborg = Card(name="yargle_glutton_of_urborg", pretty_name="Yargle, Glutton of Urborg", cost=['4', 'B'],
                             ...
                             abilities=[], set_id="DAR", rarity="Uncommon", collectible=True, set_number=113,
                             mtga_id=67330)
YawgmothsVileOffering = Card(name="yawgmoths_vile_offering", pretty_name="Yawgmoth's Vile Offering", cost=['4', 'B'],
                             color_identity=['B'], card_type="Sorcery", sub_types="",
                             abilities=[118829], set_id="DAR", rarity="Rare", collectible=True, set_number=114,
                             mtga_id=67332)
BloodstoneGoblin = Card(name="bloodstone_goblin", pretty_name="Bloodstone Goblin", cost=['1', 'R'],
                        ...
                        abilities=[118830], set_id="DAR", rarity="Common", collectible=True, set_number=115,
                        mtga_id=67334)
ChampionoftheFlame = Card(name="champion_of_the_flame", pretty_name="Champion of the Flame", cost=['1', 'R'],
                          ...
                          abilities=[14, 119025], set_id="DAR", rarity="Uncommon", collectible=True, set_number=116,
                          mtga_id=67336)
FerventStrike = Card(name="fervent_strike", pretty_name="Fervent Strike", cost=['R'],
                     color_identity=['R'], card_type="Instant", sub_types="",
                     abilities=[119026], set_id="DAR", rarity="Common", collectible=True, set_number=117,
                     mtga_id=67338)
FieryIntervention = Card(name="fiery_intervention", pretty_name="Fiery Intervention", cost=['4', 'R'],
                         ...
                         abilities=[119027], set_id="DAR", rarity="Common", collectible=True, set_number=118,
                         mtga_id=67340)
FightwithFire = Card(name="fight_with_fire", pretty_name="Fight with Fire", cost=['2', 'R'],
                     color_identity=['R'], card_type="Sorcery", sub_types="",
                     abilities=[118832, 119028], set_id="DAR", rarity="Uncommon", collectible=True, set_number=119,
                     mtga_id=67342)
FireElemental = Card(name="fire_elemental", pretty_name="Fire Elemental", cost=['3', 'R', 'R'],
                     ...
                     abilities=[], set_id="DAR", rarity="Common", collectible=True, set_number=120,
                     mtga_id=67344)
FirefistAdept = Card(name="firefist_adept", pretty_name="Firefist Adept", cost=['4', 'R'],
                     ...
                     abilities=[118834], set_id="DAR", rarity="Uncommon", collectible=True, set_number=121,
                     mtga_id=67346)
TheFirstEruption = Card(name="the_first_eruption", pretty_name="The First Eruption", cost=['2', 'R'],
                        ...
                        abilities=[118835, 119029, 119031], set_id="DAR", rarity="Rare", collectible=True, set_number=122,
                        mtga_id=67348)
TheFlameofKeld = Card(name="the_flame_of_keld", pretty_name="The Flame of Keld", cost=['1', 'R'],
                      color_identity=['R'], card_type="Enchantment", sub_types="Saga",
                      abilities=[119032, 119033, 118836], set_id="DAR", rarity="Uncommon", collectible=True, set_number=123,
                      mtga_id=67350)
FrenziedRage = Card(name="frenzied_rage", pretty_name="Frenzied Rage", cost=['1', 'R'],
                    ...
                    abilities=[1027, 62540], set_id="DAR", rarity="Common", collectible=True, set_number=124,
                    mtga_id=67352)
GhituChronicler = Card(name="ghitu_chronicler", pretty_name="Ghitu Chronicler", cost=['1', 'R'],
                       color_identity=['R'], card_type="Creature", sub_types="Human Wizard",
                       abilities=[14490, 119035], set_id="DAR", rarity="Common", collectible=True, set_number=125,
                       mtga_id=67354)
GhituJourneymage = Card(name="ghitu_journeymage", pretty_name="Ghitu Journeymage", cost=['2', 'R'],
                        color_identity=['R'], card_type="Creature", sub_types="Human Wizard",
                        abilities=[118975], set_id="DAR", rarity="Common", collectible=True, set_number=126,
                        mtga_id=67356)
GhituLavarunner = Card(name="ghitu_lavarunner", pretty_name="Ghitu Lavarunner", cost=['R'],
                       color_identity=['R'], card_type="Creature", sub_types="Human Wizard",
                       abilities=[119036], set_id="DAR", rarity="Common", collectible=True, set_number=127,
                       mtga_id=67358)
GoblinBarrage = Card(name="goblin_barrage", pretty_name="Goblin Barrage", cost=['3', 'R'],
                     color_identity=['R'], card_type="Sorcery", sub_types="",
                     abilities=[119037, 119038], set_id="DAR", rarity="Uncommon", collectible=True, set_number=128,
                     mtga_id=67360)
GoblinChainwhirler = Card(name="goblin_chainwhirler", pretty_name="Goblin Chainwhirler", cost=['R', 'R', 'R'],
                          color_identity=['R'], card_type="Creature", sub_types="Goblin Warrior",
                          abilities=[6, 119039], set_id="DAR", rarity="Rare", collectible=True, set_number=129,
                          mtga_id=67362)
GoblinWarchief = Card(name="goblin_warchief", pretty_name="Goblin Warchief", cost=['1', 'R', 'R'],
                      color_identity=['R'], card_type="Creature", sub_types="Goblin Warrior",
                      abilities=[2045, 2046], set_id="DAR", rarity="Uncommon", collectible=True, set_number=130,
                      mtga_id=67364)
HaphazardBombardment = Card(name="haphazard_bombardment", pretty_name="Haphazard Bombardment", cost=['5', 'R'],
                            ...
                            abilities=[119040, 119041], set_id="DAR", rarity="Rare", collectible=True, set_number=131,
                            mtga_id=67366)
JayaBallard = Card(name="jaya_ballard", pretty_name="Jaya Ballard", cost=['2', 'R', 'R', 'R'],
                   ...
                   abilities=[119042, 119043, 119046], set_id="DAR", rarity="Mythic Rare", collectible=True, set_number=132,
                   mtga_id=67368)
JayasImmolatingInferno = Card(name="jayas_immolating_inferno", pretty_name="Jaya's Immolating Inferno", cost=['X', 'R', 'R'],
                              color_identity=['R'], card_type="Sorcery", sub_types="",
                              abilities=[119047], set_id="DAR", rarity="Rare", collectible=True, set_number=133,
                              mtga_id=67370)
KeldonOverseer = Card(name="keldon_overseer", pretty_name="Keldon Overseer", cost=['2', 'R'],
                      color_identity=['R'], card_type="Creature", sub_types="Human Warrior",
                      abilities=[14490, 9, 119048], set_id="DAR", rarity="Common", collectible=True, set_number=134,
                      mtga_id=67372)
KeldonRaider = Card(name="keldon_raider", pretty_name="Keldon Raider", cost=['2', 'R', 'R'],
                    color_identity=['R'], card_type="Creature", sub_types="Human Warrior",
                    abilities=[100041], set_id="DAR", rarity="Common", collectible=True, set_number=135,
                    mtga_id=67374)
KeldonWarcaller = Card(name="keldon_warcaller", pretty_name="Keldon Warcaller", cost=['1', 'R'],
                       color_identity=['R'], card_type="Creature", sub_types="Human Warrior",
                       abilities=[118838], set_id="DAR", rarity="Common", collectible=True, set_number=136,
                       mtga_id=67376)
OrcishVandal = Card(name="orcish_vandal", pretty_name="Orcish Vandal", cost=['1', 'R'],
                    ...
                    abilities=[93267], set_id="DAR", rarity="Uncommon", collectible=True, set_number=137,
                    mtga_id=67378)
RadiatingLightning = Card(name="radiating_lightning", pretty_name="Radiating Lightning", cost=['3', 'R'],
                          color_identity=['R'], card_type="Instant", sub_types="",
                          abilities=[118840], set_id="DAR", rarity="Common", collectible=True, set_number=138,
                          mtga_id=67380)
RampagingCyclops = Card(name="rampaging_cyclops", pretty_name="Rampaging Cyclops", cost=['3', 'R'],
                        ...
                        abilities=[119056], set_id="DAR", rarity="Common", collectible=True, set_number=139,
                        mtga_id=67382)
RunAmok = Card(name="run_amok", pretty_name="Run Amok", cost=['1', 'R'],
               color_identity=['R'], card_type="Instant", sub_types="",
               abilities=[118842], set_id="DAR", rarity="Common", collectible=True, set_number=140,
               mtga_id=67384)
SeismicShift = Card(name="seismic_shift", pretty_name="Seismic Shift", cost=['3', 'R'],
                    color_identity=['R'], card_type="Sorcery", sub_types="",
                    abilities=[118843], set_id="DAR", rarity="Common", collectible=True, set_number=141,
                    mtga_id=67386)
ShivanFire = Card(name="shivan_fire", pretty_name="Shivan Fire", cost=['R'],
                  color_identity=['R'], card_type="Instant", sub_types="",
                  abilities=[2852, 118844], set_id="DAR", rarity="Common", collectible=True, set_number=142,
                  mtga_id=67388)
SiegeGangCommander = Card(name="siegegang_commander", pretty_name="Siege-Gang Commander", cost=['3', 'R', 'R'],
                          ...
                          abilities=[2076, 2077], set_id="DAR", rarity="Rare", collectible=True, set_number=143,
                          mtga_id=67390)
SkirkProspector = Card(name="skirk_prospector", pretty_name="Skirk Prospector", cost=['R'],
                       color_identity=['R'], card_type="Creature", sub_types="Goblin",
                       abilities=[2429], set_id="DAR", rarity="Common", collectible=True, set_number=144,
                       mtga_id=67392)
Skizzik = Card(name="skizzik", pretty_name="Skizzik", cost=['3', 'R'],
               color_identity=['R'], card_type="Creature", sub_types="Elemental",
               abilities=[1876, 14, 9, 92187], set_id="DAR", rarity="Uncommon", collectible=True, set_number=145,
               mtga_id=67394)
SqueetheImmortal = Card(name="squee_the_immortal", pretty_name="Squee, the Immortal", cost=['1', 'R', 'R'],
                        color_identity=['R'], card_type="Creature", sub_types="Goblin",
                        abilities=[118846], set_id="DAR", rarity="Rare", collectible=True, set_number=146,
                        mtga_id=67396)
TwoHeadedGiant = Card(name="twoheaded_giant", pretty_name="Two-Headed Giant", cost=['2', 'R', 'R'],
                      ...
                      abilities=[118847], set_id="DAR", rarity="Rare", collectible=True, set_number=147,
                      mtga_id=67398)
ValdukKeeperoftheFlame = Card(name="valduk_keeper_of_the_flame", pretty_name="Valduk, Keeper of the Flame", cost=['2', 'R'],
                              ...
                              abilities=[118848], set_id="DAR", rarity="Uncommon", collectible=True, set_number=148,
                              mtga_id=67400)
VerixBladewing = Card(name="verix_bladewing", pretty_name="Verix Bladewing", cost=['2', 'R', 'R'],
                      ...
                      abilities=[2817, 8, 1205], set_id="DAR", rarity="Mythic Rare", collectible=True, set_number=149,
                      mtga_id=67402)
WarcryPhoenix = Card(name="warcry_phoenix", pretty_name="Warcry Phoenix", cost=['3', 'R'],
                     ...
                     abilities=[8, 9, 118849], set_id="DAR", rarity="Uncommon", collectible=True, set_number=150,
                     mtga_id=67404)
WarlordsFury = Card(name="warlords_fury", pretty_name="Warlord's Fury", cost=['R'],
                    color_identity=['R'], card_type="Sorcery", sub_types="",
                    abilities=[26886, 25848], set_id="DAR", rarity="Common", collectible=True, set_number=151,
                    mtga_id=67406)
WizardsLightning = Card(name="wizards_lightning", pretty_name="Wizard's Lightning", cost=['2', 'R'],
                        color_identity=['R'], card_type="Instant", sub_types="",
                        abilities=[118850, 70361], set_id="DAR", rarity="Uncommon", collectible=True, set_number=152,
                        mtga_id=67408)
AdventurousImpulse = Card(name="adventurous_impulse", pretty_name="Adventurous Impulse", cost=['G'],
                          ...
                          abilities=[118851], set_id="DAR", rarity="Common", collectible=True, set_number=153,
                          mtga_id=67410)
AncientAnimus = Card(name="ancient_animus", pretty_name="Ancient Animus", cost=['1', 'G'],
                     color_identity=['G'], card_type="Instant", sub_types="",
                     abilities=[118993], set_id="DAR", rarity="Common", collectible=True, set_number=154,
                     mtga_id=67412)
ArborArmament = Card(name="arbor_armament", pretty_name="Arbor Armament", cost=['G'],
                     color_identity=['G'], card_type="Instant", sub_types="",
                     abilities=[118997], set_id="DAR", rarity="Common", collectible=True, set_number=155,
                     mtga_id=67414)
BalothGorger = Card(name="baloth_gorger", pretty_name="Baloth Gorger", cost=['2', 'G', 'G'],
                    ...
                    abilities=[2852, 118853], set_id="DAR", rarity="Common", collectible=True, set_number=156,
                    mtga_id=67416)
BrokenBond = Card(name="broken_bond", pretty_name="Broken Bond", cost=['1', 'G'],
                  color_identity=['G'], card_type="Sorcery", sub_types="",
                  abilities=[118854], set_id="DAR", rarity="Common", collectible=True, set_number=157,
                  mtga_id=67418)
CorrosiveOoze = Card(name="corrosive_ooze", pretty_name="Corrosive Ooze", cost=['1', 'G'],
                     ...
                     abilities=[118855], set_id="DAR", rarity="Common", collectible=True, set_number=158,
                     mtga_id=67420)
ElfhameDruid = Card(name="elfhame_druid", pretty_name="Elfhame Druid", cost=['1', 'G'],
                    ...
                    abilities=[1005, 119013], set_id="DAR", rarity="Uncommon", collectible=True, set_number=159,
                    mtga_id=67422)
FungalPlots = Card(name="fungal_plots", pretty_name="Fungal Plots", cost=['1', 'G'],
                   color_identity=['G'], card_type="Enchantment", sub_types="",
                   abilities=[118858, 118859], set_id="DAR", rarity="Uncommon", collectible=True, set_number=160,
                   mtga_id=67424)
GaeasBlessing = Card(name="gaeas_blessing", pretty_name="Gaea's Blessing", cost=['1', 'G'],
                     color_identity=['G'], card_type="Sorcery", sub_types="",
                     abilities=[12792, 25848, 95093], set_id="DAR", rarity="Uncommon", collectible=True, set_number=161,
                     mtga_id=67426)
GaeasProtector = Card(name="gaeas_protector", pretty_name="Gaea's Protector", cost=['3', 'G'],
                      ...
                      abilities=[96651], set_id="DAR", rarity="Common", collectible=True, set_number=162,
                      mtga_id=67428)
GiftofGrowth = Card(name="gift_of_growth", pretty_name="Gift of Growth", cost=['1', 'G'],
                    color_identity=['G'], card_type="Instant", sub_types="",
                    abilities=[2465, 118860], set_id="DAR", rarity="Common", collectible=True, set_number=163,
                    mtga_id=67430)
GrowfromtheAshes = Card(name="grow_from_the_ashes", pretty_name="Grow from the Ashes", cost=['2', 'G'],
                        color_identity=['G'], card_type="Sorcery", sub_types="",
                        abilities=[2465, 118861], set_id="DAR", rarity="Common", collectible=True, set_number=164,
                        mtga_id=67432)
GrunntheLonelyKing = Card(name="grunn_the_lonely_king", pretty_name="Grunn, the Lonely King", cost=['4', 'G', 'G'],
                          ...
                          abilities=[2817, 92093, 1227], set_id="DAR", rarity="Uncommon", collectible=True, set_number=165,
                          mtga_id=67434)
KamahlsDruidicVow = Card(name="kamahls_druidic_vow", pretty_name="Kamahl's Druidic Vow", cost=['X', 'G', 'G'],
                         color_identity=['G'], card_type="Sorcery", sub_types="",
                         abilities=[118862], set_id="DAR", rarity="Rare", collectible=True, set_number=166,
                         mtga_id=67436)
KrosanDruid = Card(name="krosan_druid", pretty_name="Krosan Druid", cost=['2', 'G'],
                   ...
                   abilities=[118865, 118864], set_id="DAR", rarity="Common", collectible=True, set_number=167,
                   mtga_id=67438)
...
LlanowarEnvoy = Card(name="llanowar_envoy", pretty_name="Llanowar Envoy", cost=['2', 'G'],
                     ...
                     abilities=[2410], set_id="DAR", rarity="Common", collectible=True, set_number=169,
                     mtga_id=67442)
LlanowarScout = Card(name="llanowar_scout", pretty_name="Llanowar Scout", cost=['1', 'G'],
                     color_identity=['G'], card_type="Creature", sub_types="Elf Scout",
                     abilities=[6425], set_id="DAR", rarity="Common", collectible=True, set_number=170,
                     mtga_id=67444)
MammothSpider = Card(name="mammoth_spider", pretty_name="Mammoth Spider", cost=['4', 'G'],
                     ...
                     abilities=[13], set_id="DAR", rarity="Common", collectible=True, set_number=171,
                     mtga_id=67446)
MarwyntheNurturer = Card(name="marwyn_the_nurturer", pretty_name="Marwyn, the Nurturer", cost=['2', 'G'],
                         color_identity=['G'], card_type="Creature", sub_types="Elf Druid",
                         abilities=[118866, 118867], set_id="DAR", rarity="Rare", collectible=True, set_number=172,
                         mtga_id=67448)
TheMendingofDominaria = Card(name="the_mending_of_dominaria", pretty_name="The Mending of Dominaria", cost=['3', 'G', 'G'],
                             ...
                             abilities=[119273, 119274, 118869], set_id="DAR", rarity="Rare", collectible=True, set_number=173,
                             mtga_id=67450)
MultaniYavimayasAvatar = Card(name="multani_yavimayas_avatar", pretty_name="Multani, Yavimaya's Avatar", cost=['4', 'G', 'G'],
                              ...
                              abilities=[13, 14, 118870, 118871], set_id="DAR", rarity="Mythic Rare", collectible=True, set_number=174,
                              mtga_id=67452)
NaturesSpiral = Card(name="natures_spiral", pretty_name="Nature's Spiral", cost=['1', 'G'],
                     color_identity=['G'], card_type="Sorcery", sub_types="",
                     abilities=[2938], set_id="DAR", rarity="Uncommon", collectible=True, set_number=175,
                     mtga_id=67454)
PiercetheSky = Card(name="pierce_the_sky", pretty_name="Pierce the Sky", cost=['1', 'G'],
                    color_identity=['G'], card_type="Instant", sub_types="",
                    abilities=[100814], set_id="DAR", rarity="Common", collectible=True, set_number=176,
                    mtga_id=67456)
PrimordialWurm = Card(name="primordial_wurm", pretty_name="Primordial Wurm", cost=['4', 'G', 'G'],
                      ...
                      abilities=[], set_id="DAR", rarity="Common", collectible=True, set_number=177,
                      mtga_id=67458)
SaprolingMigration = Card(name="saproling_migration", pretty_name="Saproling Migration", cost=['1', 'G'],
                          color_identity=['G'], card_type="Sorcery", sub_types="",
                          abilities=[2852, 118915], set_id="DAR", rarity="Common", collectible=True, set_number=178,
                          mtga_id=67460)
SongofFreyalise = Card(name="song_of_freyalise", pretty_name="Song of Freyalise", cost=['1', 'G'],
                       color_identity=['G'], card_type="Enchantment", sub_types="Saga",
                       abilities=[119270, 119271, 118874], set_id="DAR", rarity="Uncommon", collectible=True, set_number=179,
                       mtga_id=67462)
SporeSwarm = Card(name="spore_swarm", pretty_name="Spore Swarm", cost=['3', 'G'],
                  color_identity=['G'], card_type="Instant", sub_types="",
                  abilities=[24741], set_id="DAR", rarity="Uncommon", collectible=True, set_number=180,
                  mtga_id=67464)
SporecrownThallid = Card(name="sporecrown_thallid", pretty_name="Sporecrown Thallid", cost=['1', 'G'],
                         ...
                         abilities=[118875], set_id="DAR", rarity="Uncommon", collectible=True, set_number=181,
                         mtga_id=67466)
SteelLeafChampion = Card(name="steel_leaf_champion", pretty_name="Steel Leaf Champion", cost=['G', 'G', 'G'],
                         ...
                         abilities=[87941], set_id="DAR", rarity="Rare", collectible=True, set_number=182,
                         mtga_id=67468)
SylvanAwakening = Card(name="sylvan_awakening", pretty_name="Sylvan Awakening", cost=['2', 'G'],
                       color_identity=['G'], card_type="Sorcery", sub_types="",
                       abilities=[1248], set_id="DAR", rarity="Rare", collectible=True, set_number=183,
                       mtga_id=67470)
TerritorialAllosaurus = Card(name="territorial_allosaurus", pretty_name="Territorial Allosaurus", cost=['2', 'G', 'G'],
                             ...
                             abilities=[2722, 118877], set_id="DAR", rarity="Rare", collectible=True, set_number=184,
                             mtga_id=67472)
ThornElemental = Card(name="thorn_elemental", pretty_name="Thorn Elemental", cost=['5', 'G', 'G'],
                      ...
                      abilities=[88255], set_id="DAR", rarity="Uncommon", collectible=True, set_number=185,
                      mtga_id=67474)
UntamedKavu = Card(name="untamed_kavu", pretty_name="Untamed Kavu", cost=['1', 'G'],
                   color_identity=['G'], card_type="Creature", sub_types="Kavu",
                   abilities=[2817, 15, 14, 118853], set_id="DAR", rarity="Uncommon", collectible=True, set_number=186,
                   mtga_id=67476)
VerdantForce = Card(name="verdant_force", pretty_name="Verdant Force", cost=['5', 'G', 'G', 'G'],
                    color_identity=['G'], card_type="Creature", sub_types="Elemental",
                    abilities=[2640], set_id="DAR", rarity="Rare", collectible=True, set_number=187,
                    mtga_id=67478)
WildOnslaught = Card(name="wild_onslaught", pretty_name="Wild Onslaught", cost=['3', 'G'],
                     color_identity=['G'], card_type="Instant", sub_types="",
                     abilities=[2852, 118957], set_id="DAR", rarity="Uncommon", collectible=True, set_number=188,
                     mtga_id=67480)
YavimayaSapherd = Card(name="yavimaya_sapherd", pretty_name="Yavimaya Sapherd", cost=['2', 'G'],
                       color_identity=['G'], card_type="Creature", sub_types="Fungus",
                       abilities=[118878], set_id="DAR", rarity="Common", collectible=True, set_number=189,
                       mtga_id=67482)
AdeliztheCinderWind = Card(name="adeliz_the_cinder_wind", pretty_name="Adeliz, the Cinder Wind", cost=['1', 'U', 'R'],
                           ...
                           abilities=[8, 9, 118879], set_id="DAR", rarity="Uncommon", collectible=True, set_number=190,
                           mtga_id=67484)
ArvadtheCursed = Card(name="arvad_the_cursed", pretty_name="Arvad the Cursed", cost=['3', 'W', 'B'],
                      ...
                      abilities=[1, 12, 118880], set_id="DAR", rarity="Uncommon", collectible=True, set_number=191,
                      mtga_id=67486)
AryelKnightofWindgrace = Card(name="aryel_knight_of_windgrace", pretty_name="Aryel, Knight of Windgrace", cost=['2', 'W', 'B'],
                              ...
                              abilities=[15, 118881, 118882], set_id="DAR", rarity="Rare", collectible=True, set_number=192,
                              mtga_id=67488)
DarigaazReincarnated = Card(name="darigaaz_reincarnated", pretty_name="Darigaaz Reincarnated", cost=['4', 'B', 'R', 'G'],
                            ...
                            abilities=[8, 14, 9, 118963, 118883], set_id="DAR", rarity="Mythic Rare", collectible=True, set_number=193,
                            mtga_id=67490)
GarnatheBloodflame = Card(name="garna_the_bloodflame", pretty_name="Garna, the Bloodflame", cost=['3', 'B', 'R'],
                          ...
                          abilities=[7, 118884, 61135], set_id="DAR", rarity="Uncommon", collectible=True, set_number=194,
                          mtga_id=67492)
GrandWarlordRadha = Card(name="grand_warlord_radha", pretty_name="Grand Warlord Radha", cost=['2', 'R', 'G'],
                         ...
                         abilities=[9, 118885], set_id="DAR", rarity="Rare", collectible=True, set_number=195,
                         mtga_id=67494)
HallartheFirefletcher = Card(name="hallar_the_firefletcher", pretty_name="Hallar, the Firefletcher", cost=['1', 'R', 'G'],
                             ...
                             abilities=[14, 118886], set_id="DAR", rarity="Uncommon", collectible=True, set_number=196,
                             mtga_id=67496)
JhoiraWeatherlightCaptain = Card(name="jhoira_weatherlight_captain", pretty_name="Jhoira, Weatherlight Captain", cost=['2', 'U', 'R'],
                                 ...
                                 abilities=[118968], set_id="DAR", rarity="Mythic Rare", collectible=True, set_number=197,
                                 mtga_id=67498)
JodahArchmageEternal = Card(name="jodah_archmage_eternal", pretty_name="Jodah, Archmage Eternal", cost=['1', 'U', 'R', 'W'],
                            ...
                            abilities=[8, 7022], set_id="DAR", rarity="Rare", collectible=True, set_number=198,
                            mtga_id=67500)
MuldrothatheGravetide = Card(name="muldrotha_the_gravetide", pretty_name="Muldrotha, the Gravetide", cost=['3', 'B', 'G', 'U'],
                             ...
                             abilities=[118972], set_id="DAR", rarity="Mythic Rare", collectible=True, set_number=199,
                             mtga_id=67502)
OathofTeferi = Card(name="oath_of_teferi", pretty_name="Oath of Teferi", cost=['3', 'W', 'U'],
                    ...
                    abilities=[118888, 118889], set_id="DAR", rarity="Rare", collectible=True, set_number=200,
                    mtga_id=67504)
PrimevalsGloriousRebirth = Card(name="primevals_glorious_rebirth", pretty_name="Primevals' Glorious Rebirth", cost=['5', 'W', 'B'],
                                ...
                                abilities=[118890], set_id="DAR", rarity="Rare", collectible=True, set_number=201,
                                mtga_id=67506)
RaffCapashenShipsMage = Card(name="raff_capashen_ships_mage", pretty_name="Raff Capashen, Ship's Mage", cost=['2', 'W', 'U'],
                             ...
                             abilities=[7, 8, 118978], set_id="DAR", rarity="Uncommon", collectible=True, set_number=202,
                             mtga_id=67508)
RonaDiscipleofGix = Card(name="rona_disciple_of_gix", pretty_name="Rona, Disciple of Gix", cost=['1', 'U', 'B'],
                         ...
                         abilities=[118979, 118892, 118893], set_id="DAR", rarity="Uncommon", collectible=True, set_number=203,
                         mtga_id=67510)
ShannaSisaysLegacy = Card(name="shanna_sisays_legacy", pretty_name="Shanna, Sisay's Legacy", cost=['G', 'W'],
                          ...
                          abilities=[118894, 118895], set_id="DAR", rarity="Uncommon", collectible=True, set_number=204,
                          mtga_id=67512)
SlimefoottheStowaway = Card(name="slimefoot_the_stowaway", pretty_name="Slimefoot, the Stowaway", cost=['1', 'B', 'G'],
                            ...
                            abilities=[118986, 118896], set_id="DAR", rarity="Uncommon", collectible=True, set_number=205,
                            mtga_id=67514)
TatyovaBenthicDruid = Card(name="tatyova_benthic_druid", pretty_name="Tatyova, Benthic Druid", cost=['3', 'G', 'U'],
                           ...
                           abilities=[118897], set_id="DAR", rarity="Uncommon", collectible=True, set_number=206,
                           mtga_id=67516)
TeferiHeroofDominaria = Card(name="teferi_hero_of_dominaria", pretty_name="Teferi, Hero of Dominaria", cost=['3', 'W', 'U'],
                             ...
                             abilities=[118898, 118899, 118992], set_id="DAR", rarity="Mythic Rare", collectible=True, set_number=207,
                             mtga_id=67518)
TianaShipsCaretaker = Card(name="tiana_ships_caretaker", pretty_name="Tiana, Ship's Caretaker", cost=['3', 'R', 'W'],
                           ...
                           abilities=[8, 6, 118901], set_id="DAR", rarity="Uncommon", collectible=True, set_number=208,
                           mtga_id=67520)
AesthirGlider = Card(name="aesthir_glider", pretty_name="Aesthir Glider", cost=['3'],
                     ...
                     abilities=[8, 86476], set_id="DAR", rarity="Common", collectible=True, set_number=209,
                     mtga_id=67522)
AmaranthineWall = Card(name="amaranthine_wall", pretty_name="Amaranthine Wall", cost=['4'],
                       ...
                       abilities=[2, 118902], set_id="DAR", rarity="Uncommon", collectible=True, set_number=210,
                       mtga_id=67524)
BlackbladeReforged = Card(name="blackblade_reforged", pretty_name="Blackblade Reforged", cost=['2'],
                          ...
                          abilities=[118903, 118904, 118999], set_id="DAR", rarity="Rare", collectible=True, set_number=211,
                          mtga_id=67526)
BloodtallowCandle = Card(name="bloodtallow_candle", pretty_name="Bloodtallow Candle", cost=['1'],
                         ...
                         abilities=[1290], set_id="DAR", rarity="Common", collectible=True, set_number=212,
                         mtga_id=67528)
DampingSphere = Card(name="damping_sphere", pretty_name="Damping Sphere", cost=['2'],
                     color_identity=[], card_type="Artifact", sub_types="",
                     abilities=[118906, 118907], set_id="DAR", rarity="Uncommon", collectible=True, set_number=213,
                     mtga_id=67530)
ForebearsBlade = Card(name="forebears_blade", pretty_name="Forebear's Blade", cost=['3'],
                      color_identity=[], card_type="Artifact", sub_types="Equipment",
                      abilities=[118908, 118909, 1156], set_id="DAR", rarity="Rare", collectible=True, set_number=214,
                      mtga_id=67532)
GildedLotus = Card(name="gilded_lotus", pretty_name="Gilded Lotus", cost=['5'],
                   color_identity=[], card_type="Artifact", sub_types="",
                   abilities=[4957], set_id="DAR", rarity="Rare", collectible=True, set_number=215,
                   mtga_id=67534)
GuardiansofKoilos = Card(name="guardians_of_koilos", pretty_name="Guardians of Koilos", cost=['5'],
                         ...
                         abilities=[1297], set_id="DAR", rarity="Common", collectible=True, set_number=216,
                         mtga_id=67536)
HelmoftheHost = Card(name="helm_of_the_host", pretty_name="Helm of the Host", cost=['4'],
                     color_identity=[], card_type="Artifact", sub_types="Equipment",
                     abilities=[118911, 1077], set_id="DAR", rarity="Rare", collectible=True, set_number=217,
                     mtga_id=67538)
HowlingGolem = Card(name="howling_golem", pretty_name="Howling Golem", cost=['3'],
                    ...
                    abilities=[118912], set_id="DAR", rarity="Uncommon", collectible=True, set_number=218,
                    mtga_id=67540)
IcyManipulator = Card(name="icy_manipulator", pretty_name="Icy Manipulator", cost=['4'],
                      color_identity=[], card_type="Artifact", sub_types="",
                      abilities=[4990], set_id="DAR", rarity="Uncommon", collectible=True, set_number=219,
                      mtga_id=67542)
JhoirasFamiliar = Card(name="jhoiras_familiar", pretty_name="Jhoira's Familiar", cost=['4'],
                       ...
                       abilities=[8, 119010], set_id="DAR", rarity="Uncommon", collectible=True, set_number=220,
                       mtga_id=67544)
JoustingLance = Card(name="jousting_lance", pretty_name="Jousting Lance", cost=['2'],
                     color_identity=[], card_type="Artifact", sub_types="Equipment",
                     abilities=[4712, 1304, 1156], set_id="DAR", rarity="Common", collectible=True, set_number=221,
                     mtga_id=67546)
Juggernaut = Card(name="juggernaut", pretty_name="Juggernaut", cost=['4'],
                  ...
                  abilities=[118916, 88231], set_id="DAR", rarity="Uncommon", collectible=True, set_number=222,
                  mtga_id=67548)
...
HinterlandHarbor = Card(name="hinterland_harbor", pretty_name="Hinterland Harbor", cost=[],
                        ...
                        abilities=[99488, 18504], set_id="DAR", rarity="Rare", collectible=True, set_number=240,
                        mtga_id=67584)
IsolatedChapel = Card(name="isolated_chapel", pretty_name="Isolated Chapel", cost=[],
                      color_identity=['W', 'B'], card_type="Land", sub_types="",
                      abilities=[99478, 18472], set_id="DAR", rarity="Rare", collectible=True, set_number=241,
                      mtga_id=67586)
MemorialtoFolly = Card(name="memorial_to_folly", pretty_name="Memorial to Folly", cost=[],
                       color_identity=['B'], card_type="Land", sub_types="",
                       abilities=[76735, 1003, 118933], set_id="DAR", rarity="Uncommon", collectible=True, set_number=242,
                       mtga_id=67588)
...
WoodlandCemetery = Card(name="woodland_cemetery", pretty_name="Woodland Cemetery", cost=[],
                        ...
                        abilities=[99484, 4407], set_id="DAR", rarity="Rare", collectible=True, set_number=248,
                        mtga_id=67600)
ZhalfirinVoid = Card(name="zhalfirin_void", pretty_name="Zhalfirin Void", cost=[],
                     color_identity=[], card_type="Land", sub_types="",
                     abilities=[91717, 1152], set_id="DAR", rarity="Uncommon", collectible=True, set_number=249,
                     mtga_id=67602)
Plains = Card(name="plains", pretty_name="Plains", cost=[],
              color_identity=['W'], card_type="Land", sub_types="Plains",
              abilities=[], set_id="DAR", rarity="Basic", collectible=True, set_number=250,
              mtga_id=67604)
Plains2 = Card(name="plains", pretty_name="Plains", cost=[],
               color_identity=['W'], card_type="Land", sub_types="Plains",
               abilities=[], set_id="DAR", rarity="Basic", collectible=True, set_number=251,
               mtga_id=67606)
Plains3 = Card(name="plains", pretty_name="Plains", cost=[],
               color_identity=['W'], card_type="Land", sub_types="Plains",
               abilities=[], set_id="DAR", rarity="Basic", collectible=True, set_number=252,
               mtga_id=67608)
Plains4 = Card(name="plains", pretty_name="Plains", cost=[],
               color_identity=['W'], card_type="Land", sub_types="Plains",
               abilities=[], set_id="DAR", rarity="Basic", collectible=True, set_number=253,
               mtga_id=67610)
Island = Card(name="island", pretty_name="Island", cost=[],
              color_identity=['U'], card_type="Land", sub_types="Island",
              abilities=[], set_id="DAR", rarity="Basic", collectible=True, set_number=254,
              mtga_id=67612)
Island2 = Card(name="island", pretty_name="Island", cost=[],
               color_identity=['U'], card_type="Land", sub_types="Island",
               abilities=[], set_id="DAR", rarity="Basic", collectible=True, set_number=255,
               mtga_id=67614)
Island3 = Card(name="island", pretty_name="Island", cost=[],
               color_identity=['U'], card_type="Land", sub_types="Island",
               abilities=[], set_id="DAR", rarity="Basic", collectible=True, set_number=256,
               mtga_id=67616)
Island4 = Card(name="island", pretty_name="Island", cost=[],
               color_identity=['U'], card_type="Land", sub_types="Island",
               abilities=[], set_id="DAR", rarity="Basic", collectible=True, set_number=257,
               mtga_id=67618)
Swamp = Card(name="swamp", pretty_name="Swamp", cost=[],
             color_identity=['B'], card_type="Land", sub_types="Swamp",
             abilities=[], set_id="DAR", rarity="Basic", collectible=True, set_number=258,
             mtga_id=67620)
Swamp2 = Card(name="swamp", pretty_name="Swamp", cost=[],
              color_identity=['B'], card_type="Land", sub_types="Swamp",
              abilities=[], set_id="DAR", rarity="Basic", collectible=True, set_number=259,
              mtga_id=67622)
Swamp3 = Card(name="swamp", pretty_name="Swamp", cost=[],
              color_identity=['B'], card_type="Land", sub_types="Swamp",
              abilities=[], set_id="DAR", rarity="Basic", collectible=True, set_number=260,
              mtga_id=67624)
Swamp4 = Card(name="swamp", pretty_name="Swamp", cost=[],
              color_identity=['B'], card_type="Land", sub_types="Swamp",
              abilities=[], set_id="DAR", rarity="Basic", collectible=True, set_number=261,
              mtga_id=67626)
Mountain = Card(name="mountain", pretty_name="Mountain", cost=[],
                color_identity=['R'], card_type="Land", sub_types="Mountain",
                abilities=[], set_id="DAR", rarity="Basic", collectible=True, set_number=262,
                mtga_id=67628)
Mountain2 = Card(name="mountain", pretty_name="Mountain", cost=[],
                 color_identity=['R'], card_type="Land", sub_types="Mountain",
                 abilities=[], set_id="DAR", rarity="Basic", collectible=True, set_number=263,
                 mtga_id=67630)
Mountain3 = Card(name="mountain", pretty_name="Mountain", cost=[],
                 color_identity=['R'], card_type="Land", sub_types="Mountain",
                 abilities=[], set_id="DAR", rarity="Basic", collectible=True, set_number=264,
                 mtga_id=67632)
Mountain4 = Card(name="mountain", pretty_name="Mountain", cost=[],
                 color_identity=['R'], card_type="Land", sub_types="Mountain",
                 abilities=[], set_id="DAR", rarity="Basic", collectible=True, set_number=265,
                 mtga_id=67634)
Forest = Card(name="forest", pretty_name="Forest", cost=[],
              color_identity=['G'], card_type="Land", sub_types="Forest",
              abilities=[], set_id="DAR", rarity="Basic", collectible=True, set_number=266,
              mtga_id=67636)
Forest2 = Card(name="forest", pretty_name="Forest", cost=[],
               color_identity=['G'], card_type="Land", sub_types="Forest",
               abilities=[], set_id="DAR", rarity="Basic", collectible=True, set_number=267,
               mtga_id=67638)
Forest3 = Card(name="forest", pretty_name="Forest", cost=[],
               color_identity=['G'], card_type="Land", sub_types="Forest",
               abilities=[], set_id="DAR", rarity="Basic", collectible=True, set_number=268,
               mtga_id=67640)
Forest4 = Card(name="forest", pretty_name="Forest", cost=[],
               color_identity=['G'], card_type="Land", sub_types="Forest",
               abilities=[], set_id="DAR", rarity="Basic", collectible=True, set_number=269,
               mtga_id=67642)
TeferiTimebender = Card(name="teferi_timebender", pretty_name="Teferi, Timebender", cost=['4', 'W', 'U'],
                        color_identity=['W', 'U'], card_type="Planeswalker", sub_types="Teferi",
                        abilities=[1349, 118940, 118941], set_id="DAR", rarity="Mythic Rare", collectible=True, set_number=270,
                        mtga_id=67644)
TemporalMachinations = Card(name="temporal_machinations", pretty_name="Temporal Machinations", cost=['2', 'U'],
                            color_identity=['U'], card_type="Sorcery", sub_types="",
                            abilities=[118942], set_id="DAR", rarity="Common", collectible=True, set_number=271,
                            mtga_id=67646)
NiambiFaithfulHealer = Card(name="niambi_faithful_healer", pretty_name="Niambi, Faithful Healer", cost=['1', 'W', 'U'],
                            ...
                            abilities=[118943], set_id="DAR", rarity="Rare", collectible=True, set_number=272,
                            mtga_id=67648)
TeferisSentinel = Card(name="teferis_sentinel", pretty_name="Teferi's Sentinel", cost=['5'],
                       color_identity=[], card_type="Artifact Creature", sub_types="Golem",
                       abilities=[118944], set_id="DAR", rarity="Uncommon", collectible=True, set_number=273,
                       mtga_id=67650)
MeanderingRiver = Card(name="meandering_river", pretty_name="Meandering River", cost=[],
                       color_identity=['W', 'U'], card_type="Land", sub_types="",
                       abilities=[76735, 1209], set_id="DAR", rarity="Common", collectible=True, set_number=274,
                       mtga_id=67652)
ChandraBoldPyromancer = Card(name="chandra_bold_pyromancer", pretty_name="Chandra, Bold Pyromancer", cost=['4', 'R', 'R'],
                             ...
                             abilities=[118946, 118947, 118948], set_id="DAR", rarity="Mythic Rare", collectible=True, set_number=275,
                             mtga_id=67654)
ChandrasOutburst = Card(name="chandras_outburst", pretty_name="Chandra's Outburst", cost=['3', 'R', 'R'],
                        color_identity=['R'], card_type="Sorcery", sub_types="",
                        abilities=[86663, 118950], set_id="DAR", rarity="Rare", collectible=True, set_number=276,
                        mtga_id=67656)
...
ZombieKnight = Card(name="zombie_knight", pretty_name="Zombie Knight", cost=[],
                    ...
                    abilities=[142], set_id="DAR", rarity="Token", collectible=False, set_number=10005,
                    mtga_id=67668)
...
KaroxBladewing = Card(name="karox_bladewing", pretty_name="Karox Bladewing", cost=[],
                      ...
                      abilities=[8], set_id="DAR", rarity="Token", collectible=False, set_number=10010,
                      mtga_id=67673)
Saproling = Card(name="saproling", pretty_name="Saproling", cost=[],
                 color_identity=[], card_type="Creature", sub_types="Saproling",
                 abilities=[], set_id="DAR", rarity="Token", collectible=False, set_number=10011,
                 mtga_id=67674)
Saproling2 = Card(name="saproling", pretty_name="Saproling", cost=[],
                  color_identity=[], card_type="Creature", sub_types="Saproling",
                  abilities=[], set_id="DAR", rarity="Token", collectible=False, set_number=10012,
                  mtga_id=67675)
Saproling3 = Card(name="saproling", pretty_name="Saproling", cost=[],
                  color_identity=[], card_type="Creature", sub_types="Saproling",
                  abilities=[], set_id="DAR", rarity="Token", collectible=False, set_number=10013,
                  mtga_id=67676)
Construct = Card(name="construct", pretty_name="Construct", cost=[],
                 color_identity=[], card_type="Artifact Creature", sub_types="Construct",
                 abilities=[119051], set_id="DAR", rarity="Token", collectible=False, set_number=10014,
                 mtga_id=67677)
FiresongandSunspeaker = Card(name="firesong_and_sunspeaker", pretty_name="Firesong and Sunspeaker", cost=['4', 'R', 'W'],
                             ...
                             abilities=[119626, 119627], set_id="DAR", rarity="Rare", collectible=True, set_number=280,
                             mtga_id=68369)
TeferiHeroofDominaria2 = Card(name="teferi_hero_of_dominaria", pretty_name="Teferi, Hero of Dominaria", cost=['3', 'W', 'U'],
                              color_identity=['W', 'U'], card_type="Planeswalker", sub_types="Teferi",
                              abilities=[118898, 118899, 118992], set_id="DAR", rarity="Mythic Rare", collectible=True, set_number=6000,
                              mtga_id=69451)
LlanowarElves2 = Card(name="llanowar_elves", pretty_name="Llanowar Elves", cost=['G'],
                      color_identity=['G'], card_type="Creature", sub_types="Elf Druid",
                      abilities=[1005], set_id="DAR", rarity="Common", collectible=True, set_number=168,
                      mtga_id=69781)
