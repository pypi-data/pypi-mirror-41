...
def update_table_rows(df, server, database, table, index=False, append=True):
    """
...
def update_from_difference(df, server, database, table, index=False, append=True, mod_date_col=False):
    """
