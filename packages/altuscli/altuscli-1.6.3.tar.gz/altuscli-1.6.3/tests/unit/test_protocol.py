...
from altuscli.serialize import create_serializer
from altuscli.serialize import Serializer
...
class TestSerializer(unittest.TestCase):
    ...
    def setUp(self):
        self.model = yaml.load(open(os.path.join(PROTOCOL_DIR, 'service.yaml')))
