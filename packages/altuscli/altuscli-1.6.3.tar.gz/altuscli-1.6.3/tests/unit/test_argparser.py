...
from altuscli.argparser import ArgTableArgParser
from altuscli.argparser import ServiceArgParser
from altuscli.clidriver import ServiceOperation
...
class TestArgTableArgParser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        model = yaml.load(open(os.path.join(MODEL_DIR, 'service.yaml')))
