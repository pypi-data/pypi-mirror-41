...
from altuscli import COMPLEX_TYPES
from altuscli import LIST_TYPE
from altuscli import OBJECT_TYPE
from altuscli import SCALAR_TYPES
from altuscli import shorthand
from altuscli.compat import json
from altuscli.compat import OrderedDict
from altuscli.compat import six
from altuscli.paramfile import get_paramfile
from altuscli.paramfile import ResourceLoadingError
...
def unpack_cli_arg(cli_argument, value):
    ...
    :type cli_argument: :class:`altuscli.arguments.BaseCLIArgument`
...
class ParamShorthandDocGen(object):
    ...
    def generate_shorthand_example(self, cli_name, argument_model):
        ...
        :type cli_argument: altuscli.arguments.BaseCLIArgument
