...
dependencies = {
  '3': ['pyrabbit2', 'influxdb'],
  '2': ['pyrabbit2', 'influxdb'],
}


setup(name='lbCVMFSReporting',
      use_scm_version=True,
      description='LHCb CVMFS reporting package',
      long_description='LHCb CVMFS reporting package',
      url='https://gitlab.cern.ch/lhcb-core/lb-cvmfs-reporting',
