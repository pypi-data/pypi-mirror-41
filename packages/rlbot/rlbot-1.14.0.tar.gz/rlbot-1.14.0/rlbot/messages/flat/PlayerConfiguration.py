...
def PlayerConfigurationStart(builder): builder.StartObject(5)
def PlayerConfigurationAddPlayerClassType(builder, playerClassType): builder.PrependUint8Slot(0, playerClassType, 0)
def PlayerConfigurationAddPlayerClass(builder, playerClass): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(playerClass), 0)
