...
class TxHysteresisQueue(object):
    ...
    def __init__(self, low=8000, high=10000, highwater=None, lowwater=None, flowstat_cb=None):
        #pylint: disable=too-many-arguments
        if not HAS_TWISTED:
            raise RuntimeError("Can not instantiate TxHysteresisQueue without twisted")
        self.core = _CoreHysteresisQueue(_TxSoon(), low, high, highwater, lowwater, flowstat_cb)
    def put(self, entry):
        """Add entry to the queue, returns boolean indicating success
