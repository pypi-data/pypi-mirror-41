...
Revision ID: 3c5d39510935
Revises: c2f1fafd2225
Create Date: 2019-01-10 21:10:43.548099
...
revision = '3c5d39510935'
down_revision = 'c2f1fafd2225'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    select 
      deal_table_id, 
      count(*) credit_count,
      sum(coalesce(convert_to_numeric("credit"."credit"->>'estimatedValue')::numeric, 0)) credit_estimated_value,
      sum(coalesce(convert_to_numeric("credit"."credit"->>'value')::numeric, 0)) credit_value
