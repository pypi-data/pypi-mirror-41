"""changes to aggregate views

Revision ID: bff84c33d64d
Revises: 6c67a8bea936
Create Date: 2018-10-08 20:05:21.197606
...
revision = 'bff84c33d64d'
down_revision = '6c67a8bea936'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    select 
        ...
        sum(coalesce((project->>'estimatedValue')::numeric, 0)) project_estimated_value,
        sum(coalesce((project->>'raisedValue')::numeric, 0)) project_raised_value,
    ...
    select 
      ...
      sum(coalesce(("grant"."grant"->>'amountRequested')::numeric, 0)) grant_amount_requested,
      sum(coalesce(("grant"."grant"->>'amountCommitted')::numeric, 0)) grant_amount_committed,
      sum(coalesce(("grant"."grant"->>'amountDisbursed')::numeric, 0)) grant_amount_disbursed
    ...
    select 
      ...
      sum(coalesce(("equity"."equity"->>'estimatedValue')::numeric, 0)) equity_estimated_value
    ...
    select 
       ...
       coalesce((deal->>'estimatedValue')::numeric, 0) as estimated_value,
       coalesce((deal->>'value')::numeric, 0) as value,
