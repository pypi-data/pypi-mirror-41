...
htmlhelp_basename = 'pybel-olsdoc'
...
latex_documents = [
    (master_doc, 'pybel-ols.tex', 'pybel-ols Documentation',
...
man_pages = [
    (master_doc, 'pybel-ols', 'pybel-ols Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pybel-ols', 'pybel-ols Documentation',
     author, 'pybel-ols', 'One line description of project.',
     'Miscellaneous'),
]
