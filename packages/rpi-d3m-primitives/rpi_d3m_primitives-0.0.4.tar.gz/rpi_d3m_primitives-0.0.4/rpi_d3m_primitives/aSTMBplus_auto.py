...
from rpi_d3m_primitives.featSelect.Feature_Selector_model import ASTMB
...
class aSTMBplus_auto(SupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams]):
    """
    A primitive which selects a set of features condition on which the target is independent of other features
    """
    
    metadata = metadata_base.PrimitiveMetadata({
        'id': '57d87522-3805-451a-a9db-026a636ea213',
        'version': '2.1.5',
        'name': 'aSTMBplus_auto feature selector',
        'keywords': ['Markov Blanket Discovery','Feature Selection'],
        'description':'This algorithm will learn a Markov Blanket of the target node with adaptive mutual information estimation. In this algorithm, threshold is automatically selected in an empirical way and thus there is no hyper-parameter. Nodes in the learned Markov Blanket will be the selected features',
        'source': {
        ...
        'python_path': 'd3m.primitives.feature_selection.adaptive_simultaneous_markov_blanket.Auto_RPI',
        'algorithm_types': [
    ...
    def fit(self, *, timeout: float = None, iterations: int = None) -> None:
        ...
        model = ASTMB(smallTrainSet, smallDiscTrainSet,
