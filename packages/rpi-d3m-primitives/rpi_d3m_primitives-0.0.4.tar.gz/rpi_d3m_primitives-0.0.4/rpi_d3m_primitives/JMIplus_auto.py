...
class JMIplus_auto(SupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams]):
    """
    A primitive which selects a set of features that are most relevant to the target
    """
    ...
    metadata = metadata_base.PrimitiveMetadata({
        ...
        'python_path': 'd3m.primitives.feature_selection.joint_mutual_information.Auto_RPI',
        'algorithm_types': [
