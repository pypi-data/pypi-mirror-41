...
class NaiveBayes(SupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams]):
    """
    A primitive which do naive bayes classification
    """
    ...
    metadata = metadata_base.PrimitiveMetadata({
        ...
        'description': 'This algorithm is an implementation of Naive Bayes classification, Maximize A Posterior(MAP) is applied for parameter learning.',
        'source': {
