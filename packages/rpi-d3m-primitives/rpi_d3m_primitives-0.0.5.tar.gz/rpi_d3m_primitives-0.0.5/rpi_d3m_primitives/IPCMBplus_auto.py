...
class IPCMBplus_auto(SupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams]):
    """
    ...
    metadata = metadata_base.PrimitiveMetadata({
        ...
        'version': '2.1.5',
        'name': 'IPCMBplus_auto feature selector',
        'keywords': ['Markov Blanket Discovery','Feature Selection'],
        'description': 'This algorithm is an implementation of the identity Parent-Children Markov Blanket Discovery method.Threshold is selected automatically in an empirical way and there is no hyper-parameter to tune. Nodes in the learned Markov Blanket will be the selected features',
        'source': {
        ...
        'python_path': 'd3m.primitives.feature_selection.identity_parentchildren_markov_blanket.Auto_RPI',
        'algorithm_types': [
    ...
    def fit(self, *, timeout: float = None, iterations: int = None) -> None:
        ...
        model = IPCMB(smallTrainSet, smallDiscTrainSet,
