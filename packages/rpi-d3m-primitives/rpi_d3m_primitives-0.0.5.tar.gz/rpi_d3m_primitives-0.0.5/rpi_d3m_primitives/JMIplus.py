...
class Hyperparams(hyperparams.Hyperparams):
    percentage = hyperparams.Hyperparameter[float](
        default=0.4,
        description="percentage of features wanted",
...
class JMIplus(SupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams]):
    """
    A primitive which select a set of features that are most relevant to the target
    """
    ...
    metadata = metadata_base.PrimitiveMetadata({
        ...
        'python_path': 'd3m.primitives.feature_selection.joint_mutual_information.Manual_RPI',
        'algorithm_types': [
