...
class TreeAugmentNB(SupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams]):
    """
    A primitive which do classification based on tree-augmented naive bayes
    """
    ...
    metadata = metadata_base.PrimitiveMetadata({
        ...
        'keywords': ['Tree-Augmented Naive Bayes','Classification'],
        'description': 'This algorithm is an implementation of Tree-augmented Naive Bayes classification, Maximize A Posterior(MAP) is applied for parameter learning.',
        'source': {
