...
get_ipython().system(
    'jupyter nbconvert     --TagRemovePreprocessor.enabled=True     --TagRemovePreprocessor.remove_cell_tags="[\'build\']"     --TemplateExporter.exclude_output=True     --to python "obfuscate_files.ipynb"'
)
