...
def base64_to_utf8_string(value):
    return base64.b64decode(value).decode(encodings.utf_8)

def utf8_to_base64_string(value):
    return base64.b64encode(value).decode(encodings.utf_8)

def dict_to_base64_string(value):
    return base64.b64encode(json.dumps(value)).decode(encodings.utf_8)
...
def execute_command_and_return_output(command):
    return subprocess.check_output(command).decode(encodings.utf_8)
