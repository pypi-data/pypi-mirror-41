...
dependencies = {
  '3': ['lbmessaging', 'tabulate'],
  '2': ['lbmessaging', 'tabulate']
}


setup(name='lbmessagingAdministration',
      use_scm_version=True,
      description='LHCb RabbitMQ monitor',
      long_description='LHCb RabbitMQ monitor',
      url='https://gitlab.cern.ch/lhcb-core/lbmessagingAdministration',
