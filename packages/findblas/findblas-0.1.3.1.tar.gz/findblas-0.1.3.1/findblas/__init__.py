...
def find_blas():
	...
	if platform[:3] == "win":
		...
		candidate_paths.append(os.path.join(python_fold, "Library", "mingw32", "bin"))
		candidate_paths.append(os.path.join(python_fold, "Library", "mingw32", "lib"))
		candidate_paths.append(os.path.join(python_fold, "Library", "mingw", "bin"))
		candidate_paths.append(os.path.join(python_fold, "Library", "mingw", "lib"))
		...
		candidate_paths.append(os.path.join(python_fold, "Library", "mingw", "bin", "gsl"))
		candidate_paths.append(os.path.join(python_fold, "Library", "mingw", "lib", "gsl"))
		candidate_paths.append(os.path.join(python_fold, "Library", "mingw32", "bin", "gsl"))
		candidate_paths.append(os.path.join(python_fold, "Library", "mingw32", "lib", "gsl"))
		...
		system_include_paths.append(os.path.join(python_fold, "Library", "mingw", "include"))
		system_include_paths.append(os.path.join(python_fold, "Library", "mingw32", "include"))
		...
		gsl_include_paths.append(os.path.join(python_fold, "Library", "mingw", "include", "gsl"))
		gsl_include_paths.append(os.path.join(python_fold, "Library", "mingw32", "include", "gsl"))
	else:
	...
	if platform[:3] != "win":
		...
		candidate_paths += ['/usr/lib/x86' + "_64" if sys_arch=='64' else '' +'-linux-gnu',
		...
		system_include_paths += ['/usr/include/x86' + "_64" if sys_arch=='64' else '' +'-linux-gnu', '/usr/include', '/usr/local/include', '/opt/local/include']
	else:
		...
		try:
			...
			if platform[:3] != "win":
				...
				if found_syms[0] is True:
					...
					flags_found.append("UNKNWON_BLAS")
					flags_found.append("TAKEN_FROM_SCIPY")
			else:
				flags_found.append("UNKNWON_BLAS")
				flags_found.append("TAKEN_FROM_SCIPY")
