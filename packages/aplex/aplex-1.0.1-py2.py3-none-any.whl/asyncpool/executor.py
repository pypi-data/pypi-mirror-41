"""Contains executor implementation for asyncpool."""
...
class AsyncpoolWorkerError(OSError):
    ...
    def _handle_worker_state(self,
        ...
        if state == WorkerStates.CLOSING:
            ...
            if state == WorkerStates.BROKEN:
                worker_error = AsyncpoolWorkerError(
                    'Asyncpool worker was terminated abruptly.')
            elif state == WorkerStates.ERROR:
                worker_error = AsyncpoolWorkerError(
                    'Asyncpool worker was terminated since the event '
...
class BaseAsyncPoolExecutor(object):
    ...
    def set_future_loop(self, loop: asyncio.AbstractEventLoop):
        ...
        Raises:
            ...
            AsyncpoolWorkerError: If some workers are broken or raise
                BaseException.
