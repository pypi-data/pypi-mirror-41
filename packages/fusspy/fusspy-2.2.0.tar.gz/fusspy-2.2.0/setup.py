...
PACKAGENAME = metadata.get('package_name', 'FUSS')
DESCRIPTION = metadata.get('description', 'My code For Use with Supernova Spectropolarimetry')
AUTHOR = metadata.get('author', 'H. F. Stevance')
AUTHOR_EMAIL = metadata.get('author_email', '')
LICENSE = metadata.get('license', 'unknown')
URL = metadata.get('url', 'https://github.com/HeloiseS/FUSS')
