...
def getEsclient(fullIndex=None):
	return testEsclient if isTest else relEsclient if fullIndex == 'works_video_read' else localEsclient if fullIndex in ['statistics_works_hot_grow_write', 'statistics_works_hot_write', 'statistics_works_history_read', 'statistics_works_history_write'] else dataEsclient
