...
recommendRedisPool = redis.ConnectionPool(host='r-bp160ebab6e97594.redis.rds.aliyuncs.com', port='6379', db=0, password='flrjovlOJEROIJ324')

def getIntByVidInRedis(vid):
	recommendRedis = redis.Redis(connection_pool=recommendRedisPool)
