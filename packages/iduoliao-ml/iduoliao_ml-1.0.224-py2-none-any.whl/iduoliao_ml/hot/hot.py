...
def calWorksScore(worksList, dauFactor=10):
	...
	for works in worksList:
		conv = 0 if works.resShow < 200 else works.resShowPlay * 1.0 / works.resShow
		likeRatio = 0 if works.play < 20 else works.like * 1.0 / works.play
		shareRatio = 0 if works.play < 20 else works.share * 1.0 / works.play
		longPlayRatio = 0 if works.timeCount < 20 else works.timeTotal * 1.0 / works.timeCount / works.duration * getPlayCompleteWeight(works.duration)
		subRatio = 0 if works.play < 20 else works.sub * 1.0 / works.play
