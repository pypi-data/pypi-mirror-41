...
def calWorksScore(worksList, dauFactor=10):
	...
	for works in worksList:
		conv = 0 if works.resShow < 200 else works.resShowPlay / works.resShow
		playRatio = 0 if works.play < 20 else works.like / works.play
		shareRatio = 0 if works.play < 20 else works.share / works.play
		longPlayRatio = 0 if works.play < 20 else works.longPlay / works.play
		subRatio = 0 if works.play < 20 else works.sub / works.play
		worksArgs.append([conv, playRatio, shareRatio, longPlayRatio, subRatio])
