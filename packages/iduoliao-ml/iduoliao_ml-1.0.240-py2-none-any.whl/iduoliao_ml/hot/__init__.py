...
def updateHotList(subjectHistory, worksHistory, oriWorksDict, startTime, config):
	...
	#newHits = es.searchStatisticsDataByBody("works_actions", {"query": {"bool": {"must": [{"range": {"createTime": {"gte": startTime, "lt": endTime}}}, {"terms": {"action": [1, 3, 5, 12, 13, 14, 15, 16, 17]}}]}}, "size": 10000})
