...
class Encoder(EncoderBase[Program]):
    """Generic encoder object compatible with :py:class:`Circuit` objects."""

    def __init__(self, qubit_count: int) -> None:
        super(Encoder, self).__init__(qubit_count)


class EncoderQuantumKitchenSinks(Encoder):
    """
    ...
    :Example:
        ...
        >>> encoder = EncoderQuantumKitchenSinks(qubit_count=3, data_size=5,
        ...                                            non_zero_count=3)
    ...
    def __init__(self, qubit_count: int, data_size: int, non_zero_count: int = None, sigma: float = 1.0,
        ...
        super(EncoderQuantumKitchenSinks, self).__init__(qubit_count=qubit_count)
...
class EncoderThreshold(Encoder):
    """
    ...
    :Example:
        ...
        >>> encoder = EncoderThreshold(qubit_count=5, threshold_value=3)
    ...
    def __init__(self, qubit_count: int, threshold_value: Any) -> None:
        super(EncoderThreshold, self).__init__(qubit_count=qubit_count)
