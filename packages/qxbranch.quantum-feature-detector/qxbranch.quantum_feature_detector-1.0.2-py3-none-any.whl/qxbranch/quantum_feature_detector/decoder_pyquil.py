...
class DecoderPyquil(DecoderBase[MeasurementResultsPyquil, TDecodedResults]):
    """Generic decoder object compatible with :py:class:`CircuitPyquil` objects."""

    def __init__(self) -> None:
        super(DecoderPyquil, self).__init__()


class DecoderPyquilRaw(DecoderPyquil[MeasurementResultsPyquil]):
    """
    ...
    def __init__(self) -> None:
        super(DecoderPyquilRaw, self).__init__()
    ...
    def decode_measurement(self, measurement_results: MeasurementResultsPyquil) -> MeasurementResultsPyquil:
        ...
        :param measurement_results: The raw measured values from the :py:class:`CircuitPyquil`.
        :return: The raw measured values, though reduced to dimension 2 if necessary.
        """
        return measurement_results


class DecoderPyquilMostCommon(DecoderPyquil[List[int]]):
    """
    ...
    def __init__(self) -> None:
        super(DecoderPyquilMostCommon, self).__init__()
...
class DecoderPyquilMeasurementSum(DecoderPyquil[int]):
    """
    Decoder object that finds the most common result as per the :py:class:`DecoderPyquilMostCommon`, and
    ...
    def __init__(self) -> None:
        super(DecoderPyquilMeasurementSum, self).__init__()
