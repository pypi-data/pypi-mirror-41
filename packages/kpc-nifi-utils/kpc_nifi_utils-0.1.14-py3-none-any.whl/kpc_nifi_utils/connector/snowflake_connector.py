...
class SnowflakeConnector:
    ...
    def connect(self, user=None, password=None, account=None):
        ...
        user = urlparse.quote_plus(user) if user else urlparse.quote_plus(self._username)
        password = urlparse.quote_plus(password) if password else urlparse.quote_plus(self._password)
