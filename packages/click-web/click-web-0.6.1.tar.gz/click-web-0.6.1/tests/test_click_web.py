    ...
    [
        ...
        (click.Argument(["an_argument", ], nargs=2), 1,
         {'checked': '',
          ...
          'help': '',
          'human_readable_name': 'AN ARGUMENT',
          'name': '1.0.argument.text.text.an-argument',
          'nargs': 2,
          'param': 'argument',
          'required': True,
          'type': 'text',
        ...
        (click.Option(["--an_option", ]), 0,
         {'checked': '',
          ...
          'name': '0.0.option.text.text.--an-option',
          'nargs': 1,
          'param': 'option',
          'required': False,
          'type': 'text',
        ...
        (click.Option(["--an_option", ], nargs=2), 1,
         {'checked': '',
          ...
          'help': ('--an_option TEXT...', ''),
          'human_readable_name': 'an option',
          'name': '1.0.option.text.text.--an-option',
          'nargs': 2,
          'param': 'option',
          'required': False,
          'type': 'text',
    ...
    [
        (click.Argument(["a_file_argument", ], type=click.File('rb')), 0,
         {'checked': '',
          ...
          'name': '0.0.argument.file[rb].file.a-file-argument',
          'nargs': 1,
          'param': 'argument',
          'required': True,
          'type': 'file',
        ...
        (click.Option(["--a_file_option", ], type=click.File('rb')), 0,
         {'checked': '',
          ...
          'name': '0.0.option.file[rb].file.--a-file-option',
          'nargs': 1,
          'param': 'option',
          'required': False,
          'type': 'file',
    ...
    [
        (click.Argument(["a_file_argument", ], type=click.File('wb')), 0,
         {'checked': '',
          ...
          'help': '',
          'human_readable_name': 'A FILE ARGUMENT',
          'name': '0.0.argument.file[wb].hidden.a-file-argument',
          'nargs': 1,
          'param': 'argument',
          'required': True,
          'type': 'hidden',
        ...
        (click.Option(["--a_file_option", ], type=click.File('wb')), 0,
         {'checked': '',
          ...
          'help': ('--a_file_option FILENAME', ''),
          'human_readable_name': 'a file option',
          'name': '0.0.option.file[wb].text.--a-file-option',
          'nargs': 1,
          'param': 'option',
          'required': False,
          'type': 'text',
    ...
    [
        (click.Argument(["an_argument", ], type=ACustomParamType()), 0,
         {'checked': '',
          ...
          'help': '',
          'human_readable_name': 'AN ARGUMENT',
          'name': '0.0.argument.my_click_custom_type.my_custom_type.an-argument',
          'nargs': 1,
          'param': 'argument',
          'required': True,
          'type': 'my_custom_type',
        ...
        (click.Option(["--an_option", ], type=ACustomParamType()), 0,
         {'checked': '',
          ...
          'human_readable_name': 'an option',
          'name': '0.0.option.my_click_custom_type.my_custom_type.--an-option',
          'nargs': 1,
          'param': 'option',
          'required': False,
          'type': 'my_custom_type',
