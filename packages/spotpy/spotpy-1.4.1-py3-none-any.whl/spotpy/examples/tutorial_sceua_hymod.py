...
if __name__ == "__main__":
    ...
    sampler=spotpy.algorithms.abc(spot_setup(), dbname='Rosen', dbformat='csv')
    sampler.sample(987)
...
#    sampler=spotpy.algorithms.abc(spot_setup, dbname='SCEUA_hymod', dbformat='csv', alt_objfun=None)
#    
