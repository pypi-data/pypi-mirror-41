...
def copy_objects(source_bucket_name: str, destination_bucket_name: str, source_keys: List[str],
                 destination_path: str = ''):
    destination_bucket = s3_bucket(destination_bucket_name)

    # Ensure folder structure of destination path
    if destination_path and '/' not in destination_path:
        destination_path += '/'
    ...
    for key in source_keys:
        ...
        obj = destination_bucket.Object(key=f'{destination_path}{key}')
