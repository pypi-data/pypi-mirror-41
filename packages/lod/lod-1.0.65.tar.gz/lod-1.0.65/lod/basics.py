...
class Program(object):
    ...
    """
    def __init__(self, identifier, creator_id, name, version, is_release_version, description, rating_numerator, rating_count):
...
def parse_program(dictionary):
    ...
    res = Program(identifier, creator_id, name, version, is_release_version, description, rating_numerator, rating_count)
    return res
...
class Tag(object):
    ...
    def to_json(self):
        ...
        res = {
            ...
            'comment' : self.comment if isinstance(self.comment, string_types) else str(self.comment),
            'weight' : self.weight if isinstance(self.weight, int) else float(self.weight),
...
class MessageBuilder(Message):
    ...
    def add_text(self, message_text):
        ...
        return self
    def add_html(self, html_code, external_domains=None):
        """
...
class ObjectManager(object):
        ...
        for obj in self.get_all_objects():
            if isinstance(obj, Tag):
                if obj.symbol_name == '?scenario_plan_only_trust_explicitly':
                    ...
                    special_trust_for_users.append((user_id, trusted_or_distrusted))
    ...
    def find_latest_tag(self, *args, **kwargs):
        ...
        """
        candidate_list = self._identifiers
