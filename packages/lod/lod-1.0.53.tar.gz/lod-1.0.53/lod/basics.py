...
class ObjectManager(object):
    ...
    def update_step_start(self):
        ...
        for obj in self.get_all_objects():
            if isinstance(obj, Tag):
                ...
                if obj.symbol_name == '?scenario_plan_user_trust':
    ...
    def get_creator(self, obj_or_identifier, get_event_only=False):
        ...
        if event_that_created_this_object.type == 'execute_rule':
            res = basics.parse_identifier(event_that_created_this_object.args['rule_identifier'])
        elif event_that_created_this_object.type == 'execute_option':
            res = basics.parse_identifier(event_that_created_this_object.args['option_identifier'])
        elif event_that_created_this_object.type == 'execute_program':
            res = basics.parse_identifier(event_that_created_this_object.args['program_identifier'])
