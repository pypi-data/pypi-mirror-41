...
setup(
    ...
    description='Classes and functions for managing documents navigation in a '
                'manhattan project.',
    long_description=long_description,

    # The project's main homepage (@@ add github url once public)
    url='https://git.getme.co.uk/manhattan/manhattan_nav',
    ...
    packages=find_packages('manhattan_nav'),
    package_dir={'': 'manhattan_nav'},
