...
class Sampler:
    ...
    def measure(self, number_of_waveforms: int, first_percent: float, second_percent: float, channel: int) -> None:
        self.communicate("to_measure {} {:.3f} {:.3f} {}".format(number_of_waveforms,
                                                                 first_percent,
                                                                 second_percent,
                                                                 channel))
