...
class IndexedGeometryCell:
    ...
    def __init__(self, within, intersect, distance):
        self.within = within
...
class IndexedGeometry(SesameGeometry):
        ...
        def _build_index(env, cell_size, max_distance):
            ...
            for x in X:
                for y in Y:
                    ...
                    _index[(x, y)] = IndexedGeometryCell(within, intersect, d)
    ...
    def distance(self, x, y, enlarge=0.0):
        ...
        if intersect:
            return super(IndexedGeometry, self).distance(x, y, enlarge=enlarge)
