...
from LbSoftConfDB import check_cookie, get_ariadne_cookie_path, ARIADNE_URL
...
class SoftConfDB(object):
    ...
    Test DB: http://localhost:8080/db/data/
    ...
    def __init__(self, dbConnectStr="https://ariadne-lhcb.cern.ch/db/data"):
        ...
        if envdburl != None:
            if envdburl == "DEV":
                dbConnectStr = "http://localhost:8080/db/data/"
        ...
        # making sure we do the authentication
        if self.mDBURL.startswith(ARIADNE_URL):
