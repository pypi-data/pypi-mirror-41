...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ambition_subject', '0037_auto_20181112_2012'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.DateField(blank=True, null=True, validators=[edc_protocol.validators.date_not_before_study_start, edc_base.model_validators.date.date_not_future], verbose_name='Date CSF Gene-Xpert taken'),
        ),
        migrations.AddField(
            model_name='historicalmicrobiology',
            name='csf_genexpert_performed',
            field=models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')], default='N/A', max_length=15, verbose_name='CSF Gene-Xpert performed?'),
        ),
        migrations.AddField(
            model_name='historicalmicrobiology',
