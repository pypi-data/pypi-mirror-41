...
def hfst_compile_lexc_file(comp, filename, error_stream):
    return _libhfst_dev.hfst_compile_lexc_file(comp, filename, error_stream)
hfst_compile_lexc_file = _libhfst_dev.hfst_compile_lexc_file
...
def TwolcCompiler_compile(inputfile, outputfile, silent, verbose, resolve_left_conflicts, resolve_right_conflicts, type):
    return _libhfst_dev.TwolcCompiler_compile(inputfile, outputfile, silent, verbose, resolve_left_conflicts, resolve_right_conflicts, type)
