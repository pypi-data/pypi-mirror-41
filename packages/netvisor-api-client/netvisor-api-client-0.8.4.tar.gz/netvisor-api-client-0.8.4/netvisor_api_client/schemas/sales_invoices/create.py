...
class SalesInvoiceAttachmentDataSchema(RejectUnknownFieldsSchema):
    type = fields.String(default='pdf')
    data = fields.String()
...
class SalesInvoiceAttachmentLineSchema(RejectUnknownFieldsSchema):
    ...
    document_data = fields.Nested(SalesInvoiceAttachmentDataSchema, attribute='data')
