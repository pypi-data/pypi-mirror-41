...
class cas():
    ...
    def load_env(self):
        ...
        if not os.path.exists(filename):
            self.get_credentials_from_cloud()
    ...
    def get_credentials_from_cloud(self, filename):
        ...
        self.fileutils.get_file_to_path(self.share_name, 'AutoScaler', 'credentials', filename)
