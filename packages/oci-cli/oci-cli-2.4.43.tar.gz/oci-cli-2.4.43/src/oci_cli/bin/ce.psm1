...
function GetOciSubcommands_ce() {
    $ociSubcommands = @{
        ...
        'ce cluster' = 'create create-kubeconfig delete get list update'
...
function GetOciCommandsToLongParams_ce() {
    $ociCommandsToLongParams = @{
        'ce cluster create' = 'compartment-id dashboard-enabled from-json help kubernetes-version max-wait-seconds name pods-cidr service-lb-subnet-ids services-cidr tiller-enabled vcn-id wait-for-state wait-interval-seconds'
        'ce cluster create-kubeconfig' = 'cluster-id expiration file from-json help token-version'
        ...
        'ce cluster update' = 'cluster-id from-json help if-match kubernetes-version max-wait-seconds name wait-for-state wait-interval-seconds'
        'ce cluster-options get' = 'cluster-option-id from-json help'
        'ce node-pool create' = 'cluster-id compartment-id from-json help initial-node-labels kubernetes-version max-wait-seconds name node-image-name node-shape quantity-per-subnet ssh-public-key subnet-ids wait-for-state wait-interval-seconds'
        ...
        'ce node-pool update' = 'force from-json help if-match initial-node-labels kubernetes-version max-wait-seconds name node-pool-id quantity-per-subnet subnet-ids wait-for-state wait-interval-seconds'
        'ce node-pool-options get' = 'from-json help node-pool-option-id'
        ...
        'ce work-request-error list' = 'compartment-id from-json help work-request-id'
        'ce work-request-log-entry list' = 'compartment-id from-json help work-request-id'
    }
