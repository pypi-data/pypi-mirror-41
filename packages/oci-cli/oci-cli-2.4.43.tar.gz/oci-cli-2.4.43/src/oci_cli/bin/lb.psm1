...
function GetOciCommandsToLongParams_lb() {
    $ociCommandsToLongParams = @{
        ...
        'lb hostname list' = 'from-json help load-balancer-id'
        ...
        'lb path-route-set list' = 'from-json help load-balancer-id'
        ...
        'lb rule-set list' = 'from-json help load-balancer-id'
