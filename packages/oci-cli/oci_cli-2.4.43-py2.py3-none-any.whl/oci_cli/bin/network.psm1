...
function GetOciCommandsToLongParams_network() {
    $ociCommandsToLongParams = @{
        ...
        'network cross-connect create' = 'compartment-id cross-connect-group-id display-name far-cross-connect-or-cross-connect-group-id from-json help location-name max-wait-seconds near-cross-connect-or-cross-connect-group-id port-speed-shape-name wait-for-state wait-interval-seconds'
        ...
        'network cross-connect update' = 'cross-connect-id display-name from-json help if-match is-active max-wait-seconds wait-for-state wait-interval-seconds'
        'network cross-connect-group create' = 'compartment-id display-name from-json help max-wait-seconds wait-for-state wait-interval-seconds'
        ...
        'network cross-connect-group update' = 'cross-connect-group-id display-name from-json help if-match max-wait-seconds wait-for-state wait-interval-seconds'
        ...
        'network ip-sec-connection create' = 'compartment-id cpe-id defined-tags display-name drg-id freeform-tags from-json help max-wait-seconds static-routes wait-for-state wait-interval-seconds'
        ...
        'network ip-sec-connection update' = 'defined-tags display-name force freeform-tags from-json help if-match ipsc-id max-wait-seconds wait-for-state wait-interval-seconds'
        ...
        'network virtual-circuit create' = 'bandwidth-shape-name compartment-id cross-connect-mappings customer-bgp-asn display-name from-json gateway-id help max-wait-seconds provider-name provider-service-id provider-service-name public-prefixes region type wait-for-state wait-interval-seconds'
        ...
        'network virtual-circuit update' = 'bandwidth-shape-name cross-connect-mappings customer-bgp-asn display-name force from-json gateway-id help if-match max-wait-seconds provider-state reference-comment virtual-circuit-id wait-for-state wait-interval-seconds'
        ...
        'network virtual-circuit-public-prefix list' = 'from-json help verification-state virtual-circuit-id'
