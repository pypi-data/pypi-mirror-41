...
function GetOciCommandsToLongParams_kms() {
    $ociCommandsToLongParams = @{
        'kms crypto decrypt' = 'associated-data ciphertext from-json help key-id'
        'kms crypto encrypt' = 'associated-data from-json help key-id plaintext'
        'kms crypto generate-data-encryption-key' = 'associated-data from-json help include-plaintext-key key-id key-shape'
        'kms management key create' = 'compartment-id display-name from-json help key-shape max-wait-seconds wait-for-state wait-interval-seconds'
        ...
        'kms management key update' = 'display-name from-json help if-match key-id max-wait-seconds wait-for-state wait-interval-seconds'
        ...
        'kms management vault create' = 'compartment-id display-name from-json help max-wait-seconds vault-type wait-for-state wait-interval-seconds'
        ...
        'kms management vault update' = 'display-name from-json help if-match max-wait-seconds vault-id wait-for-state wait-interval-seconds'
    }
