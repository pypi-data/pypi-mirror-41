...
if __name__ == '__main__':
    test()
try:
    from . import fail, modules, system, wifi, programs, test, os_sys, errors, discription, progress_bars
except Exception:
    pass
    try:
        from os_sys import fail, modules, system, wifi, programs, test, os_sys, errors, discriptionprogress_bars
    except Exception:
        pass
        import fail, modules, system, wifi, programs, test, os_sys, errors, discription, progress_bars
fail = fail
modules = modules
system = system
wifi = wifi
