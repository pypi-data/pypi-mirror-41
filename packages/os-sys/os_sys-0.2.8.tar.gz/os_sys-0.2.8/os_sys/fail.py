...
__all__ = ['warn_return', 'make_warn', 'print_warn', 'warn_msg', 'warning_msg', 'warn_file_no', 'msg' ]
...
f = sys.stderr
def print_warn(*args#firts message, file, problem, becuse(optional), solution, msg
               ):
    lijst = list(args)
    try:
