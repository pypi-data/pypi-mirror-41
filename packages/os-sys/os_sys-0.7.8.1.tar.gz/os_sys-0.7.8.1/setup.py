...
#als ik bij version er .dev achter zet dan is het een prereleas

long_description = long_description.replace('evry', 'every')
setuptools.setup(
    name="os_sys",
    version="0.7.8.1",#.dev moet dan hier
    author="Matthijs labots",
    contact="python_libs",
    contact_email="py_libs@gmail.com",
    author_email="libs.python@gmail.com",
    description="a big lib with many usefull tools",
    ...
    install_requires=['progress', 'tqdm', 'progressbar'],
    classifiers=[
    ...
    project_urls={
        ...
        'wiki(still under development)': 'https://github.com/Matthijs990/os_sys/wiki',
