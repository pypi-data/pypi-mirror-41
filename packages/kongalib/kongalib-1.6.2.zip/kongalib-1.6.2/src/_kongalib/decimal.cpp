 ...
 *
 *		$Revision: 28142 $
 *		$Date: 2018-03-28 09:37:35 +0200 (Wed, 28 Mar 2018) $
 *		$Author: lillo $
 *
...
MGA_Decimal_add(MGA::DecimalObject *self, PyObject *_other)
{
 ...
 */
static MGA::DecimalObject *
MGA_Decimal_sub(MGA::DecimalObject *self, PyObject *_other)
{
	MGA::DecimalObject *result;
	MGA::DecimalObject *other;
 ...
 */
static MGA::DecimalObject *
MGA_Decimal_mul(MGA::DecimalObject *self, PyObject *_other)
{
	MGA::DecimalObject *result;
	MGA::DecimalObject *other;
 ...
 */
static MGA::DecimalObject *
MGA_Decimal_rem(MGA::DecimalObject *self, PyObject *_other)
{
	MGA::DecimalObject *result;
	MGA::DecimalObject *other;
 ...
 */
static PyObject *
MGA_Decimal_divmod(MGA::DecimalObject *self, PyObject *_other)
{
 ...
 */
static MGA::DecimalObject *
MGA_Decimal_pow(MGA::DecimalObject *self, PyObject *_other, PyObject *unused)
{
	MGA::DecimalObject *result;
	MGA::DecimalObject *other;
 ...
 */
static MGA::DecimalObject *
MGA_Decimal_floor_div(MGA::DecimalObject *self, PyObject *other)
{
	PyObject *tuple;
	MGA::DecimalObject *result;
 ...
 */
static MGA::DecimalObject *
MGA_Decimal_div(MGA::DecimalObject *self, PyObject *_other)
{
	MGA::DecimalObject *result;
	MGA::DecimalObject *other;
...
MGA_Decimal_format(MGA::DecimalObject *self, PyObject *args, PyObject *kwds)
{
	...
	CL_GetLocaleInfo(&info, state->fLanguage);
