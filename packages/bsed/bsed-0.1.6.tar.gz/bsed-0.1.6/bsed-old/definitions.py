...
COMMAND_TOKEN_TREE_FILE = path.join(CONFIG_DIR, 'command_token_tree.json')
LINE_CONDITION_TOKEN_TREE_FILE = path.join(CONFIG_DIR, 'line_condition_token_tree.json')
LINE_CONDITION_TRANSLATIONS_FILE = path.join(CONFIG_DIR, 'line_condition_perl_translations.json')