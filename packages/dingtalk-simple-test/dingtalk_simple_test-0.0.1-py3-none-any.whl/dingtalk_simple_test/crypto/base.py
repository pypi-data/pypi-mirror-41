...
from dingtalk_simple_test.core.utils import random_string, to_binary, byte2int, to_text
from dingtalk_simple_test.crypto.pkcs7 import PKCS7Encoder

try:
    from dingtalk_simple_test.crypto.cryptography import DingTalkCipher
except ImportError:
    try:
        from dingtalk_simple_test.crypto.pycrypto import DingTalkCipher
    except ImportError:
