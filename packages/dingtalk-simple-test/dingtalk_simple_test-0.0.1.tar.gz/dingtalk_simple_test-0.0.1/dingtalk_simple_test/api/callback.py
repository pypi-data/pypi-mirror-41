...
class Callback(DingTalkBaseAPI):
    ...
    def register_call_back(self, call_back_tags, url, token=None, aes_key=None):
        """
        注册事件回调接口
    ...
    def update_call_back(self, call_back_tags, url, token=None, aes_key=None):
        """
        更新事件回调接口
