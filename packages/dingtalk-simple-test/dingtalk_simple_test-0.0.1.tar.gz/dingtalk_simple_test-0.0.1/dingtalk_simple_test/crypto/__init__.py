...
from dingtalk_simple_test.core.exceptions import InvalidCorpIdOrSuiteKeyException, \
    InvalidSignatureException
from dingtalk_simple_test.core.utils import DingTalkSigner, to_binary, to_text, random_string
from dingtalk_simple_test.crypto.base import BasePrpCrypto
...
class DingTalkAES(object):
    @classmethod
    def generate_encoding_aes_key(cls):
