...
from dingtalk_simple_test.api.base import DingTalkBaseAPI
from dingtalk_simple_test.core.exceptions import DingTalkClientException
from dingtalk_simple_test.core.utils import json_loads
...
class BaseClient(object):
    ...
    def __init__(self, storage, timeout=None, auto_retry=True):
        assert isinstance(storage, StrictRedis)
        # storage 简单使用redis
    ...
    #         uri = urljoin('https://aide.sellpush.com', uri)
    #     return params, uri
    ...
    #     :param url: 请求url，默认为 https://aide.sellpush.com/router/rest
    #     """
