...
def create_setupfile(outputfile):
    leapseconds = input('Introduce filename for Leapseconds kernel: ')
    frames = input('Introduce filename for Frames kernel: ')
    dskname = input('Introduce filename for generated DSK: ')
    ...
    naifbody = input(' - Naif Surface Body: ')
...
def obj2dsk():
    ...
    dx = input('Introduce x displacement: ')
    dy = input('Introduce y displacement: ')
    dz = input('Introduce z displacement: ')
