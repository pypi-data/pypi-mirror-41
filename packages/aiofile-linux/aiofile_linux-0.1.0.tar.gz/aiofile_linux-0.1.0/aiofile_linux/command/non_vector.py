...
class ReadCmd(NonVectorCmd):
    ...
    def __init__(self,
                 file: Any,
                 buffer: Union[str, NonVectorCmd.BUF_TYPE],
                 offset: int = 0,
                 length: int = None,
...
class WriteCmd(NonVectorCmd):
    ...
    def __init__(self,
                 file: Any,
                 content: Union[str, NonVectorCmd.BUF_TYPE],
                 offset: int = 0,
                 length: int = None,
                 rw_flags: IOCBRWFlag = 0,
                 priority_class: IOCBPriorityClass = IOCBPriorityClass.NONE,
