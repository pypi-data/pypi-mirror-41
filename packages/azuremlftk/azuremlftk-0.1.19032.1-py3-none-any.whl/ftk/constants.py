"""
A module that contains the definition of constants used by all classes and modules in the AML forecasting package.
"""
...
#
# Used in aml_compute and experiment modules in compute
#
AMLCOMPUTE_EXPERIMENT_TEMPLATE_NAME = 'experiment.py'
AMLCOMPUTE_CONDA_REQUIREMENTS_TEMPLATE = 'requirements_E13N.yml'
AMLCOMPUTE_OUTPUT_LOC_NAME = 'outputs'
AMLCOMPUTE_OUTPUT_JOB_RESULTS = 'job_results'
AMLCOMPUTE_OUTPUT_ERRORS = 'errors'
...
TELEMETRY_TARGET_COLUMN = 'DataTragetColumn'
