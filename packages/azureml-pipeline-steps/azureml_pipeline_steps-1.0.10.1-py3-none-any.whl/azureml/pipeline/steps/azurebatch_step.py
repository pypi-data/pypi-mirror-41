...
class AzureBatchStep(PipelineStep):
    ...
    def __init__(self,
        ...
        super().__init__(name, self._inputs, self._outputs, arguments)
    ...
    def create_node(self, graph, default_datastore, context):
        ...
        arguments = super().resolve_input_arguments(self._arguments, self._inputs, self._outputs, self._parameters)
