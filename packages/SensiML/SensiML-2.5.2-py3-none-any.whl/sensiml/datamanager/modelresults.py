...
class ModelMetrics(object):
    ...
    def recognize_signal(self, capturefile=None, stop_step=False,
        ...
        kp.recognize_signal(capture=capturefile, datafile=datafile,
                            stop_step=stop_step, segmenter=segmenter, platform=platform, get_result=False, compare_labels=compare_labels)

        results = utility.wait_for_pipeline_result(
            kp, lock=lock, silent=silent, **kwargs)
