...
class SensiML(object):
    ...
    def __init__(self, server="https://sensiml.cloud/",
        ...
        self.validate_client_version(kwargs.get("skip_validate", False))
    ...
    def validate_client_version(self, skip_validate=False):
        ...
        if response_data["SensiML_Python_Library_Windows"] != self.__version__:
            print(
            ...
            print("To see instrunctions for updating SensiML Client for the Analytic Stduio go to https://sensiml.atlassian.net/wiki/spaces/SS/pages/115179614/Updating+SensiML+Client")
        ...
        for capture in dclproj.get('CaptureFiles'):
            ...
            try:
                ...
                for metadata in file_metadata:
                    ...
                    metadata_obj.segmenter = segment_map.get(
                        metadata['segmenter'], None)
                    metadata_obj.insert()
