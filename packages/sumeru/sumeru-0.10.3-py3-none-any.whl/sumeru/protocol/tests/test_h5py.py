...
from sumeru.protocol import deserialize, serialize

from sumeru.utils import PY3, tmpfile
...
import sumeru.dask.array as da


@silence_h5py_issue775
@gen_cluster(client=True)
def test_h5py_serialize(c, s, a, b):
    from sumeru.dask.utils import SerializableLock
