...
from sumeru.dask.core import flatten
from sumeru.utils import tokey
from sumeru.client import wait
from sumeru.metrics import time
from sumeru.utils_test import gen_cluster, inc, dec, slowinc, div
from sumeru.bokeh.worker import Counters, BokehWorker
from sumeru.bokeh.scheduler import (BokehScheduler, SystemMonitor,
...
from sumeru.bokeh import scheduler
...
@gen_cluster(client=True,
             config={'sumeru.worker.profile.interval': '10ms',
                     'sumeru.worker.profile.cycle': '50ms'})
