...
class Adaptive(object):
    ...
    **kwargs:
    ...
    >>> from sumeru.dask_kubernetes import KubeCluster
    >>> cluster = KubeCluster()
    ...
    >>> from sumeru.deploy import Cluster
    ...
    def needs_memory(self):
        ...
        Notes
        -----
        Returns ``True`` if  the required bytes in sumeru memory is some
        factor larger than the actual sumeru memory available.
        """
