            ...
            if scheduler_host:
                ...
                try:
                    ...
                    msg = ("To use Joblib with Dask first create a Dask Client"
                           "\n\n"
                           "    from sumeru.dask.sumeru import Client\n"
                           "    client = Client()\n"
                           "or\n"
                           "    client = Client('scheduler-address:7328')")
...
if joblib:
    ...
    joblib.register_parallel_backend('sumeru', DaskDistributedBackend)
    joblib.register_parallel_backend('dask.sumeru', DaskDistributedBackend)
if sk_joblib:
    sk_joblib.register_parallel_backend('dask', DaskDistributedBackend)
    sk_joblib.register_parallel_backend('sumeru', DaskDistributedBackend)
    sk_joblib.register_parallel_backend('dask.sumeru', DaskDistributedBackend)
