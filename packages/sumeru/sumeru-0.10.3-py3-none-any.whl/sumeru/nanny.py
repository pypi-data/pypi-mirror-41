...
class Nanny(ServerNode):
    ...
    def __init__(self, scheduler_ip=None, scheduler_port=None,
        ...
        self.memory_terminate_fraction = dask.config.get('sumeru.worker.memory.terminate')
    ...
    def _start(self, addr_or_port=0):
        ...
        logger.info('        Start Nanny at: %26s', self.address)
...
class WorkerProcess(object):
    ...
    def _run(cls, worker_args, worker_kwargs, worker_start_args,
        ...
        try:
            from sumeru.dask.multiprocessing import initialize_worker_process
