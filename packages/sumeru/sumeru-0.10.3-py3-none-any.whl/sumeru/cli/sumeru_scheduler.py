...
from sumeru.scheduler import Scheduler
from sumeru.security import Security
from sumeru.utils import get_ip_interface, ignoring
from sumeru.cli.utils import (check_python_3, install_signal_handlers,
                                   uri_from_host_port)
from sumeru.preloading import preload_modules, validate_preload_argv
...
def main(host, port, bokeh_port, show, _bokeh, bokeh_whitelist, bokeh_prefix,
    ...
    addr = uri_from_host_port(host, port, 7328)
    ...
    if _bokeh:
        with ignoring(ImportError):
            from sumeru.bokeh.scheduler import BokehScheduler
