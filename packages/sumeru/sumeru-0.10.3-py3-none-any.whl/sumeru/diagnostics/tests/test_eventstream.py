...
from sumeru.diagnostics.eventstream import EventStream, eventstream
from sumeru.metrics import time
from sumeru.utils_test import div, gen_cluster
...
def test_eventstream(c, s, *workers):
    ...
    from sumeru.bokeh import messages
    from sumeru.diagnostics.progress_stream import task_stream_append
