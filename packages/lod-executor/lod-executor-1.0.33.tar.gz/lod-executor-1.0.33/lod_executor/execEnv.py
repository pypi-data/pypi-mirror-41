...
def execute_image(exec_env, image_name, path, execution_id, step_num, max_execution_duration, program_name):
    """
...
class ExecEnv(threading.Thread):
    ...
    def get_status_updates(self, next_io_event_index):
        ...
        with self.lock:
            ...
            last_set_status_message_tag = self.latest_object_manager.find_latest_tag('!set_status_message')
            if last_set_status_message_tag is None or last_set_status_message_tag.comment is None:
                ...
                current_status = last_set_status_message_tag.comment
            res = {
                'success' : True,
        ...
        if local_event_type == 'request_next_iteration':
            ...
            with CurrentlyDisplayedStatus(self, "Executing program..."):
                ...
                results = self._event_program_execution(object_manager, event_identifier, program_identifier,
                    docker_image_name, input_arguments_dict, max_execution_duration)
    ...
    def _event_wait_for_input(self):
        ...
        return {}
    def _event_program_execution(self, object_manager, event_identifier, program_identifier, docker_image_name, input_arguments_dict, max_execution_duration):
        """
        ...
        with CurrentlyDisplayedStatus(self, "Program execution..."):
            try:
                error_type, error_message = execute_image(self, docker_image_name, None, self.id,
                    object_manager.get_current_step(), max_execution_duration, program_identifier.name)
