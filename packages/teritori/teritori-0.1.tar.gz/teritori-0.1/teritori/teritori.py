...
def main():
    ...
    if args.go or args.gc or args.a:
    ...
    fp.combine_all(ori_rrna_range, ori_dnaa_range, ori_go_range, dnaa_max_pos,
                   ...
                   av_diff_gc, av_diff_ta, linear, args.cm, args.gc, args.a, args.go)
    ...
    if args.graph:
        ...
        if args.a or (args.gc and args.cm):
        ...
        if args.go and not args.a and not args.cm and not args.gc:
        ...
        if args.a or args.gc or args.cm:
            plt.xlabel('Sequence position')
        elif args.go and not args.a and not args.gc and not args.cm:
            plt.xlabel('Gene number')

        if args.a or (args.gc and args.cm and args.go) or (args.gc and args.cm):
        ...
        elif args.go and not args.gc and not args.a and not args.cm:
            if best_ori == "cum-":
        ...
        elif args.gc and not args.go and not args.a and not args.cm:
            black_patch = mpatches.Patch(color='black', label='GC-skew')
            dark_patch = mpatches.Patch(color='darkblue', label='TA-skew')
        ...
        if args.a or args.gc or args.go or (args.cm and args.go and args.gc) or (args.go and args.gc) \
            or (args.gc and args.cm):
            if args.o:
                plt.savefig(inner_path + "/" + args.o + ".png", format="png")
            else:
