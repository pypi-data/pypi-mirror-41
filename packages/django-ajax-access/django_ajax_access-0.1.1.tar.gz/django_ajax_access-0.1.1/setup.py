...
DIRNAME = NAME
if DIRNAME.startswith("django_"):
    DIRNAME = DIRNAME.replace("django_", "")
...
setup(
    name=NAME,
    version=find_version("src", DIRNAME, "__init__.py"),
    description="A set of views and urls for ajax-based logout and logout for Django.",
