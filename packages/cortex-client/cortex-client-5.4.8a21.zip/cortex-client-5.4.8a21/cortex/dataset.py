...
class _Viz:
    ...
    """
        A wrapper that assists users in running multiple commonly used visualizations on the same dataframe;
...
class Dataset(AbstractDataset, CamelResource):
    ...
    """
    Defines the data and query parametersfor accessing inputs to
    ...
    def pipeline(self, name, clear_cache=False, depends=None):
        ...
        :param depends: a list of attributes upon which this pipeline depends
        """
