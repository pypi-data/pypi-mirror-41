...
class BuilderFactory:
    ...
    def dataset(self, name: str, camel_version='1.0.0') -> DatasetBuilder:
        ...
        :param name: name of the dataset builder. The name must provide at least one cortex namespace
        identifier and a resource name.  
        """
    ...
    def connection(self, name: str, camel_version='1.0.0') -> ConnectionBuilder:
        ...
        :param name: name of the connection builer. The name must provide at least one cortex namespace
        identifier and a resource name.  
        """
        validate_resource_name(name)
    ...
    def skill(self, name: str, camel_version='1.0.0') -> SkillBuilder:
        ...
        :param name: name of the skill builer. The name must provide at least one cortex namespace
        identifier and a resource name.  
        """
        validate_resource_name(name)
    ...
    def action(self, name: str, camel_version='1.0.0'):
        ...
        :param name: name of the action builer. The name must provide at least one cortex namespace
        identifier and a resource name.  
        """
        validate_resource_name(name)
...
def validate_resource_name(name: str):
    ...
    if (re.compile('.+\/.+').match(name) is None): # enforce namespace validation
            raise ValueError('ERROR: {name} must provide at least one namespace path element'.format(name=name)) 