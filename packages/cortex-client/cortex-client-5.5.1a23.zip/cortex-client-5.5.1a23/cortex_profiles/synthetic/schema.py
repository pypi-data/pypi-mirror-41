...
class SchemaProvider(BaseProviderWithDependencies):
    ...
    def profile_schema(self, tenantId:Optional[str]=None, schemaId:Optional[str]=None, environmentId:Optional[str]=None, additional_attributes=[], additional_tags=[]) -> ProfileSchema:
        ...
        for schema_config in implicit_schema_configs:
            schema_builder.append_schema_config(schema_config)
