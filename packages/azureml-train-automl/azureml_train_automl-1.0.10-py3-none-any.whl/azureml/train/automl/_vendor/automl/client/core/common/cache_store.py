...
class CacheStore(ABC):
    ...
    def __init__(self, path=None, max_retries=3, module_logger=None, activity_logger: ActivityLogger = None):
        """
    ...
    def log_activity(self, custom_dimensions=None):
        """
...
class MemoryCacheStore(CacheStore):
    ...
    def __init__(self, path=None):
        """Constructor."""
        super(MemoryCacheStore, self).__init__(path=path)
