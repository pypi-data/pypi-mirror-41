...
class itkBayesianClassifierInitializationImageFilterIF2F(itkImageToImageFilterBPython.itkImageToImageFilterIF2VIF2):
    ...
    def SetMembershipFunctions(self, densityFunctionContainer):
        """
...
def itkBayesianClassifierInitializationImageFilterIF2F_cast(obj):
...
def itkBayesianClassifierInitializationImageFilterIF3F_cast(obj):
...
def itkBayesianClassifierInitializationImageFilterISS2F___New_orig__():
...
def itkBayesianClassifierInitializationImageFilterISS2F_cast(obj):
...
def itkBayesianClassifierInitializationImageFilterISS3F___New_orig__():
...
def itkBayesianClassifierInitializationImageFilterISS3F_cast(obj):
...
def itkBayesianClassifierInitializationImageFilterIUC2F_cast(obj):
...
def itkBayesianClassifierInitializationImageFilterIUC3F_cast(obj):
...
def itkBayesianClassifierInitializationImageFilterIUS2F_cast(obj):
...
def itkBayesianClassifierInitializationImageFilterIUS3F_cast(obj):
...
def bayesian_classifier_initialization_image_filter(*args, **kwargs):
    ...
    import itk
    return itk.BayesianClassifierInitializationImageFilter.__call__(*args, **kwargs)
