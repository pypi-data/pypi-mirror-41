...
def itkLabelVotingImageFilterIUC2IUC2_cast(obj):
...
def itkLabelVotingImageFilterIUC3IUC3_cast(obj):
...
def itkLabelVotingImageFilterIUS2IUS2_cast(obj):
...
def itkLabelVotingImageFilterIUS3IUS3_cast(obj):
...
def label_voting_image_filter(*args, **kwargs):
    ...
    import itk
    return itk.LabelVotingImageFilter.__call__(*args, **kwargs)
