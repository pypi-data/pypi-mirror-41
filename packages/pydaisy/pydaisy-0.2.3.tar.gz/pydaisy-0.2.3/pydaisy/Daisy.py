    ...
    def run(self):
        ...
        if platform.system()=='Linux':
            ...
            if  sys.version_info >= (3, 0):
                return subprocess.run([DaisyModel.path_to_daisy_executable, os.path.split(self.DaisyInputfile)[1]], cwd= os.path.dirname(self.DaisyInputfile), shell=True)
            else:
                return subprocess.call([DaisyModel.path_to_daisy_executable, os.path.split(self.DaisyInputfile)[1]], cwd= os.path.dirname(self.DaisyInputfile), shell=True)
