...
gameIcon = pygame.image.load('./racecar.jpg')
...
def crash():
	largeText = pygame.font.Font("./font.ttf",100)
...
def finish():
	...
	largeText = pygame.font.Font("./font.ttf",80)
...
def button(msg,x,y,w,h,ic,ac,action=None):
	...
	smallText = pygame.font.Font("./font.ttf",50)
...
def game_intro():
	...
	while intro:
		...
		middleText = pygame.font.Font("./font.ttf",70)
...
def game_loop():
	global pause
	############
	pygame.mixer.music.load('./tiantiande.wav')
	...
	while not gameExit:
		...
		Img=pygame.image.load('./photos/'+str(thingCount)+'.jpg')
