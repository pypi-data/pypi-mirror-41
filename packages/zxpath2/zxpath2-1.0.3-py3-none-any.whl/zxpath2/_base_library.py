...
def xpath(node, code, index: None or int or str = None):
    xpath_index = _parser_xpath_index(index)
    if xpath_index:
        code = '{}[{}]'.format(code, xpath_index)
        return get_once(node.xpath(code))
...
def get_html(node, encoding=None):
    bhtml = etree.tostring(node, encoding=encoding, with_tail=False)
    if encoding:
...
def _parser_xpath_index(index: None or int or str = None):
    if index is None:
        return
...
def _find(node, prefix, name=None, class_=None, text=None, index: None or int or str = None, **attrs):
...
def find(node, name=None, class_=None, text=None, deep=True, index: None or int or str = None, **attrs):
    '''
    查询节点
    :param node: 原始节点
...
def find_pre(node, name=None, class_=None, text=None, index: None or int or str = None, **attrs):
    # 返回当前节点前面的所有同级元素节点
    return _find(node, 'preceding-sibling::', name=name, class_=class_, text=text, index=index, **attrs)


def find_pre_node(node, name=None, class_=None, text=None, index: None or int or str = None, **attrs):
    # 返回当前节点前面的所有同级元素节点
    return _find(node, 'preceding-sibling::', name=name or '*', class_=class_, text=text, index=index, **attrs)


def find_next(node, name=None, class_=None, text=None, index: None or int or str = None, **attrs):
    # 返回当前节点后面的所有同级元素节点
    return _find(node, 'following-sibling::', name=name, class_=class_, text=text, index=index, **attrs)


def find_next_node(node, name=None, class_=None, text=None, index: None or int or str = None, **attrs):
    # 返回当前节点后面的所有同级元素节点
    return _find(node, 'following-sibling::', name=name or '*', class_=class_, text=text, index=index, **attrs)


def find_child(node, name=None, class_=None, text=None, index: None or int or str = None, **attrs):
    # 返回当前节点的所有子元素节点
    return _find(node, 'child::', name=name, class_=class_, text=text, index=index, **attrs)


def find_child_node(node, name=None, class_=None, text=None, index: None or int or str = None, **attrs):
    # 返回当前节点的所有子元素节点
...
def find_ancestor(node, name=None, class_=None, text=None, index: None or int or str = None, **attrs):
