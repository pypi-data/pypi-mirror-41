...
def init_microsoft(app):
    ...
    class cfg:
        ...
        redirect_uri = f'{config.APP_URL}/auth/microsoft'
    ...
    async def oauth(request):
        ...
        do_generate_url = 'code' not in request.args and (
            not isinstance(request.json, dict) or
        ...
        if do_generate_url:
            return json_response({
                ...
                ) + f'&redirect_uri={cfg.redirect_uri}&scope=user.read'
            })
        ...
        #     email='javier.ballestergarcia@telefonica.com'
        # )
