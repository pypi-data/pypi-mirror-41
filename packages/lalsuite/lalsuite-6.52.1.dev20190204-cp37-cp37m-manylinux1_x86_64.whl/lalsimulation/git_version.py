...
id = "f2c506d70a4b3895620bdecbf8bd7ba0e024569d"
date = "2019-02-2 10:23:05 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "f2c506d70a4b3895620bdecbf8bd7ba0e024569d":
        return
    msg = "Program id (f2c506d70a4b3895620bdecbf8bd7ba0e024569d) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
