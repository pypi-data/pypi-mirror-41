...
id = "c1f9fb2d8a8e0afc8bccdabd42a2b08dcdbaa994"
date = "2019-01-21 11:40:12 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "c1f9fb2d8a8e0afc8bccdabd42a2b08dcdbaa994":
        return
    msg = "Program id (c1f9fb2d8a8e0afc8bccdabd42a2b08dcdbaa994) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
