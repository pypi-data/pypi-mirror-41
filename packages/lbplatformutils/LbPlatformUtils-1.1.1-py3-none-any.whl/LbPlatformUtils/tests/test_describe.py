...
def test_get_binary_tags():
    ...
    expected = ['i686-slc5-gcc43-dbg', 'i686-slc5-gcc43-opt',
                'x86_64-centos-gcc62-dbg', 'x86_64-centos-gcc62-opt',
                'x86_64-centos-gcc7-dbg', 'x86_64-centos-gcc7-opt',
                'x86_64-centos7-gcc49-dbg', 'x86_64-centos7-gcc49-opt',
                'x86_64-centos7-gcc62-dbg', 'x86_64-centos7-gcc62-do0',
                'x86_64-centos7-gcc62-opt', 'x86_64-centos7-gcc7-dbg',
                'x86_64-centos7-gcc7-do0', 'x86_64-centos7-gcc7-opt',
                'x86_64-cerntos7-gcc62-opt', 'x86_64-slc5-gcc43-dbg',
                'x86_64-slc5-gcc43-opt', 'x86_64-slc5-gcc46-dbg',
                'x86_64-slc5-gcc46-opt', 'x86_64-slc5-icc11-dbg',
                'x86_64-slc5-icc11-opt', 'x86_64-slc6-gcc46-dbg',
                'x86_64-slc6-gcc46-opt', 'X86_64-slc6-gcc46-opt',
                'x86_64-slc6-gcc48-dbg', 'x86_64-slc6-gcc48-do0',
                'x86_64-slc6-gcc48-opt', 'x86_64-slc6-gcc49-dbg',
                'x86_64-slc6-gcc49-do0', 'x86_64-slc6-gcc49-opt',
                'x86_64-slc6-gcc62-dbg', 'x86_64-slc6-gcc62-do0',
                'x86_64-slc6-gcc62-opt', 'x86_64+avx-centos7-gcc62-opt+o3',
    ...
    urllib.request.urlopen._overrides[LbPlatformUtils.describe.BINARY_TAGS_URL] = \
        BINARY_TAGS_DATA.replace('<marker>', 'from-url').encode()

    expected[-1] = 'from-url'
    assert LbPlatformUtils.describe.allBinaryTags() == expected

    open._overrides['/some/random/file'] = json.dumps({'rows': [
        {'key': 'none', 'value': '1970-01-01'},
        {'key': 'x86_64-slc6-gcc62-opt', 'value': '2018-02-01'},
        {'key': 'x86_64-centos9-gcc9-opt', 'value': '2020-12-31'},
    ]})
