...
setup(
    ...
    description='utilities from platform detection',  # Required
    ...
    url='https://gitlab.cern.ch/lhcb-core/LbPlatformUtils',  # Optional
    ...
    #     'dev': ['check-manifest'],
    # },
    tests_require=['coverage'] + (['backports.tempfile'] if version_info < (3, 0) else []),
    ...
    data_files=[('share/bash-completion/completions', [
        'shell-completion/bash/_host-binary-tag',
        'shell-completion/bash/_lb-describe-platform',
    ])],  # Optional
    ...
    entry_points={  # Optional
        'console_scripts': [
            ...
            'host-binary-tag=LbPlatformUtils.describe:host_binary_tag_script',
        ],
    },
