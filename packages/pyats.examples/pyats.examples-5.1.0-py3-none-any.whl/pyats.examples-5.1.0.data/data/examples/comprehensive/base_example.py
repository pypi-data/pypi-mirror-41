...
References:
   For the complete and up-to-date user guide on AEtest, visit:
...
#*
#* Note:
#*   pyats.log.utils provides some logging utilities, such as banners & etc
#*
#* Example:
...
class CommonSetup(aetest.CommonSetup):
    ...
    def a_simple_subsection(self):
        ...
        #*
        #* See More:
        #* http://wwwin-pyats.cisco.com/documentation/html/aetest/results.html
    ...
    #*  
    #* Read More:
    #*   http://wwwin-pyats.cisco.com/documentation/html/aetest/loop.html
    ...
    #*
    #*  Read More:
    #*  http://wwwin-pyats.cisco.com/documentation/html/topology/usage.html
    @aetest.subsection
