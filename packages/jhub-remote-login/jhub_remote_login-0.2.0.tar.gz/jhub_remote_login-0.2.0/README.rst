...
class::
    ...
    c.JupyterHub.authenticator_class = 'jhub_remote_login.remote_user_auth.RemoteUserAuthenticator'
...
Alternatively, you can use `RemoteUserLocalAuthenticator`::
    ...
    c.JupyterHub.authenticator_class = 'jhub_remote_login.remote_user_auth.RemoteUserLocalAuthenticator'
