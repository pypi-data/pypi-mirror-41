...
class ContainerProjectOutput(ProjectMixin):
    ...
    def __init__(self, public=None, label=None, info=None, description=None, group=None, id=None, parents=None, info_exists=None, created=None, modified=None, template=None, permissions=None, files=None, notes=None, tags=None, analyses=None):  # noqa: E501
    ...
    @property
    def template(self):
        """Gets the template of this ContainerProjectOutput.


        :return: The template of this ContainerProjectOutput.
        :rtype: object
        """
    ...
    def template(self, template):
        """Sets the template of this ContainerProjectOutput.


        :param template: The template of this ContainerProjectOutput.  # noqa: E501
        :type: object
        """
