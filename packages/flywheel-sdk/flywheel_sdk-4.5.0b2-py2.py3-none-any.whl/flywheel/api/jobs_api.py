...
"""
    ...
    OpenAPI spec version: 4.5.0-beta.2
...
class JobsApi(object):
    ...
    def prepare_compete_job(self, job_id, body, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_'):
            return self.prepare_compete_job_with_http_info(job_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.prepare_compete_job_with_http_info(job_id, body, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def prepare_compete_job_with_http_info(self, job_id, body, **kwargs):  # noqa: E501
        """Create a ticket for completing a job, with id and status.
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method prepare_compete_job" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'job_id' is set
        if ('job_id' not in params or
                params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `prepare_compete_job`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `prepare_compete_job`")  # noqa: E501
