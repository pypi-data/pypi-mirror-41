...
class SQLPublish(object):
    ...
    def insert_caseexpect(self, db_case_expect: DBCaseExpect):
        ...
        sql_response_result = sql_response_result.replace(r'\\', r'\/').replace('"', r'\"').replace("'", r'\'')
        sql_sc = [
    ...
    def insert_case_request(self, db_caserequest: DBCaseRequest):
        header = str(db_caserequest.header).replace(r'\\', r'/').replace('"', r'\"').replace("'", r'\'')
        data = str(db_caserequest.data).replace(r'\\', r'/').replace('"', r'\"').replace("'", r'\'')
        sql_sc = [
    ...
    def insert_case_response(self, db_caseresponse: DBCaseResponse):
        header = str(db_caseresponse.header).replace(r'\\', r'/').replace('"', r'\"').replace("'", r'\'')
        body = str(db_caseresponse.body).replace(r'\\', r'/').replace('"', r'\"').replace("'", r'\'')
        sql_sc = [
