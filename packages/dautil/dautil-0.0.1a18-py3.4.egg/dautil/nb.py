...
class PageBuilder():
    ...
    def __init__(self, prefix, factory):
        ...
        self.keys = collect.filter_dict_keys(lambda x: x.startswith(self.prefix),
                                 mpl.rcParams)
...
class RcWidget():
    ...
    def figure_page(self):
        ...
        height = widgets.FloatSlider(min=0, max=16,
                                     value=mpl.rcParams[figsize.description][0],
                                     description='Height')
        width = widgets.FloatSlider(
            min=0, max=12, value=mpl.rcParams[figsize.description][1],
            description='Width')
