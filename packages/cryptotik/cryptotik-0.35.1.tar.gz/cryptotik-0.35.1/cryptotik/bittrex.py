...
class Bittrex(ExchangeWrapper):
    ...
    url3 = 'https://api.bittrex.com/v3/balances'
    delimiter = "-"
    headers = headers
    ...
    def _auth_headers(self, response):
        pass
    ...
    def _new_private_api(self, url, params):
        '''handles private api methods for APIv3'''
    ...
    def status(self) -> dict:
        ...
        return self.api(self.url3, 'status')['result']
    ...
    def buy_limit(self,
                  ...
                  rate: float,
                  amount: float,
                  time_in_force: str="GOOD_TIL_CANCELLED") -> dict:
        """creates buy order
        : pair - PPC-BTC
        : rate - 0.001
        : amount - 10
        : time_in_force -  GOOD_TIL_CANCELLED, IMMEDIATE_OR_CANCEL, FILL_OR_KILL
        """

        return self.private_api(self.url3 + "/orders",
                                params={"marketName": self.format_pair(pair),
                                        "direction": "BUY",
                                        "type": "LIMIT",
                                        "quantity": amount,
                                        "rate": rate,
