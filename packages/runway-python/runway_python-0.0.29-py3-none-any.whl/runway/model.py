...
class RunwayModel(object):
    ...
    def define_routes(self):
        ...
        def healthcheck():
            return jsonify(message='Model running', started=self.started, accessed=self.accessed)

        @self.app.route('/')
        def manifest():
            return jsonify(options=to_long_spec(self.options), commands=to_long_spec(self.commands))
    ...
    def parse_opts(self):
        ...
        parser.add_argument('--manifest', action='store_true', help='Show model manifest')
