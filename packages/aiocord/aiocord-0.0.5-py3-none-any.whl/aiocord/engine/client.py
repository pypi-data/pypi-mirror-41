...
class Client:
    ...
    def get_audit_log(self):
        ...
        return self._rest.get_audit_log()
    ...
    def get_messages(self, *path, limit = 50, before = None, **data):
    ...
    def delete_message(self, *path):
        ...
        return self._rest.delete_message(*path, **data)

    def get_reactions(self, *path, limit = 50, after = None, **data):
    ...
    def get_invite(self, *path):

        return self._rest.get_invite(*path)
    ...
    def add_pin(self, *path):
        ...
        return self._rest.add_pin(*path)

    def pop_pin(self, *path):

        return self._rest.pop_pin(*path)

    def add_recipient(self, *path, **data):

        return self._rest.add_recipient(*path, **data)

    def pop_recipient(self, *path, **data):

        return self._rest.pop_recipient(*path, **data)
    ...
    def get_guilds(self, limit = 100, after = None, **data):
    ...
    def get_members(self, *path, limit = 1, after = None, **data):
    ...
    def create_member(self, *path, **data):
        ...
        return self._rest.add_member(*path, **data)
    ...
    def delete_member(self, *path, **data):
        ...
        return self._rest.pop_member(*path)
