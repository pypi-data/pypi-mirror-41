...
class Client:
    ...
    async def _stream(self):
        ...
        while not self._session.closed:
            ...
            async for (type, data, extra) in self._websocket:
    ...
    async def request_guild_members(self, guild_id, query, limit):
    ...
    async def update_voice_state(self, guild_id, channel_id, mute, deaf):
    ...
    async def update_status(self, game, status, afk, since):
