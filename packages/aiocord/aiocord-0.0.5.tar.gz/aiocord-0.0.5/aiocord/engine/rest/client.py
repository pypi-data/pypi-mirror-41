...
class Client:
    ...
    async def get_message(self, *path):
        ...
        data = await self._client.get_channel_message(path, data)
    ...
    async def get_reactions(self, *path):

        data = await self._client.get_reactions(path)
    ...
    async def prune_messages(self, *path, **data):
    ...
    async def add_recipient(self, *path, **data):
    ...
    async def pop_recipient(self, *path):
    ...
    async def add_member(self, *path, **data):
    ...
    async def pop_member(self, *path):
    ...
    async def delete_role(self, *path):
        ...
        data = await self._client.delete_guild_role(path, data)
