...
#============================================================
echo "Running LC2MS processes on station BB_1"
#============================================================
...
./lc2ms $lchfile -d "$STATION_DIR" -i "1_proprietary" -o "2_miniseed_basic" -m ":%E.%S.00.%C.%Y.%D.%T.%H_%I.mseed" --experiment "4G" --sitename "BB_1" --obstype "BBOBS1" --sernum "02" -p $Config_lc2ms_Path/lc2ms.properties 
)
