...
#============================================================
echo "Running SDPCHAIN processes on station LSVE"
#============================================================
...
STATION_DIR=/Volumes/PARC_OBS_Wayne/DATA_EXPERIMENTS/2017-18.AlpArray/2017-18.AlpArray/LSVE
...
./ms2sds $mseedfiles -d $STATION_DIR -i "2_miniseed_basic" -o "SDS_uncorrected" --network "4G" --station "LSVE" -a SDS -p $Config_ms2sds_Path/ms2sds.properties) #-v
...
# - Run executable
START_REFR="2015-04-21T21:06:00"
START_INST="0"
END_REFR="2016-05-28T20:59:00.32"
END_INST="2016-05-28T20:59:01"
...
# - Run executable
(command cd $Execut_dir_ms2sds
./ms2sds $mseedfiles -d $STATION_DIR -i "3_miniseed_corr" -o "SDS_corrected" --network "4G" --station "LSVE" -a SDS -p $Config_ms2sds_Path/ms2sds.properties) #-v
