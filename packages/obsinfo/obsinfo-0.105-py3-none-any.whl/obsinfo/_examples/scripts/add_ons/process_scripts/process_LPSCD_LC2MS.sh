...
#============================================================
echo "Running LC2MS processes on station LPSCD"
#============================================================
...
./lc2ms $lchfile -d "$STATION_DIR" -i "1_proprietary" -o "2_miniseed_basic" -m ":%E.%S.00.%C.%Y.%D.%T.%H_%I.mseed" --experiment "4G" --sitename "LPSCD" --obstype "SPOBS2" --sernum "Station01" -p $Config_lc2ms_Path/lc2ms.properties 
)
