...
#============================================================
echo "Running SDPCHAIN processes on station LPSCD"
#============================================================
...
STATION_DIR=/Volumes/PARC_OBS_Wayne/DATA_EXPERIMENTS/2017-18.AlpArray/2017-18.AlpArray/LPSCD
...
./ms2sds $mseedfiles -d $STATION_DIR -i "2_miniseed_basic" -o "SDS_uncorrected" --network "4G" --station "LPSCD" -a SDS -p $Config_ms2sds_Path/ms2sds.properties) #-v
...
# - Run executable
START_REFR="2016-07-01T16:00:00"
START_INST="0"
END_REFR="2017-07-01T15:35:00.555"
END_INST="2017-07-01T15:35:00"
...
# - Run executable
(command cd $Execut_dir_ms2sds
./ms2sds $mseedfiles -d $STATION_DIR -i "3_miniseed_corr" -o "SDS_corrected" --network "4G" --station "LPSCD" -a SDS -p $Config_ms2sds_Path/ms2sds.properties) #-v
