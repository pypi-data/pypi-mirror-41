...
#============================================================
echo "Running SDPCHAIN processes on station LSVW"
#============================================================
...
STATION_DIR=/Volumes/PARC_OBS_Wayne/DATA_EXPERIMENTS/2017-18.AlpArray/2017-18.AlpArray/LSVW
...
./ms2sds $mseedfiles -d $STATION_DIR -i "2_miniseed_basic" -o "SDS_uncorrected" --network "4G" --station "LSVW" -a SDS -p $Config_ms2sds_Path/ms2sds.properties) #-v
...
# - Run executable
(command cd $Execut_dir_ms2sds
./ms2sds $mseedfiles -d $STATION_DIR -i "3_miniseed_corr" -o "SDS_corrected" --network "4G" --station "LSVW" -a SDS -p $Config_ms2sds_Path/ms2sds.properties) #-v
