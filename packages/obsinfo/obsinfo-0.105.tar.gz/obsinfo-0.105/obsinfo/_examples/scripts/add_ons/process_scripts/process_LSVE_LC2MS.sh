...
#============================================================
echo "Running LC2MS processes on station LSVE"
#============================================================
...
./lc2ms $lchfile -d "$STATION_DIR" -i "1_proprietary" -o "2_miniseed_basic" -m ":%E.%S.00.%C.%Y.%D.%T.%H_%I.mseed" --experiment "4G" --sitename "LSVE" --obstype "SPOBS2" --sernum "12" -p $Config_lc2ms_Path/lc2ms.properties 
)
