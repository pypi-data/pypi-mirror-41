...
#============================================================
echo "Running SDPCHAIN processes on station SP_1"
#============================================================
...
STATION_DIR=/Volumes/PARC_OBS_Wayne/DATA_EXPERIMENTS/2017-18.AlpArray/2017-18.AlpArray/SP_1
...
./ms2sds $mseedfiles -d $STATION_DIR -i "2_miniseed_basic" -o "SDS_uncorrected" --network "4G" --station "SP_1" -a SDS -p $Config_ms2sds_Path/ms2sds.properties) #-v
...
# - Run executable
START_REFR="2015-04-22T09:21:00"
START_INST="0"
END_REFR="2016-05-28T22:59:00.1843"
END_INST="2016-05-28T22:59:02"
...
# - Run executable
(command cd $Execut_dir_ms2sds
./ms2sds $mseedfiles -d $STATION_DIR -i "3_miniseed_corr" -o "SDS_corrected" --network "4G" --station "SP_1" -a SDS -p $Config_ms2sds_Path/ms2sds.properties) #-v
