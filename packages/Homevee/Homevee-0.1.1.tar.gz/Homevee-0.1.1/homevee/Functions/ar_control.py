...
from DeviceAPI.heating import get_thermostats
from DeviceAPI.get_modes import get_modes
from DeviceAPI.rgb_control import get_rgb_device
from Functions.tensorflow_functions import ar_control_predict, ar_control_retrain
from DeviceAPI.set_modes import set_modes
from Helper.helper_functions import has_permission
from Functions.condition_actions.actions import run_scene
from homevee.constants import DATA_DIR
from homevee.db_utils import get_server_data, get_database_con, set_server_data
from homevee.device_types import *
from file_utils import create_image
...
def ar_control(username, image_data, db):
    ...
    print(image_path)
    print class_data['NAME'] + ": " + str(predictions[0]['confidence']*100)
