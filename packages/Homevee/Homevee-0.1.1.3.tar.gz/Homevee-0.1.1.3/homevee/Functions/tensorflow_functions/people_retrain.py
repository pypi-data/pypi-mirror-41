...
from homevee.db_utils import get_database_con, get_server_data
from file_utils import get_image_directory_path
    ...
    with db:
        ...
        for label in labels:
            ...
            for data in cur.fetchall():
                ...
                print("Pfad: " + str(os.path.join(constants.DATA_DIR, data['PATH'])))
            ...
            print(label)
            print("Validation: " + str(len(validation_images)))
            print("Testing: " + str(len(testing_images)))
            print("Training: " + str(len(training_images)))
...
def people_training(username):
    ...
    try:
        ...
        print("error reading PEOPLE_TF_TRAINING_STEPS, using default: "+str(how_many_training_steps))
    ...
    try:
        ...
        print("error reading data, using default architecture: "+str(architecture))
