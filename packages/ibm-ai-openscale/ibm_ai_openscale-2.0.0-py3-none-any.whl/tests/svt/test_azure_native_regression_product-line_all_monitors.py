...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_10_score_model_and_log_payload(self):
        ...
        TestAIOpenScaleClient.scoring_records = 13
    ...
    def test_15_send_feedback_data(self):
        ...
        TestAIOpenScaleClient.feedback_records = 17
        for i in range(0, self.feedback_records):
            feedback_data.append(["F", 27, "Single", "Professional", "Personal Accessories"])

        self.subscription.feedback_logging.store(feedback_data=feedback_data, fields=fields)
        time.sleep(10)
    ...
    def test_28_disable_payload_logging_and_performance_monitoring(self):
