...
class SageMakerMachineLearningAsset(KnownServiceAsset):
    """
    Describes SageMaker Machine Learning asset.
    ...
    >>>
    >>> SageMakerMachineLearningAsset(source_uid=source_uid, binding_uid=binding_uid, input_data_type=InputDataType.STRUCTURED,
    >>>             problem_type=ProblemType.BINARY_CLASSIFICATION, prediction_column='predicted_label', label_column='diagnosis',
    ...
    def __init__(self, source_uid, binding_uid=None, problem_type=None, input_data_type=None,
                 ...
                 feature_columns=None, categorical_columns=None):
