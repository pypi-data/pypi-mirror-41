...
class SPSSMachineLearningAsset(KnownServiceAsset):
    """
    Describes SPSS Machine Learning asset.
    ...
    :type training_data_reference: json
    ...
    :param class_probability_columns: names of columns/fields with particular class probability (optional)
    :type class_probability_columns: list
    ...
    >>>
    >>> SPSSMachineLearningAsset(source_uid=uid, binding_uid=binding_uid, input_data_type=InputDataType.STRUCTURED,
    >>>         problem_type=ProblemType.BINARY_CLASSIFICATION, label_column='Risk', prediction_column='$N-RISK')
    """
    ...
    def __init__(self, source_uid, binding_uid=None, problem_type=None, input_data_type=None,
                 ...
                 class_probability_columns=None, feature_columns=None, categorical_columns=None):
        ...
        validate_type(class_probability_columns, 'class_probability_columns', list, mandatory=False)
        ...
        KnownServiceAsset.__init__(self, source_uid=source_uid, binding_uid=binding_uid, problem_type=problem_type,
                                   ...
                                   probability_column=probability_column, class_probability_columns=class_probability_columns,
