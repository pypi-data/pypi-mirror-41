...
class ClientWithMLGatewaySupport(Client):
    ...
    def _make_artifact_from_details(self, details):
        return Artifact(
            ...
            details['entity']['asset']['url'] if 'url' in details['entity']['asset'] else details['entity']['scoring_endpoint']['url'], # custom special case
            self.binding_uid,
            details['entity']['asset']['name'],
            details['entity']['asset']['asset_type'] if 'asset_type' in details['entity']['asset'] else 'model',
            details['entity']['asset']['created_at'] if 'created_at' in details['entity']['asset'] else details['metadata']['created_at'],
            [],
            details,
            details['entity']['asset_properties'],
            details['entity']['asset']['asset_rn'] if 'asset_rn' in details['entity']['asset'] else ''
        )
