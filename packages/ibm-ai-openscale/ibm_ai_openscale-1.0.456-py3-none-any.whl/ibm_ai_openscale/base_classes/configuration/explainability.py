...
class Explainability(TableFromRestApiViewer):
    ...
    def enable(self, feature_columns=None, categorical_columns=None, label_column=None, problem_type=None, input_data_type=None, training_data_reference=None, training_data_statistics=None):
        ...
        if feature_columns is not None or categorical_columns is not None or label_column is not None \
            or problem_type is not None or input_data_type is not None or training_data_reference is not None:
            print("DeprecationWarning: 'feature_columns, categorical_columns, label_column, problem_type, input_data_type, training_data_reference' parameters are deprecated and will be removed in 1.2.0 release; use corresponding params during creating asset instead.")
        ...
        if training_data_reference is None and training_data_statistics is None and input_data_type == InputDataType.STRUCTURED:
