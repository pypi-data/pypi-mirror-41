...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_13_send_feedback_data(self):
        ...
        TestAIOpenScaleClient.subscription.feedback_logging.store(feedback_data=feedback_data, feedback_format=FeedbackFormat.TEXT, data_header=True, data_delimiter=',')
