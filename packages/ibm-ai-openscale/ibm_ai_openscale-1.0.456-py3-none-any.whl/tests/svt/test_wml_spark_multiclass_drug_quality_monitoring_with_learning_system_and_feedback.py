...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_10_setup_quality_monitoring(self):
        ...
        try:
            ...
            self.fail("Unable to enable quality monitoring.")
    ...
    def test_13_set_learning_system(self):
        if not self.quality_monitoring_enabled:
            self.skipTest("Quality monitoring is not enabled.")
    ...
    def test_14_run_learning_iteration(self):
        if not self.quality_monitoring_enabled:
            self.skipTest("Quality monitoring is not enabled.")
