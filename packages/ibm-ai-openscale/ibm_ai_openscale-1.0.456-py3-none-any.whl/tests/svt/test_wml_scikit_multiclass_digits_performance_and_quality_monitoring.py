...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_05_prepare_deployment(self):
        asset_name = "AIOS Spark Digits Model"
    ...
    def test_19_disable_quality_monitoring(self):
        ...
        TestAIOpenScaleClient.subscription.performance_monitoring()
        TestAIOpenScaleClient.subscription.quality_monitoring()


        assert_monitors_enablement()
