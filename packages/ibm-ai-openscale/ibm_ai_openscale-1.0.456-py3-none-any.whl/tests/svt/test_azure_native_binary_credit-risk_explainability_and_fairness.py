...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_12_stats_on_payload_logging_table(self):
        ...
        self.assertTrue('CheckingStatus' in str(payload_table_content))
    ...
    def test_13_setup_explainability(self):
    ...
    def test_16_run_explainability(self):
        ...
        print("Explainability run: {}".format(explainability_run))
        statuses = explainability_run['entity']['status']
        print("Explainability statuses: {}".format(statuses))
    ...
    def test_19_setup_fairness_monitoring(self):
        from ibm_ai_openscale.supporting_classes import Feature

        with open('assets/training_distribution_german_credit_risk.json') as json_file:
            training_data_statistics = json.load(json_file)
        TestAIOpenScaleClient.subscription.fairness_monitoring.enable(
                features=[
                    Feature("Sex", majority=['male'], minority=['female'], threshold=0.8),
                    Feature("Age", majority=[[31, 60]], minority=[[15, 30], [61, 120]], threshold=0.8)
                ],
    ...
    def test_23_disable_explainability(self):
        TestAIOpenScaleClient.subscription.explainability.disable()

    def test_24_disable_payload_logging(self):
        TestAIOpenScaleClient.subscription.payload_logging.disable()

    def test_25_get_quality_metrics(self):
