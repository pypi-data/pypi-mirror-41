...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_12_stats_on_payload_logging_table(self):
        ...
        self.assertIn('Scored Labels', str(payload_table_content))
    ...
    def test_16_send_feedback_data(self):
        ...
        self.subscription.feedback_logging.store(feedback_data=feedback_records, fields=fields)
        time.sleep(10)
    ...
    def test_22_disable_performance_monitoring(self):
