...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_05_prepare_deployment(self):
        model_name = "AIOS Spark Drug learning model"
        deployment_name = "AIOS Spark Drug learning deployment"
    ...
    def test_12_set_learning_system(self):
        """
    ...
    def test_13_run_learning_iteration(self):
    ...
    def test_16_disable_quality_monitoring(self):
