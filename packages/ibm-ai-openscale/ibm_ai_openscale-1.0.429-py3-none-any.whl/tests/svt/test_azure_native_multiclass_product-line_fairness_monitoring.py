...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_11_setup_fairness_monitoring(self):
        ...
        TestAIOpenScaleClient.subscription.fairness_monitoring.enable(
            ...
            favourable_classes=['Golf Equipment'],
            unfavourable_classes=['Personal Accessories'],
            min_records=4,
    ...
    def test_13_run(self):
        run_details = TestAIOpenScaleClient.subscription.fairness_monitoring.run()
        print('Run details: ' + str(run_details))

        print("Fairness details: {}".format(TestAIOpenScaleClient.subscription.fairness_monitoring.get_details()))
        import time
        time.sleep(2 * 60)
        print("Fairness details: {}".format(TestAIOpenScaleClient.subscription.fairness_monitoring.get_details()))

    def test_14_stats_on_fairness_monitoring_table(self):
        TestAIOpenScaleClient.subscription.payload_logging.show_table()
    ...
    def test_16_get_metrics(self):
        ...
        print(TestAIOpenScaleClient.ai_client.data_mart.get_deployment_metrics(metric_type='fairness'))
