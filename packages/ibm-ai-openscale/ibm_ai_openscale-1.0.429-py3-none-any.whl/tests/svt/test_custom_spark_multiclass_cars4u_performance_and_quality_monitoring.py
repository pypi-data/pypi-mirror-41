...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_05_subscribe_custom(self):
        subscription = self.ai_client.data_mart.subscriptions.add(CustomMachineLearningAsset(source_uid='action', prediction_column='predictedActionLabel', binding_uid=self.binding_uid))
