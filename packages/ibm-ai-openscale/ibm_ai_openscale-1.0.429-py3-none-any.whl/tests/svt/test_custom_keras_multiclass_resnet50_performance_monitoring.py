...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_05_subscribe_custom(self):
        ...
        subscription = self.ai_client.data_mart.subscriptions.add(CustomMachineLearningAsset(source_uid='resnet50', binding_uid=self.binding_uid, input_data_type=InputDataType.UNSTRUCTURED_IMAGE), deployment_uids=['resnet50'])
