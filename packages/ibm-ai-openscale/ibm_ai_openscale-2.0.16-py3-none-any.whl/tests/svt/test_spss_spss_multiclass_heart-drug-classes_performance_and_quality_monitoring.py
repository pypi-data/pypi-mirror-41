...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_22_setup_explainability(self):
        ...
        # with open('assets/training_distribution_spss_multiclass_drug_selection.json') as json_file:
    ...
    def test_25_setup_fairness_monitoring(self):
        ...
        #     data_df,
        #     {
        #         "model_type": ProblemType.MULTICLASS_CLASSIFICATION,
        #         "class_label": 'Drug',
        #         "feature_columns": ['Age', 'Sex', 'BP', 'Cholesterol', 'Na', 'K'],
        #         "categorical_columns": ['Sex', 'BP', 'Cholesterol'],
        #         "fairness_inputs": {
        ...
        #             ],
        #             "min_records": 5,
        #             "favourable_class": ['drugA', 'drugC', 'drugY'],
        #             "unfavourable_class": ['drugB', 'drugX']
        #         }
        #     }
        # ).get_training_statistics()
        #
        # self.assertIsNotNone(self.training_data_statistics)
