...
class TrainingStats():
    ...
    def __computeTrainingDataDistribution(self):
        ...
        try:
            ...
            if self.model_type is not None and self.model_type == "regression":
                ...
                distribution_data = self.__compute_regression_training_distribution(data, fairness_attributes_list,
                                                                                    favourable_unfavourable_class,
                                                                                    feature_data_types)
            else:
                distribution_data = self.__compute_training_distribution(data_frame, data, self.training_data_info,
    ...
    def __compute_regression_training_distribution(self, data, fairness_attributes, favourable_classes,
                                                   feature_data_types):
        distribution_data = []
        distinct_data = {}
    ...
    def __compute_training_distribution(self, payload_df, data, request_payload, feature_attributs, feature_data_types):
        ...
        fairness_params = {"class_label": self.training_data_info["class_label"],
                           "fairness_attributes": fairness_attributes_list}
