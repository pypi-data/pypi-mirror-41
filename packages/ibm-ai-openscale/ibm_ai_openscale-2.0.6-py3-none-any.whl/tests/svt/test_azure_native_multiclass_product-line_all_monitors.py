...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_12_stats_on_payload_logging_table(self):
        ...
        assert_payload_logging_python_table_content(python_table_content=python_table_content, fields=['Scored Probabilities', 'Scored Labels', 'Scored Probabilities for Class "Personal Accessories"'])
