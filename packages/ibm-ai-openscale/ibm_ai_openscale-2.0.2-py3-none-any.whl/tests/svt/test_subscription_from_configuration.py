...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_04_subscribe_sagemaker_asset_from_configuration(self):
        with open('assets/sagemaker_native_multiclass_breast-cancer_all_monitors_sub_configuration.json', 'r') as fp:
    ...
    def test_08_score_model_and_log_payload(self):
        ...
        request, response, response_time = self.score(binding_details=binding_details,
        ...
        records_list.append(PayloadRecord(request=request, response=response, response_time=int(response_time), scoring_id=TestAIOpenScaleClient.transaction_id))
        for i in range(0, 15):
    ...
    def test_17_run_explainability(self):
    ...
    def test_18_print_explainability_table_schema(self):
        TestAIOpenScaleClient.subscription.explainability.print_table_schema()

    def test_19_stats_on_explainability_table(self):
    ...
    def test_20_run_fairness(self):
        run_details = TestAIOpenScaleClient.subscription.fairness_monitoring.run(deployment_uid=self.deployment_uid, background_mode=False)
        print("Run details: {}".format(run_details))
    ...
    def test_21_stats_on_fairness_monitoring_table(self):
    ...
    def test_22_load_subscription_configuration_again(self):
    ...
    def test_23_delete_subscription_and_load_again(self):
    ...
    def test_24_run_quality_monitor_again(self):
        # TODO
        pass

    def test_25_disable_all_monitors(self):
