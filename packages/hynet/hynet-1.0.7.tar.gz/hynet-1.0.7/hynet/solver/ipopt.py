    ...
    def _get_hessian_index(qcqp):
        ...
        **Remark:** This method as well as ``_get_hessian_data`` assumes that
        ...
        row = np.concatenate((range_v,               # Diag. top-left
                              ...
                              e_dst,                 # Off-diag. top-left
                              e_dst + qcqp.dim_v,    # Off-diag. bottom-right
                              e_src + qcqp.dim_v,    # Off-diag. bottom-left
                              e_dst + qcqp.dim_v))   # Off-diag. bottom-left

        col = np.concatenate((range_v,               # Diag. top-left
                              range_v + qcqp.dim_v,  # Diag. bottom-right
                              e_src,                 # Off-diag. top-left
                              e_src + qcqp.dim_v,    # Off-diag. bottom-right
                              e_dst,                 # Off-diag. bottom-left
                              e_src))                # Off-diag. bottom-left
        return row, col
