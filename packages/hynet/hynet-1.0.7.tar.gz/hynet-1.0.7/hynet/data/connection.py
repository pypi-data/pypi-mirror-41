...
class DBConnection:
    ...
    def grid_name(self):
        ...
        return '' if self.empty else self.get_setting(DBInfoKey.GRID_NAME)
    ...
    def description(self):
        ...
        if self.empty:
            return ''
        return textwrap.fill(self.get_setting(DBInfoKey.DESCRIPTION),
                             width=DESCRIPTION_LINE_LENGTH)
