...
def interactive_walras(**kwargs):
    ...
    widgets.interact(_interactive_walras,
        ...
        gamma=widgets.FloatSlider(description='$\\gamma$',
            min=kwargs['gamma_min'], max=kwargs['gamma_max'], step=kwargs['gamma_step'], value=kwargs['gamma']),    
        A=widgets.FloatSlider(description='A',
            min=kwargs['A_min'], max=kwargs['A_max'], step=kwargs['A_step'], value=kwargs['A']),                            
        w=widgets.BoundedFloatText(description='$w$',min=0.05, max=2.00, step=0.001, value=0.2),
