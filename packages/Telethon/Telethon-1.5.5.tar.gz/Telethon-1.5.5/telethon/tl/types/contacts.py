...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypePeer, TypeChat, TypeContactLink, TypePopularContact, TypeTopPeerCategoryPeers, TypeImportedContact, TypeUser, TypeContact, TypeContactBlocked
