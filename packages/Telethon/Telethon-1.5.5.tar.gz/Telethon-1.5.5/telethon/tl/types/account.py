...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypePasswordKdfAlgo, TypePrivacyRule, TypeWebAuthorization, TypeSecureRequiredType, TypeSecureValue, TypeSecureSecretSettings, TypeUser, TypeAuthorization, TypeSecureValueError, TypeSecurePasswordKdfAlgo, TypeWallPaper
