...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeFoundGif, TypeEncryptedFile, TypeChat, TypeStickerSet, TypeChatFull, TypeStickerSetCovered, TypeDocument, TypeBotInlineResult, TypeInlineBotSwitchPM, TypeUser, TypeMessage, TypeStickerPack, TypeDialog, TypeHighScore
