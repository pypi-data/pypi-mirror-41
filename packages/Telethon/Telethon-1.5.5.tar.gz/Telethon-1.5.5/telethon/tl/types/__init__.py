...
class WallPaper(TLObject):
    CONSTRUCTOR_ID = 0xf04f91ec
    SUBCLASS_OF_ID = 0x96a2c98b

    def __init__(self, id, access_hash, slug, document, creator=None, default=None):
        """
        :param int id:
        :param int access_hash:
        :param str slug:
    ...
    def __bytes__(self):
        return b''.join((
            b'\xec\x91O\xf0',
            struct.pack('<q', self.id),
            struct.pack('<I', (0 if self.creator is None or self.creator is False else 1) | (0 if self.default is None or self.default is False else 2)),
            struct.pack('<q', self.access_hash),
            self.serialize_bytes(self.slug),
            bytes(self.document),
        ))
    ...
    def from_reader(cls, reader):
        ...
        _slug = reader.tgread_string()
        _document = reader.tgread_object()
        return cls(id=_id, access_hash=_access_hash, slug=_slug, document=_document, creator=_creator, default=_default)
