...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputBotInlineMessageID, TypeInputBotInlineResult, TypeInputChatPhoto, TypeInlineBotSwitchPM, TypeBool, TypeMessageEntity, TypeSendMessageAction, TypeChatBannedRights, TypeReportReason, TypeInputSingleMedia, TypeInputMessage, TypeInputStickerSet, TypeInputPeer, TypeInputDialogPeer, TypeInputGeoPoint, TypeInputUser, TypeReplyMarkup, TypeInputEncryptedFile, TypeInputMedia, TypeShippingOption, TypeInputDocument, TypeInputStickeredMedia, TypeInputEncryptedChat, TypeMessagesFilter
