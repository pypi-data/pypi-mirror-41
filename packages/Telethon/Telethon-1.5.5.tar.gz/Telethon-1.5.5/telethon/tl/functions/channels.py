...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChatBannedRights, TypeChannelParticipantsFilter, TypeBool, TypeChannelAdminLogEventsFilter, TypeInputStickerSet, TypeInputUser, TypeInputChatPhoto, TypeInputChannel, TypeInputMessage, TypeChatAdminRights
