...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputSecureValue, TypeInputPrivacyRule, TypeAccountDaysTTL, TypeInputPeer, TypeInputPeerNotifySettings, TypeInputNotifyPeer, TypeInputWallPaper, TypeInputFile, TypeInputCheckPasswordSRP, TypeInputPrivacyKey, TypeReportReason, TypeSecureValueHash, TypeSecureValueType, TypeSecureCredentialsEncrypted, TypeBool
...
class SaveWallPaperRequest(TLRequest):
    CONSTRUCTOR_ID = 0x189581b3
    SUBCLASS_OF_ID = 0xf5b399ac

    def __init__(self, wallpaper, unsave):
        """
        :param TypeInputWallPaper wallpaper:
    ...
    def from_reader(cls, reader):
        ...
        return cls(wallpaper=_wallpaper, unsave=_unsave)
...
class UploadWallPaperRequest(TLRequest):
    ...
    def from_reader(cls, reader):
        ...
        return cls(file=_file, mime_type=_mime_type)
