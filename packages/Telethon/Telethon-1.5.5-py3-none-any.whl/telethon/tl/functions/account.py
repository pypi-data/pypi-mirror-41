...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputWallPaper, TypeInputCheckPasswordSRP, TypeSecureValueHash, TypeAccountDaysTTL, TypeInputFile, TypeReportReason, TypeInputPrivacyRule, TypeInputPrivacyKey, TypeInputPeerNotifySettings, TypeSecureCredentialsEncrypted, TypeInputPeer, TypeSecureValueType, TypeInputSecureValue, TypeInputNotifyPeer, TypeBool
