...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputStickerSet, TypeSendMessageAction, TypeInputChatPhoto, TypeInputBotInlineMessageID, TypeReplyMarkup, TypeMessageEntity, TypeInlineBotSwitchPM, TypeInputPeer, TypeInputUser, TypeInputSingleMedia, TypeInputStickeredMedia, TypeChatBannedRights, TypeBool, TypeInputEncryptedChat, TypeInputBotInlineResult, TypeInputMedia, TypeInputGeoPoint, TypeReportReason, TypeInputEncryptedFile, TypeMessagesFilter, TypeShippingOption, TypeInputDialogPeer, TypeInputDocument, TypeInputMessage
