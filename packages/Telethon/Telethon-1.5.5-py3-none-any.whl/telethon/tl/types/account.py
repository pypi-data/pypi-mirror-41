...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSecurePasswordKdfAlgo, TypeWallPaper, TypeUser, TypeSecureValueError, TypeWebAuthorization, TypeAuthorization, TypePrivacyRule, TypePasswordKdfAlgo, TypeSecureSecretSettings, TypeSecureValue, TypeSecureRequiredType
