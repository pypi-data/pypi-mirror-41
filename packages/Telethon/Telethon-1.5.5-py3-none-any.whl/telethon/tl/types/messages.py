...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeStickerPack, TypeUser, TypeInlineBotSwitchPM, TypeHighScore, TypeChatFull, TypeFoundGif, TypeDialog, TypeStickerSetCovered, TypeStickerSet, TypeBotInlineResult, TypeDocument, TypeEncryptedFile, TypeChat, TypeMessage
