...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeUser, TypeContactBlocked, TypeContactLink, TypeContact, TypePopularContact, TypePeer, TypeTopPeerCategoryPeers, TypeChat, TypeImportedContact
