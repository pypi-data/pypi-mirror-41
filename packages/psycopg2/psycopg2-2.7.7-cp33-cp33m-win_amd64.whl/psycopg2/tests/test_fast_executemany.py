...
class TestPaginate(unittest.TestCase):
    def test_paginate(self):
        ...
        self.assertEqual(list(pag(list(range(99)))), [list(range(99))])
        self.assertEqual(list(pag(list(range(100)))), [list(range(100))])
        self.assertEqual(list(pag(list(range(101)))), [list(range(100)), [100]])
        self.assertEqual(
            list(pag(list(range(200)))), [list(range(100)), list(range(100, 200))])
        self.assertEqual(
            list(pag(list(range(1000)))),
