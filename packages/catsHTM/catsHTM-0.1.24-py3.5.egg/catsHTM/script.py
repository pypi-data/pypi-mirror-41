        ...
        for i in range(Nh1): #for each trixels in the highest level of Cat1
            ...
            if HTM1[index_cat1-1]['Nsrc']>0:#if the trixel contains sources:
                ...
                if len(Cat2)>0:
                    ...
                    print('i (or matlab Ih1-1)={0},indexes_analog_to_matlab must be matlab Indcatmindist-1 everywhere, check if this is the case: {1}'.format(i,indexes_analog_to_matlab))
                    #pdb.set_trace()
                    ...
                    np.savetxt('Cat2matched.txt',Cat2matched) #pas ok
