...
if lib_checker.installed_libs[SCIKIT]:
    from watson_machine_learning_client.libs.repository_v3.mlrepositoryartifact.scikit_pipeline_reader import ScikitPipelineReader
    from watson_machine_learning_client.libs.repository_v3.mlrepositoryartifact.xgboost_model_reader import XGBoostModelReader
    from sklearn.base import BaseEstimator
    from watson_machine_learning_client.libs.repository_v3.mlrepositoryartifact.version_helper import ScikitVersionHelper, XGBoostVersionHelper

if lib_checker.installed_libs[XGBOOST]:
    from xgboost import XGBRegressor, XGBClassifier
    from watson_machine_learning_client.libs.repository_v3.mlrepositoryartifact.version_helper import ScikitVersionHelper
    import sys
    try:
