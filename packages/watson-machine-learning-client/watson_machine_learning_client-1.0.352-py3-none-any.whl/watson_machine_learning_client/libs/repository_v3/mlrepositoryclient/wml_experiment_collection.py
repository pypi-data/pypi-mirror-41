...
from repository_v3.swagger_client.models import ExperimentInput,TagRepository,\
    ExperimentInputSettings,MetricObjectExperiments,HyperParametersOptimizationExperiments,EvaluationDefinitionExperiments
from repository_v3.swagger_client.models import TrainingReferenceExperiments,ComputeConfigurationExperiments
...
from repository_v3.swagger_client.models import HyperParametersOptimizationExperimentsMethodParameters, HyperParametersOptimizationExperimentsMethod, \
...
class WmlExperimentCollection:
    ...
    def __init__(self, base_path, repository_api, client):
        ...
        from repository_v3.mlrepositoryclient import MLRepositoryApi
