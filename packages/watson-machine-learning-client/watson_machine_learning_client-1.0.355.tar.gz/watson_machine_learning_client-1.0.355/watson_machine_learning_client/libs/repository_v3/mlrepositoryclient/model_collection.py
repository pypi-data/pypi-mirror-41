...
from watson_machine_learning_client.libs.repository_v3.swagger_client.rest import ApiException
from watson_machine_learning_client.libs.repository_v3.mlrepository import  ModelArtifact
from watson_machine_learning_client.libs.repository_v3.mlrepository import MetaNames
from watson_machine_learning_client.libs.repository_v3.swagger_client.models import ModelInput, ModelVersionInput, ModelTrainingDataRef, ModelVersionOutput, \
...
from watson_machine_learning_client.libs.repository_v3.swagger_client.models import EvaluationDefinitionMetrics, ConnectionObjectWithNameRepository, ArrayDataInputRepository, EvaluationDefinitionRepositoryMetrics
from watson_machine_learning_client.libs.repository_v3.swagger_client.models import MlAssetsCreateModelInput, FrameworkOutputRepository, AuthorRepository, EvaluationDefinitionRepository, FrameworkOutputRepositoryLibraries,FrameworkOutputRepositoryRuntimes
from watson_machine_learning_client.libs.repository_v3.swagger_client.models import ContentLocation,HyperParameters
from watson_machine_learning_client.libs.repository_v3.util.json_2_object_mapper import Json2ObjectMapper
from watson_machine_learning_client.libs.repository_v3.util.exceptions import UnsupportedTFSerializationFormat,InvalidCaffeModelArchive
from watson_machine_learning_client.libs.repository_v3.swagger_client.models import  MlAssetsModelSizeOutput
from watson_machine_learning_client.libs.repository_v3.util.unique_id_gen import uid_generate
from watson_machine_learning_client.libs.repository_v3.swagger_client.models.framework_output_repository_runtimes import FrameworkOutputRepositoryRuntimes
...
class ModelCollection:
    ...
    def __init__(self, base_path, repository_api, client):
        ...
        from watson_machine_learning_client.libs.repository_v3.mlrepositoryclient import MLRepositoryClient
        from watson_machine_learning_client.libs.repository_v3.mlrepositoryclient import MLRepositoryApi
