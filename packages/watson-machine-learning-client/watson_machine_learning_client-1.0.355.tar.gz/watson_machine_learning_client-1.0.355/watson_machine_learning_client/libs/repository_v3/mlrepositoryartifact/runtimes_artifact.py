...
from watson_machine_learning_client.libs.repository_v3.mlrepository import MetaNames, MetaProps, WmlRuntimesArtifact
from watson_machine_learning_client.libs.repository_v3.mlrepositoryartifact.runtimes_artifact_reader import RuntimesArtifactReader
