...
dependencies = {
  '3': ['lbinstall', 'PyYAML', 'pykwalify', 'gitpython'],
  '2': ['lbinstall', 'PyYAML', 'pykwalify', 'gitpython']
}
...
setup(name='lbdevmanager',
      ...
      url='https://gitlab.cern.ch/lhcb-core/lbdevmanagerl',

      author='Ben Couturier, Stefan-Gabriel Chitic',
      author_email='ben.couturier@cern.ch, stefan-gabriel@chitic.eu',
      license='GPL',
