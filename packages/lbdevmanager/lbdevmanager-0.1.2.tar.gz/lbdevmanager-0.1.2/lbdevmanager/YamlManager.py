...
class YamlManager:
    ...
    def __init__(self, configFile, exclusionFile):
    ...
    def loadExclusion(self):
        exclusion_list = []
        with open(self.exclusionFile) as f:
            for l in f.readlines():
                if re.match("^\s*#", l):
                    continue
                else:
                    exclusion_list.append(re.compile(l.rstrip()))
    ...
    def getPrefixList(self):
        ...
        exclusionlist = self.loadExclusion()
        return (prefixlist, exclusionlist)
