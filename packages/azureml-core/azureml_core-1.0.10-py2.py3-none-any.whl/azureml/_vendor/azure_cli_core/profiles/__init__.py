...
#  pylint: disable=unused-import
from azureml._vendor.azure_cli_core.profiles._shared import AZURE_API_PROFILES, ResourceType, \
    CustomResourceType, PROFILE_TYPE

from azureml._vendor.azure_cli_core.profiles._shared import get_api_version as _sdk_get_api_version
from azureml._vendor.azure_cli_core.profiles._shared import supported_api_version as _sdk_supported_api_version
from azureml._vendor.azure_cli_core.profiles._shared import supported_api_version as _sdk_supported_api_version
from azureml._vendor.azure_cli_core.profiles._shared import get_versioned_sdk as _sdk_get_versioned_sdk


def get_api_version(cloud_type, resource_type, as_sdk_profile=False):
    ...
    return _sdk_get_api_version(cloud_type.profile, resource_type, as_sdk_profile)


def supported_api_version(cloud_type, resource_type, min_api=None, max_api=None, operation_group=None):
    ...
    """
    return _sdk_supported_api_version(cloud_type.profile,
...
def get_sdk(cloud_type, resource_type, *attr_args, **kwargs):
    ...
    """
    return _sdk_get_versioned_sdk(cloud_type.profile, resource_type, *attr_args, **kwargs)
