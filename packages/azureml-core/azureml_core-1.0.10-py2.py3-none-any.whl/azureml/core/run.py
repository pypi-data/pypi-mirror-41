...
class Run(_RunBase):
    ...
    def log_accuracy_table(self, name, value, description=""):
        ...
        :param name: The name of the accuracy tale
        :type name: str
        :param value: json containing name, version, and data properties
        :type value: str
        :param description: An optional metric description
