...
class DataStoreOperations(object):
    ...
    def list(
            self, subscription_id, resource_group_name, workspace_name, data_store_names=None, continuation_token=None, count=None, custom_headers=None, raw=False, **operation_config):
        """
    ...
    def create(
            self, subscription_id, resource_group_name, workspace_name, dto=None, create_if_not_exists=None, custom_headers=None, raw=False, **operation_config):
        """
    ...
    def update(
            self, name, subscription_id, resource_group_name, workspace_name, dto=None, create_if_not_exists=None, custom_headers=None, raw=False, **operation_config):
        """
    ...
    def v10_meta_ping_get(
        ...
        """
        # Construct URL
        url = self.v10_meta_ping_get.metadata['url']
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    v10_meta_ping_get.metadata = {'url': '/datastore/v1.0/meta/ping'}

    def v10_meta_alive_get(
            self, custom_headers=None, raw=False, **operation_config):
        """
        ...
        """
        # Construct URL
        url = self.v10_meta_alive_get.metadata['url']
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    v10_meta_alive_get.metadata = {'url': '/datastore/v1.0/meta/alive'}

    def v10_meta_version_get(
            self, custom_headers=None, raw=False, **operation_config):
        """
        ...
        """
        # Construct URL
        url = self.v10_meta_version_get.metadata['url']
        ...
        return deserialized
    v10_meta_version_get.metadata = {'url': '/datastore/v1.0/meta/version'}
