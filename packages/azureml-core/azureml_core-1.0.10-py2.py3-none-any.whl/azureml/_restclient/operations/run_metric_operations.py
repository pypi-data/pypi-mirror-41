...
class RunMetricOperations(object):
    ...
    def list(
            self, subscription_id, resource_group_name, workspace_name, experiment_name, filter=None, continuationtoken=None, orderby=None, sortorder=None, top=None, count=None, mergestrategytype=None, mergestrategyoptions=None, mergestrategysettingsversion=None, mergestrategysettingsselectmetrics=None, custom_headers=None, raw=False, **operation_config):
        """
