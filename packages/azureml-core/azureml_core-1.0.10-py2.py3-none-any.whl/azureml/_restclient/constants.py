...
class RunStatus(object):
    ...
    def list(cls):
        ...
        return [cls.QUEUED, cls.PREPARING, cls.PROVISIONING, cls.PREPARING,
                cls.STARTING, cls.RUNNING, cls.CANCEL_REQUESTED, cls.CANCELED,
                cls.FINALIZING, cls.CANCELED, cls.COMPLETED, cls.FAILED]
