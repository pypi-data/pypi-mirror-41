...
class CiscoConfParse(object):
    ...
    def convert_braces_to_ios(self, input_list, stop_width=4):
        ...
        (?:\s*
          ...
          |(?P<braces_alone>[\{{\}}\;])
          |(?P<junos_elseif>^\s*\}}\s*elseif\s*\{{\s*.+?\}}\s+\{{)
        ...
        def line_level(input):
            ...
            if not (mm is None):
                ...
                junos_elseif = results.get('junos_elseif', None)
                # FIXME elseif is still broken in some cases
                #print "DBG", junos_elseif
                ...
                elif junos_elseif is not None:
                    return 'elseif', level_offset
