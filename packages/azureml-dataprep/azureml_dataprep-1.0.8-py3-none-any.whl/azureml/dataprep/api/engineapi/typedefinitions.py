...
class AddBlockToListMessageArguments:
    def __init__(self,
        ...
        self._pod = {
            ...
            'projectContext': to_dprep_pod(project_context),
        }
    ...
    def project_context(self) -> str:
        return self._pod['projectContext']

    @project_context.setter
    def project_context(self, value: str):
        self._pod['projectContext'] = to_dprep_pod(value)
...
class DataSourceProperties:
    ...
    @property
    def column_count(self) -> float:
        return self._pod['columnCount']

    @column_count.setter
    def column_count(self, value: float):
    ...
    def column_positions(self, value: List[float]):
    ...
    @property
    def skip_lines_count(self) -> float:
        return self._pod['skipLinesCount']

    @skip_lines_count.setter
    def skip_lines_count(self, value: float):
...
class ActivityReference:
    def __init__(self,
        ...
        referenced_activity_id: UUID = None,
        referenced_branch_id: UUID = None,
        ...
        self._pod = {
            ...
            'referencedActivityId': to_dprep_pod(referenced_activity_id),
            'referencedBranchId': to_dprep_pod(referenced_branch_id),
    ...
    @property
    def referenced_activity_id(self) -> UUID:
        return UUID(self._pod['referencedActivityId']) if self._pod['referencedActivityId'] is not None else None

    @referenced_activity_id.setter
    def referenced_activity_id(self, value: UUID):
        self._pod['referencedActivityId'] = to_dprep_pod(value)

    @property
    def referenced_branch_id(self) -> UUID:
        return UUID(self._pod['referencedBranchId']) if self._pod['referencedBranchId'] is not None else None

    @referenced_branch_id.setter
    def referenced_branch_id(self, value: UUID):
        self._pod['referencedBranchId'] = to_dprep_pod(value)
...
class DataField:
    def __init__(self,
        ...
        self._pod = {
            'type': to_dprep_pod(type),
            'value': to_dprep_pod(value),
            'warningCode': to_dprep_pod(warning_code),
        }
    ...
    def warning_code(self) -> str:
        return self._pod['warningCode']

    @warning_code.setter
    def warning_code(self, value: str):
        self._pod['warningCode'] = to_dprep_pod(value)
...
class ExecuteInspectorCommonArguments:
    ...
    @row_count.setter
    def row_count(self, value: float):
...
class AnonymousProjectData:
    def __init__(self,
        activities: List['AnonymousActivityData'] = None
    ):
        self._pod = {
            'activities': to_dprep_pod(activities),
        }

    @property
    def activities(self) -> List['AnonymousActivityData']:
        return [AnonymousActivityData.from_pod(i) if i is not None else None for i in self._pod['activities']] if self._pod['activities'] is not None else None

    @activities.setter
    def activities(self, value: List['AnonymousActivityData']):
        self._pod['activities'] = to_dprep_pod(value)
...
class ResolveReferenceMessageArguments:
    def __init__(self,
        dataflow_name: str = None,
        package_path: str = None,
    ):
        self._pod = {
            'dataflowName': to_dprep_pod(dataflow_name),
            'packagePath': to_dprep_pod(package_path),
        }

    @property
    def dataflow_name(self) -> str:
        return self._pod['dataflowName']

    @dataflow_name.setter
    def dataflow_name(self, value: str):
        self._pod['dataflowName'] = to_dprep_pod(value)

    @property
    def package_path(self) -> str:
        return self._pod['packagePath']

    @package_path.setter
    def package_path(self, value: str):
        self._pod['packagePath'] = to_dprep_pod(value)
...
class SaveProjectFromDataMessageArguments:
    def __init__(self,
        path: str = None,
        project: 'AnonymousProjectData' = None,
    ):
        self._pod = {
            'path': to_dprep_pod(path),
            'project': to_dprep_pod(project),
        }
    ...
    @property
    def project(self) -> 'AnonymousProjectData':
        return AnonymousProjectData.from_pod(self._pod['project']) if self._pod['project'] is not None else None

    @project.setter
    def project(self, value: 'AnonymousProjectData'):
        self._pod['project'] = to_dprep_pod(value)
...
class ProfileResult:
    def __init__(self,
        ...
        count: float = None,
        empty_count: float = None,
        error_count: float = None,
        histogram: List['HistogramBin'] = None,
        max: object = None,
        min: object = None,
        missing_count: float = None,
        moments: 'Moments' = None,
        not_missing_count: float = None,
    ...
    @property
    def empty_count(self) -> float:
        return self._pod['emptyCount']

    @empty_count.setter
    def empty_count(self, value: float):
    ...
    @error_count.setter
    def error_count(self, value: float):
    ...
    @property
    def missing_count(self) -> float:
        return self._pod['missingCount']

    @missing_count.setter
    def missing_count(self, value: float):
    ...
    @property
    def not_missing_count(self) -> float:
        return self._pod['notMissingCount']

    @not_missing_count.setter
    def not_missing_count(self, value: float):
...
class LocalRunnerDetails:
    ...
    def runner(self) -> 'Runner':
        return Runner(self._pod['runner']) if self._pod['runner'] is not None else None

    @runner.setter
    def runner(self, value: 'Runner'):
        self._pod['runner'] = to_dprep_pod(value)
...
class ClusterData:
    def __init__(self,
        id: UUID = None,
        livy_password: 'Secret' = None,
        livy_user_name: str = None,
        storage_access_key: 'Secret' = None,
        ...
        self._pod = {
            'id': to_dprep_pod(id),
            'livyPassword': to_dprep_pod(livy_password),
            'livyUserName': to_dprep_pod(livy_user_name),
            'storageAccessKey': to_dprep_pod(storage_access_key),
            'storageAccount': to_dprep_pod(storage_account),
            'storageContainer': to_dprep_pod(storage_container),
            'url': to_dprep_pod(url),
        }
    ...
    @property
    def livy_password(self) -> 'Secret':
        return Secret.from_pod(self._pod['livyPassword']) if self._pod['livyPassword'] is not None else None

    @livy_password.setter
    def livy_password(self, value: 'Secret'):
        self._pod['livyPassword'] = to_dprep_pod(value)

    @property
    def livy_user_name(self) -> str:
        return self._pod['livyUserName']

    @livy_user_name.setter
    def livy_user_name(self, value: str):
        self._pod['livyUserName'] = to_dprep_pod(value)

    @property
    def storage_access_key(self) -> 'Secret':
        return Secret.from_pod(self._pod['storageAccessKey']) if self._pod['storageAccessKey'] is not None else None

    @storage_access_key.setter
    def storage_access_key(self, value: 'Secret'):
        self._pod['storageAccessKey'] = to_dprep_pod(value)

    @property
    def storage_account(self) -> str:
        return self._pod['storageAccount']

    @storage_account.setter
    def storage_account(self, value: str):
        self._pod['storageAccount'] = to_dprep_pod(value)

    @property
    def storage_container(self) -> str:
        return self._pod['storageContainer']

    @storage_container.setter
    def storage_container(self, value: str):
        self._pod['storageContainer'] = to_dprep_pod(value)

    @property
    def url(self) -> str:
        return self._pod['url']

    @url.setter
    def url(self, value: str):
        self._pod['url'] = to_dprep_pod(value)
...
class LivyRunnerDetails:
    def __init__(self,
        cluster_data: 'ClusterData' = None,
        name: str = None,
        runner: 'Runner' = None,
    ):
        self._pod = {
            'clusterData': to_dprep_pod(cluster_data),
            'name': to_dprep_pod(name),
            'runner': to_dprep_pod(runner),
        }
    ...
    def cluster_data(self) -> 'ClusterData':
        return ClusterData.from_pod(self._pod['clusterData']) if self._pod['clusterData'] is not None else None

    @cluster_data.setter
    def cluster_data(self, value: 'ClusterData'):
        self._pod['clusterData'] = to_dprep_pod(value)
