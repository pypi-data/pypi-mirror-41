...
"""
    This module includes the optimization elements (quantities,
    constraints and objectives) formulated in LP or MILP :
...
class ExtDynConstraint(DynamicConstraint, ExternalConstraint):
    ...
    ** Description **
    ...
    def __init__(self, exp_t, t_range, name='EDCST0', active=True,
