    ...
    **Description**
    ...
    def maximize_production(self, obj_operated_unit_list=None, weight=1):
        ...
        for operated_unit in final_operated_unit_list:
            self.max_production = Objective(name='max_production_{}'
                                            .format(operated_unit.name),
                                            exp='-lpSum({}_p[t] '
                                                'for t in time.I)'
                                            .format(operated_unit.name),
                                            weight=weight,
    ...
    # CO2 objectives
    def minimize_co2_emission(self, obj_operated_unit_list=None, weight=1):
        """
        ...
        final_operated_unit_list = self._check_operated_unit_list(
            obj_operated_unit_list)
        for operated_unit in final_operated_unit_list:
            operated_unit.minimize_co2_emission(weight=weight)
    ...
    def minimize_operating_cost(self, obj_operated_unit_list=None, weight=1):
        ...
        final_operated_unit_list = self._check_operated_unit_list(
            obj_operated_unit_list)
        for operated_unit in final_operated_unit_list:
            operated_unit.minimize_operating_costs(weight=weight)
    ...
    def minimize_starting_cost(self, obj_operated_unit_list=None, weight=1):
        ...
        final_operated_unit_list = self._check_operated_unit_list(
            obj_operated_unit_list)
        for operated_unit in final_operated_unit_list:
            operated_unit.minimize_starting_costs(weight=weight)
    ...
    def energy_production_minimum(self, min_e_tot,
        ...
        cst_name = 'min_energy_conso{}'.format(production_name_string)
        exp = 'lpSum({0}) >= {1}'.format(production_p_string, min_e_tot)
    ...
    def energy_production_maximum(self, max_e_tot,
        ...
        cst_name = 'max_energy_conso{}'.format(production_name_string)
        exp = 'lpSum({0}) <= {1}'.format(production_p_string, max_e_tot)
    ...
    def power_production_minimum(self, min_p, time,
        ...
        cst_name = 'min_power_conso_{}'.format(production_name_string)
    ...
    def power_production_maximum(self, max_p, time,
        ...
        cst_name = 'max_power_conso_{}'.format(production_name_string)
