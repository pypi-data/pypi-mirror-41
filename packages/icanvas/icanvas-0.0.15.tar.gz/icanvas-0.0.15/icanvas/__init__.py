...
def db(server_type,db_type,app_server_path):
    ...
    subprocess.check_output("rm -rf /var/.canvas/tmpl && curl -XGET -v -u admin:admin123 http://172.19.29.253:8081/repository/canvas/18/tmpl.zip -O && unzip tmpl.zip -d /var/.canvas/tmpl/", shell=True)
