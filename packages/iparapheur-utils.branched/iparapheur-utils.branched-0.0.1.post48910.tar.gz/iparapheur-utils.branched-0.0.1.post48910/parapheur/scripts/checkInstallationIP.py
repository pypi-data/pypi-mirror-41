...
# besoin HTTP/HTTPS sortant, accès http://crl.adullact.org validca.libriciel.fr http://libersign.libriciel.fr
...
def check_required_software():
    ...
    da_commands = ['at', 'tar', 'crontab', 'unzip', 'mailx', 'openssl',
                   ...
                   '/opt/jdk1.8.0_161/bin/java', 'redis-server']
...
def check_alfresco_sh(basedir, filename):
    ...
    if not isexistsfile(basedir, filename):
        ...
        return -1
    # TODO: detect 'ulimit' statements, detect additionnal 'cd $INSTALLDIR' statement
    hasInstallDir = False
    hasUlimit1 = False
    hasUlimit2 = False
