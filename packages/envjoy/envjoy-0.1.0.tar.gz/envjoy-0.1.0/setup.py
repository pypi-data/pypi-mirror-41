...
# DISABLED/BUG: this line fails when `pip install envjoy` but works `pip install .`
# from envjoy import __version__
...
name = 'envjoy'
version = '0.1.0'
description = 'A more enjoyable environment variable getter and setter - for Python.'
keywords = [
    'env',
    'environment',
    'environ',
