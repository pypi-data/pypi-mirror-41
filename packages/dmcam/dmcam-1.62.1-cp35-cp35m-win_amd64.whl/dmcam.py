...
class camera_para_t(object):
    ...
    scale = _swig_property(_dmcam.camera_para_t_scale_get, _dmcam.camera_para_t_scale_set)
...
DM_FRAME_FMT_RAW = _dmcam.DM_FRAME_FMT_RAW
...
def cap_set_frame_buffer(dev, frame_buf, frame_buf_size):
    return _dmcam.cap_set_frame_buffer(dev, frame_buf, frame_buf_size)
cap_set_frame_buffer = _dmcam.cap_set_frame_buffer
