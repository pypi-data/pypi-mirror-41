...
from rada_package_budzsergiy.utils import load_rada, save_rada
...
class UkraineConsole(Console):
    ...
    def run(self):
        help_text = """
              ...
              Введіть 15, додати спікера
              Введіть 16, повідомити хабарників про можливу перевірку СБУ
        ...
        while True:
            ...
            if user_input == 1:
                ...
                spiker_info = input(
                    "Enter a spiker info: surname name data_f_birth weight height: ")
                spiker = self.fraction_class(*spiker_info)
                self.rada_class.add_spiker(spiker)
            elif user_input == 16:
                # self.fraction_class.ra
                self.rada_class.spiker.notify_all_habarnikiv(self.rada)
            elif user_input == 0:
