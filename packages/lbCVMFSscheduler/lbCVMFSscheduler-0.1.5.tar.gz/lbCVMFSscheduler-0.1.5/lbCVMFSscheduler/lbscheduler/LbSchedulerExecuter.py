...
class RPCSchedulerExecutor(object):
    def __init__(self, queue, vhost, topic, delay, command, args=[]):
        self.client = RPCClient(self.result, vhost=vhost, topic=topic)
        self.delay = delay
    ...
    def _call(self):
        ...
        self.client.publish(self.queue, message.convertToJson())
