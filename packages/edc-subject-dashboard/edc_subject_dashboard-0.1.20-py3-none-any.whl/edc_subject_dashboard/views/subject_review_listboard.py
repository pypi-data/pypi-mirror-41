...
class SubjectReviewListboardView(NavbarViewMixin, EdcBaseViewMixin,
    ...
    def get_queryset(self):
        ...
        if not self.search_term:
            return qs.values('subject_identifier').annotate(
                visit_count=Count('subject_identifier')).order_by('subject_identifier')
        return qs
