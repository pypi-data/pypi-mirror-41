...
class test_KrigingOps(unittest.TestCase):
    ...
    def test1_prepareForVesperKrig_filesExist(self):
        ...
        gdfPoints, gdfpts_crs = convert.convert_csv_to_points(file, coord_columns_epsg=4326, out_epsg=28354)
        out_gdf, out_crs= clean_trim_points(gdfPoints, gdfpts_crs, data_col, fileSubName + '_trimmed.csv',
