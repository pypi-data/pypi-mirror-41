...
setup(
    ...
    url='https://git.getme.co.uk/manhattan/manhattan_publishing',
    ...
    packages=find_packages('manhattan_publishing'),
    package_dir={'': 'manhattan_publishing'},
