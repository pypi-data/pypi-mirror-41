...
class AIPW:
    def __init__(self, df, exposure, outcome):
        """AIPW is NO longer maintained. Please use AIPTW instead
        ...
        outcome : str
            Column name of the outcome variable. Currently only binary is supported
        """
        warnings.warn("AIPW is no longer maintained. AIPW has been replaced by AIPTW. AIPW will no longer be available"
                      " in version 0.5.0", DeprecationWarning)
