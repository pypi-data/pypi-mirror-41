...
class PeriodTestCase(ModuleTestCase):
    ...
    def test_period_same_startpos_endpos(self):
        ...
        with set_company(employee1.company):
            ...
            self.assertRaisesRegex(UserError,
                "The working time item overlaps with this item: '10.03.2018: 08:00 - 15:00'",
                perobj.save)
    ...
    def test_period_get_overlaps(self):
        ...
        with set_company(employee1.company):
            ...
            self.assertEqual(Period.get_overlaps(employee1.id, p1, None, None), [])
            self.assertEqual(Period.get_overlaps(employee1.id, p3, None, None), [])
            
            # find overlap of 'p3'
            self.assertEqual(Period.get_overlaps(employee1.id, None, 
    ...
    def test_period_overlaps_on_write(self):
        ...
        with set_company(employee1.company):
            ...
            self.assertRaisesRegex(UserError,
                "The working time item overlaps with this item: '05.07.2018: 06:30 - --:--'",
                perobj.save)
