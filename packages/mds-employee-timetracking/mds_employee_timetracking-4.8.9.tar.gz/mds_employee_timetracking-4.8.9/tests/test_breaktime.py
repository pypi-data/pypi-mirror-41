...
class BreakTimeTestCase(ModuleTestCase):
    ...
    def test_breaktime_reduced_worktime_4h20m_to_4h(self):
        ...
        BreakTime = Pool().get('employee_timetracking.breaktime')
        (wtime, btime) = BreakTime.get_reduced_worktime(tar1, timedelta(seconds=4*60*60 + 20*60))
    ...
    def test_breaktime_reduced_worktime_4h50m_to_4h20m(self):
        ...
        tar1 = self.prep_ruleset()
        BreakTime = Pool().get('employee_timetracking.breaktime')
        (wtime, btime) = BreakTime.get_reduced_worktime(tar1, timedelta(seconds=4*60*60 + 50*60))
    ...
    def test_breaktime_reduced_worktime_5h50m_to_5h20m(self):
        ...
        tar1 = self.prep_ruleset()
        BreakTime = Pool().get('employee_timetracking.breaktime')
        (wtime, btime) = BreakTime.get_reduced_worktime(tar1, timedelta(seconds=5*60*60 + 50*60))
    ...
    def test_breaktime_reduced_worktime_6h00m_to_5h30m(self):
        ...
        tar1 = self.prep_ruleset()
        BreakTime = Pool().get('employee_timetracking.breaktime')
        (wtime, btime) = BreakTime.get_reduced_worktime(tar1, timedelta(seconds=6*60*60))
    ...
    def test_breaktime_reduced_worktime_6h10m_to_5h30m(self):
        ...
        tar1 = self.prep_ruleset()
        BreakTime = Pool().get('employee_timetracking.breaktime')
        (wtime, btime) = BreakTime.get_reduced_worktime(tar1, timedelta(seconds=6*60*60 + 10*60))
        self.assertEqual(str(wtime), '5:30:00')
    ...
    def test_breaktime_reduced_worktime_6h15m_to_5h30m(self):
        ...
        tar1 = self.prep_ruleset()
        BreakTime = Pool().get('employee_timetracking.breaktime')
        (wtime, btime) = BreakTime.get_reduced_worktime(tar1, timedelta(seconds=6*60*60 + 15*60))
        self.assertEqual(str(wtime), '5:30:00')
    ...
    def test_breaktime_reduced_worktime_6h20m_to_5h35m(self):
        ...
        tar1 = self.prep_ruleset()
        BreakTime = Pool().get('employee_timetracking.breaktime')
        (wtime, btime) = BreakTime.get_reduced_worktime(tar1, timedelta(seconds=6*60*60 + 20*60))
    ...
    def test_breaktime_reduced_worktime_6h30m_to_5h45m(self):
        ...
        tar1 = self.prep_ruleset()
        BreakTime = Pool().get('employee_timetracking.breaktime')
        (wtime, btime) = BreakTime.get_reduced_worktime(tar1, timedelta(seconds=6*60*60 + 30*60))
    ...
    def test_breaktime_reduced_worktime_6h58m_to_6h13m(self):
        ...
        tar1 = self.prep_ruleset()
        BreakTime = Pool().get('employee_timetracking.breaktime')
        (wtime, btime) = BreakTime.get_reduced_worktime(tar1, timedelta(seconds=6*60*60 + 58*60))
    ...
    def test_breaktime_reduced_worktime_7h10m_to_6h25m(self):
        ...
        tar1 = self.prep_ruleset()
        BreakTime = Pool().get('employee_timetracking.breaktime')
        (wtime, btime) = BreakTime.get_reduced_worktime(tar1, timedelta(seconds=7*60*60 + 10*60))
    ...
    def test_breaktime_reduced_worktime_7h58m_to_7h13m(self):
        ...
        tar1 = self.prep_ruleset()
        BreakTime = Pool().get('employee_timetracking.breaktime')
        (wtime, btime) = BreakTime.get_reduced_worktime(tar1, timedelta(seconds=7*60*60 + 58*60))
    ...
    def test_breaktime_reduced_worktime_8h00m_to_7h15m(self):
        ...
        tar1 = self.prep_ruleset()
        BreakTime = Pool().get('employee_timetracking.breaktime')
        (wtime, btime) = BreakTime.get_reduced_worktime(tar1, timedelta(seconds=8*60*60))
    ...
    def test_breaktime_reduced_worktime_8h14m_to_7h15m(self):
        ...
        tar1 = self.prep_ruleset()
        BreakTime = Pool().get('employee_timetracking.breaktime')
        (wtime, btime) = BreakTime.get_reduced_worktime(tar1, timedelta(seconds=8*60*60 + 14*60))
        self.assertEqual(str(wtime), '7:15:00')
    ...
    def test_breaktime_reduced_worktime_8h16m_to_7h16m(self):
        ...
        tar1 = self.prep_ruleset()
        BreakTime = Pool().get('employee_timetracking.breaktime')
        (wtime, btime) = BreakTime.get_reduced_worktime(tar1, timedelta(seconds=8*60*60 + 16*60))
    ...
    def test_breaktime_reduced_worktime_8h45m_to_7h45m(self):
        ...
        tar1 = self.prep_ruleset()
        BreakTime = Pool().get('employee_timetracking.breaktime')
        (wtime, btime) = BreakTime.get_reduced_worktime(tar1, timedelta(seconds=8*60*60 + 45*60))
    ...
    def test_breaktime_reduced_worktime_0h45m_to_0h25m(self):
        ...
        tar1 = self.prep_ruleset()
        BreakTime = Pool().get('employee_timetracking.breaktime')
        (wtime, btime) = BreakTime.get_reduced_worktime(tar1, timedelta(seconds=45*60))
    ...
    def test_breaktime_reduced_worktime_0h15m_to_0h00m(self):
        ...
        tar1 = self.prep_ruleset()
        BreakTime = Pool().get('employee_timetracking.breaktime')
        (wtime, btime) = BreakTime.get_reduced_worktime(tar1, timedelta(seconds=15*60))
    ...
    def test_breaktime_reduced_worktime_3h30m_to_3h10m(self):
        ...
        tar1 = self.prep_ruleset()
        BreakTime = Pool().get('employee_timetracking.breaktime')
        (wtime, btime) = BreakTime.get_reduced_worktime(tar1, timedelta(seconds=3*60*60 + 30*60))
    ...
    def test_breaktime_reduced_worktime_10h30m_to_9h30m(self):
        ...
        tar1 = self.prep_ruleset()
        BreakTime = Pool().get('employee_timetracking.breaktime')
        (wtime, btime) = BreakTime.get_reduced_worktime(tar1, timedelta(seconds=10*60*60 + 30*60))
