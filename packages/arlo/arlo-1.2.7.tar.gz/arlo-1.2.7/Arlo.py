...
class Arlo(object):
    ...
    def NotifyAndGetResponse(self, basestation, body, timeout=600):
        basestation_id = basestation.get('deviceId')
    ...
    def SubscribeToMotionEvents(self, basestation, callback, timeout=600):
    ...
    def HandleEvents(self, basestation, callback, timeout=600):
    ...
    def TriggerAndHandleEvent(self, basestation, trigger, callback, timeout=600):
