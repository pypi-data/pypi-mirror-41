...
a = [1.5e-09, 7.2e-14, 7.5e-14, 1e-05, 8e-06, 298.15, 1.5, 1.5, 1.5, 1200.0, 30555.0, 45829.0, 0.0326, 0.025, 0.38, 0.4, 0.45, 1.0307e-10, 1.334e-10, 4.65e-05, 4.3e-05, 1.6e-05, 100.0, 10.0, 0.363, 7.0, 3.0, 7.0, 3.0, 3.0, -1.0, 1.0, 1.0, 4000.0]
a = np.array(a)
for i in range(len(a)):
	print(a[i], i)
#
b = np.zeros((10000,133))
# print(b[:,0])
# for i in range(50)
# p2d_fd.model(a, b)
# # # print(b.shape)
