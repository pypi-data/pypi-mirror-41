...
def _local_build_alpha_vantage_stock(api_key, start_date, end_date, out_dir, ids=None):
    ...
    quandl_av = AlphaVantage(api_key)
    df = quandl_av.get_daily(start_date, end_date, ids)
...
def build_db(client, start_date, end_date, ids_us=None, ids_cn=None):
    ...
    #_local_build_quandl_us_stock(client.key_quandl, start_date, end_date, raw_us_db, ids_us)
    _local_build_alpha_vantage_stock(client.key_alpha_vantage, start_date, end_date, raw_us_db, ids_us)
