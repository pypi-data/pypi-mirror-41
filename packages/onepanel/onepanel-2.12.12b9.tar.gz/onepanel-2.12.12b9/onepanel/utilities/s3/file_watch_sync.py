...
class FileWatchSynchronizerEventHandler(PatternMatchingEventHandler):
    def __init__(self, path, remote_path, synchronizer, hook=None, ignore_patterns=None):
        """
    ...
    def on_moved(self, event):
        ...
        # Ignore vim temporary file
        if event.dest_path[-1] == '~':
            return
    ...
    def _synchronize_difference(self, difference):
        self.synchronizer.synchronize_single(difference, self.hook)
