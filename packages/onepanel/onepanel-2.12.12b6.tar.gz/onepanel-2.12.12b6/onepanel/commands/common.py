...
from onepanel.commands.datasets import datasets_clone, datasets_download, DatasetViewController, general_push, watch_sync
...
@click.pass_context
@login_required
def push(ctx, message, name, quiet, background, watch, threads):
    home = os.getcwd()
