...
def _watch_sync(ctx, threads=10):
    ...
    observer.schedule(FileWatchSynchronizerEventHandler(cwd, dataset_path, synchronizer, print_status(cwd_length), ignore_patterns=['.*', '*.swx', '*.swpx', '*.swp', '*~']),
