...
class Parameters:
    ...
    def parse_command_line(self):
        ...
        parser.add_argument('-bgs', dest='bedgraph_smooth',
                            choices=[0, 1], metavar='', default=1,
...
class Transcript_struct_data_preparation(Data_preparation):
    ...
    def create_dict(self):
        ...
        global_parameters = dict(scaffold=scaffold, start=start, end=end, pdf=pdf)
    ...
    def highlighting_the_frame(self):
        try:
            for hf in self.parameters.config['highlight_frame']:
                ...
                self.real_pdf.setLineWidth(0.1)
                ...
                y_down -= 1.5 * self.height_of_string
                ...
                self.real_pdf.setFont('regular', self.parameters.config['hframe_font_size'])
                y_down -= 0.3 * self.height_of_string
...
class Aa_seq_tracks_maker(Tracks_maker):
    ...
    def create_tracks(self):
        try:
            ...
            sys.exit(
                'Unable to create a Aminoacid sequence track. Please check the entered data and the installation of the required modules (see the program manual).')
