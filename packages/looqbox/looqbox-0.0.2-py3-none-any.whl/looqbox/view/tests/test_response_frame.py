...
class TestResponseFrame(unittest.TestCase):
    ...
    def test_json_creation(self):
        ...
        self.assertEqual(expected_json, frame.to_json_structure, msg="Failed basic JSON structure test")
        ...
        expected_json = json.dumps(mock_json, sort_keys=True, indent=1)
        self.assertEqual(expected_json, frame.to_json_structure, msg="JSON test failed with more than one style")
