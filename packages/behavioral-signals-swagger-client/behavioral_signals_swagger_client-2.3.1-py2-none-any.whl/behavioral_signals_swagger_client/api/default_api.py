...
class DefaultApi(object):
    ...
    def send_process_audio(self, cid, adata, channels, calldirection, **kwargs):  # noqa: E501
        """send_process_audio  # noqa: E501

        Sends a new caller request with audio file upload  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.send_process_audio(cid, adata, channels, calldirection, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.send_process_audio_with_http_info(cid, adata, channels, calldirection, **kwargs)  # noqa: E501
        else:
            (data) = self.send_process_audio_with_http_info(cid, adata, channels, calldirection, **kwargs)  # noqa: E501
            return data

    def send_process_audio_with_http_info(self, cid, adata, channels, calldirection, **kwargs):  # noqa: E501
        """send_process_audio  # noqa: E501

        Sends a new caller request with audio file upload  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.send_process_audio_with_http_info(cid, adata, channels, calldirection, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['cid', 'adata', 'channels', 'calldirection', 'name', 'customer_id', 'customer_ind', 'agent_team', 'agent_id', 'campaign_id', 'calltype', 'ani', 'calltime', 'timezone', 'storedata', 'tag', 'meta']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('adata' not in params or
                params['adata'] is None):
            raise ValueError("Missing the required parameter `adata` when calling `send_process_audio`")  # noqa: E501
        ...
        local_var_files = {}
        if 'adata' in params:
            local_var_files['adata'] = params['adata']  # noqa: E501
    ...
    def send_process_tcp(self, cid, channels, calldirection, **kwargs):  # noqa: E501
        ...
        Sends a new caller request in tcp mode  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def send_process_tcp_with_http_info(self, cid, channels, calldirection, **kwargs):  # noqa: E501
        ...
        all_params = ['cid', 'channels', 'calldirection', 'name', 'customer_id', 'customer_ind', 'agent_team', 'agent_id', 'campaign_id', 'calltype', 'ani', 'calltime', 'timezone', 'storedata', 'tag', 'meta']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def send_process_url(self, cid, url, channels, calldirection, **kwargs):  # noqa: E501
        ...
        Sends a new caller request with a url for data  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def send_process_url_with_http_info(self, cid, url, channels, calldirection, **kwargs):  # noqa: E501
        ...
        all_params = ['cid', 'url', 'channels', 'calldirection', 'name', 'customer_id', 'customer_ind', 'agent_team', 'agent_id', 'campaign_id', 'calltype', 'ani', 'calltime', 'timezone', 'storedata', 'tag', 'meta']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def send_process_video(self, cid, url, channels, calldirection, **kwargs):  # noqa: E501
        ...
        Sends a new caller request to process a video file from url  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update_process(self, cid, pid, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_process_with_http_info(cid, pid, **kwargs)  # noqa: E501
        else:
            (data) = self.update_process_with_http_info(cid, pid, **kwargs)  # noqa: E501
            return data

    def update_process_with_http_info(self, cid, pid, **kwargs):  # noqa: E501
        """update_process  # noqa: E501
        ...
        all_params = ['cid', 'pid', 'name', 'customer_id', 'customer_ind', 'agent_team', 'agent_id', 'campaign_id', 'calltype', 'ani', 'calltime', 'timezone', 'tag', 'meta', 'rerun']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('cid' not in params or
                params['cid'] is None):
            raise ValueError("Missing the required parameter `cid` when calling `update_process`")  # noqa: E501
        # verify the required parameter 'pid' is set
        if ('pid' not in params or
                params['pid'] is None):
            raise ValueError("Missing the required parameter `pid` when calling `update_process`")  # noqa: E501
        ...
        if 'rerun' in params:
            ...
            collection_formats['rerun'] = 'csv'  # noqa: E501
