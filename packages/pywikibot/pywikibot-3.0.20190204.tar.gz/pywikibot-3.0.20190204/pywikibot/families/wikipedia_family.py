...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'sh', 'hu', 'ko', 'cs', 'ro', 'ms', 'tr', 'eu', 'eo', 'hy', 'bg', 'da',
        'he', 'sk', 'zh-min-nan', 'kk', 'min', 'ce', 'hr', 'lt', 'et', 'sl',
        'be', 'el', 'gl', 'ur', 'az', 'simple', 'nn', 'uz', 'la', 'th', 'hi',
        'ka', 'vo', 'ta', 'azb', 'cy', 'ast', 'mk', 'tg', 'lv', 'mg', 'oc',
        'tt', 'ky', 'bs', 'tl', 'sq', 'new', 'zh-yue', 'te', 'af', 'br',
        'be-tarask', 'pms', 'bn', 'ml', 'lb', 'jv', 'ht', 'sco', 'mr', 'ga',
        'sw', 'pnb', 'ba', 'is', 'my', 'nds', 'cv', 'fy', 'su', 'lmo', 'an',
        'ne', 'yo', 'pa', 'gu', 'io', 'bar', 'scn', 'als', 'bpy', 'kn', 'ku',
        'ckb', 'ia', 'qu', 'arz', 'mn', 'wuu', 'bat-smg', 'si', 'wa', 'gd',
        'yi', 'or', 'nap', 'am', 'cdo', 'bug', 'hsb', 'map-bms', 'mai', 'fo',
        'mzn', 'xmf', 'li', 'sah', 'eml', 'ilo', 'sa', 'os', 'vec', 'sd',
        'mrj', 'mhr', 'hif', 'ps', 'roa-tara', 'diq', 'hak', 'zh-classical',
        'bcl', 'pam', 'frr', 'nso', 'szl', 'ace', 'se', 'km', 'mi', 'nv',
        'rue', 'nah', 'nds-nl', 'vls', 'bh', 'gan', 'crh', 'sc', 'vep', 'bo',
        'glk', 'co', 'so', 'tk', 'fiu-vro', 'myv', 'lrc', 'kv', 'csb', 'as',
        'gv', 'zea', 'udm', 'ay', 'ie', 'pcd', 'sn', 'ug', 'nrm', 'stq', 'lez',
        'lad', 'kw', 'mwl', 'gn', 'gom', 'rm', 'lij', 'ab', 'koi', 'mt', 'haw',
        'shn', 'fur', 'frp', 'ha', 'dsb', 'lo', 'lfn', 'ang', 'ln', 'ext',
        'cbk-zam', 'dv', 'dty', 'kab', 'ksh', 'olo', 'gag', 'pi', 'pag', 'pfl',
        'av', 'bxr', 'xal', 'bjn', 'krc', 'gor', 'pap', 'kaa', 'za', 'pdc',
        'rw', 'tyv', 'to', 'kl', 'nov', 'jam', 'arc', 'kbd', 'tpi', 'kbp',
        'tet', 'ig', 'ki', 'na', 'jbo', 'roa-rup', 'lbe', 'ty', 'mdf', 'kg',
        'bi', 'wo', 'lg', 'srn', 'zu', 'atj', 'tcy', 'chr', 'ltg', 'inh', 'sm',
        'om', 'xh', 'pih', 'cu', 'rmy', 'bm', 'tw', 'tn', 'chy', 'rn', 'got',
        'ts', 'tum', 'ak', 'sat', 'st', 'ny', 'ch', 'pnt', 'ss', 'fj', 'ady',
        'iu', 'ee', 'ks', 've', 'ik', 'sg', 'ff', 'dz', 'ti', 'cr', 'din',
    ]
