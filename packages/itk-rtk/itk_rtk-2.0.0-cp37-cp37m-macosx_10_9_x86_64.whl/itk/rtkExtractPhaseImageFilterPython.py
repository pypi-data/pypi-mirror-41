...
class rtkExtractPhaseImageFilterID1(itkInPlaceImageFilterRTKPython.itkInPlaceImageFilterID1ID1):
    ...
    def SetMovingAverageSize(self, _arg: 'unsigned long const') -> "void":
    ...
    def GetMovingAverageSize(self) -> "unsigned long":
    ...
    def SetUnsharpMaskSize(self, _arg: 'unsigned long const') -> "void":
    ...
    def GetUnsharpMaskSize(self) -> "unsigned long":
