...
class itkMatrixD11(object):
    ...
    def GetVnlMatrix(self, *args) -> "vnl_matrix_fixed< double,1,1 > const &":
        """
        GetVnlMatrix(itkMatrixD11 self) -> vnl_matrix_fixed< double,1,1 >
        GetVnlMatrix(itkMatrixD11 self) -> vnl_matrix_fixed< double,1,1 > const &
        """
        return _itkMatrixRTKPython.itkMatrixD11_GetVnlMatrix(self, *args)
...
itkMatrixD11.GetVnlMatrix = new_instancemethod(_itkMatrixRTKPython.itkMatrixD11_GetVnlMatrix, None, itkMatrixD11)
