...
class rtkADMMWaveletsConeBeamReconstructionFilterIF3(rtkIterativeConeBeamReconstructionFilterPython.rtkIterativeConeBeamReconstructionFilterIF3):
    ...
    def __New_orig__() -> "rtkADMMWaveletsConeBeamReconstructionFilterIF3_Pointer":
    ...
    def Clone(self) -> "rtkADMMWaveletsConeBeamReconstructionFilterIF3_Pointer":
    ...
    def SetAL_iterations(self, _arg: 'float const') -> "void":
    ...
    def GetAL_iterations(self) -> "float":
    ...
    def SetCG_iterations(self, _arg: 'float const') -> "void":
    ...
    def GetCG_iterations(self) -> "float":
    ...
    def SetNumberOfLevels(self, _arg: 'unsigned int const') -> "void":
    ...
    def cast(obj: 'itkLightObject') -> "rtkADMMWaveletsConeBeamReconstructionFilterIF3 *":
...
def rtkADMMWaveletsConeBeamReconstructionFilterIF3___New_orig__() -> "rtkADMMWaveletsConeBeamReconstructionFilterIF3_Pointer":
    """rtkADMMWaveletsConeBeamReconstructionFilterIF3___New_orig__() -> rtkADMMWaveletsConeBeamReconstructionFilterIF3_Pointer"""
    return _rtkADMMWaveletsConeBeamReconstructionFilterPython.rtkADMMWaveletsConeBeamReconstructionFilterIF3___New_orig__()

def rtkADMMWaveletsConeBeamReconstructionFilterIF3_cast(obj: 'itkLightObject') -> "rtkADMMWaveletsConeBeamReconstructionFilterIF3 *":
...
def admm_wavelets_cone_beam_reconstruction_filter(*args, **kwargs):
    ...
    import itk
    return itk.ADMMWaveletsConeBeamReconstructionFilter.__call__(*args, **kwargs)
