...
class itkImageBase1(ITKCommonBasePython.itkDataObject):
    ...
    def GetOffsetTable(self) -> "long long const *":
        """GetOffsetTable(itkImageBase1 self) -> long long const *"""
        return _itkImageBaseRTKPython.itkImageBase1_GetOffsetTable(self)


    def ComputeOffset(self, ind: 'itkIndex1') -> "long long":
        """ComputeOffset(itkImageBase1 self, itkIndex1 ind) -> long long"""
        return _itkImageBaseRTKPython.itkImageBase1_ComputeOffset(self, ind)


    def ComputeIndex(self, offset: 'long long') -> "itkIndex1":
        """ComputeIndex(itkImageBase1 self, long long offset) -> itkIndex1"""
