...
class vectoritkPointD1(object):
    ...
    def __len__(self) -> "std::vector< itkPointD1 >::size_type":
        """__len__(vectoritkPointD1 self) -> std::vector< itkPointD1 >::size_type"""
        return _itkPointRTKPython.vectoritkPointD1___len__(self)


    def __getslice__(self, i: 'std::vector< itkPointD1 >::difference_type', j: 'std::vector< itkPointD1 >::difference_type') -> "std::vector< itkPointD1,std::allocator< itkPointD1 > > *":
    ...
    def __delslice__(self, i: 'std::vector< itkPointD1 >::difference_type', j: 'std::vector< itkPointD1 >::difference_type') -> "void":
    ...
    def __getitem__(self, *args) -> "std::vector< itkPointD1 >::value_type const &":
        """
    ...
    def rend(self) -> "std::vector< itkPointD1 >::reverse_iterator":
    ...
    def get_allocator(self) -> "std::vector< itkPointD1 >::allocator_type":
    ...
    def erase(self, *args) -> "std::vector< itkPointD1 >::iterator":
        """
...
class itkPointD1(itkFixedArrayPython.itkFixedArrayD1):
    ...
    def GetVectorFromOrigin(self) -> "itkVectorD1":
    ...
    def SetToMidPoint(self, arg0: 'itkPointD1', arg1: 'itkPointD1') -> "void":
...
def itkPointD1_GetPointDimension() -> "unsigned int":
    """itkPointD1_GetPointDimension() -> unsigned int"""
    return _itkPointRTKPython.itkPointD1_GetPointDimension()

def itkPointD1___len__() -> "unsigned int":
