...
def itkInPlaceImageFilterID1ID1_cast(obj):
...
def itkInPlaceImageFilterID3ID2_cast(obj):
...
def itkInPlaceImageFilterIF1IF1_cast(obj):
...
def itkInPlaceImageFilterIF3ID2_cast(obj):
...
def itkInPlaceImageFilterVIF3VIF3_cast(obj):
...
def in_place_image_filter(*args, **kwargs):
    ...
    import itk
    return itk.InPlaceImageFilter.__call__(*args, **kwargs)
