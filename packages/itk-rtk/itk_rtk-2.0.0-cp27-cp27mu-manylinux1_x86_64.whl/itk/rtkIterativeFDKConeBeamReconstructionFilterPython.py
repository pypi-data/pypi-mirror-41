...
def rtkIterativeFDKConeBeamReconstructionFilterIF3IF3D___New_orig__():
...
def rtkIterativeFDKConeBeamReconstructionFilterIF3IF3D_cast(obj):
...
def iterative_fdk_cone_beam_reconstruction_filter(*args, **kwargs):
    ...
    import itk
    return itk.IterativeFDKConeBeamReconstructionFilter.__call__(*args, **kwargs)
