...
class GLObject(_object):
    ...
    __repr__ = _swig_repr
    if _newclass:
        getVisusClassName = staticmethod(_VisusGuiPy.GLObject_getVisusClassName)
    else:
        getVisusClassName = _VisusGuiPy.GLObject_getVisusClassName
...
def GLObject_getVisusClassName():
    return _VisusGuiPy.GLObject_getVisusClassName()
GLObject_getVisusClassName = _VisusGuiPy.GLObject_getVisusClassName
...
class GLBatch(_object):
    ...
    __repr__ = _swig_repr
    if _newclass:
        getVisusClassName = staticmethod(_VisusGuiPy.GLBatch_getVisusClassName)
    else:
        getVisusClassName = _VisusGuiPy.GLBatch_getVisusClassName
...
def GLBatch_getVisusClassName():
    return _VisusGuiPy.GLBatch_getVisusClassName()
GLBatch_getVisusClassName = _VisusGuiPy.GLBatch_getVisusClassName
...
class GLMesh(_object):
    ...
    __repr__ = _swig_repr
    if _newclass:
        getVisusClassName = staticmethod(_VisusGuiPy.GLMesh_getVisusClassName)
    else:
        getVisusClassName = _VisusGuiPy.GLMesh_getVisusClassName
...
def GLMesh_getVisusClassName():
    return _VisusGuiPy.GLMesh_getVisusClassName()
GLMesh_getVisusClassName = _VisusGuiPy.GLMesh_getVisusClassName
...
class GLModelview(GLObject):
    ...
    __repr__ = _swig_repr
    if _newclass:
        getVisusClassName = staticmethod(_VisusGuiPy.GLModelview_getVisusClassName)
    else:
        getVisusClassName = _VisusGuiPy.GLModelview_getVisusClassName
...
def GLModelview_getVisusClassName():
    return _VisusGuiPy.GLModelview_getVisusClassName()
GLModelview_getVisusClassName = _VisusGuiPy.GLModelview_getVisusClassName
...
class GLPhongObject(GLObject):
    ...
    __repr__ = _swig_repr
    if _newclass:
        getVisusClassName = staticmethod(_VisusGuiPy.GLPhongObject_getVisusClassName)
    else:
        getVisusClassName = _VisusGuiPy.GLPhongObject_getVisusClassName
...
def GLPhongObject_getVisusClassName():
    return _VisusGuiPy.GLPhongObject_getVisusClassName()
GLPhongObject_getVisusClassName = _VisusGuiPy.GLPhongObject_getVisusClassName
...
class GLNeedContext(_object):
    ...
    __repr__ = _swig_repr
    if _newclass:
        getVisusClassName = staticmethod(_VisusGuiPy.GLNeedContext_getVisusClassName)
    else:
        getVisusClassName = _VisusGuiPy.GLNeedContext_getVisusClassName
...
def GLNeedContext_getVisusClassName():
    return _VisusGuiPy.GLNeedContext_getVisusClassName()
GLNeedContext_getVisusClassName = _VisusGuiPy.GLNeedContext_getVisusClassName
...
class GLCanvas(_object):
    ...
    __repr__ = _swig_repr
    if _newclass:
        getVisusClassName = staticmethod(_VisusGuiPy.GLCanvas_getVisusClassName)
    else:
        getVisusClassName = _VisusGuiPy.GLCanvas_getVisusClassName
...
def GLCanvas_getVisusClassName():
    return _VisusGuiPy.GLCanvas_getVisusClassName()
GLCanvas_getVisusClassName = _VisusGuiPy.GLCanvas_getVisusClassName
