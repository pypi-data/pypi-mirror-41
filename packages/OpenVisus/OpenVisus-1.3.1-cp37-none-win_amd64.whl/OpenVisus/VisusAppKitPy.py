...
class ViewerPlugin(_object):
    ...
    __repr__ = _swig_repr
    if _newclass:
        getVisusClassName = staticmethod(_VisusAppKitPy.ViewerPlugin_getVisusClassName)
    else:
        getVisusClassName = _VisusAppKitPy.ViewerPlugin_getVisusClassName
...
def ViewerPlugin_getVisusClassName():
    return _VisusAppKitPy.ViewerPlugin_getVisusClassName()
ViewerPlugin_getVisusClassName = _VisusAppKitPy.ViewerPlugin_getVisusClassName
...
class Viewer(VisusDataflowPy.DataflowListener):
    ...
    __repr__ = _swig_repr
    if _newclass:
        getVisusClassName = staticmethod(_VisusAppKitPy.Viewer_getVisusClassName)
    else:
        getVisusClassName = _VisusAppKitPy.Viewer_getVisusClassName
...
def Viewer_getVisusClassName():
    return _VisusAppKitPy.Viewer_getVisusClassName()
Viewer_getVisusClassName = _VisusAppKitPy.Viewer_getVisusClassName
