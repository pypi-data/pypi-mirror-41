...
class IdxFile(VisusKernelPy.Object):
    __swig_setmethods__ = {}
    ...
    __repr__ = _swig_repr
    if _newclass:
        getVisusClassName = staticmethod(_VisusIdxPy.IdxFile_getVisusClassName)
    else:
        getVisusClassName = _VisusIdxPy.IdxFile_getVisusClassName
    ...
    if _newclass:
        openFromUrl = staticmethod(_VisusIdxPy.IdxFile_openFromUrl)
    else:
        openFromUrl = _VisusIdxPy.IdxFile_openFromUrl
...
def IdxFile_getVisusClassName():
    return _VisusIdxPy.IdxFile_getVisusClassName()
IdxFile_getVisusClassName = _VisusIdxPy.IdxFile_getVisusClassName
...
def IdxFile_openFromUrl(url):
    return _VisusIdxPy.IdxFile_openFromUrl(url)
IdxFile_openFromUrl = _VisusIdxPy.IdxFile_openFromUrl
...
class IdxDataset(VisusDbPy.Dataset):
    ...
    __repr__ = _swig_repr
    if _newclass:
        getVisusClassName = staticmethod(_VisusIdxPy.IdxDataset_getVisusClassName)
    else:
        getVisusClassName = _VisusIdxPy.IdxDataset_getVisusClassName
    ...
    __del__ = lambda self: None
    if _newclass:
        loadDataset = staticmethod(_VisusIdxPy.IdxDataset_loadDataset)
    else:
        loadDataset = _VisusIdxPy.IdxDataset_loadDataset
    if _newclass:
    ...
    def compress(self, compression):
        return _VisusIdxPy.IdxDataset_compress(self, compression)
    ...
    if _newclass:
        create = staticmethod(_VisusIdxPy.IdxDataset_create)
    else:
        create = _VisusIdxPy.IdxDataset_create

    def setIdxFile(self, value):
        return _VisusIdxPy.IdxDataset_setIdxFile(self, value)

    def cloneForMosaic(self):
        return _VisusIdxPy.IdxDataset_cloneForMosaic(self)
...
def IdxDataset_getVisusClassName():
    return _VisusIdxPy.IdxDataset_getVisusClassName()
IdxDataset_getVisusClassName = _VisusIdxPy.IdxDataset_getVisusClassName

def IdxDataset_loadDataset(url):
    return _VisusIdxPy.IdxDataset_loadDataset(url)
IdxDataset_loadDataset = _VisusIdxPy.IdxDataset_loadDataset

def IdxDataset_tryRemoveLockAndCorruptedBinaryFiles(*args):
    return _VisusIdxPy.IdxDataset_tryRemoveLockAndCorruptedBinaryFiles(*args)
...
def IdxDataset_create(*args):
    return _VisusIdxPy.IdxDataset_create(*args)
IdxDataset_create = _VisusIdxPy.IdxDataset_create
...
class IdxMultipleDataset(IdxDataset):
    ...
    __repr__ = _swig_repr
    if _newclass:
        getVisusClassName = staticmethod(_VisusIdxPy.IdxMultipleDataset_getVisusClassName)
    else:
        getVisusClassName = _VisusIdxPy.IdxMultipleDataset_getVisusClassName
...
def IdxMultipleDataset_getVisusClassName():
    return _VisusIdxPy.IdxMultipleDataset_getVisusClassName()
IdxMultipleDataset_getVisusClassName = _VisusIdxPy.IdxMultipleDataset_getVisusClassName
