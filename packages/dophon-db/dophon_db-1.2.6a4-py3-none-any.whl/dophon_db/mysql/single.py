...
def getDbObj(path, debug: bool = False, auto_fix: bool = False, proxy_getter: bool = True):
    """
    获取数据表实例
    :param path: xml文件路径
    ...
    singleton_obj = CurObj(r_path, True, debug, proxy_getter)
    obj_manager[r_path] = singleton_obj
    return singleton_obj


def getPgObj(path, debug: bool = False, auto_fix: bool = False, proxy_getter: bool = True):
    """
    获取数据表实例
    :param path: xml文件路径
    :param debug: 是否开启调试模式
    ...
    if r_path in obj_manager:
        return obj_manager[r_path]
    singleton_obj = PageObj(r_path, True, debug, proxy_getter)
    obj_manager[r_path] = singleton_obj
    return singleton_obj
