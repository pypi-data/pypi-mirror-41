...
class TestCvmfsDevMsg(unittest.TestCase):
    ...
    def test_order(self):
        ...
        threading.Timer(5, self.triggerSingal).start()
        self.gateway.start()

        # define the order
        order = ['lhcb-2018-patches', 'lhcb-tdr-test',
                 'lhcb-run2-patches', 'lhcb-gauss-dev', 'lhcb-2017-patches',
                 ...
                 'lhcb-gauss-newgen',
                 'lhcb-clang-test', 'lhcb-reco14-patches',
