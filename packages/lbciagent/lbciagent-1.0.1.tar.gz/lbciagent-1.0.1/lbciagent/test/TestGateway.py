...
class TestCvmfsDevMsg(unittest.TestCase):
    ...
    def test_BigData(self):
        ...
        # define the order
        order = ['lhcb-head', 'lhcb-clang-test', 'lhcb-gaudi-merge',
                 'lhcb-future', 'lhcb-2017-patches', 'lhcb-2018-patches',
                 'lhcb-gaudi-head', 'lhcb-2016-patches', 'lhcb-gauss-cmake',
                 'lhcb-gauss-dev', 'lhcb-sim09-upgrade', 'lhcb-lcg-dev4',
                 'lhcb-reco14-patches', 'lhcb-stripping21-patches',
                 'lhcb-gauss-newgen', 'lhcb-gauss-newgen2',
