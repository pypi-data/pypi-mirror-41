...
def getStyles(styleFaces, config):
    ...
    return [(FormatTypes.Default,
            ...
            (FormatTypes.Heading4, "fore:%(bordeaux)s,bold,face:%(mono)s,size:%(heading4)d" % styleFaces),
            (FormatTypes.Heading3, "fore:%(bordeaux)s,bold,face:%(mono)s,size:%(heading3)d" % styleFaces),
            (FormatTypes.Heading2, "fore:%(bordeaux)s,bold,face:%(mono)s,size:%(heading2)d" % styleFaces),
            (FormatTypes.Heading1, "fore:%(bordeaux)s,bold,face:%(mono)s,size:%(heading1)d" % styleFaces),
            (FormatTypes.Url,
                    "fore:%(colLink)s,face:%(mono)s,size:%(size)d" % styleFaces),
            (FormatTypes.Script,
            ...
            (FormatTypes.ToDo, "fore:%(darkgreen)s,bold,face:%(mono)s,size:%(size)d" % styleFaces)]
#    return [(FormatTypes.Default,
#                    "fore:%(colPlaintext)s,face:%(mono)s,size:%(size)d" % styleFaces),
#            (FormatTypes.WikiWord,
