...
import re
from WikidPad.lib.pwiki.WikiExceptions import *
from WikidPad.lib.pwiki import StringOps, Localization
from WikidPad.lib.pwiki.StringOps import UPPERCASE, LOWERCASE, revStr
...
+r"\d+(\-\d+)+|"
+r"[" + LETTERS + r"]+((\-|\d+)(\w+|\d)?)+|"
+r"[" + UPPERCASE + r"]+[" + LOWERCASE + r"]+[" + UPPERCASE + r"]+[" + LETTERS + string.digits + r"]*|"
