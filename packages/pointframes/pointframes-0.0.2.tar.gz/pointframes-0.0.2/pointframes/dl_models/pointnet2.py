...
class PointNet2(object):
    ''' Object for configuring PointNet++ training.
        All attributes defaults are set to those released in
        the original implementation.

        train_data attribute must be a PointNet2_Data object.
    '''
    ...
    def train(self):
        pf.dl_models.train_pointnet2(self)

    def predict(self):
        inference_array = pf.dl_models.pointnet2_prediction(self)
        return inference_array

class PointNet2_Data():
    ''' PointNet2 training data class.
        Contains all variables to train an instance
        of PointNet2 defined in this file.
    '''
    ...
    def __init__(self):
        ...
        self._train_smpw = None
        self._test_smpw = None
        self._num_classes = None
    ...
    @property
    def train_smpw(self):
        return self._train_smpw
    @train_smpw.setter
    def train_smpw(self, train_smpw):
        self._train_labels = train_smpw

    @property
    def test_smpw(self):
        return self._test_smpw
    @test_smpw.setter
    def test_smpw(self, test_smpw):
        self._test_smpw = test_smpw

class PointNet2_Predict(object):
