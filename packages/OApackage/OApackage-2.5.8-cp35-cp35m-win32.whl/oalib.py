...
class arrayfile_t(object):
    ...
    def __init__(self, *args):
        ...
        __init__(arrayfile::arrayfile_t self, std::string const filename, int nrows, int ncols, int narrays=-1, arrayfile::arrayfilemode_t m, int nb=8) -> arrayfile_t
        __init__(arrayfile::arrayfile_t self, std::string const filename, int nrows, int ncols, int narrays=-1, arrayfile::arrayfilemode_t m) -> arrayfile_t
    ...
    def createfile(self, *args):
        """
        createfile(arrayfile_t self, std::string const filename, int nrows, int ncols, int narrays=-1, arrayfile::arrayfilemode_t m, int nb=8)
