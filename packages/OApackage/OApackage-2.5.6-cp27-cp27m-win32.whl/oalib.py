...
def print_combinations(n, k):
    ...
    """
    return _oalib.print_combinations(n, k)
...
def createJ2tableConference(confmatrix):
    """createJ2tableConference(array_link confmatrix) -> array_link"""
    return _oalib.createJ2tableConference(confmatrix)

def createJdtable(al):
    """createJdtable(array_link al) -> array_link"""
    return _oalib.createJdtable(al)
...
class array_link(object):
    ...
    def Fvalues(self, jj):
        """
        Fvalues(array_link self, int jj) -> intVector
        ...
        """
        return _oalib.array_link_Fvalues(self, jj)


    def FvaluesConference(self, jj):
        """
        FvaluesConference(array_link self, int jj) -> intVector
        ...
        """
        return _oalib.array_link_FvaluesConference(self, jj)
    ...
    def __add__(self, *args):
        ...
        __add__(array_link self, array_t v) -> array_link
        """
    ...
    def __sub__(self, *args):
        ...
        __sub__(array_link self, array_t v) -> array_link
        """
    ...
    def __mul__(self, *args):
        ...
        __mul__(array_link self, array_t val) -> array_link
        """
        return _oalib.array_link___mul__(self, *args)


    def __imul__(self, val):
        """__imul__(array_link self, array_t val) -> array_link"""
        return _oalib.array_link___imul__(self, val)


    def __iadd__(self, val):
        """__iadd__(array_link self, array_t val) -> array_link"""
        return _oalib.array_link___iadd__(self, val)


    def __isub__(self, val):
        """__isub__(array_link self, array_t val) -> array_link"""
        return _oalib.array_link___isub__(self, val)
    ...
    def __init__(self, *args):
        ...
        __init__(array_link self, array_link arg2, intVector colperm) -> array_link
        ...
        __init__(array_link self, intVector v, rowindex_t nrows, colindex_t ncols, int index=0) -> array_link
        __init__(array_link self, intVector v, rowindex_t nrows, colindex_t ncols) -> array_link
...
def Jcharacteristics_conference(al, jj, verbose=0):
    """
    ...
    """
    return _oalib.Jcharacteristics_conference(al, jj, verbose)
...
class jstructbase_t(object):
    ...
    def calc(self, al):
        """
        calc(jstructbase_t self, array_link al)



        """
        return _oalib.jstructbase_t_calc(self, al)
...
class jstruct_t(object):
    ...
    abberation = _swig_property(_oalib.jstruct_t_abberation_get, _oalib.jstruct_t_abberation_set)
...
class jstructconference_t(jstructbase_t):
    ...
    def __init__(self, *args):
        ...
        __init__(jstructconference_t self, array_link al, int jj=4) -> jstructconference_t
        __init__(jstructconference_t self, array_link al) -> jstructconference_t
...
def jvaluefast(array, N, J, pp):
    """jvaluefast(array_t const * array, rowindex_t N, int const J, colindex_t const * pp) -> int"""
    return _oalib.jvaluefast(array, N, J, pp)
...
class arrayfile_t(object):
    ...
    def __init__(self, *args):
        ...
        __init__(arrayfile::arrayfile_t self, std::string const fname, int verbose=1) -> arrayfile_t
        __init__(arrayfile::arrayfile_t self, std::string const fname) -> arrayfile_t
        __init__(arrayfile::arrayfile_t self, std::string const fname, int nrows, int ncols, int narrays=-1, arrayfile::arrayfilemode_t m, int nb=8) -> arrayfile_t
        __init__(arrayfile::arrayfile_t self, std::string const fname, int nrows, int ncols, int narrays=-1, arrayfile::arrayfilemode_t m) -> arrayfile_t
        __init__(arrayfile::arrayfile_t self, std::string const fname, int nrows, int ncols, int narrays=-1) -> arrayfile_t
        __init__(arrayfile::arrayfile_t self, std::string const fname, int nrows, int ncols) -> arrayfile_t
    ...
    def createfile(self, *args):
        """
        createfile(arrayfile_t self, std::string const fname, int nrows, int ncols, int narrays=-1, arrayfile::arrayfilemode_t m, int nb=8)
        createfile(arrayfile_t self, std::string const fname, int nrows, int ncols, int narrays=-1, arrayfile::arrayfilemode_t m)
        createfile(arrayfile_t self, std::string const fname, int nrows, int ncols, int narrays=-1)
        createfile(arrayfile_t self, std::string const fname, int nrows, int ncols)
...
def readarrayfile(*args):
    ...
    readarrayfile(char const * fname, arraylist_t arraylist, int verbose=1, int * setcols=None, int * setrows=None, int * setbits=None) -> int
    readarrayfile(char const * fname, arraylist_t arraylist, int verbose=1, int * setcols=None, int * setrows=None) -> int
    readarrayfile(char const * fname, arraylist_t arraylist, int verbose=1, int * setcols=None) -> int
    readarrayfile(char const * fname, arraylist_t arraylist, int verbose=1) -> int
    readarrayfile(char const * fname, arraylist_t arraylist) -> int
    """
    return _oalib.readarrayfile(*args)

def writearrayfile(*args):
    """
    writearrayfile(char const * fname, arraylist_t arraylist, arrayfile::arrayfilemode_t mode, int nrows, int ncols) -> int
    writearrayfile(char const * fname, arraylist_t arraylist, arrayfile::arrayfilemode_t mode, int nrows) -> int
    writearrayfile(char const * fname, arraylist_t arraylist, arrayfile::arrayfilemode_t mode) -> int
    writearrayfile(char const * fname, arraylist_t arraylist) -> int
...
def create_arrayfile(*args):
    """
    create_arrayfile(char const * fname, int rows, int cols, int narrays, arrayfile::arrayfilemode_t mode, int nbits=8) -> arrayfile_t
    create_arrayfile(char const * fname, int rows, int cols, int narrays, arrayfile::arrayfilemode_t mode) -> arrayfile_t
    create_arrayfile(char const * fname, int rows, int cols, int narrays) -> arrayfile_t
    """
    return _oalib.create_arrayfile(*args)
...
def selectArrays(*args):
    ...
    selectArrays(std::string filename, int ii) -> array_link
...
def array2eigenMainEffects(array, verbose=1):
    """
    array2eigenMainEffects(array_link array, int verbose=1) -> MatrixFloat
    array2eigenMainEffects(array_link array) -> MatrixFloat
    """
    return _oalib.array2eigenMainEffects(array, verbose)
...
def base_name(path):
    """
    base_name(std::string const & path) -> std::string



    """
    return _oalib.base_name(path)
...
def Defficiency(al, verbose=0):
    """
    Defficiency(array_link al, int verbose=0) -> double
    Defficiency(array_link al) -> double
    ...
    """
    return _oalib.Defficiency(al, verbose)

def Defficiencies(al, arrayclass, verbose=0, addDs0=0):
    """
    Defficiencies(array_link al, arraydata_t arrayclass, int verbose=0, int addDs0=0) -> doubleVector
    Defficiencies(array_link al, arraydata_t arrayclass, int verbose=0) -> doubleVector
    Defficiencies(array_link al, arraydata_t arrayclass) -> doubleVector



    """
    return _oalib.Defficiencies(al, arrayclass, verbose, addDs0)
...
def projDeff(al, number_of_factors, verbose=0):
    """
    projDeff(array_link al, int number_of_factors, int verbose=0) -> doubleVector
    projDeff(array_link al, int number_of_factors) -> doubleVector
    ...
    * `verbose` :  
    ...
    """
    return _oalib.projDeff(al, number_of_factors, verbose)
...
def Jcharacteristics(al, jj=4, verbose=0):
    """
    Jcharacteristics(array_link al, int jj=4, int verbose=0) -> intVector
    Jcharacteristics(array_link al, int jj=4) -> intVector
    Jcharacteristics(array_link al) -> intVector
    ...
    """
    return _oalib.Jcharacteristics(al, jj, verbose)
...
def GWLPmixed(al, verbose=0, truncate=1):
    """
    GWLPmixed(array_link al, int verbose=0, int truncate=1) -> doubleVector
    GWLPmixed(array_link al, int verbose=0) -> doubleVector
    GWLPmixed(array_link al) -> doubleVector
    ...
    * `truncate` :  
    ...
    """
    return _oalib.GWLPmixed(al, verbose, truncate)
...
def projectionGWLPdoublevalues(al):
    """
    projectionGWLPdoublevalues(array_link al) -> doubleVector
    ...
    """
    return _oalib.projectionGWLPdoublevalues(al)

def CL2discrepancy(al):
    """
    CL2discrepancy(array_link al) -> double
    ...
    """
    return _oalib.CL2discrepancy(al)
...
def conference_design2modelmatrix(conference_design, mode, verbose):
    """
    conference_design2modelmatrix(array_link conference_design, char const * mode, int verbose) -> array_link
...
def md5(*args):
    """
    md5(void * data, int numbytes) -> std::string
...
def scoreD(efficiencies, alpha):
    """
    scoreD(doubleVector efficiencies, doubleVector alpha) -> double
    ...
    * `alpha` :  
    ...
    """
    return _oalib.scoreD(efficiencies, alpha)
...
def optimDeff(A0, arrayclass, alpha, verbose=1, optimmethod=DOPTIM_AUTOMATIC, niter=100000, nabort=0):
    """
    optimDeff(array_link A0, arraydata_t arrayclass, doubleVector alpha, int verbose=1, int optimmethod=DOPTIM_AUTOMATIC, int niter=100000, int nabort=0) -> array_link
    optimDeff(array_link A0, arraydata_t arrayclass, doubleVector alpha, int verbose=1, int optimmethod=DOPTIM_AUTOMATIC, int niter=100000) -> array_link
    optimDeff(array_link A0, arraydata_t arrayclass, doubleVector alpha, int verbose=1, int optimmethod=DOPTIM_AUTOMATIC) -> array_link
    optimDeff(array_link A0, arraydata_t arrayclass, doubleVector alpha, int verbose=1) -> array_link
    optimDeff(array_link A0, arraydata_t arrayclass, doubleVector alpha) -> array_link
    ...
    * `nabort` :  
    ...
    """
    return _oalib.optimDeff(A0, arrayclass, alpha, verbose, optimmethod, niter, nabort)
class DoptimReturn(object):
    ...
    nimproved = _swig_property(_oalib.DoptimReturn_nimproved_get, _oalib.DoptimReturn_nimproved_set)
...
def Doptimize(arrayclass, nrestarts, alpha, verbose, method=DOPTIM_AUTOMATIC, niter=300000, maxtime=100000, nabort=5000):
    """
    Doptimize(arraydata_t arrayclass, int nrestarts, doubleVector alpha, int verbose, int method=DOPTIM_AUTOMATIC, int niter=300000, double maxtime=100000, int nabort=5000) -> DoptimReturn
    Doptimize(arraydata_t arrayclass, int nrestarts, doubleVector alpha, int verbose, int method=DOPTIM_AUTOMATIC, int niter=300000, double maxtime=100000) -> DoptimReturn
    Doptimize(arraydata_t arrayclass, int nrestarts, doubleVector alpha, int verbose, int method=DOPTIM_AUTOMATIC, int niter=300000) -> DoptimReturn
    Doptimize(arraydata_t arrayclass, int nrestarts, doubleVector alpha, int verbose, int method=DOPTIM_AUTOMATIC) -> DoptimReturn
...
class OAextend(object):
    ...
    def __init__(self, *args):
        ...
        __init__(OAextend self, arraydata_t ad) -> OAextend
...
def extend_arraylist(*args):
    ...
    extend_arraylist(arraylist_t alist, arraydata_t arrayclass) -> arraylist_t
...
def extend_array(*args):
    """
    extend_array(array_link al, arraydata_t array_class, OAextend oaextend) -> arraylist_t
    extend_array(array_link al, arraydata_t arrayclass) -> arraylist_t
    extend_array(carray_t * array, arraydata_t arg2, colindex_t const extensioncol, arraylist_t solutions, OAextend oaextend) -> int
...
def apply_hadamard(al, hcol):
    """
    apply_hadamard(array_link al, colindex_t hcol)
    ...
    """
    return _oalib.apply_hadamard(al, hcol)
...
class conference_t(object):
    ...
    def create_root_three(self):
        """
        create_root_three(conference_t self) -> array_link
        ...
        """
        return _oalib.conference_t_create_root_three(self)


    def createDconferenceRootArrays(self):
        """
        createDconferenceRootArrays(conference_t self) -> arraylist_t
        ...
        """
        return _oalib.conference_t_createDconferenceRootArrays(self)


    def addRootArrays(self, lst):
        """
        addRootArrays(conference_t self, arraylist_t lst)
        ...
        """
        return _oalib.conference_t_addRootArrays(self, lst)
...
def generateConferenceExtensions(array, conference_type, zero_index, verbose=1, filtersymm=1, filterj2=1):
    """
    generateConferenceExtensions(array_link array, conference_t conference_type, int zero_index, int verbose=1, int filtersymm=1, int filterj2=1) -> conference_columnVector
    generateConferenceExtensions(array_link array, conference_t conference_type, int zero_index, int verbose=1, int filtersymm=1) -> conference_columnVector
    ...
    * `filterj2` :  
    ...
    """
    return _oalib.generateConferenceExtensions(array, conference_type, zero_index, verbose, filtersymm, filterj2)

def generateConferenceRestrictedExtensions(array, conference_type, zero_index, verbose=1, filtersymm=1, filterip=1):
    """
    generateConferenceRestrictedExtensions(array_link array, conference_t conference_type, int zero_index, int verbose=1, int filtersymm=1, int filterip=1) -> conference_columnVector
    generateConferenceRestrictedExtensions(array_link array, conference_t conference_type, int zero_index, int verbose=1, int filtersymm=1) -> conference_columnVector
    ...
    """
    return _oalib.generateConferenceRestrictedExtensions(array, conference_type, zero_index, verbose, filtersymm, filterip)

def generateDoubleConferenceExtensions(array, conference_type, verbose=1, filtersymm=1, filterip=1, filterJ3=0, filtersymminline=1):
    """
    generateDoubleConferenceExtensions(array_link array, conference_t conference_type, int verbose=1, int filtersymm=1, int filterip=1, int filterJ3=0, int filtersymminline=1) -> conference_columnVector
    generateDoubleConferenceExtensions(array_link array, conference_t conference_type, int verbose=1, int filtersymm=1, int filterip=1, int filterJ3=0) -> conference_columnVector
    generateDoubleConferenceExtensions(array_link array, conference_t conference_type, int verbose=1, int filtersymm=1, int filterip=1) -> conference_columnVector
    generateDoubleConferenceExtensions(array_link array, conference_t conference_type, int verbose=1, int filtersymm=1) -> conference_columnVector
    ...
    """
    return _oalib.generateDoubleConferenceExtensions(array, conference_type, verbose, filtersymm, filterip, filterJ3, filtersymminline)

def generateSingleConferenceExtensions(array, conference_type, zero_index, verbose, filtersymm, filterj2, filterj3, filtersymminline=0):
    """
    generateSingleConferenceExtensions(array_link array, conference_t conference_type, int zero_index, int verbose, int filtersymm, int filterj2, int filterj3, int filtersymminline=0) -> conference_columnVector
    generateSingleConferenceExtensions(array_link array, conference_t conference_type, int zero_index, int verbose, int filtersymm, int filterj2, int filterj3) -> conference_columnVector
    ...
    """
    return _oalib.generateSingleConferenceExtensions(array, conference_type, zero_index, verbose, filtersymm, filterj2, filterj3, filtersymminline)
...
def compareLMC0(alL, alR):
    """
    compareLMC0(array_link alL, array_link alR) -> bool
    ...
    """
    return _oalib.compareLMC0(alL, alR)

def sortLMC0(lst):
    """
    sortLMC0(arraylist_t lst) -> arraylist_t
...
def LMC0check(al, verbose=0):
    """
    LMC0check(array_link al, int verbose=0) -> lmc_t
    LMC0check(array_link al) -> lmc_t
    ...
    """
    return _oalib.LMC0check(al, verbose)

def isConferenceFoldover(al, verbose=0):
    """
    isConferenceFoldover(array_link al, int verbose=0) -> bool
    isConferenceFoldover(array_link al) -> bool
    ...
    """
    return _oalib.isConferenceFoldover(al, verbose)
...
class DconferenceFilter(object):
    ...
    def __init__(self, _als, filtersymm_, filterj2_, filterj3_=1):
        """
        __init__(DconferenceFilter self, array_link _als, int filtersymm_, int filterj2_, int filterj3_=1) -> DconferenceFilter
        __init__(DconferenceFilter self, array_link _als, int filtersymm_, int filterj2_) -> DconferenceFilter



        """
        this = _oalib.new_DconferenceFilter(_als, filtersymm_, filterj2_, filterj3_)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
class mvalue_t_long(object):
    ...
    def __init__(self, *args):
        ...
        __init__(mvalue_t<(long)> self, long m, mvalue_t< long >::direction_t dd) -> mvalue_t_long
        __init__(mvalue_t<(long)> self, long m) -> mvalue_t_long
        __init__(mvalue_t<(long)> self, longVector vv, mvalue_t< long >::direction_t dd) -> mvalue_t_long
        __init__(mvalue_t<(long)> self, longVector vv) -> mvalue_t_long
...
class mvalue_t_double(object):
    ...
    def __init__(self, *args):
        ...
        __init__(mvalue_t<(double)> self, double m, mvalue_t< double >::direction_t dd) -> mvalue_t_double
        __init__(mvalue_t<(double)> self, double m) -> mvalue_t_double
        __init__(mvalue_t<(double)> self, doubleVector vv, mvalue_t< double >::direction_t dd) -> mvalue_t_double
        __init__(mvalue_t<(double)> self, doubleVector vv) -> mvalue_t_double
...
class ParetoLongLong(object):
    ...
    def addvalue(self, val, idx):
        """
        addvalue(ParetoLongLong self, longVector val, long const idx) -> bool
        ...
        """
        return _oalib.ParetoLongLong_addvalue(self, val, idx)
...
class ParetoMultiLongLong(object):
    ...
    def addvalue(self, val, idx):
        """
        addvalue(ParetoMultiLongLong self, vector_mvalue_t_long val, long const idx) -> bool
        ...
        """
        return _oalib.ParetoMultiLongLong_addvalue(self, val, idx)
...
class ParetoMultiDoubleLong(object):
    ...
    def addvalue(self, val, idx):
        """
        addvalue(ParetoMultiDoubleLong self, vector_mvalue_t_double val, long const idx) -> bool
        ...
        """
        return _oalib.ParetoMultiDoubleLong_addvalue(self, val, idx)
...
class ParetoDoubleLong(object):
    ...
    def addvalue(self, val, idx):
        """
        addvalue(ParetoDoubleLong self, doubleVector val, long const idx) -> bool
        ...
        """
        return _oalib.ParetoDoubleLong_addvalue(self, val, idx)
