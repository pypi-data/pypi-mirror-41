...
class ModelParams(object):
    ...
    def __init__(self, long_name=None, desc=None, readonly=None, threshold=None, reference_time=None, regex=None, similar_words=None, word_manifold=None, lid_model_file=None):  # noqa: E501
